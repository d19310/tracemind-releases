"use strict";var f8=Object.create;var El=Object.defineProperty;var h8=Object.getOwnPropertyDescriptor;var g8=Object.getOwnPropertyNames;var m8=Object.getPrototypeOf,y8=Object.prototype.hasOwnProperty;var yn=(t,e)=>()=>(t&&(e=t(t=0)),e);var An=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),wi=(t,e)=>{for(var n in e)El(t,n,{get:e[n],enumerable:!0})},mh=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let a of g8(e))!y8.call(t,a)&&a!==n&&El(t,a,{get:()=>e[a],enumerable:!(i=h8(e,a))||i.enumerable});return t};var Le=(t,e,n)=>(n=t!=null?f8(m8(t)):{},mh(e||!t||!t.__esModule?El(n,"default",{value:t,enumerable:!0}):n,t)),x8=t=>mh(El({},"__esModule",{value:!0}),t);var id={};wi(id,{buildRequest:()=>Hs,chat:()=>Cl,createProviderHttpError:()=>Us,extractStreamDelta:()=>ed,parseResponse:()=>Sl,streamChat:()=>nd,summarizeProviderErrorBody:()=>xh,validateConfig:()=>ga});function ga(t){return t.provider?t.provider!=="ollama"&&(!t.apiKey||t.apiKey.trim()==="")?{valid:!1,error:"AI Provider API Key \u672A\u914D\u7F6E"}:!t.model||t.model.trim()===""?{valid:!1,error:"AI Provider \u6A21\u578B\u672A\u914D\u7F6E"}:{valid:!0}:{valid:!1,error:"AI Provider \u7C7B\u578B\u7F3A\u5931"}}function b8(t){return t.replace(/sk-[a-zA-Z0-9_-]{20,}/g,"sk-***").replace(/Bearer\s+[a-zA-Z0-9._\-+=]+/gi,"Bearer ***").replace(/x-api-key:\s*\S+/gi,"x-api-key: ***")}function xh(t){let e;try{let a=JSON.parse(t);e=a.error?.message||a.message||""}catch{e=t}let i=String(e).trim().replace(/\n/g," ").slice(0,v8);return i?b8(i):"(empty response)"}async function Us(t){let e=await t.text().catch(()=>""),n=xh(e);return new Error(`AI Provider \u8BF7\u6C42\u5931\u8D25 (HTTP ${t.status}): ${n}`)}function Hs(t,e){let n=e.find(a=>a.role==="system"),i=e.filter(a=>a.role!=="system");switch(t.provider){case"openai":{let a=(t.baseUrl||"https://api.openai.com").replace(/\/+$/,""),r=a.endsWith("/v1")?"/chat/completions":"/v1/chat/completions",s=t.reasoningEffort||(t.enableThinking?"high":void 0),o={model:t.model,messages:e};return s&&(o.reasoning_effort=s),{url:`${a}${r}`,method:"POST",headers:{Authorization:`Bearer ${t.apiKey}`,"Content-Type":"application/json"},body:JSON.stringify(o)}}case"anthropic":{let a={model:t.model,system:n?.content,messages:i.map(r=>({role:r.role,content:r.content}))};return(t.enableThinking||t.reasoningEffort)&&(a.thinking={type:"adaptive",effort:t.reasoningEffort||"high"}),{url:t.baseUrl||"https://api.anthropic.com/v1/messages",method:"POST",headers:{"x-api-key":t.apiKey,"anthropic-version":"2023-06-01","Content-Type":"application/json"},body:JSON.stringify(a)}}default:{let r=(t.baseUrl||(t.provider==="ollama"?"http://localhost:11434":"")).replace(/\/+$/,""),s=r.endsWith("/v1")?"/chat/completions":"/v1/chat/completions",o=t.reasoningEffort||(t.enableThinking?"high":void 0),l={model:t.model,messages:e};return o&&(l.reasoning_effort=o),{url:`${r}${s}`,method:"POST",headers:{"Content-Type":"application/json",...t.apiKey?{Authorization:`Bearer ${t.apiKey}`}:{}},body:JSON.stringify(l)}}}}async function Cl(t,e){let n=ga(e);if(!n.valid)throw new Error(n.error);let i=Hs(e,t),a=await fetch(i.url,{method:i.method||"POST",headers:i.headers,body:i.body});if(!a.ok)throw await Us(a);let r=await a.json();return{content:Sl(e.provider,r).content}}function ed(t,e){if(!e.startsWith("data: "))return"";let n=e.slice(6).trim();if(!n||n==="[DONE]")return"";try{let i=JSON.parse(n);if(t==="anthropic")return i.type==="content_block_delta"&&i.delta?.text?i.delta.text:"";let a=i.choices;return a&&a.length>0&&a[0].delta?.content?a[0].delta.content:""}catch{return""}}async function nd(t,e,n){let i=ga(e);if(!i.valid){n.onError(new Error(i.error));return}try{let a=Hs(e,t),r=JSON.parse(a.body||"{}");r.stream=!0;let s={...a.headers,Accept:"text/event-stream"},o=await fetch(a.url,{method:a.method||"POST",headers:s,body:JSON.stringify(r)});if(!o.ok)throw await Us(o);if(!o.body)throw new Error("Response body is null \u2014 streaming not supported");let l=o.body.getReader(),c=new TextDecoder,u="",d="";for(;;){let{done:p,value:f}=await l.read();if(p)break;d+=c.decode(f,{stream:!0});let y=d.split(`
`);d=y.pop()||"";for(let x of y){let E=x.trim();if(!E)continue;let v=ed(e.provider,E);v&&(u+=v,n.onDelta(v))}}if(d.trim()){let p=ed(e.provider,d.trim());p&&(u+=p,n.onDelta(p))}n.onDone(u)}catch(a){n.onError(a)}}function Sl(t,e){switch(t){case"openai":{let n=e.choices;if(!n||n.length===0)throw new Error("Empty response from OpenAI");return{role:"assistant",content:n[0].message.content}}case"anthropic":{let n=e.content;if(!n||n.length===0)throw new Error("Empty response from Anthropic");return{role:"assistant",content:n[0].text}}default:{let n=e.choices;if(!n||n.length===0)throw new Error("Empty response from AI provider");return{role:"assistant",content:n[0].message.content}}}}var v8,Ci=yn(()=>{"use strict";v8=200});function Eh(t){let e=require("fs");try{return e.readdirSync(t,{withFileTypes:!0}).filter(n=>n.isDirectory()).map(n=>`${t}/${n.name}`)}catch{return[]}}function E8(t){let e=`${t}/.nvm/versions/node`,n=`${t}/.local/share/fnm/node-versions`,i=Eh(e).map(r=>`${r}/bin`),a=Eh(n).map(r=>`${r}/installation/bin`);return wh([...i,...a,`${t}/.asdf/shims`,`${t}/.local/share/mise/shims`])}function w8(){let{homedir:t}=require("os"),e=t();return[`${e}/.opencode/bin`,`${e}/.local/bin`,`${e}/.npm-global/bin`,`${e}/.bun/bin`,`${e}/.yarn/bin`,`${e}/.volta/bin`,`${e}/Library/pnpm`,...E8(e),"/opt/homebrew/bin","/usr/local/bin","/usr/bin","/bin","/usr/sbin","/sbin"]}function wh(t){return[...new Set(t.map(e=>e.trim()).filter(Boolean))]}function C8(t){return`'${t.replace(/'/g,"'\\''")}'`}function S8(){let{execSync:t}=require("child_process"),e=process.env.SHELL||"/bin/zsh";try{return t('printf "%s" "$PATH"',{encoding:"utf-8",timeout:3e3,shell:e,env:process.env}).trim()}catch{return""}}function A8(t){return[...new Set([...(t||"").split(":").filter(Boolean),...S8().split(":").filter(Boolean),...w8()])].join(":")}function ad(t){let e={...process.env,...t};return e.PATH=A8(e.PATH),e}async function ge(t){let{execSync:e}=require("child_process"),n=ad(),i=n.PATH.split(":").map(s=>`${s}/${t}`),a=process.env.SHELL||"/bin/zsh";try{let s=e(`command -v ${C8(t)}`,{encoding:"utf-8",timeout:5e3,shell:a,env:n}).trim().split(/\r?\n/)[0];if(s)return s}catch{}let r=[...i,t];for(let s of wh(r))try{return e(`"${s}" --version 2>&1`,{encoding:"utf-8",timeout:5e3,env:n}),s}catch{continue}return null}var mr=yn(()=>{"use strict"});var Sh={};wi(Sh,{claudeCodeProvider:()=>rd});var T8,M8,Ch,_8,rd,sd=yn(()=>{"use strict";mr();({spawn:T8}=require("child_process")),M8=require("readline"),Ch="claude",_8=600*1e3,rd={name:"Claude Code",description:"Anthropic \u51FA\u54C1\u7684\u672C\u5730 AI \u7F16\u7A0B agent\uFF0C\u901A\u8FC7 claude CLI \u8C03\u7528",async detect(){let t=await ge(Ch);if(!t)return!1;try{let{execSync:e}=require("child_process"),n=e(`"${t}" --version 2>&1`,{encoding:"utf-8",timeout:1e4});return/[Cc]laude|[0-9]+\.[0-9]+\.[0-9]+/.test(n)}catch{return!1}},execute(t,e){let n=null,i=!1,a=null,r=null,s=null,o=Date.now(),l=e?.timeoutMs||_8;return(async()=>{try{let u=await ge(Ch);if(!u){let h=new Error("\u627E\u4E0D\u5230 claude CLI\uFF0C\u8BF7\u786E\u8BA4\u5DF2\u5B89\u88C5 Claude Code");s?.(h),r?.({status:"failed",output:"",error:h.message,durationMs:Date.now()-o});return}let d=["-p","--output-format","stream-json","--input-format","stream-json","--verbose"];e?.model&&d.push("--model",e.model);let p={...process.env};if(e?.env&&Object.assign(p,e.env),n=T8(u,d,{env:p,cwd:e?.cwd||process.cwd(),stdio:["pipe","pipe","pipe"]}),i){n.kill();return}n.on("error",h=>{s?.(h),r?.({status:"failed",output:"",error:h.message,durationMs:Date.now()-o})});let f=setTimeout(()=>{n&&!n.killed&&(n.kill(),r?.({status:"timeout",output:"",error:"\u6267\u884C\u8D85\u65F6",durationMs:Date.now()-o}))},l),y=M8.createInterface({input:n.stdout,crlfDelay:1/0}),x="",E="";y.on("line",h=>{if(h.trim())try{let b=JSON.parse(h);switch(b.type){case"system":b.session_id&&(x=b.session_id),b.subtype==="init"&&a?.({type:"status",content:"running",sessionId:x});break;case"assistant":{let j=b.message?.content||[];for(let T of j)T.type==="text"&&T.text?(E+=T.text,a?.({type:"text",content:T.text})):T.type==="tool_use"&&a?.({type:"tool-use",toolName:T.name,toolInput:T.input});break}case"user":{let j=b.message?.content||[];for(let T of j)T.type==="tool_use"&&T.name&&a?.({type:"tool-result",toolName:T.name});break}case"result":clearTimeout(f);let w=b.is_error||b.subtype==="error_during_execution",B=b.output||E;r?.({status:w?"failed":"completed",output:B,error:w?b.output||"\u672A\u77E5\u9519\u8BEF":void 0,durationMs:Date.now()-o});break}}catch{}}),y.on("close",()=>{clearTimeout(f),i||r?.({status:"completed",output:E,durationMs:Date.now()-o})});let v=JSON.stringify({type:"user",message:{role:"user",content:t}});n.stdin.write(v+`
`),n.stdin.end()}catch(u){s?.(u),r?.({status:"failed",output:"",error:u.message,durationMs:Date.now()-o})}})(),{set onMessage(u){a=u},get onMessage(){return a},set onDone(u){r=u},get onDone(){return r},set onError(u){s=u},get onError(){return s},abort(){i=!0,n&&!n.killed&&n.kill()}}}}});var _h={};wi(_h,{hermesProvider:()=>od});var I8,F8,Mh,O8,od,ld=yn(()=>{"use strict";mr();({spawn:I8}=require("child_process")),F8=require("readline"),Mh="hermes",O8=600*1e3,od={name:"Hermes",description:"\u5F00\u6E90 AI agent \u6846\u67B6\uFF0C\u652F\u6301\u591A provider\uFF0C\u901A\u8FC7 hermes CLI \u8C03\u7528",async detect(){let t=await ge(Mh);if(!t)return!1;try{let{execSync:e}=require("child_process"),n=e(`${t} --version 2>&1`,{encoding:"utf-8",timeout:1e4});return/Hermes Agent/i.test(n)}catch{return!1}},execute(t,e){let n=null,i=!1,a=null,r=null,s=null,o=Date.now();return(async()=>{try{let c=await ge(Mh);if(!c){let E=new Error("\u627E\u4E0D\u5230 hermes CLI\uFF0C\u8BF7\u786E\u8BA4\u5DF2\u5B89\u88C5 Hermes Agent");s?.(E),r?.({status:"failed",output:"",error:E.message,durationMs:Date.now()-o});return}let u=["-z",t];e?.model&&u.unshift("-m",e.model);let d={...process.env,...e?.env};if(n=I8(c,u,{env:d,cwd:e?.cwd||process.cwd(),stdio:["ignore","pipe","pipe"]}),i){n.kill();return}n.on("error",E=>{s?.(E),r?.({status:"failed",output:"",error:E.message,durationMs:Date.now()-o})});let p=setTimeout(()=>{n&&!n.killed&&(n.kill(),r?.({status:"timeout",output:"",error:"\u6267\u884C\u8D85\u65F6",durationMs:Date.now()-o}))},e?.timeoutMs||O8),f="",y=F8.createInterface({input:n.stdout,crlfDelay:1/0});y.on("line",E=>{f+=E+`
`,a?.({type:"text",content:E+`
`})}),y.on("close",()=>{clearTimeout(p),r?.({status:"completed",output:f.trim(),durationMs:Date.now()-o})});let x="";n.stderr&&n.stderr.on("data",E=>{x+=E.toString()}),n.on("close",E=>{clearTimeout(p),E!==0&&f===""&&r?.({status:"failed",output:"",error:`hermes \u9000\u51FA\u7801 ${E}: ${x.slice(0,500)}`,durationMs:Date.now()-o})})}catch(c){s?.(c),r?.({status:"failed",output:"",error:c.message,durationMs:Date.now()-o})}})(),{set onMessage(c){a=c},get onMessage(){return a},set onDone(c){r=c},get onDone(){return r},set onError(c){s=c},get onError(){return s},abort(){i=!0,n&&!n.killed&&n.kill()}}}}});async function xr(t,e){if(!t.vault.getAbstractFileByPath(e))try{await t.vault.createFolder(e)}catch(i){if(!i.message?.includes("already exists"))throw i}}async function Ne(t,e){let n=e.split("/");if(n.length<2)return;let i=n.slice(0,-1),a="";for(let r of i)a=a?`${a}/${r}`:r,await xr(t,a)}var Hn=yn(()=>{"use strict"});function Gs(t){switch(t.type){case"diary_source":case"entity_source":case"material_source":return"source";case"user_reply":case"agent_reply":return"response";case"user_note":return t.data?.replyToBlockId?"response":"thinking";case"insight":return t.data?.replyToBlockId||t.data?.userReplyBlockId?"response":"thinking";case"output":case"task":case"decision":case"experiment":return"output";case"error":case"warning":return"system";default:return"thinking"}}var gd=yn(()=>{"use strict"});function wt(){return`block-${Date.now()}-${++a7}`}function ce(t){return{id:t.id||wt(),category:t.category||Gs({type:t.type,data:t.data}),type:t.type,title:t.title,summary:t.summary,bullets:t.bullets,detail:t.detail,sourceRefs:t.sourceRefs,agentRunId:t.agentRunId,position:t.position||{x:0,y:0},size:t.size||{...Ee},data:t.data}}var a7,Ee,le,qs=yn(()=>{"use strict";gd();a7=0,Ee={width:216,height:120},le={width:190,height:104}});var Gh={};wi(Gh,{diaryBlockToSource:()=>Vh,diaryBlocksToSources:()=>s7,parseDiaryDateFromPath:()=>Hh});function Hh(t){return t?(t.match(/(?:^|\/)(\d{4}-\d{2}-\d{2})(?:\.md)?$/)||t.match(/(\d{4}-\d{2}-\d{2})/))?.[1]:void 0}function Yh(t){return t.sourceDate||Hh(t.sourcePath)}function r7(t){let e=Yh(t);return e&&t.timestamp?`\u65E5\u8BB0\uFF1A${e} ${t.timestamp}`:e?`\u65E5\u8BB0\uFF1A${e}`:t.timestamp?`\u65E5\u8BB0\uFF1A${t.timestamp}`:"\u65E5\u8BB0"}function Vh(t,e){let n=Yh(t);return ce({type:"diary_source",category:"source",title:r7(t),summary:t.content.slice(0,120),detail:t.content,data:{diaryBlockId:t.id,sourceDate:n,sourcePath:t.sourcePath,timestamp:t.timestamp,parentId:t.parentId},position:{x:100,y:100+e*180},size:{...Ee}})}function s7(t){return t.map((e,n)=>Vh(e,n))}var qh=yn(()=>{"use strict";qs()});var Xh={};wi(Xh,{createExplorationSession:()=>o7});function o7(t){let e=t.now||new Date().toISOString();return{id:t.id,title:t.title,canvasPath:t.canvasPath,createdAt:e,updatedAt:e,blocks:t.blocks||[],edges:[],groups:[],exportHistory:[]}}var Kh=yn(()=>{"use strict"});function Xs(t){let e=t;return e?.tracemind?.kind==="exploration_canvas"&&Array.isArray(e.nodes)&&Array.isArray(e.edges)}function md(t){let e=[`## ${t.title}`];return t.summary&&e.push("",t.summary),t.bullets?.length&&e.push("",...t.bullets.slice(0,3).map(n=>`- ${n}`)),e.join(`
`)}function Zh(t){return{nodes:[...t.blocks.map(e=>({id:e.id,type:e.type.endsWith("_source")&&typeof e.data?.filePath=="string"?"file":"text",x:e.position.x,y:e.position.y,width:e.size.width,height:e.size.height,text:md(e),file:typeof e.data?.filePath=="string"?e.data.filePath:void 0,tracemind:{version:"0.1",category:e.category||Gs(e),blockType:e.type,title:e.title,summary:e.summary,bullets:e.bullets,detail:e.detail,sourceRefs:e.sourceRefs,agentRunId:e.agentRunId,edited:e.edited,versions:e.versions,data:e.data}})),...(t.groups||[]).map(e=>({id:e.id,type:"group",x:e.position.x,y:e.position.y,width:e.size.width,height:e.size.height,label:e.title,tracemind:{version:"0.1",nodeType:"group",title:e.title,blockIds:e.blockIds,createdAt:e.createdAt}}))],edges:t.edges.map(e=>({id:e.id,fromNode:e.from,toNode:e.to,label:e.label,tracemind:{edgeType:e.type,agentRunId:e.agentRunId}})),tracemind:{kind:"exploration_canvas",version:"0.1",renderer:"blocksuite-edgeless",sessionId:t.id,title:t.title}}}function Qh(t){if(!Xs(t))throw new Error("Not a TraceMind exploration canvas");let e=t.nodes.filter(r=>r.type!=="group").map(r=>{let s=r.tracemind||{};return{id:r.id,type:s.blockType||"user_note",category:s.category||Gs({type:s.blockType||"user_note",data:s.data}),title:s.title||r.text?.split(`
`)[0]?.replace(/^##\s*/,"")||r.id,summary:s.summary,bullets:s.bullets,detail:s.detail,sourceRefs:s.sourceRefs,agentRunId:s.agentRunId,edited:s.edited,versions:s.versions,position:{x:r.x,y:r.y},size:{width:r.width,height:r.height},data:s.data}}),n=t.edges.map(r=>({id:r.id,from:r.fromNode,to:r.toNode,type:r.tracemind?.edgeType||"references",label:r.label,agentRunId:r.tracemind?.agentRunId})),i=new Date().toISOString(),a=t.nodes.filter(r=>r.type==="group").map(r=>{let s=r.tracemind||{};return{id:r.id,title:s.title||r.label||"\u5206\u7EC4",blockIds:Array.isArray(s.blockIds)?s.blockIds:[],position:{x:r.x,y:r.y},size:{width:r.width,height:r.height},createdAt:s.createdAt||i}});return{id:t.tracemind?.sessionId||`exploration-${Date.now()}`,title:t.tracemind?.title||"\u672A\u547D\u540D\u63A2\u7D22",canvasPath:"",createdAt:i,updatedAt:i,blocks:e,edges:n,groups:a,exportHistory:[]}}var Ml=yn(()=>{"use strict";gd()});var Jh={};wi(Jh,{loadExplorationSession:()=>xd,saveExplorationSession:()=>yd});async function yd(t,e){let n=Zh(e),i=JSON.stringify(n,null,2);await Ne(t,e.canvasPath);let a=t.vault.getFileByPath(e.canvasPath);a?await t.vault.modify(a,i):await t.vault.create(e.canvasPath,i)}async function xd(t,e){let n=t.vault.getFileByPath(e);if(!n)return null;try{let i=await t.vault.read(n),a=JSON.parse(i);if(!Xs(a))return null;let r=Qh(a);return r.canvasPath=e,r}catch{return null}}var vd=yn(()=>{"use strict";Ml();Hn()});var Ig=An(K=>{"use strict";var Bd=Symbol.for("react.transitional.element"),T7=Symbol.for("react.portal"),M7=Symbol.for("react.fragment"),_7=Symbol.for("react.strict_mode"),B7=Symbol.for("react.profiler"),R7=Symbol.for("react.consumer"),D7=Symbol.for("react.context"),I7=Symbol.for("react.forward_ref"),F7=Symbol.for("react.suspense"),O7=Symbol.for("react.memo"),Tg=Symbol.for("react.lazy"),z7=Symbol.for("react.activity"),wg=Symbol.iterator;function L7(t){return t===null||typeof t!="object"?null:(t=wg&&t[wg]||t["@@iterator"],typeof t=="function"?t:null)}var Mg={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},_g=Object.assign,Bg={};function kr(t,e,n){this.props=t,this.context=e,this.refs=Bg,this.updater=n||Mg}kr.prototype.isReactComponent={};kr.prototype.setState=function(t,e){if(typeof t!="object"&&typeof t!="function"&&t!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,t,e,"setState")};kr.prototype.forceUpdate=function(t){this.updater.enqueueForceUpdate(this,t,"forceUpdate")};function Rg(){}Rg.prototype=kr.prototype;function Rd(t,e,n){this.props=t,this.context=e,this.refs=Bg,this.updater=n||Mg}var Dd=Rd.prototype=new Rg;Dd.constructor=Rd;_g(Dd,kr.prototype);Dd.isPureReactComponent=!0;var Cg=Array.isArray;function _d(){}var Mt={H:null,A:null,T:null,S:null},Dg=Object.prototype.hasOwnProperty;function Id(t,e,n){var i=n.ref;return{$$typeof:Bd,type:t,key:e,ref:i!==void 0?i:null,props:n}}function N7(t,e){return Id(t.type,e,t.props)}function Fd(t){return typeof t=="object"&&t!==null&&t.$$typeof===Bd}function P7(t){var e={"=":"=0",":":"=2"};return"$"+t.replace(/[=:]/g,function(n){return e[n]})}var Sg=/\/+/g;function Md(t,e){return typeof t=="object"&&t!==null&&t.key!=null?P7(""+t.key):e.toString(36)}function j7(t){switch(t.status){case"fulfilled":return t.value;case"rejected":throw t.reason;default:switch(typeof t.status=="string"?t.then(_d,_d):(t.status="pending",t.then(function(e){t.status==="pending"&&(t.status="fulfilled",t.value=e)},function(e){t.status==="pending"&&(t.status="rejected",t.reason=e)})),t.status){case"fulfilled":return t.value;case"rejected":throw t.reason}}throw t}function br(t,e,n,i,a){var r=typeof t;(r==="undefined"||r==="boolean")&&(t=null);var s=!1;if(t===null)s=!0;else switch(r){case"bigint":case"string":case"number":s=!0;break;case"object":switch(t.$$typeof){case Bd:case T7:s=!0;break;case Tg:return s=t._init,br(s(t._payload),e,n,i,a)}}if(s)return a=a(t),s=i===""?"."+Md(t,0):i,Cg(a)?(n="",s!=null&&(n=s.replace(Sg,"$&/")+"/"),br(a,e,n,"",function(c){return c})):a!=null&&(Fd(a)&&(a=N7(a,n+(a.key==null||t&&t.key===a.key?"":(""+a.key).replace(Sg,"$&/")+"/")+s)),e.push(a)),1;s=0;var o=i===""?".":i+":";if(Cg(t))for(var l=0;l<t.length;l++)i=t[l],r=o+Md(i,l),s+=br(i,e,n,r,a);else if(l=L7(t),typeof l=="function")for(t=l.call(t),l=0;!(i=t.next()).done;)i=i.value,r=o+Md(i,l++),s+=br(i,e,n,r,a);else if(r==="object"){if(typeof t.then=="function")return br(j7(t),e,n,i,a);throw e=String(t),Error("Objects are not valid as a React child (found: "+(e==="[object Object]"?"object with keys {"+Object.keys(t).join(", ")+"}":e)+"). If you meant to render a collection of children, use an array instead.")}return s}function Ll(t,e,n){if(t==null)return t;var i=[],a=0;return br(t,i,"","",function(r){return e.call(n,r,a++)}),i}function $7(t){if(t._status===-1){var e=t._result;e=e(),e.then(function(n){(t._status===0||t._status===-1)&&(t._status=1,t._result=n)},function(n){(t._status===0||t._status===-1)&&(t._status=2,t._result=n)}),t._status===-1&&(t._status=0,t._result=e)}if(t._status===1)return t._result.default;throw t._result}var Ag=typeof reportError=="function"?reportError:function(t){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var e=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof t=="object"&&t!==null&&typeof t.message=="string"?String(t.message):String(t),error:t});if(!window.dispatchEvent(e))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",t);return}console.error(t)},U7={map:Ll,forEach:function(t,e,n){Ll(t,function(){e.apply(this,arguments)},n)},count:function(t){var e=0;return Ll(t,function(){e++}),e},toArray:function(t){return Ll(t,function(e){return e})||[]},only:function(t){if(!Fd(t))throw Error("React.Children.only expected to receive a single React element child.");return t}};K.Activity=z7;K.Children=U7;K.Component=kr;K.Fragment=M7;K.Profiler=B7;K.PureComponent=Rd;K.StrictMode=_7;K.Suspense=F7;K.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=Mt;K.__COMPILER_RUNTIME={__proto__:null,c:function(t){return Mt.H.useMemoCache(t)}};K.cache=function(t){return function(){return t.apply(null,arguments)}};K.cacheSignal=function(){return null};K.cloneElement=function(t,e,n){if(t==null)throw Error("The argument must be a React element, but you passed "+t+".");var i=_g({},t.props),a=t.key;if(e!=null)for(r in e.key!==void 0&&(a=""+e.key),e)!Dg.call(e,r)||r==="key"||r==="__self"||r==="__source"||r==="ref"&&e.ref===void 0||(i[r]=e[r]);var r=arguments.length-2;if(r===1)i.children=n;else if(1<r){for(var s=Array(r),o=0;o<r;o++)s[o]=arguments[o+2];i.children=s}return Id(t.type,a,i)};K.createContext=function(t){return t={$$typeof:D7,_currentValue:t,_currentValue2:t,_threadCount:0,Provider:null,Consumer:null},t.Provider=t,t.Consumer={$$typeof:R7,_context:t},t};K.createElement=function(t,e,n){var i,a={},r=null;if(e!=null)for(i in e.key!==void 0&&(r=""+e.key),e)Dg.call(e,i)&&i!=="key"&&i!=="__self"&&i!=="__source"&&(a[i]=e[i]);var s=arguments.length-2;if(s===1)a.children=n;else if(1<s){for(var o=Array(s),l=0;l<s;l++)o[l]=arguments[l+2];a.children=o}if(t&&t.defaultProps)for(i in s=t.defaultProps,s)a[i]===void 0&&(a[i]=s[i]);return Id(t,r,a)};K.createRef=function(){return{current:null}};K.forwardRef=function(t){return{$$typeof:I7,render:t}};K.isValidElement=Fd;K.lazy=function(t){return{$$typeof:Tg,_payload:{_status:-1,_result:t},_init:$7}};K.memo=function(t,e){return{$$typeof:O7,type:t,compare:e===void 0?null:e}};K.startTransition=function(t){var e=Mt.T,n={};Mt.T=n;try{var i=t(),a=Mt.S;a!==null&&a(n,i),typeof i=="object"&&i!==null&&typeof i.then=="function"&&i.then(_d,Ag)}catch(r){Ag(r)}finally{e!==null&&n.types!==null&&(e.types=n.types),Mt.T=e}};K.unstable_useCacheRefresh=function(){return Mt.H.useCacheRefresh()};K.use=function(t){return Mt.H.use(t)};K.useActionState=function(t,e,n){return Mt.H.useActionState(t,e,n)};K.useCallback=function(t,e){return Mt.H.useCallback(t,e)};K.useContext=function(t){return Mt.H.useContext(t)};K.useDebugValue=function(){};K.useDeferredValue=function(t,e){return Mt.H.useDeferredValue(t,e)};K.useEffect=function(t,e){return Mt.H.useEffect(t,e)};K.useEffectEvent=function(t){return Mt.H.useEffectEvent(t)};K.useId=function(){return Mt.H.useId()};K.useImperativeHandle=function(t,e,n){return Mt.H.useImperativeHandle(t,e,n)};K.useInsertionEffect=function(t,e){return Mt.H.useInsertionEffect(t,e)};K.useLayoutEffect=function(t,e){return Mt.H.useLayoutEffect(t,e)};K.useMemo=function(t,e){return Mt.H.useMemo(t,e)};K.useOptimistic=function(t,e){return Mt.H.useOptimistic(t,e)};K.useReducer=function(t,e,n){return Mt.H.useReducer(t,e,n)};K.useRef=function(t){return Mt.H.useRef(t)};K.useState=function(t){return Mt.H.useState(t)};K.useSyncExternalStore=function(t,e,n){return Mt.H.useSyncExternalStore(t,e,n)};K.useTransition=function(){return Mt.H.useTransition()};K.version="19.2.6"});var xa=An((TT,Fg)=>{"use strict";Fg.exports=Ig()});var Yg=An(Ft=>{"use strict";function Nd(t,e){var n=t.length;t.push(e);t:for(;0<n;){var i=n-1>>>1,a=t[i];if(0<Nl(a,e))t[i]=e,t[n]=a,n=i;else break t}}function Mn(t){return t.length===0?null:t[0]}function jl(t){if(t.length===0)return null;var e=t[0],n=t.pop();if(n!==e){t[0]=n;t:for(var i=0,a=t.length,r=a>>>1;i<r;){var s=2*(i+1)-1,o=t[s],l=s+1,c=t[l];if(0>Nl(o,n))l<a&&0>Nl(c,o)?(t[i]=c,t[l]=n,i=l):(t[i]=o,t[s]=n,i=s);else if(l<a&&0>Nl(c,n))t[i]=c,t[l]=n,i=l;else break t}}return e}function Nl(t,e){var n=t.sortIndex-e.sortIndex;return n!==0?n:t.id-e.id}Ft.unstable_now=void 0;typeof performance=="object"&&typeof performance.now=="function"?(Og=performance,Ft.unstable_now=function(){return Og.now()}):(Od=Date,zg=Od.now(),Ft.unstable_now=function(){return Od.now()-zg});var Og,Od,zg,qn=[],Ai=[],H7=1,Je=null,ue=3,Pd=!1,Ws=!1,to=!1,jd=!1,Pg=typeof setTimeout=="function"?setTimeout:null,jg=typeof clearTimeout=="function"?clearTimeout:null,Lg=typeof setImmediate<"u"?setImmediate:null;function Pl(t){for(var e=Mn(Ai);e!==null;){if(e.callback===null)jl(Ai);else if(e.startTime<=t)jl(Ai),e.sortIndex=e.expirationTime,Nd(qn,e);else break;e=Mn(Ai)}}function $d(t){if(to=!1,Pl(t),!Ws)if(Mn(qn)!==null)Ws=!0,wr||(wr=!0,Er());else{var e=Mn(Ai);e!==null&&Ud($d,e.startTime-t)}}var wr=!1,eo=-1,$g=5,Ug=-1;function Hg(){return jd?!0:!(Ft.unstable_now()-Ug<$g)}function zd(){if(jd=!1,wr){var t=Ft.unstable_now();Ug=t;var e=!0;try{t:{Ws=!1,to&&(to=!1,jg(eo),eo=-1),Pd=!0;var n=ue;try{e:{for(Pl(t),Je=Mn(qn);Je!==null&&!(Je.expirationTime>t&&Hg());){var i=Je.callback;if(typeof i=="function"){Je.callback=null,ue=Je.priorityLevel;var a=i(Je.expirationTime<=t);if(t=Ft.unstable_now(),typeof a=="function"){Je.callback=a,Pl(t),e=!0;break e}Je===Mn(qn)&&jl(qn),Pl(t)}else jl(qn);Je=Mn(qn)}if(Je!==null)e=!0;else{var r=Mn(Ai);r!==null&&Ud($d,r.startTime-t),e=!1}}break t}finally{Je=null,ue=n,Pd=!1}e=void 0}}finally{e?Er():wr=!1}}}var Er;typeof Lg=="function"?Er=function(){Lg(zd)}:typeof MessageChannel<"u"?(Ld=new MessageChannel,Ng=Ld.port2,Ld.port1.onmessage=zd,Er=function(){Ng.postMessage(null)}):Er=function(){Pg(zd,0)};var Ld,Ng;function Ud(t,e){eo=Pg(function(){t(Ft.unstable_now())},e)}Ft.unstable_IdlePriority=5;Ft.unstable_ImmediatePriority=1;Ft.unstable_LowPriority=4;Ft.unstable_NormalPriority=3;Ft.unstable_Profiling=null;Ft.unstable_UserBlockingPriority=2;Ft.unstable_cancelCallback=function(t){t.callback=null};Ft.unstable_forceFrameRate=function(t){0>t||125<t?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):$g=0<t?Math.floor(1e3/t):5};Ft.unstable_getCurrentPriorityLevel=function(){return ue};Ft.unstable_next=function(t){switch(ue){case 1:case 2:case 3:var e=3;break;default:e=ue}var n=ue;ue=e;try{return t()}finally{ue=n}};Ft.unstable_requestPaint=function(){jd=!0};Ft.unstable_runWithPriority=function(t,e){switch(t){case 1:case 2:case 3:case 4:case 5:break;default:t=3}var n=ue;ue=t;try{return e()}finally{ue=n}};Ft.unstable_scheduleCallback=function(t,e,n){var i=Ft.unstable_now();switch(typeof n=="object"&&n!==null?(n=n.delay,n=typeof n=="number"&&0<n?i+n:i):n=i,t){case 1:var a=-1;break;case 2:a=250;break;case 5:a=1073741823;break;case 4:a=1e4;break;default:a=5e3}return a=n+a,t={id:H7++,callback:e,priorityLevel:t,startTime:n,expirationTime:a,sortIndex:-1},n>i?(t.sortIndex=n,Nd(Ai,t),Mn(qn)===null&&t===Mn(Ai)&&(to?(jg(eo),eo=-1):to=!0,Ud($d,n-i))):(t.sortIndex=a,Nd(qn,t),Ws||Pd||(Ws=!0,wr||(wr=!0,Er()))),t};Ft.unstable_shouldYield=Hg;Ft.unstable_wrapCallback=function(t){var e=ue;return function(){var n=ue;ue=e;try{return t.apply(this,arguments)}finally{ue=n}}}});var Gg=An((_T,Vg)=>{"use strict";Vg.exports=Yg()});var Xg=An(ye=>{"use strict";var Y7=xa();function qg(t){var e="https://react.dev/errors/"+t;if(1<arguments.length){e+="?args[]="+encodeURIComponent(arguments[1]);for(var n=2;n<arguments.length;n++)e+="&args[]="+encodeURIComponent(arguments[n])}return"Minified React error #"+t+"; visit "+e+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function Ti(){}var me={d:{f:Ti,r:function(){throw Error(qg(522))},D:Ti,C:Ti,L:Ti,m:Ti,X:Ti,S:Ti,M:Ti},p:0,findDOMNode:null},V7=Symbol.for("react.portal");function G7(t,e,n){var i=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:V7,key:i==null?null:""+i,children:t,containerInfo:e,implementation:n}}var no=Y7.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function $l(t,e){if(t==="font")return"";if(typeof e=="string")return e==="use-credentials"?e:""}ye.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=me;ye.createPortal=function(t,e){var n=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)throw Error(qg(299));return G7(t,e,null,n)};ye.flushSync=function(t){var e=no.T,n=me.p;try{if(no.T=null,me.p=2,t)return t()}finally{no.T=e,me.p=n,me.d.f()}};ye.preconnect=function(t,e){typeof t=="string"&&(e?(e=e.crossOrigin,e=typeof e=="string"?e==="use-credentials"?e:"":void 0):e=null,me.d.C(t,e))};ye.prefetchDNS=function(t){typeof t=="string"&&me.d.D(t)};ye.preinit=function(t,e){if(typeof t=="string"&&e&&typeof e.as=="string"){var n=e.as,i=$l(n,e.crossOrigin),a=typeof e.integrity=="string"?e.integrity:void 0,r=typeof e.fetchPriority=="string"?e.fetchPriority:void 0;n==="style"?me.d.S(t,typeof e.precedence=="string"?e.precedence:void 0,{crossOrigin:i,integrity:a,fetchPriority:r}):n==="script"&&me.d.X(t,{crossOrigin:i,integrity:a,fetchPriority:r,nonce:typeof e.nonce=="string"?e.nonce:void 0})}};ye.preinitModule=function(t,e){if(typeof t=="string")if(typeof e=="object"&&e!==null){if(e.as==null||e.as==="script"){var n=$l(e.as,e.crossOrigin);me.d.M(t,{crossOrigin:n,integrity:typeof e.integrity=="string"?e.integrity:void 0,nonce:typeof e.nonce=="string"?e.nonce:void 0})}}else e==null&&me.d.M(t)};ye.preload=function(t,e){if(typeof t=="string"&&typeof e=="object"&&e!==null&&typeof e.as=="string"){var n=e.as,i=$l(n,e.crossOrigin);me.d.L(t,n,{crossOrigin:i,integrity:typeof e.integrity=="string"?e.integrity:void 0,nonce:typeof e.nonce=="string"?e.nonce:void 0,type:typeof e.type=="string"?e.type:void 0,fetchPriority:typeof e.fetchPriority=="string"?e.fetchPriority:void 0,referrerPolicy:typeof e.referrerPolicy=="string"?e.referrerPolicy:void 0,imageSrcSet:typeof e.imageSrcSet=="string"?e.imageSrcSet:void 0,imageSizes:typeof e.imageSizes=="string"?e.imageSizes:void 0,media:typeof e.media=="string"?e.media:void 0})}};ye.preloadModule=function(t,e){if(typeof t=="string")if(e){var n=$l(e.as,e.crossOrigin);me.d.m(t,{as:typeof e.as=="string"&&e.as!=="script"?e.as:void 0,crossOrigin:n,integrity:typeof e.integrity=="string"?e.integrity:void 0})}else me.d.m(t)};ye.requestFormReset=function(t){me.d.r(t)};ye.unstable_batchedUpdates=function(t,e){return t(e)};ye.useFormState=function(t,e,n){return no.H.useFormState(t,e,n)};ye.useFormStatus=function(){return no.H.useHostTransitionStatus()};ye.version="19.2.6"});var Qg=An((RT,Zg)=>{"use strict";function Kg(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(Kg)}catch(t){console.error(t)}}Kg(),Zg.exports=Xg()});var c5=An(pu=>{"use strict";var Xt=Gg(),wy=xa(),q7=Qg();function _(t){var e="https://react.dev/errors/"+t;if(1<arguments.length){e+="?args[]="+encodeURIComponent(arguments[1]);for(var n=2;n<arguments.length;n++)e+="&args[]="+encodeURIComponent(arguments[n])}return"Minified React error #"+t+"; visit "+e+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function Cy(t){return!(!t||t.nodeType!==1&&t.nodeType!==9&&t.nodeType!==11)}function Ho(t){var e=t,n=t;if(t.alternate)for(;e.return;)e=e.return;else{t=e;do e=t,(e.flags&4098)!==0&&(n=e.return),t=e.return;while(t)}return e.tag===3?n:null}function Sy(t){if(t.tag===13){var e=t.memoizedState;if(e===null&&(t=t.alternate,t!==null&&(e=t.memoizedState)),e!==null)return e.dehydrated}return null}function Ay(t){if(t.tag===31){var e=t.memoizedState;if(e===null&&(t=t.alternate,t!==null&&(e=t.memoizedState)),e!==null)return e.dehydrated}return null}function Jg(t){if(Ho(t)!==t)throw Error(_(188))}function X7(t){var e=t.alternate;if(!e){if(e=Ho(t),e===null)throw Error(_(188));return e!==t?null:t}for(var n=t,i=e;;){var a=n.return;if(a===null)break;var r=a.alternate;if(r===null){if(i=a.return,i!==null){n=i;continue}break}if(a.child===r.child){for(r=a.child;r;){if(r===n)return Jg(a),t;if(r===i)return Jg(a),e;r=r.sibling}throw Error(_(188))}if(n.return!==i.return)n=a,i=r;else{for(var s=!1,o=a.child;o;){if(o===n){s=!0,n=a,i=r;break}if(o===i){s=!0,i=a,n=r;break}o=o.sibling}if(!s){for(o=r.child;o;){if(o===n){s=!0,n=r,i=a;break}if(o===i){s=!0,i=r,n=a;break}o=o.sibling}if(!s)throw Error(_(189))}}if(n.alternate!==i)throw Error(_(190))}if(n.tag!==3)throw Error(_(188));return n.stateNode.current===n?t:e}function Ty(t){var e=t.tag;if(e===5||e===26||e===27||e===6)return t;for(t=t.child;t!==null;){if(e=Ty(t),e!==null)return e;t=t.sibling}return null}var Rt=Object.assign,K7=Symbol.for("react.element"),Ul=Symbol.for("react.transitional.element"),uo=Symbol.for("react.portal"),_r=Symbol.for("react.fragment"),My=Symbol.for("react.strict_mode"),Ep=Symbol.for("react.profiler"),_y=Symbol.for("react.consumer"),ei=Symbol.for("react.context"),xf=Symbol.for("react.forward_ref"),wp=Symbol.for("react.suspense"),Cp=Symbol.for("react.suspense_list"),vf=Symbol.for("react.memo"),Mi=Symbol.for("react.lazy"),Sp=Symbol.for("react.activity"),Z7=Symbol.for("react.memo_cache_sentinel"),Wg=Symbol.iterator;function io(t){return t===null||typeof t!="object"?null:(t=Wg&&t[Wg]||t["@@iterator"],typeof t=="function"?t:null)}var Q7=Symbol.for("react.client.reference");function Ap(t){if(t==null)return null;if(typeof t=="function")return t.$$typeof===Q7?null:t.displayName||t.name||null;if(typeof t=="string")return t;switch(t){case _r:return"Fragment";case Ep:return"Profiler";case My:return"StrictMode";case wp:return"Suspense";case Cp:return"SuspenseList";case Sp:return"Activity"}if(typeof t=="object")switch(t.$$typeof){case uo:return"Portal";case ei:return t.displayName||"Context";case _y:return(t._context.displayName||"Context")+".Consumer";case xf:var e=t.render;return t=t.displayName,t||(t=e.displayName||e.name||"",t=t!==""?"ForwardRef("+t+")":"ForwardRef"),t;case vf:return e=t.displayName||null,e!==null?e:Ap(t.type)||"Memo";case Mi:e=t._payload,t=t._init;try{return Ap(t(e))}catch{}}return null}var po=Array.isArray,V=wy.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,ht=q7.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,Ca={pending:!1,data:null,method:null,action:null},Tp=[],Br=-1;function In(t){return{current:t}}function Wt(t){0>Br||(t.current=Tp[Br],Tp[Br]=null,Br--)}function At(t,e){Br++,Tp[Br]=t.current,t.current=e}var Dn=In(null),_o=In(null),Pi=In(null),kc=In(null);function Ec(t,e){switch(At(Pi,e),At(_o,t),At(Dn,null),e.nodeType){case 9:case 11:t=(t=e.documentElement)&&(t=t.namespaceURI)?sy(t):0;break;default:if(t=e.tagName,e=e.namespaceURI)e=sy(e),t=K6(e,t);else switch(t){case"svg":t=1;break;case"math":t=2;break;default:t=0}}Wt(Dn),At(Dn,t)}function Xr(){Wt(Dn),Wt(_o),Wt(Pi)}function Mp(t){t.memoizedState!==null&&At(kc,t);var e=Dn.current,n=K6(e,t.type);e!==n&&(At(_o,t),At(Dn,n))}function wc(t){_o.current===t&&(Wt(Dn),Wt(_o)),kc.current===t&&(Wt(kc),jo._currentValue=Ca)}var Hd,tm;function ba(t){if(Hd===void 0)try{throw Error()}catch(n){var e=n.stack.trim().match(/\n( *(at )?)/);Hd=e&&e[1]||"",tm=-1<n.stack.indexOf(`
    at`)?" (<anonymous>)":-1<n.stack.indexOf("@")?"@unknown:0:0":""}return`
`+Hd+t+tm}var Yd=!1;function Vd(t,e){if(!t||Yd)return"";Yd=!0;var n=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var i={DetermineComponentFrameRoot:function(){try{if(e){var d=function(){throw Error()};if(Object.defineProperty(d.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(d,[])}catch(f){var p=f}Reflect.construct(t,[],d)}else{try{d.call()}catch(f){p=f}t.call(d.prototype)}}else{try{throw Error()}catch(f){p=f}(d=t())&&typeof d.catch=="function"&&d.catch(function(){})}}catch(f){if(f&&p&&typeof f.stack=="string")return[f.stack,p.stack]}return[null,null]}};i.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var a=Object.getOwnPropertyDescriptor(i.DetermineComponentFrameRoot,"name");a&&a.configurable&&Object.defineProperty(i.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var r=i.DetermineComponentFrameRoot(),s=r[0],o=r[1];if(s&&o){var l=s.split(`
`),c=o.split(`
...
`+l[i].replace(" at new "," at ");return t.displayName&&u.includes("<anonymous>")&&(u=u.replace("<anonymous>",t.displayName)),u}while(1<=i&&0<=a);break}}}finally{Yd=!1,Error.prepareStackTrace=n}return(n=t?t.displayName||t.name:"")?ba(n):""}function J7(t,e){switch(t.tag){case 26:case 27:case 5:return ba(t.type);case 16:return ba("Lazy");case 13:return t.child!==e&&e!==null?ba("Suspense Fallback"):ba("Suspense");case 19:return ba("SuspenseList");case 0:case 15:return Vd(t.type,!1);case 11:return Vd(t.type.render,!1);case 1:return Vd(t.type,!0);case 31:return ba("Activity");default:return""}}function em(t){try{var e="",n=null;do e+=J7(t,n),n=t,t=t.return;while(t);return e}catch(i){return`
Error generating stack: `+i.message+`
`+i.stack}}var _p=Object.prototype.hasOwnProperty,bf=Xt.unstable_scheduleCallback,Gd=Xt.unstable_cancelCallback,W7=Xt.unstable_shouldYield,t9=Xt.unstable_requestPaint,He=Xt.unstable_now,e9=Xt.unstable_getCurrentPriorityLevel,By=Xt.unstable_ImmediatePriority,Ry=Xt.unstable_UserBlockingPriority,Cc=Xt.unstable_NormalPriority,n9=Xt.unstable_LowPriority,Dy=Xt.unstable_IdlePriority,i9=Xt.log,a9=Xt.unstable_setDisableYieldValue,Yo=null,Ye=null;function Fi(t){if(typeof i9=="function"&&a9(t),Ye&&typeof Ye.setStrictMode=="function")try{Ye.setStrictMode(Yo,t)}catch{}}var Ve=Math.clz32?Math.clz32:o9,r9=Math.log,s9=Math.LN2;function o9(t){return t>>>=0,t===0?32:31-(r9(t)/s9|0)|0}var Hl=256,Yl=262144,Vl=4194304;function ka(t){var e=t&42;if(e!==0)return e;switch(t&-t){case 1:return 1;case 2:return 2;case 4:return 4;case 8:return 8;case 16:return 16;case 32:return 32;case 64:return 64;case 128:return 128;case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:return t&261888;case 262144:case 524288:case 1048576:case 2097152:return t&3932160;case 4194304:case 8388608:case 16777216:case 33554432:return t&62914560;case 67108864:return 67108864;case 134217728:return 134217728;case 268435456:return 268435456;case 536870912:return 536870912;case 1073741824:return 0;default:return t}}function Zc(t,e,n){var i=t.pendingLanes;if(i===0)return 0;var a=0,r=t.suspendedLanes,s=t.pingedLanes;t=t.warmLanes;var o=i&134217727;return o!==0?(i=o&~r,i!==0?a=ka(i):(s&=o,s!==0?a=ka(s):n||(n=o&~t,n!==0&&(a=ka(n))))):(o=i&~r,o!==0?a=ka(o):s!==0?a=ka(s):n||(n=i&~t,n!==0&&(a=ka(n)))),a===0?0:e!==0&&e!==a&&(e&r)===0&&(r=a&-a,n=e&-e,r>=n||r===32&&(n&4194048)!==0)?e:a}function Vo(t,e){return(t.pendingLanes&~(t.suspendedLanes&~t.pingedLanes)&e)===0}function l9(t,e){switch(t){case 1:case 2:case 4:case 8:case 64:return e+250;case 16:case 32:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return e+5e3;case 4194304:case 8388608:case 16777216:case 33554432:return-1;case 67108864:case 134217728:case 268435456:case 536870912:case 1073741824:return-1;default:return-1}}function Iy(){var t=Vl;return Vl<<=1,(Vl&62914560)===0&&(Vl=4194304),t}function qd(t){for(var e=[],n=0;31>n;n++)e.push(t);return e}function Go(t,e){t.pendingLanes|=e,e!==268435456&&(t.suspendedLanes=0,t.pingedLanes=0,t.warmLanes=0)}function c9(t,e,n,i,a,r){var s=t.pendingLanes;t.pendingLanes=n,t.suspendedLanes=0,t.pingedLanes=0,t.warmLanes=0,t.expiredLanes&=n,t.entangledLanes&=n,t.errorRecoveryDisabledLanes&=n,t.shellSuspendCounter=0;var o=t.entanglements,l=t.expirationTimes,c=t.hiddenUpdates;for(n=s&~n;0<n;){var u=31-Ve(n),d=1<<u;o[u]=0,l[u]=-1;var p=c[u];if(p!==null)for(c[u]=null,u=0;u<p.length;u++){var f=p[u];f!==null&&(f.lane&=-536870913)}n&=~d}i!==0&&Fy(t,i,0),r!==0&&a===0&&t.tag!==0&&(t.suspendedLanes|=r&~(s&~e))}function Fy(t,e,n){t.pendingLanes|=e,t.suspendedLanes&=~e;var i=31-Ve(e);t.entangledLanes|=e,t.entanglements[i]=t.entanglements[i]|1073741824|n&261930}function Oy(t,e){var n=t.entangledLanes|=e;for(t=t.entanglements;n;){var i=31-Ve(n),a=1<<i;a&e|t[i]&e&&(t[i]|=e),n&=~a}}function zy(t,e){var n=e&-e;return n=(n&42)!==0?1:kf(n),(n&(t.suspendedLanes|e))!==0?0:n}function kf(t){switch(t){case 2:t=1;break;case 8:t=4;break;case 32:t=16;break;case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:case 4194304:case 8388608:case 16777216:case 33554432:t=128;break;case 268435456:t=134217728;break;default:t=0}return t}function Ef(t){return t&=-t,2<t?8<t?(t&134217727)!==0?32:268435456:8:2}function Ly(){var t=ht.p;return t!==0?t:(t=window.event,t===void 0?32:s5(t.type))}function nm(t,e){var n=ht.p;try{return ht.p=t,e()}finally{ht.p=n}}var Ji=Math.random().toString(36).slice(2),ne="__reactFiber$"+Ji,_e="__reactProps$"+Ji,rs="__reactContainer$"+Ji,Bp="__reactEvents$"+Ji,u9="__reactListeners$"+Ji,d9="__reactHandles$"+Ji,im="__reactResources$"+Ji,qo="__reactMarker$"+Ji;function wf(t){delete t[ne],delete t[_e],delete t[Bp],delete t[u9],delete t[d9]}function Rr(t){var e=t[ne];if(e)return e;for(var n=t.parentNode;n;){if(e=n[rs]||n[ne]){if(n=e.alternate,e.child!==null||n!==null&&n.child!==null)for(t=dy(t);t!==null;){if(n=t[ne])return n;t=dy(t)}return e}t=n,n=t.parentNode}return null}function ss(t){if(t=t[ne]||t[rs]){var e=t.tag;if(e===5||e===6||e===13||e===31||e===26||e===27||e===3)return t}return null}function fo(t){var e=t.tag;if(e===5||e===26||e===27||e===6)return t.stateNode;throw Error(_(33))}function $r(t){var e=t[im];return e||(e=t[im]={hoistableStyles:new Map,hoistableScripts:new Map}),e}function Jt(t){t[qo]=!0}var Ny=new Set,Py={};function Fa(t,e){Kr(t,e),Kr(t+"Capture",e)}function Kr(t,e){for(Py[t]=e,t=0;t<e.length;t++)Ny.add(e[t])}var p9=RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"),am={},rm={};function f9(t){return _p.call(rm,t)?!0:_p.call(am,t)?!1:p9.test(t)?rm[t]=!0:(am[t]=!0,!1)}function sc(t,e,n){if(f9(e))if(n===null)t.removeAttribute(e);else{switch(typeof n){case"undefined":case"function":case"symbol":t.removeAttribute(e);return;case"boolean":var i=e.toLowerCase().slice(0,5);if(i!=="data-"&&i!=="aria-"){t.removeAttribute(e);return}}t.setAttribute(e,""+n)}}function Gl(t,e,n){if(n===null)t.removeAttribute(e);else{switch(typeof n){case"undefined":case"function":case"symbol":case"boolean":t.removeAttribute(e);return}t.setAttribute(e,""+n)}}function Xn(t,e,n,i){if(i===null)t.removeAttribute(n);else{switch(typeof i){case"undefined":case"function":case"symbol":case"boolean":t.removeAttribute(n);return}t.setAttributeNS(e,n,""+i)}}function tn(t){switch(typeof t){case"bigint":case"boolean":case"number":case"string":case"undefined":return t;case"object":return t;default:return""}}function jy(t){var e=t.type;return(t=t.nodeName)&&t.toLowerCase()==="input"&&(e==="checkbox"||e==="radio")}function h9(t,e,n){var i=Object.getOwnPropertyDescriptor(t.constructor.prototype,e);if(!t.hasOwnProperty(e)&&typeof i<"u"&&typeof i.get=="function"&&typeof i.set=="function"){var a=i.get,r=i.set;return Object.defineProperty(t,e,{configurable:!0,get:function(){return a.call(this)},set:function(s){n=""+s,r.call(this,s)}}),Object.defineProperty(t,e,{enumerable:i.enumerable}),{getValue:function(){return n},setValue:function(s){n=""+s},stopTracking:function(){t._valueTracker=null,delete t[e]}}}}function Rp(t){if(!t._valueTracker){var e=jy(t)?"checked":"value";t._valueTracker=h9(t,e,""+t[e])}}function $y(t){if(!t)return!1;var e=t._valueTracker;if(!e)return!0;var n=e.getValue(),i="";return t&&(i=jy(t)?t.checked?"true":"false":t.value),t=i,t!==n?(e.setValue(t),!0):!1}function Sc(t){if(t=t||(typeof document<"u"?document:void 0),typeof t>"u")return null;try{return t.activeElement||t.body}catch{return t.body}}var g9=/[\n"\\]/g;function an(t){return t.replace(g9,function(e){return"\\"+e.charCodeAt(0).toString(16)+" "})}function Dp(t,e,n,i,a,r,s,o){t.name="",s!=null&&typeof s!="function"&&typeof s!="symbol"&&typeof s!="boolean"?t.type=s:t.removeAttribute("type"),e!=null?s==="number"?(e===0&&t.value===""||t.value!=e)&&(t.value=""+tn(e)):t.value!==""+tn(e)&&(t.value=""+tn(e)):s!=="submit"&&s!=="reset"||t.removeAttribute("value"),e!=null?Ip(t,s,tn(e)):n!=null?Ip(t,s,tn(n)):i!=null&&t.removeAttribute("value"),a==null&&r!=null&&(t.defaultChecked=!!r),a!=null&&(t.checked=a&&typeof a!="function"&&typeof a!="symbol"),o!=null&&typeof o!="function"&&typeof o!="symbol"&&typeof o!="boolean"?t.name=""+tn(o):t.removeAttribute("name")}function Uy(t,e,n,i,a,r,s,o){if(r!=null&&typeof r!="function"&&typeof r!="symbol"&&typeof r!="boolean"&&(t.type=r),e!=null||n!=null){if(!(r!=="submit"&&r!=="reset"||e!=null)){Rp(t);return}n=n!=null?""+tn(n):"",e=e!=null?""+tn(e):n,o||e===t.value||(t.value=e),t.defaultValue=e}i=i??a,i=typeof i!="function"&&typeof i!="symbol"&&!!i,t.checked=o?t.checked:!!i,t.defaultChecked=!!i,s!=null&&typeof s!="function"&&typeof s!="symbol"&&typeof s!="boolean"&&(t.name=s),Rp(t)}function Ip(t,e,n){e==="number"&&Sc(t.ownerDocument)===t||t.defaultValue===""+n||(t.defaultValue=""+n)}function Ur(t,e,n,i){if(t=t.options,e){e={};for(var a=0;a<n.length;a++)e["$"+n[a]]=!0;for(n=0;n<t.length;n++)a=e.hasOwnProperty("$"+t[n].value),t[n].selected!==a&&(t[n].selected=a),a&&i&&(t[n].defaultSelected=!0)}else{for(n=""+tn(n),e=null,a=0;a<t.length;a++){if(t[a].value===n){t[a].selected=!0,i&&(t[a].defaultSelected=!0);return}e!==null||t[a].disabled||(e=t[a])}e!==null&&(e.selected=!0)}}function Hy(t,e,n){if(e!=null&&(e=""+tn(e),e!==t.value&&(t.value=e),n==null)){t.defaultValue!==e&&(t.defaultValue=e);return}t.defaultValue=n!=null?""+tn(n):""}function Yy(t,e,n,i){if(e==null){if(i!=null){if(n!=null)throw Error(_(92));if(po(i)){if(1<i.length)throw Error(_(93));i=i[0]}n=i}n==null&&(n=""),e=n}n=tn(e),t.defaultValue=n,i=t.textContent,i===n&&i!==""&&i!==null&&(t.value=i),Rp(t)}function Zr(t,e){if(e){var n=t.firstChild;if(n&&n===t.lastChild&&n.nodeType===3){n.nodeValue=e;return}}t.textContent=e}var m9=new Set("animationIterationCount aspectRatio borderImageOutset borderImageSlice borderImageWidth boxFlex boxFlexGroup boxOrdinalGroup columnCount columns flex flexGrow flexPositive flexShrink flexNegative flexOrder gridArea gridRow gridRowEnd gridRowSpan gridRowStart gridColumn gridColumnEnd gridColumnSpan gridColumnStart fontWeight lineClamp lineHeight opacity order orphans scale tabSize widows zIndex zoom fillOpacity floodOpacity stopOpacity strokeDasharray strokeDashoffset strokeMiterlimit strokeOpacity strokeWidth MozAnimationIterationCount MozBoxFlex MozBoxFlexGroup MozLineClamp msAnimationIterationCount msFlex msZoom msFlexGrow msFlexNegative msFlexOrder msFlexPositive msFlexShrink msGridColumn msGridColumnSpan msGridRow msGridRowSpan WebkitAnimationIterationCount WebkitBoxFlex WebKitBoxFlexGroup WebkitBoxOrdinalGroup WebkitColumnCount WebkitColumns WebkitFlex WebkitFlexGrow WebkitFlexPositive WebkitFlexShrink WebkitLineClamp".split(" "));function sm(t,e,n){var i=e.indexOf("--")===0;n==null||typeof n=="boolean"||n===""?i?t.setProperty(e,""):e==="float"?t.cssFloat="":t[e]="":i?t.setProperty(e,n):typeof n!="number"||n===0||m9.has(e)?e==="float"?t.cssFloat=n:t[e]=(""+n).trim():t[e]=n+"px"}function Vy(t,e,n){if(e!=null&&typeof e!="object")throw Error(_(62));if(t=t.style,n!=null){for(var i in n)!n.hasOwnProperty(i)||e!=null&&e.hasOwnProperty(i)||(i.indexOf("--")===0?t.setProperty(i,""):i==="float"?t.cssFloat="":t[i]="");for(var a in e)i=e[a],e.hasOwnProperty(a)&&n[a]!==i&&sm(t,a,i)}else for(var r in e)e.hasOwnProperty(r)&&sm(t,r,e[r])}function Cf(t){if(t.indexOf("-")===-1)return!1;switch(t){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}var y9=new Map([["acceptCharset","accept-charset"],["htmlFor","for"],["httpEquiv","http-equiv"],["crossOrigin","crossorigin"],["accentHeight","accent-height"],["alignmentBaseline","alignment-baseline"],["arabicForm","arabic-form"],["baselineShift","baseline-shift"],["capHeight","cap-height"],["clipPath","clip-path"],["clipRule","clip-rule"],["colorInterpolation","color-interpolation"],["colorInterpolationFilters","color-interpolation-filters"],["colorProfile","color-profile"],["colorRendering","color-rendering"],["dominantBaseline","dominant-baseline"],["enableBackground","enable-background"],["fillOpacity","fill-opacity"],["fillRule","fill-rule"],["floodColor","flood-color"],["floodOpacity","flood-opacity"],["fontFamily","font-family"],["fontSize","font-size"],["fontSizeAdjust","font-size-adjust"],["fontStretch","font-stretch"],["fontStyle","font-style"],["fontVariant","font-variant"],["fontWeight","font-weight"],["glyphName","glyph-name"],["glyphOrientationHorizontal","glyph-orientation-horizontal"],["glyphOrientationVertical","glyph-orientation-vertical"],["horizAdvX","horiz-adv-x"],["horizOriginX","horiz-origin-x"],["imageRendering","image-rendering"],["letterSpacing","letter-spacing"],["lightingColor","lighting-color"],["markerEnd","marker-end"],["markerMid","marker-mid"],["markerStart","marker-start"],["overlinePosition","overline-position"],["overlineThickness","overline-thickness"],["paintOrder","paint-order"],["panose-1","panose-1"],["pointerEvents","pointer-events"],["renderingIntent","rendering-intent"],["shapeRendering","shape-rendering"],["stopColor","stop-color"],["stopOpacity","stop-opacity"],["strikethroughPosition","strikethrough-position"],["strikethroughThickness","strikethrough-thickness"],["strokeDasharray","stroke-dasharray"],["strokeDashoffset","stroke-dashoffset"],["strokeLinecap","stroke-linecap"],["strokeLinejoin","stroke-linejoin"],["strokeMiterlimit","stroke-miterlimit"],["strokeOpacity","stroke-opacity"],["strokeWidth","stroke-width"],["textAnchor","text-anchor"],["textDecoration","text-decoration"],["textRendering","text-rendering"],["transformOrigin","transform-origin"],["underlinePosition","underline-position"],["underlineThickness","underline-thickness"],["unicodeBidi","unicode-bidi"],["unicodeRange","unicode-range"],["unitsPerEm","units-per-em"],["vAlphabetic","v-alphabetic"],["vHanging","v-hanging"],["vIdeographic","v-ideographic"],["vMathematical","v-mathematical"],["vectorEffect","vector-effect"],["vertAdvY","vert-adv-y"],["vertOriginX","vert-origin-x"],["vertOriginY","vert-origin-y"],["wordSpacing","word-spacing"],["writingMode","writing-mode"],["xmlnsXlink","xmlns:xlink"],["xHeight","x-height"]]),x9=/^[\u0000-\u001F ]*j[\r\n\t]*a[\r\n\t]*v[\r\n\t]*a[\r\n\t]*s[\r\n\t]*c[\r\n\t]*r[\r\n\t]*i[\r\n\t]*p[\r\n\t]*t[\r\n\t]*:/i;function oc(t){return x9.test(""+t)?"javascript:throw new Error('React has blocked a javascript: URL as a security precaution.')":t}function ni(){}var Fp=null;function Sf(t){return t=t.target||t.srcElement||window,t.correspondingUseElement&&(t=t.correspondingUseElement),t.nodeType===3?t.parentNode:t}var Dr=null,Hr=null;function om(t){var e=ss(t);if(e&&(t=e.stateNode)){var n=t[_e]||null;t:switch(t=e.stateNode,e.type){case"input":if(Dp(t,n.value,n.defaultValue,n.defaultValue,n.checked,n.defaultChecked,n.type,n.name),e=n.name,n.type==="radio"&&e!=null){for(n=t;n.parentNode;)n=n.parentNode;for(n=n.querySelectorAll('input[name="'+an(""+e)+'"][type="radio"]'),e=0;e<n.length;e++){var i=n[e];if(i!==t&&i.form===t.form){var a=i[_e]||null;if(!a)throw Error(_(90));Dp(i,a.value,a.defaultValue,a.defaultValue,a.checked,a.defaultChecked,a.type,a.name)}}for(e=0;e<n.length;e++)i=n[e],i.form===t.form&&$y(i)}break t;case"textarea":Hy(t,n.value,n.defaultValue);break t;case"select":e=n.value,e!=null&&Ur(t,!!n.multiple,e,!1)}}}var Xd=!1;function Gy(t,e,n){if(Xd)return t(e,n);Xd=!0;try{var i=t(e);return i}finally{if(Xd=!1,(Dr!==null||Hr!==null)&&(lu(),Dr&&(e=Dr,t=Hr,Hr=Dr=null,om(e),t)))for(e=0;e<t.length;e++)om(t[e])}}function Bo(t,e){var n=t.stateNode;if(n===null)return null;var i=n[_e]||null;if(i===null)return null;n=i[e];t:switch(e){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(i=!i.disabled)||(t=t.type,i=!(t==="button"||t==="input"||t==="select"||t==="textarea")),t=!i;break t;default:t=!1}if(t)return null;if(n&&typeof n!="function")throw Error(_(231,e,typeof n));return n}var oi=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),Op=!1;if(oi)try{Cr={},Object.defineProperty(Cr,"passive",{get:function(){Op=!0}}),window.addEventListener("test",Cr,Cr),window.removeEventListener("test",Cr,Cr)}catch{Op=!1}var Cr,Oi=null,Af=null,lc=null;function qy(){if(lc)return lc;var t,e=Af,n=e.length,i,a="value"in Oi?Oi.value:Oi.textContent,r=a.length;for(t=0;t<n&&e[t]===a[t];t++);var s=n-t;for(i=1;i<=s&&e[n-i]===a[r-i];i++);return lc=a.slice(t,1<i?1-i:void 0)}function cc(t){var e=t.keyCode;return"charCode"in t?(t=t.charCode,t===0&&e===13&&(t=13)):t=e,t===10&&(t=13),32<=t||t===13?t:0}function ql(){return!0}function lm(){return!1}function Be(t){function e(n,i,a,r,s){this._reactName=n,this._targetInst=a,this.type=i,this.nativeEvent=r,this.target=s,this.currentTarget=null;for(var o in t)t.hasOwnProperty(o)&&(n=t[o],this[o]=n?n(r):r[o]);return this.isDefaultPrevented=(r.defaultPrevented!=null?r.defaultPrevented:r.returnValue===!1)?ql:lm,this.isPropagationStopped=lm,this}return Rt(e.prototype,{preventDefault:function(){this.defaultPrevented=!0;var n=this.nativeEvent;n&&(n.preventDefault?n.preventDefault():typeof n.returnValue!="unknown"&&(n.returnValue=!1),this.isDefaultPrevented=ql)},stopPropagation:function(){var n=this.nativeEvent;n&&(n.stopPropagation?n.stopPropagation():typeof n.cancelBubble!="unknown"&&(n.cancelBubble=!0),this.isPropagationStopped=ql)},persist:function(){},isPersistent:ql}),e}var Oa={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(t){return t.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},Qc=Be(Oa),Xo=Rt({},Oa,{view:0,detail:0}),v9=Be(Xo),Kd,Zd,ao,Jc=Rt({},Xo,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:Tf,button:0,buttons:0,relatedTarget:function(t){return t.relatedTarget===void 0?t.fromElement===t.srcElement?t.toElement:t.fromElement:t.relatedTarget},movementX:function(t){return"movementX"in t?t.movementX:(t!==ao&&(ao&&t.type==="mousemove"?(Kd=t.screenX-ao.screenX,Zd=t.screenY-ao.screenY):Zd=Kd=0,ao=t),Kd)},movementY:function(t){return"movementY"in t?t.movementY:Zd}}),cm=Be(Jc),b9=Rt({},Jc,{dataTransfer:0}),k9=Be(b9),E9=Rt({},Xo,{relatedTarget:0}),Qd=Be(E9),w9=Rt({},Oa,{animationName:0,elapsedTime:0,pseudoElement:0}),C9=Be(w9),S9=Rt({},Oa,{clipboardData:function(t){return"clipboardData"in t?t.clipboardData:window.clipboardData}}),A9=Be(S9),T9=Rt({},Oa,{data:0}),um=Be(T9),M9={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},_9={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},B9={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function R9(t){var e=this.nativeEvent;return e.getModifierState?e.getModifierState(t):(t=B9[t])?!!e[t]:!1}function Tf(){return R9}var D9=Rt({},Xo,{key:function(t){if(t.key){var e=M9[t.key]||t.key;if(e!=="Unidentified")return e}return t.type==="keypress"?(t=cc(t),t===13?"Enter":String.fromCharCode(t)):t.type==="keydown"||t.type==="keyup"?_9[t.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:Tf,charCode:function(t){return t.type==="keypress"?cc(t):0},keyCode:function(t){return t.type==="keydown"||t.type==="keyup"?t.keyCode:0},which:function(t){return t.type==="keypress"?cc(t):t.type==="keydown"||t.type==="keyup"?t.keyCode:0}}),I9=Be(D9),F9=Rt({},Jc,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),dm=Be(F9),O9=Rt({},Xo,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:Tf}),z9=Be(O9),L9=Rt({},Oa,{propertyName:0,elapsedTime:0,pseudoElement:0}),N9=Be(L9),P9=Rt({},Jc,{deltaX:function(t){return"deltaX"in t?t.deltaX:"wheelDeltaX"in t?-t.wheelDeltaX:0},deltaY:function(t){return"deltaY"in t?t.deltaY:"wheelDeltaY"in t?-t.wheelDeltaY:"wheelDelta"in t?-t.wheelDelta:0},deltaZ:0,deltaMode:0}),j9=Be(P9),$9=Rt({},Oa,{newState:0,oldState:0}),U9=Be($9),H9=[9,13,27,32],Mf=oi&&"CompositionEvent"in window,mo=null;oi&&"documentMode"in document&&(mo=document.documentMode);var Y9=oi&&"TextEvent"in window&&!mo,Xy=oi&&(!Mf||mo&&8<mo&&11>=mo),pm=" ",fm=!1;function Ky(t,e){switch(t){case"keyup":return H9.indexOf(e.keyCode)!==-1;case"keydown":return e.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function Zy(t){return t=t.detail,typeof t=="object"&&"data"in t?t.data:null}var Ir=!1;function V9(t,e){switch(t){case"compositionend":return Zy(e);case"keypress":return e.which!==32?null:(fm=!0,pm);case"textInput":return t=e.data,t===pm&&fm?null:t;default:return null}}function G9(t,e){if(Ir)return t==="compositionend"||!Mf&&Ky(t,e)?(t=qy(),lc=Af=Oi=null,Ir=!1,t):null;switch(t){case"paste":return null;case"keypress":if(!(e.ctrlKey||e.altKey||e.metaKey)||e.ctrlKey&&e.altKey){if(e.char&&1<e.char.length)return e.char;if(e.which)return String.fromCharCode(e.which)}return null;case"compositionend":return Xy&&e.locale!=="ko"?null:e.data;default:return null}}var q9={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function hm(t){var e=t&&t.nodeName&&t.nodeName.toLowerCase();return e==="input"?!!q9[t.type]:e==="textarea"}function Qy(t,e,n,i){Dr?Hr?Hr.push(i):Hr=[i]:Dr=i,e=Hc(e,"onChange"),0<e.length&&(n=new Qc("onChange","change",null,n,i),t.push({event:n,listeners:e}))}var yo=null,Ro=null;function X9(t){G6(t,0)}function Wc(t){var e=fo(t);if($y(e))return t}function gm(t,e){if(t==="change")return e}var Jy=!1;oi&&(oi?(Kl="oninput"in document,Kl||(Jd=document.createElement("div"),Jd.setAttribute("oninput","return;"),Kl=typeof Jd.oninput=="function"),Xl=Kl):Xl=!1,Jy=Xl&&(!document.documentMode||9<document.documentMode));var Xl,Kl,Jd;function mm(){yo&&(yo.detachEvent("onpropertychange",Wy),Ro=yo=null)}function Wy(t){if(t.propertyName==="value"&&Wc(Ro)){var e=[];Qy(e,Ro,t,Sf(t)),Gy(X9,e)}}function K9(t,e,n){t==="focusin"?(mm(),yo=e,Ro=n,yo.attachEvent("onpropertychange",Wy)):t==="focusout"&&mm()}function Z9(t){if(t==="selectionchange"||t==="keyup"||t==="keydown")return Wc(Ro)}function Q9(t,e){if(t==="click")return Wc(e)}function J9(t,e){if(t==="input"||t==="change")return Wc(e)}function W9(t,e){return t===e&&(t!==0||1/t===1/e)||t!==t&&e!==e}var qe=typeof Object.is=="function"?Object.is:W9;function Do(t,e){if(qe(t,e))return!0;if(typeof t!="object"||t===null||typeof e!="object"||e===null)return!1;var n=Object.keys(t),i=Object.keys(e);if(n.length!==i.length)return!1;for(i=0;i<n.length;i++){var a=n[i];if(!_p.call(e,a)||!qe(t[a],e[a]))return!1}return!0}function ym(t){for(;t&&t.firstChild;)t=t.firstChild;return t}function xm(t,e){var n=ym(t);t=0;for(var i;n;){if(n.nodeType===3){if(i=t+n.textContent.length,t<=e&&i>=e)return{node:n,offset:e-t};t=i}t:{for(;n;){if(n.nextSibling){n=n.nextSibling;break t}n=n.parentNode}n=void 0}n=ym(n)}}function t2(t,e){return t&&e?t===e?!0:t&&t.nodeType===3?!1:e&&e.nodeType===3?t2(t,e.parentNode):"contains"in t?t.contains(e):t.compareDocumentPosition?!!(t.compareDocumentPosition(e)&16):!1:!1}function e2(t){t=t!=null&&t.ownerDocument!=null&&t.ownerDocument.defaultView!=null?t.ownerDocument.defaultView:window;for(var e=Sc(t.document);e instanceof t.HTMLIFrameElement;){try{var n=typeof e.contentWindow.location.href=="string"}catch{n=!1}if(n)t=e.contentWindow;else break;e=Sc(t.document)}return e}function _f(t){var e=t&&t.nodeName&&t.nodeName.toLowerCase();return e&&(e==="input"&&(t.type==="text"||t.type==="search"||t.type==="tel"||t.type==="url"||t.type==="password")||e==="textarea"||t.contentEditable==="true")}var tv=oi&&"documentMode"in document&&11>=document.documentMode,Fr=null,zp=null,xo=null,Lp=!1;function vm(t,e,n){var i=n.window===n?n.document:n.nodeType===9?n:n.ownerDocument;Lp||Fr==null||Fr!==Sc(i)||(i=Fr,"selectionStart"in i&&_f(i)?i={start:i.selectionStart,end:i.selectionEnd}:(i=(i.ownerDocument&&i.ownerDocument.defaultView||window).getSelection(),i={anchorNode:i.anchorNode,anchorOffset:i.anchorOffset,focusNode:i.focusNode,focusOffset:i.focusOffset}),xo&&Do(xo,i)||(xo=i,i=Hc(zp,"onSelect"),0<i.length&&(e=new Qc("onSelect","select",null,e,n),t.push({event:e,listeners:i}),e.target=Fr)))}function va(t,e){var n={};return n[t.toLowerCase()]=e.toLowerCase(),n["Webkit"+t]="webkit"+e,n["Moz"+t]="moz"+e,n}var Or={animationend:va("Animation","AnimationEnd"),animationiteration:va("Animation","AnimationIteration"),animationstart:va("Animation","AnimationStart"),transitionrun:va("Transition","TransitionRun"),transitionstart:va("Transition","TransitionStart"),transitioncancel:va("Transition","TransitionCancel"),transitionend:va("Transition","TransitionEnd")},Wd={},n2={};oi&&(n2=document.createElement("div").style,"AnimationEvent"in window||(delete Or.animationend.animation,delete Or.animationiteration.animation,delete Or.animationstart.animation),"TransitionEvent"in window||delete Or.transitionend.transition);function za(t){if(Wd[t])return Wd[t];if(!Or[t])return t;var e=Or[t],n;for(n in e)if(e.hasOwnProperty(n)&&n in n2)return Wd[t]=e[n];return t}var i2=za("animationend"),a2=za("animationiteration"),r2=za("animationstart"),ev=za("transitionrun"),nv=za("transitionstart"),iv=za("transitioncancel"),s2=za("transitionend"),o2=new Map,Np="abort auxClick beforeToggle cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");Np.push("scrollEnd");function bn(t,e){o2.set(t,e),Fa(e,[t])}var Ac=typeof reportError=="function"?reportError:function(t){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var e=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof t=="object"&&t!==null&&typeof t.message=="string"?String(t.message):String(t),error:t});if(!window.dispatchEvent(e))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",t);return}console.error(t)},We=[],zr=0,Bf=0;function tu(){for(var t=zr,e=Bf=zr=0;e<t;){var n=We[e];We[e++]=null;var i=We[e];We[e++]=null;var a=We[e];We[e++]=null;var r=We[e];if(We[e++]=null,i!==null&&a!==null){var s=i.pending;s===null?a.next=a:(a.next=s.next,s.next=a),i.pending=a}r!==0&&l2(n,a,r)}}function eu(t,e,n,i){We[zr++]=t,We[zr++]=e,We[zr++]=n,We[zr++]=i,Bf|=i,t.lanes|=i,t=t.alternate,t!==null&&(t.lanes|=i)}function Rf(t,e,n,i){return eu(t,e,n,i),Tc(t)}function La(t,e){return eu(t,null,null,e),Tc(t)}function l2(t,e,n){t.lanes|=n;var i=t.alternate;i!==null&&(i.lanes|=n);for(var a=!1,r=t.return;r!==null;)r.childLanes|=n,i=r.alternate,i!==null&&(i.childLanes|=n),r.tag===22&&(t=r.stateNode,t===null||t._visibility&1||(a=!0)),t=r,r=r.return;return t.tag===3?(r=t.stateNode,a&&e!==null&&(a=31-Ve(n),t=r.hiddenUpdates,i=t[a],i===null?t[a]=[e]:i.push(e),e.lane=n|536870912),r):null}function Tc(t){if(50<To)throw To=0,sf=null,Error(_(185));for(var e=t.return;e!==null;)t=e,e=t.return;return t.tag===3?t.stateNode:null}var Lr={};function av(t,e,n,i){this.tag=t,this.key=n,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.refCleanup=this.ref=null,this.pendingProps=e,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=i,this.subtreeFlags=this.flags=0,this.deletions=null,this.childLanes=this.lanes=0,this.alternate=null}function $e(t,e,n,i){return new av(t,e,n,i)}function Df(t){return t=t.prototype,!(!t||!t.isReactComponent)}function ai(t,e){var n=t.alternate;return n===null?(n=$e(t.tag,e,t.key,t.mode),n.elementType=t.elementType,n.type=t.type,n.stateNode=t.stateNode,n.alternate=t,t.alternate=n):(n.pendingProps=e,n.type=t.type,n.flags=0,n.subtreeFlags=0,n.deletions=null),n.flags=t.flags&65011712,n.childLanes=t.childLanes,n.lanes=t.lanes,n.child=t.child,n.memoizedProps=t.memoizedProps,n.memoizedState=t.memoizedState,n.updateQueue=t.updateQueue,e=t.dependencies,n.dependencies=e===null?null:{lanes:e.lanes,firstContext:e.firstContext},n.sibling=t.sibling,n.index=t.index,n.ref=t.ref,n.refCleanup=t.refCleanup,n}function c2(t,e){t.flags&=65011714;var n=t.alternate;return n===null?(t.childLanes=0,t.lanes=e,t.child=null,t.subtreeFlags=0,t.memoizedProps=null,t.memoizedState=null,t.updateQueue=null,t.dependencies=null,t.stateNode=null):(t.childLanes=n.childLanes,t.lanes=n.lanes,t.child=n.child,t.subtreeFlags=0,t.deletions=null,t.memoizedProps=n.memoizedProps,t.memoizedState=n.memoizedState,t.updateQueue=n.updateQueue,t.type=n.type,e=n.dependencies,t.dependencies=e===null?null:{lanes:e.lanes,firstContext:e.firstContext}),t}function uc(t,e,n,i,a,r){var s=0;if(i=t,typeof t=="function")Df(t)&&(s=1);else if(typeof t=="string")s=ob(t,n,Dn.current)?26:t==="html"||t==="head"||t==="body"?27:5;else t:switch(t){case Sp:return t=$e(31,n,e,a),t.elementType=Sp,t.lanes=r,t;case _r:return Sa(n.children,a,r,e);case My:s=8,a|=24;break;case Ep:return t=$e(12,n,e,a|2),t.elementType=Ep,t.lanes=r,t;case wp:return t=$e(13,n,e,a),t.elementType=wp,t.lanes=r,t;case Cp:return t=$e(19,n,e,a),t.elementType=Cp,t.lanes=r,t;default:if(typeof t=="object"&&t!==null)switch(t.$$typeof){case ei:s=10;break t;case _y:s=9;break t;case xf:s=11;break t;case vf:s=14;break t;case Mi:s=16,i=null;break t}s=29,n=Error(_(130,t===null?"null":typeof t,"")),i=null}return e=$e(s,n,e,a),e.elementType=t,e.type=i,e.lanes=r,e}function Sa(t,e,n,i){return t=$e(7,t,i,e),t.lanes=n,t}function tp(t,e,n){return t=$e(6,t,null,e),t.lanes=n,t}function u2(t){var e=$e(18,null,null,0);return e.stateNode=t,e}function ep(t,e,n){return e=$e(4,t.children!==null?t.children:[],t.key,e),e.lanes=n,e.stateNode={containerInfo:t.containerInfo,pendingChildren:null,implementation:t.implementation},e}var bm=new WeakMap;function rn(t,e){if(typeof t=="object"&&t!==null){var n=bm.get(t);return n!==void 0?n:(e={value:t,source:e,stack:em(e)},bm.set(t,e),e)}return{value:t,source:e,stack:em(e)}}var Nr=[],Pr=0,Mc=null,Io=0,en=[],nn=0,Xi=null,_n=1,Bn="";function Wn(t,e){Nr[Pr++]=Io,Nr[Pr++]=Mc,Mc=t,Io=e}function d2(t,e,n){en[nn++]=_n,en[nn++]=Bn,en[nn++]=Xi,Xi=t;var i=_n;t=Bn;var a=32-Ve(i)-1;i&=~(1<<a),n+=1;var r=32-Ve(e)+a;if(30<r){var s=a-a%5;r=(i&(1<<s)-1).toString(32),i>>=s,a-=s,_n=1<<32-Ve(e)+a|n<<a|i,Bn=r+t}else _n=1<<r|n<<a|i,Bn=t}function If(t){t.return!==null&&(Wn(t,1),d2(t,1,0))}function Ff(t){for(;t===Mc;)Mc=Nr[--Pr],Nr[Pr]=null,Io=Nr[--Pr],Nr[Pr]=null;for(;t===Xi;)Xi=en[--nn],en[nn]=null,Bn=en[--nn],en[nn]=null,_n=en[--nn],en[nn]=null}function p2(t,e){en[nn++]=_n,en[nn++]=Bn,en[nn++]=Xi,_n=e.id,Bn=e.overflow,Xi=t}var ie=null,Bt=null,ut=!1,ji=null,sn=!1,Pp=Error(_(519));function Ki(t){var e=Error(_(418,1<arguments.length&&arguments[1]!==void 0&&arguments[1]?"text":"HTML",""));throw Fo(rn(e,t)),Pp}function km(t){var e=t.stateNode,n=t.type,i=t.memoizedProps;switch(e[ne]=t,e[_e]=i,n){case"dialog":it("cancel",e),it("close",e);break;case"iframe":case"object":case"embed":it("load",e);break;case"video":case"audio":for(n=0;n<No.length;n++)it(No[n],e);break;case"source":it("error",e);break;case"img":case"image":case"link":it("error",e),it("load",e);break;case"details":it("toggle",e);break;case"input":it("invalid",e),Uy(e,i.value,i.defaultValue,i.checked,i.defaultChecked,i.type,i.name,!0);break;case"select":it("invalid",e);break;case"textarea":it("invalid",e),Yy(e,i.value,i.defaultValue,i.children)}n=i.children,typeof n!="string"&&typeof n!="number"&&typeof n!="bigint"||e.textContent===""+n||i.suppressHydrationWarning===!0||X6(e.textContent,n)?(i.popover!=null&&(it("beforetoggle",e),it("toggle",e)),i.onScroll!=null&&it("scroll",e),i.onScrollEnd!=null&&it("scrollend",e),i.onClick!=null&&(e.onclick=ni),e=!0):e=!1,e||Ki(t,!0)}function Em(t){for(ie=t.return;ie;)switch(ie.tag){case 5:case 31:case 13:sn=!1;return;case 27:case 3:sn=!0;return;default:ie=ie.return}}function Sr(t){if(t!==ie)return!1;if(!ut)return Em(t),ut=!0,!1;var e=t.tag,n;if((n=e!==3&&e!==27)&&((n=e===5)&&(n=t.type,n=!(n!=="form"&&n!=="button")||df(t.type,t.memoizedProps)),n=!n),n&&Bt&&Ki(t),Em(t),e===13){if(t=t.memoizedState,t=t!==null?t.dehydrated:null,!t)throw Error(_(317));Bt=uy(t)}else if(e===31){if(t=t.memoizedState,t=t!==null?t.dehydrated:null,!t)throw Error(_(317));Bt=uy(t)}else e===27?(e=Bt,Wi(t.type)?(t=gf,gf=null,Bt=t):Bt=e):Bt=ie?ln(t.stateNode.nextSibling):null;return!0}function _a(){Bt=ie=null,ut=!1}function np(){var t=ji;return t!==null&&(Te===null?Te=t:Te.push.apply(Te,t),ji=null),t}function Fo(t){ji===null?ji=[t]:ji.push(t)}var jp=In(null),Na=null,ii=null;function Bi(t,e,n){At(jp,e._currentValue),e._currentValue=n}function ri(t){t._currentValue=jp.current,Wt(jp)}function $p(t,e,n){for(;t!==null;){var i=t.alternate;if((t.childLanes&e)!==e?(t.childLanes|=e,i!==null&&(i.childLanes|=e)):i!==null&&(i.childLanes&e)!==e&&(i.childLanes|=e),t===n)break;t=t.return}}function Up(t,e,n,i){var a=t.child;for(a!==null&&(a.return=t);a!==null;){var r=a.dependencies;if(r!==null){var s=a.child;r=r.firstContext;t:for(;r!==null;){var o=r;r=a;for(var l=0;l<e.length;l++)if(o.context===e[l]){r.lanes|=n,o=r.alternate,o!==null&&(o.lanes|=n),$p(r.return,n,t),i||(s=null);break t}r=o.next}}else if(a.tag===18){if(s=a.return,s===null)throw Error(_(341));s.lanes|=n,r=s.alternate,r!==null&&(r.lanes|=n),$p(s,n,t),s=null}else s=a.child;if(s!==null)s.return=a;else for(s=a;s!==null;){if(s===t){s=null;break}if(a=s.sibling,a!==null){a.return=s.return,s=a;break}s=s.return}a=s}}function os(t,e,n,i){t=null;for(var a=e,r=!1;a!==null;){if(!r){if((a.flags&524288)!==0)r=!0;else if((a.flags&262144)!==0)break}if(a.tag===10){var s=a.alternate;if(s===null)throw Error(_(387));if(s=s.memoizedProps,s!==null){var o=a.type;qe(a.pendingProps.value,s.value)||(t!==null?t.push(o):t=[o])}}else if(a===kc.current){if(s=a.alternate,s===null)throw Error(_(387));s.memoizedState.memoizedState!==a.memoizedState.memoizedState&&(t!==null?t.push(jo):t=[jo])}a=a.return}t!==null&&Up(e,t,n,i),e.flags|=262144}function _c(t){for(t=t.firstContext;t!==null;){if(!qe(t.context._currentValue,t.memoizedValue))return!0;t=t.next}return!1}function Ba(t){Na=t,ii=null,t=t.dependencies,t!==null&&(t.firstContext=null)}function ae(t){return f2(Na,t)}function Zl(t,e){return Na===null&&Ba(t),f2(t,e)}function f2(t,e){var n=e._currentValue;if(e={context:e,memoizedValue:n,next:null},ii===null){if(t===null)throw Error(_(308));ii=e,t.dependencies={lanes:0,firstContext:e},t.flags|=524288}else ii=ii.next=e;return n}var rv=typeof AbortController<"u"?AbortController:function(){var t=[],e=this.signal={aborted:!1,addEventListener:function(n,i){t.push(i)}};this.abort=function(){e.aborted=!0,t.forEach(function(n){return n()})}},sv=Xt.unstable_scheduleCallback,ov=Xt.unstable_NormalPriority,Yt={$$typeof:ei,Consumer:null,Provider:null,_currentValue:null,_currentValue2:null,_threadCount:0};function Of(){return{controller:new rv,data:new Map,refCount:0}}function Ko(t){t.refCount--,t.refCount===0&&sv(ov,function(){t.controller.abort()})}var vo=null,Hp=0,Qr=0,Yr=null;function lv(t,e){if(vo===null){var n=vo=[];Hp=0,Qr=s1(),Yr={status:"pending",value:void 0,then:function(i){n.push(i)}}}return Hp++,e.then(wm,wm),e}function wm(){if(--Hp===0&&vo!==null){Yr!==null&&(Yr.status="fulfilled");var t=vo;vo=null,Qr=0,Yr=null;for(var e=0;e<t.length;e++)(0,t[e])()}}function cv(t,e){var n=[],i={status:"pending",value:null,reason:null,then:function(a){n.push(a)}};return t.then(function(){i.status="fulfilled",i.value=e;for(var a=0;a<n.length;a++)(0,n[a])(e)},function(a){for(i.status="rejected",i.reason=a,a=0;a<n.length;a++)(0,n[a])(void 0)}),i}var Cm=V.S;V.S=function(t,e){T6=He(),typeof e=="object"&&e!==null&&typeof e.then=="function"&&lv(t,e),Cm!==null&&Cm(t,e)};var Aa=In(null);function zf(){var t=Aa.current;return t!==null?t:Ct.pooledCache}function dc(t,e){e===null?At(Aa,Aa.current):At(Aa,e.pool)}function h2(){var t=zf();return t===null?null:{parent:Yt._currentValue,pool:t}}var ls=Error(_(460)),Lf=Error(_(474)),nu=Error(_(542)),Bc={then:function(){}};function Sm(t){return t=t.status,t==="fulfilled"||t==="rejected"}function g2(t,e,n){switch(n=t[n],n===void 0?t.push(e):n!==e&&(e.then(ni,ni),e=n),e.status){case"fulfilled":return e.value;case"rejected":throw t=e.reason,Tm(t),t;default:if(typeof e.status=="string")e.then(ni,ni);else{if(t=Ct,t!==null&&100<t.shellSuspendCounter)throw Error(_(482));t=e,t.status="pending",t.then(function(i){if(e.status==="pending"){var a=e;a.status="fulfilled",a.value=i}},function(i){if(e.status==="pending"){var a=e;a.status="rejected",a.reason=i}})}switch(e.status){case"fulfilled":return e.value;case"rejected":throw t=e.reason,Tm(t),t}throw Ta=e,ls}}function Ea(t){try{var e=t._init;return e(t._payload)}catch(n){throw n!==null&&typeof n=="object"&&typeof n.then=="function"?(Ta=n,ls):n}}var Ta=null;function Am(){if(Ta===null)throw Error(_(459));var t=Ta;return Ta=null,t}function Tm(t){if(t===ls||t===nu)throw Error(_(483))}var Vr=null,Oo=0;function Ql(t){var e=Oo;return Oo+=1,Vr===null&&(Vr=[]),g2(Vr,t,e)}function ro(t,e){e=e.props.ref,t.ref=e!==void 0?e:null}function Jl(t,e){throw e.$$typeof===K7?Error(_(525)):(t=Object.prototype.toString.call(e),Error(_(31,t==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":t)))}function m2(t){function e(v,h){if(t){var b=v.deletions;b===null?(v.deletions=[h],v.flags|=16):b.push(h)}}function n(v,h){if(!t)return null;for(;h!==null;)e(v,h),h=h.sibling;return null}function i(v){for(var h=new Map;v!==null;)v.key!==null?h.set(v.key,v):h.set(v.index,v),v=v.sibling;return h}function a(v,h){return v=ai(v,h),v.index=0,v.sibling=null,v}function r(v,h,b){return v.index=b,t?(b=v.alternate,b!==null?(b=b.index,b<h?(v.flags|=67108866,h):b):(v.flags|=67108866,h)):(v.flags|=1048576,h)}function s(v){return t&&v.alternate===null&&(v.flags|=67108866),v}function o(v,h,b,w){return h===null||h.tag!==6?(h=tp(b,v.mode,w),h.return=v,h):(h=a(h,b),h.return=v,h)}function l(v,h,b,w){var B=b.type;return B===_r?u(v,h,b.props.children,w,b.key):h!==null&&(h.elementType===B||typeof B=="object"&&B!==null&&B.$$typeof===Mi&&Ea(B)===h.type)?(h=a(h,b.props),ro(h,b),h.return=v,h):(h=uc(b.type,b.key,b.props,null,v.mode,w),ro(h,b),h.return=v,h)}function c(v,h,b,w){return h===null||h.tag!==4||h.stateNode.containerInfo!==b.containerInfo||h.stateNode.implementation!==b.implementation?(h=ep(b,v.mode,w),h.return=v,h):(h=a(h,b.children||[]),h.return=v,h)}function u(v,h,b,w,B){return h===null||h.tag!==7?(h=Sa(b,v.mode,w,B),h.return=v,h):(h=a(h,b),h.return=v,h)}function d(v,h,b){if(typeof h=="string"&&h!==""||typeof h=="number"||typeof h=="bigint")return h=tp(""+h,v.mode,b),h.return=v,h;if(typeof h=="object"&&h!==null){switch(h.$$typeof){case Ul:return b=uc(h.type,h.key,h.props,null,v.mode,b),ro(b,h),b.return=v,b;case uo:return h=ep(h,v.mode,b),h.return=v,h;case Mi:return h=Ea(h),d(v,h,b)}if(po(h)||io(h))return h=Sa(h,v.mode,b,null),h.return=v,h;if(typeof h.then=="function")return d(v,Ql(h),b);if(h.$$typeof===ei)return d(v,Zl(v,h),b);Jl(v,h)}return null}function p(v,h,b,w){var B=h!==null?h.key:null;if(typeof b=="string"&&b!==""||typeof b=="number"||typeof b=="bigint")return B!==null?null:o(v,h,""+b,w);if(typeof b=="object"&&b!==null){switch(b.$$typeof){case Ul:return b.key===B?l(v,h,b,w):null;case uo:return b.key===B?c(v,h,b,w):null;case Mi:return b=Ea(b),p(v,h,b,w)}if(po(b)||io(b))return B!==null?null:u(v,h,b,w,null);if(typeof b.then=="function")return p(v,h,Ql(b),w);if(b.$$typeof===ei)return p(v,h,Zl(v,b),w);Jl(v,b)}return null}function f(v,h,b,w,B){if(typeof w=="string"&&w!==""||typeof w=="number"||typeof w=="bigint")return v=v.get(b)||null,o(h,v,""+w,B);if(typeof w=="object"&&w!==null){switch(w.$$typeof){case Ul:return v=v.get(w.key===null?b:w.key)||null,l(h,v,w,B);case uo:return v=v.get(w.key===null?b:w.key)||null,c(h,v,w,B);case Mi:return w=Ea(w),f(v,h,b,w,B)}if(po(w)||io(w))return v=v.get(b)||null,u(h,v,w,B,null);if(typeof w.then=="function")return f(v,h,b,Ql(w),B);if(w.$$typeof===ei)return f(v,h,b,Zl(h,w),B);Jl(h,w)}return null}function y(v,h,b,w){for(var B=null,j=null,T=h,P=h=0,D=null;T!==null&&P<b.length;P++){T.index>P?(D=T,T=null):D=T.sibling;var I=p(v,T,b[P],w);if(I===null){T===null&&(T=D);break}t&&T&&I.alternate===null&&e(v,T),h=r(I,h,P),j===null?B=I:j.sibling=I,j=I,T=D}if(P===b.length)return n(v,T),ut&&Wn(v,P),B;if(T===null){for(;P<b.length;P++)T=d(v,b[P],w),T!==null&&(h=r(T,h,P),j===null?B=T:j.sibling=T,j=T);return ut&&Wn(v,P),B}for(T=i(T);P<b.length;P++)D=f(T,v,P,b[P],w),D!==null&&(t&&D.alternate!==null&&T.delete(D.key===null?P:D.key),h=r(D,h,P),j===null?B=D:j.sibling=D,j=D);return t&&T.forEach(function(q){return e(v,q)}),ut&&Wn(v,P),B}function x(v,h,b,w){if(b==null)throw Error(_(151));for(var B=null,j=null,T=h,P=h=0,D=null,I=b.next();T!==null&&!I.done;P++,I=b.next()){T.index>P?(D=T,T=null):D=T.sibling;var q=p(v,T,I.value,w);if(q===null){T===null&&(T=D);break}t&&T&&q.alternate===null&&e(v,T),h=r(q,h,P),j===null?B=q:j.sibling=q,j=q,T=D}if(I.done)return n(v,T),ut&&Wn(v,P),B;if(T===null){for(;!I.done;P++,I=b.next())I=d(v,I.value,w),I!==null&&(h=r(I,h,P),j===null?B=I:j.sibling=I,j=I);return ut&&Wn(v,P),B}for(T=i(T);!I.done;P++,I=b.next())I=f(T,v,P,I.value,w),I!==null&&(t&&I.alternate!==null&&T.delete(I.key===null?P:I.key),h=r(I,h,P),j===null?B=I:j.sibling=I,j=I);return t&&T.forEach(function(Et){return e(v,Et)}),ut&&Wn(v,P),B}function E(v,h,b,w){if(typeof b=="object"&&b!==null&&b.type===_r&&b.key===null&&(b=b.props.children),typeof b=="object"&&b!==null){switch(b.$$typeof){case Ul:t:{for(var B=b.key;h!==null;){if(h.key===B){if(B=b.type,B===_r){if(h.tag===7){n(v,h.sibling),w=a(h,b.props.children),w.return=v,v=w;break t}}else if(h.elementType===B||typeof B=="object"&&B!==null&&B.$$typeof===Mi&&Ea(B)===h.type){n(v,h.sibling),w=a(h,b.props),ro(w,b),w.return=v,v=w;break t}n(v,h);break}else e(v,h);h=h.sibling}b.type===_r?(w=Sa(b.props.children,v.mode,w,b.key),w.return=v,v=w):(w=uc(b.type,b.key,b.props,null,v.mode,w),ro(w,b),w.return=v,v=w)}return s(v);case uo:t:{for(B=b.key;h!==null;){if(h.key===B)if(h.tag===4&&h.stateNode.containerInfo===b.containerInfo&&h.stateNode.implementation===b.implementation){n(v,h.sibling),w=a(h,b.children||[]),w.return=v,v=w;break t}else{n(v,h);break}else e(v,h);h=h.sibling}w=ep(b,v.mode,w),w.return=v,v=w}return s(v);case Mi:return b=Ea(b),E(v,h,b,w)}if(po(b))return y(v,h,b,w);if(io(b)){if(B=io(b),typeof B!="function")throw Error(_(150));return b=B.call(b),x(v,h,b,w)}if(typeof b.then=="function")return E(v,h,Ql(b),w);if(b.$$typeof===ei)return E(v,h,Zl(v,b),w);Jl(v,b)}return typeof b=="string"&&b!==""||typeof b=="number"||typeof b=="bigint"?(b=""+b,h!==null&&h.tag===6?(n(v,h.sibling),w=a(h,b),w.return=v,v=w):(n(v,h),w=tp(b,v.mode,w),w.return=v,v=w),s(v)):n(v,h)}return function(v,h,b,w){try{Oo=0;var B=E(v,h,b,w);return Vr=null,B}catch(T){if(T===ls||T===nu)throw T;var j=$e(29,T,null,v.mode);return j.lanes=w,j.return=v,j}}}var Ra=m2(!0),y2=m2(!1),_i=!1;function Nf(t){t.updateQueue={baseState:t.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null,lanes:0,hiddenCallbacks:null},callbacks:null}}function Yp(t,e){t=t.updateQueue,e.updateQueue===t&&(e.updateQueue={baseState:t.baseState,firstBaseUpdate:t.firstBaseUpdate,lastBaseUpdate:t.lastBaseUpdate,shared:t.shared,callbacks:null})}function $i(t){return{lane:t,tag:0,payload:null,callback:null,next:null}}function Ui(t,e,n){var i=t.updateQueue;if(i===null)return null;if(i=i.shared,(ft&2)!==0){var a=i.pending;return a===null?e.next=e:(e.next=a.next,a.next=e),i.pending=e,e=Tc(t),l2(t,null,n),e}return eu(t,i,e,n),Tc(t)}function bo(t,e,n){if(e=e.updateQueue,e!==null&&(e=e.shared,(n&4194048)!==0)){var i=e.lanes;i&=t.pendingLanes,n|=i,e.lanes=n,Oy(t,n)}}function ip(t,e){var n=t.updateQueue,i=t.alternate;if(i!==null&&(i=i.updateQueue,n===i)){var a=null,r=null;if(n=n.firstBaseUpdate,n!==null){do{var s={lane:n.lane,tag:n.tag,payload:n.payload,callback:null,next:null};r===null?a=r=s:r=r.next=s,n=n.next}while(n!==null);r===null?a=r=e:r=r.next=e}else a=r=e;n={baseState:i.baseState,firstBaseUpdate:a,lastBaseUpdate:r,shared:i.shared,callbacks:i.callbacks},t.updateQueue=n;return}t=n.lastBaseUpdate,t===null?n.firstBaseUpdate=e:t.next=e,n.lastBaseUpdate=e}var Vp=!1;function ko(){if(Vp){var t=Yr;if(t!==null)throw t}}function Eo(t,e,n,i){Vp=!1;var a=t.updateQueue;_i=!1;var r=a.firstBaseUpdate,s=a.lastBaseUpdate,o=a.shared.pending;if(o!==null){a.shared.pending=null;var l=o,c=l.next;l.next=null,s===null?r=c:s.next=c,s=l;var u=t.alternate;u!==null&&(u=u.updateQueue,o=u.lastBaseUpdate,o!==s&&(o===null?u.firstBaseUpdate=c:o.next=c,u.lastBaseUpdate=l))}if(r!==null){var d=a.baseState;s=0,u=c=l=null,o=r;do{var p=o.lane&-536870913,f=p!==o.lane;if(f?(ot&p)===p:(i&p)===p){p!==0&&p===Qr&&(Vp=!0),u!==null&&(u=u.next={lane:0,tag:o.tag,payload:o.payload,callback:null,next:null});t:{var y=t,x=o;p=e;var E=n;switch(x.tag){case 1:if(y=x.payload,typeof y=="function"){d=y.call(E,d,p);break t}d=y;break t;case 3:y.flags=y.flags&-65537|128;case 0:if(y=x.payload,p=typeof y=="function"?y.call(E,d,p):y,p==null)break t;d=Rt({},d,p);break t;case 2:_i=!0}}p=o.callback,p!==null&&(t.flags|=64,f&&(t.flags|=8192),f=a.callbacks,f===null?a.callbacks=[p]:f.push(p))}else f={lane:p,tag:o.tag,payload:o.payload,callback:o.callback,next:null},u===null?(c=u=f,l=d):u=u.next=f,s|=p;if(o=o.next,o===null){if(o=a.shared.pending,o===null)break;f=o,o=f.next,f.next=null,a.lastBaseUpdate=f,a.shared.pending=null}}while(!0);u===null&&(l=d),a.baseState=l,a.firstBaseUpdate=c,a.lastBaseUpdate=u,r===null&&(a.shared.lanes=0),Qi|=s,t.lanes=s,t.memoizedState=d}}function x2(t,e){if(typeof t!="function")throw Error(_(191,t));t.call(e)}function v2(t,e){var n=t.callbacks;if(n!==null)for(t.callbacks=null,t=0;t<n.length;t++)x2(n[t],e)}var Jr=In(null),Rc=In(0);function Mm(t,e){t=di,At(Rc,t),At(Jr,e),di=t|e.baseLanes}function Gp(){At(Rc,di),At(Jr,Jr.current)}function Pf(){di=Rc.current,Wt(Jr),Wt(Rc)}var Xe=In(null),on=null;function Ri(t){var e=t.alternate;At(Pt,Pt.current&1),At(Xe,t),on===null&&(e===null||Jr.current!==null||e.memoizedState!==null)&&(on=t)}function qp(t){At(Pt,Pt.current),At(Xe,t),on===null&&(on=t)}function b2(t){t.tag===22?(At(Pt,Pt.current),At(Xe,t),on===null&&(on=t)):Di(t)}function Di(){At(Pt,Pt.current),At(Xe,Xe.current)}function je(t){Wt(Xe),on===t&&(on=null),Wt(Pt)}var Pt=In(0);function Dc(t){for(var e=t;e!==null;){if(e.tag===13){var n=e.memoizedState;if(n!==null&&(n=n.dehydrated,n===null||ff(n)||hf(n)))return e}else if(e.tag===19&&(e.memoizedProps.revealOrder==="forwards"||e.memoizedProps.revealOrder==="backwards"||e.memoizedProps.revealOrder==="unstable_legacy-backwards"||e.memoizedProps.revealOrder==="together")){if((e.flags&128)!==0)return e}else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===t)break;for(;e.sibling===null;){if(e.return===null||e.return===t)return null;e=e.return}e.sibling.return=e.return,e=e.sibling}return null}var li=0,Q=null,kt=null,Ut=null,Ic=!1,Gr=!1,Da=!1,Fc=0,zo=0,qr=null,uv=0;function zt(){throw Error(_(321))}function jf(t,e){if(e===null)return!1;for(var n=0;n<e.length&&n<t.length;n++)if(!qe(t[n],e[n]))return!1;return!0}function $f(t,e,n,i,a,r){return li=r,Q=e,e.memoizedState=null,e.updateQueue=null,e.lanes=0,V.H=t===null||t.memoizedState===null?Q2:Jf,Da=!1,r=n(i,a),Da=!1,Gr&&(r=E2(e,n,i,a)),k2(t),r}function k2(t){V.H=Lo;var e=kt!==null&&kt.next!==null;if(li=0,Ut=kt=Q=null,Ic=!1,zo=0,qr=null,e)throw Error(_(300));t===null||Vt||(t=t.dependencies,t!==null&&_c(t)&&(Vt=!0))}function E2(t,e,n,i){Q=t;var a=0;do{if(Gr&&(qr=null),zo=0,Gr=!1,25<=a)throw Error(_(301));if(a+=1,Ut=kt=null,t.updateQueue!=null){var r=t.updateQueue;r.lastEffect=null,r.events=null,r.stores=null,r.memoCache!=null&&(r.memoCache.index=0)}V.H=J2,r=e(n,i)}while(Gr);return r}function dv(){var t=V.H,e=t.useState()[0];return e=typeof e.then=="function"?Zo(e):e,t=t.useState()[0],(kt!==null?kt.memoizedState:null)!==t&&(Q.flags|=1024),e}function Uf(){var t=Fc!==0;return Fc=0,t}function Hf(t,e,n){e.updateQueue=t.updateQueue,e.flags&=-2053,t.lanes&=~n}function Yf(t){if(Ic){for(t=t.memoizedState;t!==null;){var e=t.queue;e!==null&&(e.pending=null),t=t.next}Ic=!1}li=0,Ut=kt=Q=null,Gr=!1,zo=Fc=0,qr=null}function xe(){var t={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return Ut===null?Q.memoizedState=Ut=t:Ut=Ut.next=t,Ut}function jt(){if(kt===null){var t=Q.alternate;t=t!==null?t.memoizedState:null}else t=kt.next;var e=Ut===null?Q.memoizedState:Ut.next;if(e!==null)Ut=e,kt=t;else{if(t===null)throw Q.alternate===null?Error(_(467)):Error(_(310));kt=t,t={memoizedState:kt.memoizedState,baseState:kt.baseState,baseQueue:kt.baseQueue,queue:kt.queue,next:null},Ut===null?Q.memoizedState=Ut=t:Ut=Ut.next=t}return Ut}function iu(){return{lastEffect:null,events:null,stores:null,memoCache:null}}function Zo(t){var e=zo;return zo+=1,qr===null&&(qr=[]),t=g2(qr,t,e),e=Q,(Ut===null?e.memoizedState:Ut.next)===null&&(e=e.alternate,V.H=e===null||e.memoizedState===null?Q2:Jf),t}function au(t){if(t!==null&&typeof t=="object"){if(typeof t.then=="function")return Zo(t);if(t.$$typeof===ei)return ae(t)}throw Error(_(438,String(t)))}function Vf(t){var e=null,n=Q.updateQueue;if(n!==null&&(e=n.memoCache),e==null){var i=Q.alternate;i!==null&&(i=i.updateQueue,i!==null&&(i=i.memoCache,i!=null&&(e={data:i.data.map(function(a){return a.slice()}),index:0})))}if(e==null&&(e={data:[],index:0}),n===null&&(n=iu(),Q.updateQueue=n),n.memoCache=e,n=e.data[e.index],n===void 0)for(n=e.data[e.index]=Array(t),i=0;i<t;i++)n[i]=Z7;return e.index++,n}function ci(t,e){return typeof e=="function"?e(t):e}function pc(t){var e=jt();return Gf(e,kt,t)}function Gf(t,e,n){var i=t.queue;if(i===null)throw Error(_(311));i.lastRenderedReducer=n;var a=t.baseQueue,r=i.pending;if(r!==null){if(a!==null){var s=a.next;a.next=r.next,r.next=s}e.baseQueue=a=r,i.pending=null}if(r=t.baseState,a===null)t.memoizedState=r;else{e=a.next;var o=s=null,l=null,c=e,u=!1;do{var d=c.lane&-536870913;if(d!==c.lane?(ot&d)===d:(li&d)===d){var p=c.revertLane;if(p===0)l!==null&&(l=l.next={lane:0,revertLane:0,gesture:null,action:c.action,hasEagerState:c.hasEagerState,eagerState:c.eagerState,next:null}),d===Qr&&(u=!0);else if((li&p)===p){c=c.next,p===Qr&&(u=!0);continue}else d={lane:0,revertLane:c.revertLane,gesture:null,action:c.action,hasEagerState:c.hasEagerState,eagerState:c.eagerState,next:null},l===null?(o=l=d,s=r):l=l.next=d,Q.lanes|=p,Qi|=p;d=c.action,Da&&n(r,d),r=c.hasEagerState?c.eagerState:n(r,d)}else p={lane:d,revertLane:c.revertLane,gesture:c.gesture,action:c.action,hasEagerState:c.hasEagerState,eagerState:c.eagerState,next:null},l===null?(o=l=p,s=r):l=l.next=p,Q.lanes|=d,Qi|=d;c=c.next}while(c!==null&&c!==e);if(l===null?s=r:l.next=o,!qe(r,t.memoizedState)&&(Vt=!0,u&&(n=Yr,n!==null)))throw n;t.memoizedState=r,t.baseState=s,t.baseQueue=l,i.lastRenderedState=r}return a===null&&(i.lanes=0),[t.memoizedState,i.dispatch]}function ap(t){var e=jt(),n=e.queue;if(n===null)throw Error(_(311));n.lastRenderedReducer=t;var i=n.dispatch,a=n.pending,r=e.memoizedState;if(a!==null){n.pending=null;var s=a=a.next;do r=t(r,s.action),s=s.next;while(s!==a);qe(r,e.memoizedState)||(Vt=!0),e.memoizedState=r,e.baseQueue===null&&(e.baseState=r),n.lastRenderedState=r}return[r,i]}function w2(t,e,n){var i=Q,a=jt(),r=ut;if(r){if(n===void 0)throw Error(_(407));n=n()}else n=e();var s=!qe((kt||a).memoizedState,n);if(s&&(a.memoizedState=n,Vt=!0),a=a.queue,qf(A2.bind(null,i,a,t),[t]),a.getSnapshot!==e||s||Ut!==null&&Ut.memoizedState.tag&1){if(i.flags|=2048,Wr(9,{destroy:void 0},S2.bind(null,i,a,n,e),null),Ct===null)throw Error(_(349));r||(li&127)!==0||C2(i,e,n)}return n}function C2(t,e,n){t.flags|=16384,t={getSnapshot:e,value:n},e=Q.updateQueue,e===null?(e=iu(),Q.updateQueue=e,e.stores=[t]):(n=e.stores,n===null?e.stores=[t]:n.push(t))}function S2(t,e,n,i){e.value=n,e.getSnapshot=i,T2(e)&&M2(t)}function A2(t,e,n){return n(function(){T2(e)&&M2(t)})}function T2(t){var e=t.getSnapshot;t=t.value;try{var n=e();return!qe(t,n)}catch{return!0}}function M2(t){var e=La(t,2);e!==null&&Me(e,t,2)}function Xp(t){var e=xe();if(typeof t=="function"){var n=t;if(t=n(),Da){Fi(!0);try{n()}finally{Fi(!1)}}}return e.memoizedState=e.baseState=t,e.queue={pending:null,lanes:0,dispatch:null,lastRenderedReducer:ci,lastRenderedState:t},e}function _2(t,e,n,i){return t.baseState=n,Gf(t,kt,typeof i=="function"?i:ci)}function pv(t,e,n,i,a){if(su(t))throw Error(_(485));if(t=e.action,t!==null){var r={payload:a,action:t,next:null,isTransition:!0,status:"pending",value:null,reason:null,listeners:[],then:function(s){r.listeners.push(s)}};V.T!==null?n(!0):r.isTransition=!1,i(r),n=e.pending,n===null?(r.next=e.pending=r,B2(e,r)):(r.next=n.next,e.pending=n.next=r)}}function B2(t,e){var n=e.action,i=e.payload,a=t.state;if(e.isTransition){var r=V.T,s={};V.T=s;try{var o=n(a,i),l=V.S;l!==null&&l(s,o),_m(t,e,o)}catch(c){Kp(t,e,c)}finally{r!==null&&s.types!==null&&(r.types=s.types),V.T=r}}else try{r=n(a,i),_m(t,e,r)}catch(c){Kp(t,e,c)}}function _m(t,e,n){n!==null&&typeof n=="object"&&typeof n.then=="function"?n.then(function(i){Bm(t,e,i)},function(i){return Kp(t,e,i)}):Bm(t,e,n)}function Bm(t,e,n){e.status="fulfilled",e.value=n,R2(e),t.state=n,e=t.pending,e!==null&&(n=e.next,n===e?t.pending=null:(n=n.next,e.next=n,B2(t,n)))}function Kp(t,e,n){var i=t.pending;if(t.pending=null,i!==null){i=i.next;do e.status="rejected",e.reason=n,R2(e),e=e.next;while(e!==i)}t.action=null}function R2(t){t=t.listeners;for(var e=0;e<t.length;e++)(0,t[e])()}function D2(t,e){return e}function Rm(t,e){if(ut){var n=Ct.formState;if(n!==null){t:{var i=Q;if(ut){if(Bt){e:{for(var a=Bt,r=sn;a.nodeType!==8;){if(!r){a=null;break e}if(a=ln(a.nextSibling),a===null){a=null;break e}}r=a.data,a=r==="F!"||r==="F"?a:null}if(a){Bt=ln(a.nextSibling),i=a.data==="F!";break t}}Ki(i)}i=!1}i&&(e=n[0])}}return n=xe(),n.memoizedState=n.baseState=e,i={pending:null,lanes:0,dispatch:null,lastRenderedReducer:D2,lastRenderedState:e},n.queue=i,n=X2.bind(null,Q,i),i.dispatch=n,i=Xp(!1),r=Qf.bind(null,Q,!1,i.queue),i=xe(),a={state:e,dispatch:null,action:t,pending:null},i.queue=a,n=pv.bind(null,Q,a,r,n),a.dispatch=n,i.memoizedState=t,[e,n,!1]}function Dm(t){var e=jt();return I2(e,kt,t)}function I2(t,e,n){if(e=Gf(t,e,D2)[0],t=pc(ci)[0],typeof e=="object"&&e!==null&&typeof e.then=="function")try{var i=Zo(e)}catch(s){throw s===ls?nu:s}else i=e;e=jt();var a=e.queue,r=a.dispatch;return n!==e.memoizedState&&(Q.flags|=2048,Wr(9,{destroy:void 0},fv.bind(null,a,n),null)),[i,r,t]}function fv(t,e){t.action=e}function Im(t){var e=jt(),n=kt;if(n!==null)return I2(e,n,t);jt(),e=e.memoizedState,n=jt();var i=n.queue.dispatch;return n.memoizedState=t,[e,i,!1]}function Wr(t,e,n,i){return t={tag:t,create:n,deps:i,inst:e,next:null},e=Q.updateQueue,e===null&&(e=iu(),Q.updateQueue=e),n=e.lastEffect,n===null?e.lastEffect=t.next=t:(i=n.next,n.next=t,t.next=i,e.lastEffect=t),t}function F2(){return jt().memoizedState}function fc(t,e,n,i){var a=xe();Q.flags|=t,a.memoizedState=Wr(1|e,{destroy:void 0},n,i===void 0?null:i)}function ru(t,e,n,i){var a=jt();i=i===void 0?null:i;var r=a.memoizedState.inst;kt!==null&&i!==null&&jf(i,kt.memoizedState.deps)?a.memoizedState=Wr(e,r,n,i):(Q.flags|=t,a.memoizedState=Wr(1|e,r,n,i))}function Fm(t,e){fc(8390656,8,t,e)}function qf(t,e){ru(2048,8,t,e)}function hv(t){Q.flags|=4;var e=Q.updateQueue;if(e===null)e=iu(),Q.updateQueue=e,e.events=[t];else{var n=e.events;n===null?e.events=[t]:n.push(t)}}function O2(t){var e=jt().memoizedState;return hv({ref:e,nextImpl:t}),function(){if((ft&2)!==0)throw Error(_(440));return e.impl.apply(void 0,arguments)}}function z2(t,e){return ru(4,2,t,e)}function L2(t,e){return ru(4,4,t,e)}function N2(t,e){if(typeof e=="function"){t=t();var n=e(t);return function(){typeof n=="function"?n():e(null)}}if(e!=null)return t=t(),e.current=t,function(){e.current=null}}function P2(t,e,n){n=n!=null?n.concat([t]):null,ru(4,4,N2.bind(null,e,t),n)}function Xf(){}function j2(t,e){var n=jt();e=e===void 0?null:e;var i=n.memoizedState;return e!==null&&jf(e,i[1])?i[0]:(n.memoizedState=[t,e],t)}function $2(t,e){var n=jt();e=e===void 0?null:e;var i=n.memoizedState;if(e!==null&&jf(e,i[1]))return i[0];if(i=t(),Da){Fi(!0);try{t()}finally{Fi(!1)}}return n.memoizedState=[i,e],i}function Kf(t,e,n){return n===void 0||(li&1073741824)!==0&&(ot&261930)===0?t.memoizedState=e:(t.memoizedState=n,t=_6(),Q.lanes|=t,Qi|=t,n)}function U2(t,e,n,i){return qe(n,e)?n:Jr.current!==null?(t=Kf(t,n,i),qe(t,e)||(Vt=!0),t):(li&42)===0||(li&1073741824)!==0&&(ot&261930)===0?(Vt=!0,t.memoizedState=n):(t=_6(),Q.lanes|=t,Qi|=t,e)}function H2(t,e,n,i,a){var r=ht.p;ht.p=r!==0&&8>r?r:8;var s=V.T,o={};V.T=o,Qf(t,!1,e,n);try{var l=a(),c=V.S;if(c!==null&&c(o,l),l!==null&&typeof l=="object"&&typeof l.then=="function"){var u=cv(l,i);wo(t,e,u,Ge(t))}else wo(t,e,i,Ge(t))}catch(d){wo(t,e,{then:function(){},status:"rejected",reason:d},Ge())}finally{ht.p=r,s!==null&&o.types!==null&&(s.types=o.types),V.T=s}}function gv(){}function Zp(t,e,n,i){if(t.tag!==5)throw Error(_(476));var a=Y2(t).queue;H2(t,a,e,Ca,n===null?gv:function(){return V2(t),n(i)})}function Y2(t){var e=t.memoizedState;if(e!==null)return e;e={memoizedState:Ca,baseState:Ca,baseQueue:null,queue:{pending:null,lanes:0,dispatch:null,lastRenderedReducer:ci,lastRenderedState:Ca},next:null};var n={};return e.next={memoizedState:n,baseState:n,baseQueue:null,queue:{pending:null,lanes:0,dispatch:null,lastRenderedReducer:ci,lastRenderedState:n},next:null},t.memoizedState=e,t=t.alternate,t!==null&&(t.memoizedState=e),e}function V2(t){var e=Y2(t);e.next===null&&(e=t.alternate.memoizedState),wo(t,e.next.queue,{},Ge())}function Zf(){return ae(jo)}function G2(){return jt().memoizedState}function q2(){return jt().memoizedState}function mv(t){for(var e=t.return;e!==null;){switch(e.tag){case 24:case 3:var n=Ge();t=$i(n);var i=Ui(e,t,n);i!==null&&(Me(i,e,n),bo(i,e,n)),e={cache:Of()},t.payload=e;return}e=e.return}}function yv(t,e,n){var i=Ge();n={lane:i,revertLane:0,gesture:null,action:n,hasEagerState:!1,eagerState:null,next:null},su(t)?K2(e,n):(n=Rf(t,e,n,i),n!==null&&(Me(n,t,i),Z2(n,e,i)))}function X2(t,e,n){var i=Ge();wo(t,e,n,i)}function wo(t,e,n,i){var a={lane:i,revertLane:0,gesture:null,action:n,hasEagerState:!1,eagerState:null,next:null};if(su(t))K2(e,a);else{var r=t.alternate;if(t.lanes===0&&(r===null||r.lanes===0)&&(r=e.lastRenderedReducer,r!==null))try{var s=e.lastRenderedState,o=r(s,n);if(a.hasEagerState=!0,a.eagerState=o,qe(o,s))return eu(t,e,a,0),Ct===null&&tu(),!1}catch{}if(n=Rf(t,e,a,i),n!==null)return Me(n,t,i),Z2(n,e,i),!0}return!1}function Qf(t,e,n,i){if(i={lane:2,revertLane:s1(),gesture:null,action:i,hasEagerState:!1,eagerState:null,next:null},su(t)){if(e)throw Error(_(479))}else e=Rf(t,n,i,2),e!==null&&Me(e,t,2)}function su(t){var e=t.alternate;return t===Q||e!==null&&e===Q}function K2(t,e){Gr=Ic=!0;var n=t.pending;n===null?e.next=e:(e.next=n.next,n.next=e),t.pending=e}function Z2(t,e,n){if((n&4194048)!==0){var i=e.lanes;i&=t.pendingLanes,n|=i,e.lanes=n,Oy(t,n)}}var Lo={readContext:ae,use:au,useCallback:zt,useContext:zt,useEffect:zt,useImperativeHandle:zt,useLayoutEffect:zt,useInsertionEffect:zt,useMemo:zt,useReducer:zt,useRef:zt,useState:zt,useDebugValue:zt,useDeferredValue:zt,useTransition:zt,useSyncExternalStore:zt,useId:zt,useHostTransitionStatus:zt,useFormState:zt,useActionState:zt,useOptimistic:zt,useMemoCache:zt,useCacheRefresh:zt};Lo.useEffectEvent=zt;var Q2={readContext:ae,use:au,useCallback:function(t,e){return xe().memoizedState=[t,e===void 0?null:e],t},useContext:ae,useEffect:Fm,useImperativeHandle:function(t,e,n){n=n!=null?n.concat([t]):null,fc(4194308,4,N2.bind(null,e,t),n)},useLayoutEffect:function(t,e){return fc(4194308,4,t,e)},useInsertionEffect:function(t,e){fc(4,2,t,e)},useMemo:function(t,e){var n=xe();e=e===void 0?null:e;var i=t();if(Da){Fi(!0);try{t()}finally{Fi(!1)}}return n.memoizedState=[i,e],i},useReducer:function(t,e,n){var i=xe();if(n!==void 0){var a=n(e);if(Da){Fi(!0);try{n(e)}finally{Fi(!1)}}}else a=e;return i.memoizedState=i.baseState=a,t={pending:null,lanes:0,dispatch:null,lastRenderedReducer:t,lastRenderedState:a},i.queue=t,t=t.dispatch=yv.bind(null,Q,t),[i.memoizedState,t]},useRef:function(t){var e=xe();return t={current:t},e.memoizedState=t},useState:function(t){t=Xp(t);var e=t.queue,n=X2.bind(null,Q,e);return e.dispatch=n,[t.memoizedState,n]},useDebugValue:Xf,useDeferredValue:function(t,e){var n=xe();return Kf(n,t,e)},useTransition:function(){var t=Xp(!1);return t=H2.bind(null,Q,t.queue,!0,!1),xe().memoizedState=t,[!1,t]},useSyncExternalStore:function(t,e,n){var i=Q,a=xe();if(ut){if(n===void 0)throw Error(_(407));n=n()}else{if(n=e(),Ct===null)throw Error(_(349));(ot&127)!==0||C2(i,e,n)}a.memoizedState=n;var r={value:n,getSnapshot:e};return a.queue=r,Fm(A2.bind(null,i,r,t),[t]),i.flags|=2048,Wr(9,{destroy:void 0},S2.bind(null,i,r,n,e),null),n},useId:function(){var t=xe(),e=Ct.identifierPrefix;if(ut){var n=Bn,i=_n;n=(i&~(1<<32-Ve(i)-1)).toString(32)+n,e="_"+e+"R_"+n,n=Fc++,0<n&&(e+="H"+n.toString(32)),e+="_"}else n=uv++,e="_"+e+"r_"+n.toString(32)+"_";return t.memoizedState=e},useHostTransitionStatus:Zf,useFormState:Rm,useActionState:Rm,useOptimistic:function(t){var e=xe();e.memoizedState=e.baseState=t;var n={pending:null,lanes:0,dispatch:null,lastRenderedReducer:null,lastRenderedState:null};return e.queue=n,e=Qf.bind(null,Q,!0,n),n.dispatch=e,[t,e]},useMemoCache:Vf,useCacheRefresh:function(){return xe().memoizedState=mv.bind(null,Q)},useEffectEvent:function(t){var e=xe(),n={impl:t};return e.memoizedState=n,function(){if((ft&2)!==0)throw Error(_(440));return n.impl.apply(void 0,arguments)}}},Jf={readContext:ae,use:au,useCallback:j2,useContext:ae,useEffect:qf,useImperativeHandle:P2,useInsertionEffect:z2,useLayoutEffect:L2,useMemo:$2,useReducer:pc,useRef:F2,useState:function(){return pc(ci)},useDebugValue:Xf,useDeferredValue:function(t,e){var n=jt();return U2(n,kt.memoizedState,t,e)},useTransition:function(){var t=pc(ci)[0],e=jt().memoizedState;return[typeof t=="boolean"?t:Zo(t),e]},useSyncExternalStore:w2,useId:G2,useHostTransitionStatus:Zf,useFormState:Dm,useActionState:Dm,useOptimistic:function(t,e){var n=jt();return _2(n,kt,t,e)},useMemoCache:Vf,useCacheRefresh:q2};Jf.useEffectEvent=O2;var J2={readContext:ae,use:au,useCallback:j2,useContext:ae,useEffect:qf,useImperativeHandle:P2,useInsertionEffect:z2,useLayoutEffect:L2,useMemo:$2,useReducer:ap,useRef:F2,useState:function(){return ap(ci)},useDebugValue:Xf,useDeferredValue:function(t,e){var n=jt();return kt===null?Kf(n,t,e):U2(n,kt.memoizedState,t,e)},useTransition:function(){var t=ap(ci)[0],e=jt().memoizedState;return[typeof t=="boolean"?t:Zo(t),e]},useSyncExternalStore:w2,useId:G2,useHostTransitionStatus:Zf,useFormState:Im,useActionState:Im,useOptimistic:function(t,e){var n=jt();return kt!==null?_2(n,kt,t,e):(n.baseState=t,[t,n.queue.dispatch])},useMemoCache:Vf,useCacheRefresh:q2};J2.useEffectEvent=O2;function rp(t,e,n,i){e=t.memoizedState,n=n(i,e),n=n==null?e:Rt({},e,n),t.memoizedState=n,t.lanes===0&&(t.updateQueue.baseState=n)}var Qp={enqueueSetState:function(t,e,n){t=t._reactInternals;var i=Ge(),a=$i(i);a.payload=e,n!=null&&(a.callback=n),e=Ui(t,a,i),e!==null&&(Me(e,t,i),bo(e,t,i))},enqueueReplaceState:function(t,e,n){t=t._reactInternals;var i=Ge(),a=$i(i);a.tag=1,a.payload=e,n!=null&&(a.callback=n),e=Ui(t,a,i),e!==null&&(Me(e,t,i),bo(e,t,i))},enqueueForceUpdate:function(t,e){t=t._reactInternals;var n=Ge(),i=$i(n);i.tag=2,e!=null&&(i.callback=e),e=Ui(t,i,n),e!==null&&(Me(e,t,n),bo(e,t,n))}};function Om(t,e,n,i,a,r,s){return t=t.stateNode,typeof t.shouldComponentUpdate=="function"?t.shouldComponentUpdate(i,r,s):e.prototype&&e.prototype.isPureReactComponent?!Do(n,i)||!Do(a,r):!0}function zm(t,e,n,i){t=e.state,typeof e.componentWillReceiveProps=="function"&&e.componentWillReceiveProps(n,i),typeof e.UNSAFE_componentWillReceiveProps=="function"&&e.UNSAFE_componentWillReceiveProps(n,i),e.state!==t&&Qp.enqueueReplaceState(e,e.state,null)}function Ia(t,e){var n=e;if("ref"in e){n={};for(var i in e)i!=="ref"&&(n[i]=e[i])}if(t=t.defaultProps){n===e&&(n=Rt({},n));for(var a in t)n[a]===void 0&&(n[a]=t[a])}return n}function W2(t){Ac(t)}function t6(t){console.error(t)}function e6(t){Ac(t)}function Oc(t,e){try{var n=t.onUncaughtError;n(e.value,{componentStack:e.stack})}catch(i){setTimeout(function(){throw i})}}function Lm(t,e,n){try{var i=t.onCaughtError;i(n.value,{componentStack:n.stack,errorBoundary:e.tag===1?e.stateNode:null})}catch(a){setTimeout(function(){throw a})}}function Jp(t,e,n){return n=$i(n),n.tag=3,n.payload={element:null},n.callback=function(){Oc(t,e)},n}function n6(t){return t=$i(t),t.tag=3,t}function i6(t,e,n,i){var a=n.type.getDerivedStateFromError;if(typeof a=="function"){var r=i.value;t.payload=function(){return a(r)},t.callback=function(){Lm(e,n,i)}}var s=n.stateNode;s!==null&&typeof s.componentDidCatch=="function"&&(t.callback=function(){Lm(e,n,i),typeof a!="function"&&(Hi===null?Hi=new Set([this]):Hi.add(this));var o=i.stack;this.componentDidCatch(i.value,{componentStack:o!==null?o:""})})}function xv(t,e,n,i,a){if(n.flags|=32768,i!==null&&typeof i=="object"&&typeof i.then=="function"){if(e=n.alternate,e!==null&&os(e,n,a,!0),n=Xe.current,n!==null){switch(n.tag){case 31:case 13:return on===null?jc():n.alternate===null&&Lt===0&&(Lt=3),n.flags&=-257,n.flags|=65536,n.lanes=a,i===Bc?n.flags|=16384:(e=n.updateQueue,e===null?n.updateQueue=new Set([i]):e.add(i),mp(t,i,a)),!1;case 22:return n.flags|=65536,i===Bc?n.flags|=16384:(e=n.updateQueue,e===null?(e={transitions:null,markerInstances:null,retryQueue:new Set([i])},n.updateQueue=e):(n=e.retryQueue,n===null?e.retryQueue=new Set([i]):n.add(i)),mp(t,i,a)),!1}throw Error(_(435,n.tag))}return mp(t,i,a),jc(),!1}if(ut)return e=Xe.current,e!==null?((e.flags&65536)===0&&(e.flags|=256),e.flags|=65536,e.lanes=a,i!==Pp&&(t=Error(_(422),{cause:i}),Fo(rn(t,n)))):(i!==Pp&&(e=Error(_(423),{cause:i}),Fo(rn(e,n))),t=t.current.alternate,t.flags|=65536,a&=-a,t.lanes|=a,i=rn(i,n),a=Jp(t.stateNode,i,a),ip(t,a),Lt!==4&&(Lt=2)),!1;var r=Error(_(520),{cause:i});if(r=rn(r,n),Ao===null?Ao=[r]:Ao.push(r),Lt!==4&&(Lt=2),e===null)return!0;i=rn(i,n),n=e;do{switch(n.tag){case 3:return n.flags|=65536,t=a&-a,n.lanes|=t,t=Jp(n.stateNode,i,t),ip(n,t),!1;case 1:if(e=n.type,r=n.stateNode,(n.flags&128)===0&&(typeof e.getDerivedStateFromError=="function"||r!==null&&typeof r.componentDidCatch=="function"&&(Hi===null||!Hi.has(r))))return n.flags|=65536,a&=-a,n.lanes|=a,a=n6(a),i6(a,t,n,i),ip(n,a),!1}n=n.return}while(n!==null);return!1}var Wf=Error(_(461)),Vt=!1;function ee(t,e,n,i){e.child=t===null?y2(e,null,n,i):Ra(e,t.child,n,i)}function Nm(t,e,n,i,a){n=n.render;var r=e.ref;if("ref"in i){var s={};for(var o in i)o!=="ref"&&(s[o]=i[o])}else s=i;return Ba(e),i=$f(t,e,n,s,r,a),o=Uf(),t!==null&&!Vt?(Hf(t,e,a),ui(t,e,a)):(ut&&o&&If(e),e.flags|=1,ee(t,e,i,a),e.child)}function Pm(t,e,n,i,a){if(t===null){var r=n.type;return typeof r=="function"&&!Df(r)&&r.defaultProps===void 0&&n.compare===null?(e.tag=15,e.type=r,a6(t,e,r,i,a)):(t=uc(n.type,null,i,e,e.mode,a),t.ref=e.ref,t.return=e,e.child=t)}if(r=t.child,!t1(t,a)){var s=r.memoizedProps;if(n=n.compare,n=n!==null?n:Do,n(s,i)&&t.ref===e.ref)return ui(t,e,a)}return e.flags|=1,t=ai(r,i),t.ref=e.ref,t.return=e,e.child=t}function a6(t,e,n,i,a){if(t!==null){var r=t.memoizedProps;if(Do(r,i)&&t.ref===e.ref)if(Vt=!1,e.pendingProps=i=r,t1(t,a))(t.flags&131072)!==0&&(Vt=!0);else return e.lanes=t.lanes,ui(t,e,a)}return Wp(t,e,n,i,a)}function r6(t,e,n,i){var a=i.children,r=t!==null?t.memoizedState:null;if(t===null&&e.stateNode===null&&(e.stateNode={_visibility:1,_pendingMarkers:null,_retryCache:null,_transitions:null}),i.mode==="hidden"){if((e.flags&128)!==0){if(r=r!==null?r.baseLanes|n:n,t!==null){for(i=e.child=t.child,a=0;i!==null;)a=a|i.lanes|i.childLanes,i=i.sibling;i=a&~r}else i=0,e.child=null;return jm(t,e,r,n,i)}if((n&536870912)!==0)e.memoizedState={baseLanes:0,cachePool:null},t!==null&&dc(e,r!==null?r.cachePool:null),r!==null?Mm(e,r):Gp(),b2(e);else return i=e.lanes=536870912,jm(t,e,r!==null?r.baseLanes|n:n,n,i)}else r!==null?(dc(e,r.cachePool),Mm(e,r),Di(e),e.memoizedState=null):(t!==null&&dc(e,null),Gp(),Di(e));return ee(t,e,a,n),e.child}function ho(t,e){return t!==null&&t.tag===22||e.stateNode!==null||(e.stateNode={_visibility:1,_pendingMarkers:null,_retryCache:null,_transitions:null}),e.sibling}function jm(t,e,n,i,a){var r=zf();return r=r===null?null:{parent:Yt._currentValue,pool:r},e.memoizedState={baseLanes:n,cachePool:r},t!==null&&dc(e,null),Gp(),b2(e),t!==null&&os(t,e,i,!0),e.childLanes=a,null}function hc(t,e){return e=zc({mode:e.mode,children:e.children},t.mode),e.ref=t.ref,t.child=e,e.return=t,e}function $m(t,e,n){return Ra(e,t.child,null,n),t=hc(e,e.pendingProps),t.flags|=2,je(e),e.memoizedState=null,t}function vv(t,e,n){var i=e.pendingProps,a=(e.flags&128)!==0;if(e.flags&=-129,t===null){if(ut){if(i.mode==="hidden")return t=hc(e,i),e.lanes=536870912,ho(null,t);if(qp(e),(t=Bt)?(t=Q6(t,sn),t=t!==null&&t.data==="&"?t:null,t!==null&&(e.memoizedState={dehydrated:t,treeContext:Xi!==null?{id:_n,overflow:Bn}:null,retryLane:536870912,hydrationErrors:null},n=u2(t),n.return=e,e.child=n,ie=e,Bt=null)):t=null,t===null)throw Ki(e);return e.lanes=536870912,null}return hc(e,i)}var r=t.memoizedState;if(r!==null){var s=r.dehydrated;if(qp(e),a)if(e.flags&256)e.flags&=-257,e=$m(t,e,n);else if(e.memoizedState!==null)e.child=t.child,e.flags|=128,e=null;else throw Error(_(558));else if(Vt||os(t,e,n,!1),a=(n&t.childLanes)!==0,Vt||a){if(i=Ct,i!==null&&(s=zy(i,n),s!==0&&s!==r.retryLane))throw r.retryLane=s,La(t,s),Me(i,t,s),Wf;jc(),e=$m(t,e,n)}else t=r.treeContext,Bt=ln(s.nextSibling),ie=e,ut=!0,ji=null,sn=!1,t!==null&&p2(e,t),e=hc(e,i),e.flags|=4096;return e}return t=ai(t.child,{mode:i.mode,children:i.children}),t.ref=e.ref,e.child=t,t.return=e,t}function gc(t,e){var n=e.ref;if(n===null)t!==null&&t.ref!==null&&(e.flags|=4194816);else{if(typeof n!="function"&&typeof n!="object")throw Error(_(284));(t===null||t.ref!==n)&&(e.flags|=4194816)}}function Wp(t,e,n,i,a){return Ba(e),n=$f(t,e,n,i,void 0,a),i=Uf(),t!==null&&!Vt?(Hf(t,e,a),ui(t,e,a)):(ut&&i&&If(e),e.flags|=1,ee(t,e,n,a),e.child)}function Um(t,e,n,i,a,r){return Ba(e),e.updateQueue=null,n=E2(e,i,n,a),k2(t),i=Uf(),t!==null&&!Vt?(Hf(t,e,r),ui(t,e,r)):(ut&&i&&If(e),e.flags|=1,ee(t,e,n,r),e.child)}function Hm(t,e,n,i,a){if(Ba(e),e.stateNode===null){var r=Lr,s=n.contextType;typeof s=="object"&&s!==null&&(r=ae(s)),r=new n(i,r),e.memoizedState=r.state!==null&&r.state!==void 0?r.state:null,r.updater=Qp,e.stateNode=r,r._reactInternals=e,r=e.stateNode,r.props=i,r.state=e.memoizedState,r.refs={},Nf(e),s=n.contextType,r.context=typeof s=="object"&&s!==null?ae(s):Lr,r.state=e.memoizedState,s=n.getDerivedStateFromProps,typeof s=="function"&&(rp(e,n,s,i),r.state=e.memoizedState),typeof n.getDerivedStateFromProps=="function"||typeof r.getSnapshotBeforeUpdate=="function"||typeof r.UNSAFE_componentWillMount!="function"&&typeof r.componentWillMount!="function"||(s=r.state,typeof r.componentWillMount=="function"&&r.componentWillMount(),typeof r.UNSAFE_componentWillMount=="function"&&r.UNSAFE_componentWillMount(),s!==r.state&&Qp.enqueueReplaceState(r,r.state,null),Eo(e,i,r,a),ko(),r.state=e.memoizedState),typeof r.componentDidMount=="function"&&(e.flags|=4194308),i=!0}else if(t===null){r=e.stateNode;var o=e.memoizedProps,l=Ia(n,o);r.props=l;var c=r.context,u=n.contextType;s=Lr,typeof u=="object"&&u!==null&&(s=ae(u));var d=n.getDerivedStateFromProps;u=typeof d=="function"||typeof r.getSnapshotBeforeUpdate=="function",o=e.pendingProps!==o,u||typeof r.UNSAFE_componentWillReceiveProps!="function"&&typeof r.componentWillReceiveProps!="function"||(o||c!==s)&&zm(e,r,i,s),_i=!1;var p=e.memoizedState;r.state=p,Eo(e,i,r,a),ko(),c=e.memoizedState,o||p!==c||_i?(typeof d=="function"&&(rp(e,n,d,i),c=e.memoizedState),(l=_i||Om(e,n,l,i,p,c,s))?(u||typeof r.UNSAFE_componentWillMount!="function"&&typeof r.componentWillMount!="function"||(typeof r.componentWillMount=="function"&&r.componentWillMount(),typeof r.UNSAFE_componentWillMount=="function"&&r.UNSAFE_componentWillMount()),typeof r.componentDidMount=="function"&&(e.flags|=4194308)):(typeof r.componentDidMount=="function"&&(e.flags|=4194308),e.memoizedProps=i,e.memoizedState=c),r.props=i,r.state=c,r.context=s,i=l):(typeof r.componentDidMount=="function"&&(e.flags|=4194308),i=!1)}else{r=e.stateNode,Yp(t,e),s=e.memoizedProps,u=Ia(n,s),r.props=u,d=e.pendingProps,p=r.context,c=n.contextType,l=Lr,typeof c=="object"&&c!==null&&(l=ae(c)),o=n.getDerivedStateFromProps,(c=typeof o=="function"||typeof r.getSnapshotBeforeUpdate=="function")||typeof r.UNSAFE_componentWillReceiveProps!="function"&&typeof r.componentWillReceiveProps!="function"||(s!==d||p!==l)&&zm(e,r,i,l),_i=!1,p=e.memoizedState,r.state=p,Eo(e,i,r,a),ko();var f=e.memoizedState;s!==d||p!==f||_i||t!==null&&t.dependencies!==null&&_c(t.dependencies)?(typeof o=="function"&&(rp(e,n,o,i),f=e.memoizedState),(u=_i||Om(e,n,u,i,p,f,l)||t!==null&&t.dependencies!==null&&_c(t.dependencies))?(c||typeof r.UNSAFE_componentWillUpdate!="function"&&typeof r.componentWillUpdate!="function"||(typeof r.componentWillUpdate=="function"&&r.componentWillUpdate(i,f,l),typeof r.UNSAFE_componentWillUpdate=="function"&&r.UNSAFE_componentWillUpdate(i,f,l)),typeof r.componentDidUpdate=="function"&&(e.flags|=4),typeof r.getSnapshotBeforeUpdate=="function"&&(e.flags|=1024)):(typeof r.componentDidUpdate!="function"||s===t.memoizedProps&&p===t.memoizedState||(e.flags|=4),typeof r.getSnapshotBeforeUpdate!="function"||s===t.memoizedProps&&p===t.memoizedState||(e.flags|=1024),e.memoizedProps=i,e.memoizedState=f),r.props=i,r.state=f,r.context=l,i=u):(typeof r.componentDidUpdate!="function"||s===t.memoizedProps&&p===t.memoizedState||(e.flags|=4),typeof r.getSnapshotBeforeUpdate!="function"||s===t.memoizedProps&&p===t.memoizedState||(e.flags|=1024),i=!1)}return r=i,gc(t,e),i=(e.flags&128)!==0,r||i?(r=e.stateNode,n=i&&typeof n.getDerivedStateFromError!="function"?null:r.render(),e.flags|=1,t!==null&&i?(e.child=Ra(e,t.child,null,a),e.child=Ra(e,null,n,a)):ee(t,e,n,a),e.memoizedState=r.state,t=e.child):t=ui(t,e,a),t}function Ym(t,e,n,i){return _a(),e.flags|=256,ee(t,e,n,i),e.child}var sp={dehydrated:null,treeContext:null,retryLane:0,hydrationErrors:null};function op(t){return{baseLanes:t,cachePool:h2()}}function lp(t,e,n){return t=t!==null?t.childLanes&~n:0,e&&(t|=Ue),t}function s6(t,e,n){var i=e.pendingProps,a=!1,r=(e.flags&128)!==0,s;if((s=r)||(s=t!==null&&t.memoizedState===null?!1:(Pt.current&2)!==0),s&&(a=!0,e.flags&=-129),s=(e.flags&32)!==0,e.flags&=-33,t===null){if(ut){if(a?Ri(e):Di(e),(t=Bt)?(t=Q6(t,sn),t=t!==null&&t.data!=="&"?t:null,t!==null&&(e.memoizedState={dehydrated:t,treeContext:Xi!==null?{id:_n,overflow:Bn}:null,retryLane:536870912,hydrationErrors:null},n=u2(t),n.return=e,e.child=n,ie=e,Bt=null)):t=null,t===null)throw Ki(e);return hf(t)?e.lanes=32:e.lanes=536870912,null}var o=i.children;return i=i.fallback,a?(Di(e),a=e.mode,o=zc({mode:"hidden",children:o},a),i=Sa(i,a,n,null),o.return=e,i.return=e,o.sibling=i,e.child=o,i=e.child,i.memoizedState=op(n),i.childLanes=lp(t,s,n),e.memoizedState=sp,ho(null,i)):(Ri(e),tf(e,o))}var l=t.memoizedState;if(l!==null&&(o=l.dehydrated,o!==null)){if(r)e.flags&256?(Ri(e),e.flags&=-257,e=cp(t,e,n)):e.memoizedState!==null?(Di(e),e.child=t.child,e.flags|=128,e=null):(Di(e),o=i.fallback,a=e.mode,i=zc({mode:"visible",children:i.children},a),o=Sa(o,a,n,null),o.flags|=2,i.return=e,o.return=e,i.sibling=o,e.child=i,Ra(e,t.child,null,n),i=e.child,i.memoizedState=op(n),i.childLanes=lp(t,s,n),e.memoizedState=sp,e=ho(null,i));else if(Ri(e),hf(o)){if(s=o.nextSibling&&o.nextSibling.dataset,s)var c=s.dgst;s=c,i=Error(_(419)),i.stack="",i.digest=s,Fo({value:i,source:null,stack:null}),e=cp(t,e,n)}else if(Vt||os(t,e,n,!1),s=(n&t.childLanes)!==0,Vt||s){if(s=Ct,s!==null&&(i=zy(s,n),i!==0&&i!==l.retryLane))throw l.retryLane=i,La(t,i),Me(s,t,i),Wf;ff(o)||jc(),e=cp(t,e,n)}else ff(o)?(e.flags|=192,e.child=t.child,e=null):(t=l.treeContext,Bt=ln(o.nextSibling),ie=e,ut=!0,ji=null,sn=!1,t!==null&&p2(e,t),e=tf(e,i.children),e.flags|=4096);return e}return a?(Di(e),o=i.fallback,a=e.mode,l=t.child,c=l.sibling,i=ai(l,{mode:"hidden",children:i.children}),i.subtreeFlags=l.subtreeFlags&65011712,c!==null?o=ai(c,o):(o=Sa(o,a,n,null),o.flags|=2),o.return=e,i.return=e,i.sibling=o,e.child=i,ho(null,i),i=e.child,o=t.child.memoizedState,o===null?o=op(n):(a=o.cachePool,a!==null?(l=Yt._currentValue,a=a.parent!==l?{parent:l,pool:l}:a):a=h2(),o={baseLanes:o.baseLanes|n,cachePool:a}),i.memoizedState=o,i.childLanes=lp(t,s,n),e.memoizedState=sp,ho(t.child,i)):(Ri(e),n=t.child,t=n.sibling,n=ai(n,{mode:"visible",children:i.children}),n.return=e,n.sibling=null,t!==null&&(s=e.deletions,s===null?(e.deletions=[t],e.flags|=16):s.push(t)),e.child=n,e.memoizedState=null,n)}function tf(t,e){return e=zc({mode:"visible",children:e},t.mode),e.return=t,t.child=e}function zc(t,e){return t=$e(22,t,null,e),t.lanes=0,t}function cp(t,e,n){return Ra(e,t.child,null,n),t=tf(e,e.pendingProps.children),t.flags|=2,e.memoizedState=null,t}function Vm(t,e,n){t.lanes|=e;var i=t.alternate;i!==null&&(i.lanes|=e),$p(t.return,e,n)}function up(t,e,n,i,a,r){var s=t.memoizedState;s===null?t.memoizedState={isBackwards:e,rendering:null,renderingStartTime:0,last:i,tail:n,tailMode:a,treeForkCount:r}:(s.isBackwards=e,s.rendering=null,s.renderingStartTime=0,s.last=i,s.tail=n,s.tailMode=a,s.treeForkCount=r)}function o6(t,e,n){var i=e.pendingProps,a=i.revealOrder,r=i.tail;i=i.children;var s=Pt.current,o=(s&2)!==0;if(o?(s=s&1|2,e.flags|=128):s&=1,At(Pt,s),ee(t,e,i,n),i=ut?Io:0,!o&&t!==null&&(t.flags&128)!==0)t:for(t=e.child;t!==null;){if(t.tag===13)t.memoizedState!==null&&Vm(t,n,e);else if(t.tag===19)Vm(t,n,e);else if(t.child!==null){t.child.return=t,t=t.child;continue}if(t===e)break t;for(;t.sibling===null;){if(t.return===null||t.return===e)break t;t=t.return}t.sibling.return=t.return,t=t.sibling}switch(a){case"forwards":for(n=e.child,a=null;n!==null;)t=n.alternate,t!==null&&Dc(t)===null&&(a=n),n=n.sibling;n=a,n===null?(a=e.child,e.child=null):(a=n.sibling,n.sibling=null),up(e,!1,a,n,r,i);break;case"backwards":case"unstable_legacy-backwards":for(n=null,a=e.child,e.child=null;a!==null;){if(t=a.alternate,t!==null&&Dc(t)===null){e.child=a;break}t=a.sibling,a.sibling=n,n=a,a=t}up(e,!0,n,null,r,i);break;case"together":up(e,!1,null,null,void 0,i);break;default:e.memoizedState=null}return e.child}function ui(t,e,n){if(t!==null&&(e.dependencies=t.dependencies),Qi|=e.lanes,(n&e.childLanes)===0)if(t!==null){if(os(t,e,n,!1),(n&e.childLanes)===0)return null}else return null;if(t!==null&&e.child!==t.child)throw Error(_(153));if(e.child!==null){for(t=e.child,n=ai(t,t.pendingProps),e.child=n,n.return=e;t.sibling!==null;)t=t.sibling,n=n.sibling=ai(t,t.pendingProps),n.return=e;n.sibling=null}return e.child}function t1(t,e){return(t.lanes&e)!==0?!0:(t=t.dependencies,!!(t!==null&&_c(t)))}function bv(t,e,n){switch(e.tag){case 3:Ec(e,e.stateNode.containerInfo),Bi(e,Yt,t.memoizedState.cache),_a();break;case 27:case 5:Mp(e);break;case 4:Ec(e,e.stateNode.containerInfo);break;case 10:Bi(e,e.type,e.memoizedProps.value);break;case 31:if(e.memoizedState!==null)return e.flags|=128,qp(e),null;break;case 13:var i=e.memoizedState;if(i!==null)return i.dehydrated!==null?(Ri(e),e.flags|=128,null):(n&e.child.childLanes)!==0?s6(t,e,n):(Ri(e),t=ui(t,e,n),t!==null?t.sibling:null);Ri(e);break;case 19:var a=(t.flags&128)!==0;if(i=(n&e.childLanes)!==0,i||(os(t,e,n,!1),i=(n&e.childLanes)!==0),a){if(i)return o6(t,e,n);e.flags|=128}if(a=e.memoizedState,a!==null&&(a.rendering=null,a.tail=null,a.lastEffect=null),At(Pt,Pt.current),i)break;return null;case 22:return e.lanes=0,r6(t,e,n,e.pendingProps);case 24:Bi(e,Yt,t.memoizedState.cache)}return ui(t,e,n)}function l6(t,e,n){if(t!==null)if(t.memoizedProps!==e.pendingProps)Vt=!0;else{if(!t1(t,n)&&(e.flags&128)===0)return Vt=!1,bv(t,e,n);Vt=(t.flags&131072)!==0}else Vt=!1,ut&&(e.flags&1048576)!==0&&d2(e,Io,e.index);switch(e.lanes=0,e.tag){case 16:t:{var i=e.pendingProps;if(t=Ea(e.elementType),e.type=t,typeof t=="function")Df(t)?(i=Ia(t,i),e.tag=1,e=Hm(null,e,t,i,n)):(e.tag=0,e=Wp(null,e,t,i,n));else{if(t!=null){var a=t.$$typeof;if(a===xf){e.tag=11,e=Nm(null,e,t,i,n);break t}else if(a===vf){e.tag=14,e=Pm(null,e,t,i,n);break t}}throw e=Ap(t)||t,Error(_(306,e,""))}}return e;case 0:return Wp(t,e,e.type,e.pendingProps,n);case 1:return i=e.type,a=Ia(i,e.pendingProps),Hm(t,e,i,a,n);case 3:t:{if(Ec(e,e.stateNode.containerInfo),t===null)throw Error(_(387));i=e.pendingProps;var r=e.memoizedState;a=r.element,Yp(t,e),Eo(e,i,null,n);var s=e.memoizedState;if(i=s.cache,Bi(e,Yt,i),i!==r.cache&&Up(e,[Yt],n,!0),ko(),i=s.element,r.isDehydrated)if(r={element:i,isDehydrated:!1,cache:s.cache},e.updateQueue.baseState=r,e.memoizedState=r,e.flags&256){e=Ym(t,e,i,n);break t}else if(i!==a){a=rn(Error(_(424)),e),Fo(a),e=Ym(t,e,i,n);break t}else for(t=e.stateNode.containerInfo,t.nodeType===9?t=t.body:t=t.nodeName==="HTML"?t.ownerDocument.body:t,Bt=ln(t.firstChild),ie=e,ut=!0,ji=null,sn=!0,n=y2(e,null,i,n),e.child=n;n;)n.flags=n.flags&-3|4096,n=n.sibling;else{if(_a(),i===a){e=ui(t,e,n);break t}ee(t,e,i,n)}e=e.child}return e;case 26:return gc(t,e),t===null?(n=fy(e.type,null,e.pendingProps,null))?e.memoizedState=n:ut||(n=e.type,t=e.pendingProps,i=Yc(Pi.current).createElement(n),i[ne]=e,i[_e]=t,re(i,n,t),Jt(i),e.stateNode=i):e.memoizedState=fy(e.type,t.memoizedProps,e.pendingProps,t.memoizedState),null;case 27:return Mp(e),t===null&&ut&&(i=e.stateNode=J6(e.type,e.pendingProps,Pi.current),ie=e,sn=!0,a=Bt,Wi(e.type)?(gf=a,Bt=ln(i.firstChild)):Bt=a),ee(t,e,e.pendingProps.children,n),gc(t,e),t===null&&(e.flags|=4194304),e.child;case 5:return t===null&&ut&&((a=i=Bt)&&(i=Xv(i,e.type,e.pendingProps,sn),i!==null?(e.stateNode=i,ie=e,Bt=ln(i.firstChild),sn=!1,a=!0):a=!1),a||Ki(e)),Mp(e),a=e.type,r=e.pendingProps,s=t!==null?t.memoizedProps:null,i=r.children,df(a,r)?i=null:s!==null&&df(a,s)&&(e.flags|=32),e.memoizedState!==null&&(a=$f(t,e,dv,null,null,n),jo._currentValue=a),gc(t,e),ee(t,e,i,n),e.child;case 6:return t===null&&ut&&((t=n=Bt)&&(n=Kv(n,e.pendingProps,sn),n!==null?(e.stateNode=n,ie=e,Bt=null,t=!0):t=!1),t||Ki(e)),null;case 13:return s6(t,e,n);case 4:return Ec(e,e.stateNode.containerInfo),i=e.pendingProps,t===null?e.child=Ra(e,null,i,n):ee(t,e,i,n),e.child;case 11:return Nm(t,e,e.type,e.pendingProps,n);case 7:return ee(t,e,e.pendingProps,n),e.child;case 8:return ee(t,e,e.pendingProps.children,n),e.child;case 12:return ee(t,e,e.pendingProps.children,n),e.child;case 10:return i=e.pendingProps,Bi(e,e.type,i.value),ee(t,e,i.children,n),e.child;case 9:return a=e.type._context,i=e.pendingProps.children,Ba(e),a=ae(a),i=i(a),e.flags|=1,ee(t,e,i,n),e.child;case 14:return Pm(t,e,e.type,e.pendingProps,n);case 15:return a6(t,e,e.type,e.pendingProps,n);case 19:return o6(t,e,n);case 31:return vv(t,e,n);case 22:return r6(t,e,n,e.pendingProps);case 24:return Ba(e),i=ae(Yt),t===null?(a=zf(),a===null&&(a=Ct,r=Of(),a.pooledCache=r,r.refCount++,r!==null&&(a.pooledCacheLanes|=n),a=r),e.memoizedState={parent:i,cache:a},Nf(e),Bi(e,Yt,a)):((t.lanes&n)!==0&&(Yp(t,e),Eo(e,null,null,n),ko()),a=t.memoizedState,r=e.memoizedState,a.parent!==i?(a={parent:i,cache:i},e.memoizedState=a,e.lanes===0&&(e.memoizedState=e.updateQueue.baseState=a),Bi(e,Yt,i)):(i=r.cache,Bi(e,Yt,i),i!==a.cache&&Up(e,[Yt],n,!0))),ee(t,e,e.pendingProps.children,n),e.child;case 29:throw e.pendingProps}throw Error(_(156,e.tag))}function Kn(t){t.flags|=4}function dp(t,e,n,i,a){if((e=(t.mode&32)!==0)&&(e=!1),e){if(t.flags|=16777216,(a&335544128)===a)if(t.stateNode.complete)t.flags|=8192;else if(D6())t.flags|=8192;else throw Ta=Bc,Lf}else t.flags&=-16777217}function Gm(t,e){if(e.type!=="stylesheet"||(e.state.loading&4)!==0)t.flags&=-16777217;else if(t.flags|=16777216,!e5(e))if(D6())t.flags|=8192;else throw Ta=Bc,Lf}function Wl(t,e){e!==null&&(t.flags|=4),t.flags&16384&&(e=t.tag!==22?Iy():536870912,t.lanes|=e,ts|=e)}function so(t,e){if(!ut)switch(t.tailMode){case"hidden":e=t.tail;for(var n=null;e!==null;)e.alternate!==null&&(n=e),e=e.sibling;n===null?t.tail=null:n.sibling=null;break;case"collapsed":n=t.tail;for(var i=null;n!==null;)n.alternate!==null&&(i=n),n=n.sibling;i===null?e||t.tail===null?t.tail=null:t.tail.sibling=null:i.sibling=null}}function _t(t){var e=t.alternate!==null&&t.alternate.child===t.child,n=0,i=0;if(e)for(var a=t.child;a!==null;)n|=a.lanes|a.childLanes,i|=a.subtreeFlags&65011712,i|=a.flags&65011712,a.return=t,a=a.sibling;else for(a=t.child;a!==null;)n|=a.lanes|a.childLanes,i|=a.subtreeFlags,i|=a.flags,a.return=t,a=a.sibling;return t.subtreeFlags|=i,t.childLanes=n,e}function kv(t,e,n){var i=e.pendingProps;switch(Ff(e),e.tag){case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return _t(e),null;case 1:return _t(e),null;case 3:return n=e.stateNode,i=null,t!==null&&(i=t.memoizedState.cache),e.memoizedState.cache!==i&&(e.flags|=2048),ri(Yt),Xr(),n.pendingContext&&(n.context=n.pendingContext,n.pendingContext=null),(t===null||t.child===null)&&(Sr(e)?Kn(e):t===null||t.memoizedState.isDehydrated&&(e.flags&256)===0||(e.flags|=1024,np())),_t(e),null;case 26:var a=e.type,r=e.memoizedState;return t===null?(Kn(e),r!==null?(_t(e),Gm(e,r)):(_t(e),dp(e,a,null,i,n))):r?r!==t.memoizedState?(Kn(e),_t(e),Gm(e,r)):(_t(e),e.flags&=-16777217):(t=t.memoizedProps,t!==i&&Kn(e),_t(e),dp(e,a,t,i,n)),null;case 27:if(wc(e),n=Pi.current,a=e.type,t!==null&&e.stateNode!=null)t.memoizedProps!==i&&Kn(e);else{if(!i){if(e.stateNode===null)throw Error(_(166));return _t(e),null}t=Dn.current,Sr(e)?km(e,t):(t=J6(a,i,n),e.stateNode=t,Kn(e))}return _t(e),null;case 5:if(wc(e),a=e.type,t!==null&&e.stateNode!=null)t.memoizedProps!==i&&Kn(e);else{if(!i){if(e.stateNode===null)throw Error(_(166));return _t(e),null}if(r=Dn.current,Sr(e))km(e,r);else{var s=Yc(Pi.current);switch(r){case 1:r=s.createElementNS("http://www.w3.org/2000/svg",a);break;case 2:r=s.createElementNS("http://www.w3.org/1998/Math/MathML",a);break;default:switch(a){case"svg":r=s.createElementNS("http://www.w3.org/2000/svg",a);break;case"math":r=s.createElementNS("http://www.w3.org/1998/Math/MathML",a);break;case"script":r=s.createElement("div"),r.innerHTML="<script><\/script>",r=r.removeChild(r.firstChild);break;case"select":r=typeof i.is=="string"?s.createElement("select",{is:i.is}):s.createElement("select"),i.multiple?r.multiple=!0:i.size&&(r.size=i.size);break;default:r=typeof i.is=="string"?s.createElement(a,{is:i.is}):s.createElement(a)}}r[ne]=e,r[_e]=i;t:for(s=e.child;s!==null;){if(s.tag===5||s.tag===6)r.appendChild(s.stateNode);else if(s.tag!==4&&s.tag!==27&&s.child!==null){s.child.return=s,s=s.child;continue}if(s===e)break t;for(;s.sibling===null;){if(s.return===null||s.return===e)break t;s=s.return}s.sibling.return=s.return,s=s.sibling}e.stateNode=r;t:switch(re(r,a,i),a){case"button":case"input":case"select":case"textarea":i=!!i.autoFocus;break t;case"img":i=!0;break t;default:i=!1}i&&Kn(e)}}return _t(e),dp(e,e.type,t===null?null:t.memoizedProps,e.pendingProps,n),null;case 6:if(t&&e.stateNode!=null)t.memoizedProps!==i&&Kn(e);else{if(typeof i!="string"&&e.stateNode===null)throw Error(_(166));if(t=Pi.current,Sr(e)){if(t=e.stateNode,n=e.memoizedProps,i=null,a=ie,a!==null)switch(a.tag){case 27:case 5:i=a.memoizedProps}t[ne]=e,t=!!(t.nodeValue===n||i!==null&&i.suppressHydrationWarning===!0||X6(t.nodeValue,n)),t||Ki(e,!0)}else t=Yc(t).createTextNode(i),t[ne]=e,e.stateNode=t}return _t(e),null;case 31:if(n=e.memoizedState,t===null||t.memoizedState!==null){if(i=Sr(e),n!==null){if(t===null){if(!i)throw Error(_(318));if(t=e.memoizedState,t=t!==null?t.dehydrated:null,!t)throw Error(_(557));t[ne]=e}else _a(),(e.flags&128)===0&&(e.memoizedState=null),e.flags|=4;_t(e),t=!1}else n=np(),t!==null&&t.memoizedState!==null&&(t.memoizedState.hydrationErrors=n),t=!0;if(!t)return e.flags&256?(je(e),e):(je(e),null);if((e.flags&128)!==0)throw Error(_(558))}return _t(e),null;case 13:if(i=e.memoizedState,t===null||t.memoizedState!==null&&t.memoizedState.dehydrated!==null){if(a=Sr(e),i!==null&&i.dehydrated!==null){if(t===null){if(!a)throw Error(_(318));if(a=e.memoizedState,a=a!==null?a.dehydrated:null,!a)throw Error(_(317));a[ne]=e}else _a(),(e.flags&128)===0&&(e.memoizedState=null),e.flags|=4;_t(e),a=!1}else a=np(),t!==null&&t.memoizedState!==null&&(t.memoizedState.hydrationErrors=a),a=!0;if(!a)return e.flags&256?(je(e),e):(je(e),null)}return je(e),(e.flags&128)!==0?(e.lanes=n,e):(n=i!==null,t=t!==null&&t.memoizedState!==null,n&&(i=e.child,a=null,i.alternate!==null&&i.alternate.memoizedState!==null&&i.alternate.memoizedState.cachePool!==null&&(a=i.alternate.memoizedState.cachePool.pool),r=null,i.memoizedState!==null&&i.memoizedState.cachePool!==null&&(r=i.memoizedState.cachePool.pool),r!==a&&(i.flags|=2048)),n!==t&&n&&(e.child.flags|=8192),Wl(e,e.updateQueue),_t(e),null);case 4:return Xr(),t===null&&o1(e.stateNode.containerInfo),_t(e),null;case 10:return ri(e.type),_t(e),null;case 19:if(Wt(Pt),i=e.memoizedState,i===null)return _t(e),null;if(a=(e.flags&128)!==0,r=i.rendering,r===null)if(a)so(i,!1);else{if(Lt!==0||t!==null&&(t.flags&128)!==0)for(t=e.child;t!==null;){if(r=Dc(t),r!==null){for(e.flags|=128,so(i,!1),t=r.updateQueue,e.updateQueue=t,Wl(e,t),e.subtreeFlags=0,t=n,n=e.child;n!==null;)c2(n,t),n=n.sibling;return At(Pt,Pt.current&1|2),ut&&Wn(e,i.treeForkCount),e.child}t=t.sibling}i.tail!==null&&He()>Nc&&(e.flags|=128,a=!0,so(i,!1),e.lanes=4194304)}else{if(!a)if(t=Dc(r),t!==null){if(e.flags|=128,a=!0,t=t.updateQueue,e.updateQueue=t,Wl(e,t),so(i,!0),i.tail===null&&i.tailMode==="hidden"&&!r.alternate&&!ut)return _t(e),null}else 2*He()-i.renderingStartTime>Nc&&n!==536870912&&(e.flags|=128,a=!0,so(i,!1),e.lanes=4194304);i.isBackwards?(r.sibling=e.child,e.child=r):(t=i.last,t!==null?t.sibling=r:e.child=r,i.last=r)}return i.tail!==null?(t=i.tail,i.rendering=t,i.tail=t.sibling,i.renderingStartTime=He(),t.sibling=null,n=Pt.current,At(Pt,a?n&1|2:n&1),ut&&Wn(e,i.treeForkCount),t):(_t(e),null);case 22:case 23:return je(e),Pf(),i=e.memoizedState!==null,t!==null?t.memoizedState!==null!==i&&(e.flags|=8192):i&&(e.flags|=8192),i?(n&536870912)!==0&&(e.flags&128)===0&&(_t(e),e.subtreeFlags&6&&(e.flags|=8192)):_t(e),n=e.updateQueue,n!==null&&Wl(e,n.retryQueue),n=null,t!==null&&t.memoizedState!==null&&t.memoizedState.cachePool!==null&&(n=t.memoizedState.cachePool.pool),i=null,e.memoizedState!==null&&e.memoizedState.cachePool!==null&&(i=e.memoizedState.cachePool.pool),i!==n&&(e.flags|=2048),t!==null&&Wt(Aa),null;case 24:return n=null,t!==null&&(n=t.memoizedState.cache),e.memoizedState.cache!==n&&(e.flags|=2048),ri(Yt),_t(e),null;case 25:return null;case 30:return null}throw Error(_(156,e.tag))}function Ev(t,e){switch(Ff(e),e.tag){case 1:return t=e.flags,t&65536?(e.flags=t&-65537|128,e):null;case 3:return ri(Yt),Xr(),t=e.flags,(t&65536)!==0&&(t&128)===0?(e.flags=t&-65537|128,e):null;case 26:case 27:case 5:return wc(e),null;case 31:if(e.memoizedState!==null){if(je(e),e.alternate===null)throw Error(_(340));_a()}return t=e.flags,t&65536?(e.flags=t&-65537|128,e):null;case 13:if(je(e),t=e.memoizedState,t!==null&&t.dehydrated!==null){if(e.alternate===null)throw Error(_(340));_a()}return t=e.flags,t&65536?(e.flags=t&-65537|128,e):null;case 19:return Wt(Pt),null;case 4:return Xr(),null;case 10:return ri(e.type),null;case 22:case 23:return je(e),Pf(),t!==null&&Wt(Aa),t=e.flags,t&65536?(e.flags=t&-65537|128,e):null;case 24:return ri(Yt),null;case 25:return null;default:return null}}function c6(t,e){switch(Ff(e),e.tag){case 3:ri(Yt),Xr();break;case 26:case 27:case 5:wc(e);break;case 4:Xr();break;case 31:e.memoizedState!==null&&je(e);break;case 13:je(e);break;case 19:Wt(Pt);break;case 10:ri(e.type);break;case 22:case 23:je(e),Pf(),t!==null&&Wt(Aa);break;case 24:ri(Yt)}}function Qo(t,e){try{var n=e.updateQueue,i=n!==null?n.lastEffect:null;if(i!==null){var a=i.next;n=a;do{if((n.tag&t)===t){i=void 0;var r=n.create,s=n.inst;i=r(),s.destroy=i}n=n.next}while(n!==a)}}catch(o){vt(e,e.return,o)}}function Zi(t,e,n){try{var i=e.updateQueue,a=i!==null?i.lastEffect:null;if(a!==null){var r=a.next;i=r;do{if((i.tag&t)===t){var s=i.inst,o=s.destroy;if(o!==void 0){s.destroy=void 0,a=e;var l=n,c=o;try{c()}catch(u){vt(a,l,u)}}}i=i.next}while(i!==r)}}catch(u){vt(e,e.return,u)}}function u6(t){var e=t.updateQueue;if(e!==null){var n=t.stateNode;try{v2(e,n)}catch(i){vt(t,t.return,i)}}}function d6(t,e,n){n.props=Ia(t.type,t.memoizedProps),n.state=t.memoizedState;try{n.componentWillUnmount()}catch(i){vt(t,e,i)}}function Co(t,e){try{var n=t.ref;if(n!==null){switch(t.tag){case 26:case 27:case 5:var i=t.stateNode;break;case 30:i=t.stateNode;break;default:i=t.stateNode}typeof n=="function"?t.refCleanup=n(i):n.current=i}}catch(a){vt(t,e,a)}}function Rn(t,e){var n=t.ref,i=t.refCleanup;if(n!==null)if(typeof i=="function")try{i()}catch(a){vt(t,e,a)}finally{t.refCleanup=null,t=t.alternate,t!=null&&(t.refCleanup=null)}else if(typeof n=="function")try{n(null)}catch(a){vt(t,e,a)}else n.current=null}function p6(t){var e=t.type,n=t.memoizedProps,i=t.stateNode;try{t:switch(e){case"button":case"input":case"select":case"textarea":n.autoFocus&&i.focus();break t;case"img":n.src?i.src=n.src:n.srcSet&&(i.srcset=n.srcSet)}}catch(a){vt(t,t.return,a)}}function pp(t,e,n){try{var i=t.stateNode;Uv(i,t.type,n,e),i[_e]=e}catch(a){vt(t,t.return,a)}}function f6(t){return t.tag===5||t.tag===3||t.tag===26||t.tag===27&&Wi(t.type)||t.tag===4}function fp(t){t:for(;;){for(;t.sibling===null;){if(t.return===null||f6(t.return))return null;t=t.return}for(t.sibling.return=t.return,t=t.sibling;t.tag!==5&&t.tag!==6&&t.tag!==18;){if(t.tag===27&&Wi(t.type)||t.flags&2||t.child===null||t.tag===4)continue t;t.child.return=t,t=t.child}if(!(t.flags&2))return t.stateNode}}function ef(t,e,n){var i=t.tag;if(i===5||i===6)t=t.stateNode,e?(n.nodeType===9?n.body:n.nodeName==="HTML"?n.ownerDocument.body:n).insertBefore(t,e):(e=n.nodeType===9?n.body:n.nodeName==="HTML"?n.ownerDocument.body:n,e.appendChild(t),n=n._reactRootContainer,n!=null||e.onclick!==null||(e.onclick=ni));else if(i!==4&&(i===27&&Wi(t.type)&&(n=t.stateNode,e=null),t=t.child,t!==null))for(ef(t,e,n),t=t.sibling;t!==null;)ef(t,e,n),t=t.sibling}function Lc(t,e,n){var i=t.tag;if(i===5||i===6)t=t.stateNode,e?n.insertBefore(t,e):n.appendChild(t);else if(i!==4&&(i===27&&Wi(t.type)&&(n=t.stateNode),t=t.child,t!==null))for(Lc(t,e,n),t=t.sibling;t!==null;)Lc(t,e,n),t=t.sibling}function h6(t){var e=t.stateNode,n=t.memoizedProps;try{for(var i=t.type,a=e.attributes;a.length;)e.removeAttributeNode(a[0]);re(e,i,n),e[ne]=t,e[_e]=n}catch(r){vt(t,t.return,r)}}var ti=!1,Ht=!1,hp=!1,qm=typeof WeakSet=="function"?WeakSet:Set,Qt=null;function wv(t,e){if(t=t.containerInfo,cf=Xc,t=e2(t),_f(t)){if("selectionStart"in t)var n={start:t.selectionStart,end:t.selectionEnd};else t:{n=(n=t.ownerDocument)&&n.defaultView||window;var i=n.getSelection&&n.getSelection();if(i&&i.rangeCount!==0){n=i.anchorNode;var a=i.anchorOffset,r=i.focusNode;i=i.focusOffset;try{n.nodeType,r.nodeType}catch{n=null;break t}var s=0,o=-1,l=-1,c=0,u=0,d=t,p=null;e:for(;;){for(var f;d!==n||a!==0&&d.nodeType!==3||(o=s+a),d!==r||i!==0&&d.nodeType!==3||(l=s+i),d.nodeType===3&&(s+=d.nodeValue.length),(f=d.firstChild)!==null;)p=d,d=f;for(;;){if(d===t)break e;if(p===n&&++c===a&&(o=s),p===r&&++u===i&&(l=s),(f=d.nextSibling)!==null)break;d=p,p=d.parentNode}d=f}n=o===-1||l===-1?null:{start:o,end:l}}else n=null}n=n||{start:0,end:0}}else n=null;for(uf={focusedElem:t,selectionRange:n},Xc=!1,Qt=e;Qt!==null;)if(e=Qt,t=e.child,(e.subtreeFlags&1028)!==0&&t!==null)t.return=e,Qt=t;else for(;Qt!==null;){switch(e=Qt,r=e.alternate,t=e.flags,e.tag){case 0:if((t&4)!==0&&(t=e.updateQueue,t=t!==null?t.events:null,t!==null))for(n=0;n<t.length;n++)a=t[n],a.ref.impl=a.nextImpl;break;case 11:case 15:break;case 1:if((t&1024)!==0&&r!==null){t=void 0,n=e,a=r.memoizedProps,r=r.memoizedState,i=n.stateNode;try{var y=Ia(n.type,a);t=i.getSnapshotBeforeUpdate(y,r),i.__reactInternalSnapshotBeforeUpdate=t}catch(x){vt(n,n.return,x)}}break;case 3:if((t&1024)!==0){if(t=e.stateNode.containerInfo,n=t.nodeType,n===9)pf(t);else if(n===1)switch(t.nodeName){case"HEAD":case"HTML":case"BODY":pf(t);break;default:t.textContent=""}}break;case 5:case 26:case 27:case 6:case 4:case 17:break;default:if((t&1024)!==0)throw Error(_(163))}if(t=e.sibling,t!==null){t.return=e.return,Qt=t;break}Qt=e.return}}function g6(t,e,n){var i=n.flags;switch(n.tag){case 0:case 11:case 15:Qn(t,n),i&4&&Qo(5,n);break;case 1:if(Qn(t,n),i&4)if(t=n.stateNode,e===null)try{t.componentDidMount()}catch(s){vt(n,n.return,s)}else{var a=Ia(n.type,e.memoizedProps);e=e.memoizedState;try{t.componentDidUpdate(a,e,t.__reactInternalSnapshotBeforeUpdate)}catch(s){vt(n,n.return,s)}}i&64&&u6(n),i&512&&Co(n,n.return);break;case 3:if(Qn(t,n),i&64&&(t=n.updateQueue,t!==null)){if(e=null,n.child!==null)switch(n.child.tag){case 27:case 5:e=n.child.stateNode;break;case 1:e=n.child.stateNode}try{v2(t,e)}catch(s){vt(n,n.return,s)}}break;case 27:e===null&&i&4&&h6(n);case 26:case 5:Qn(t,n),e===null&&i&4&&p6(n),i&512&&Co(n,n.return);break;case 12:Qn(t,n);break;case 31:Qn(t,n),i&4&&x6(t,n);break;case 13:Qn(t,n),i&4&&v6(t,n),i&64&&(t=n.memoizedState,t!==null&&(t=t.dehydrated,t!==null&&(n=Dv.bind(null,n),Zv(t,n))));break;case 22:if(i=n.memoizedState!==null||ti,!i){e=e!==null&&e.memoizedState!==null||Ht,a=ti;var r=Ht;ti=i,(Ht=e)&&!r?Jn(t,n,(n.subtreeFlags&8772)!==0):Qn(t,n),ti=a,Ht=r}break;case 30:break;default:Qn(t,n)}}function m6(t){var e=t.alternate;e!==null&&(t.alternate=null,m6(e)),t.child=null,t.deletions=null,t.sibling=null,t.tag===5&&(e=t.stateNode,e!==null&&wf(e)),t.stateNode=null,t.return=null,t.dependencies=null,t.memoizedProps=null,t.memoizedState=null,t.pendingProps=null,t.stateNode=null,t.updateQueue=null}var Ot=null,Ae=!1;function Zn(t,e,n){for(n=n.child;n!==null;)y6(t,e,n),n=n.sibling}function y6(t,e,n){if(Ye&&typeof Ye.onCommitFiberUnmount=="function")try{Ye.onCommitFiberUnmount(Yo,n)}catch{}switch(n.tag){case 26:Ht||Rn(n,e),Zn(t,e,n),n.memoizedState?n.memoizedState.count--:n.stateNode&&(n=n.stateNode,n.parentNode.removeChild(n));break;case 27:Ht||Rn(n,e);var i=Ot,a=Ae;Wi(n.type)&&(Ot=n.stateNode,Ae=!1),Zn(t,e,n),Mo(n.stateNode),Ot=i,Ae=a;break;case 5:Ht||Rn(n,e);case 6:if(i=Ot,a=Ae,Ot=null,Zn(t,e,n),Ot=i,Ae=a,Ot!==null)if(Ae)try{(Ot.nodeType===9?Ot.body:Ot.nodeName==="HTML"?Ot.ownerDocument.body:Ot).removeChild(n.stateNode)}catch(r){vt(n,e,r)}else try{Ot.removeChild(n.stateNode)}catch(r){vt(n,e,r)}break;case 18:Ot!==null&&(Ae?(t=Ot,ly(t.nodeType===9?t.body:t.nodeName==="HTML"?t.ownerDocument.body:t,n.stateNode),as(t)):ly(Ot,n.stateNode));break;case 4:i=Ot,a=Ae,Ot=n.stateNode.containerInfo,Ae=!0,Zn(t,e,n),Ot=i,Ae=a;break;case 0:case 11:case 14:case 15:Zi(2,n,e),Ht||Zi(4,n,e),Zn(t,e,n);break;case 1:Ht||(Rn(n,e),i=n.stateNode,typeof i.componentWillUnmount=="function"&&d6(n,e,i)),Zn(t,e,n);break;case 21:Zn(t,e,n);break;case 22:Ht=(i=Ht)||n.memoizedState!==null,Zn(t,e,n),Ht=i;break;default:Zn(t,e,n)}}function x6(t,e){if(e.memoizedState===null&&(t=e.alternate,t!==null&&(t=t.memoizedState,t!==null))){t=t.dehydrated;try{as(t)}catch(n){vt(e,e.return,n)}}}function v6(t,e){if(e.memoizedState===null&&(t=e.alternate,t!==null&&(t=t.memoizedState,t!==null&&(t=t.dehydrated,t!==null))))try{as(t)}catch(n){vt(e,e.return,n)}}function Cv(t){switch(t.tag){case 31:case 13:case 19:var e=t.stateNode;return e===null&&(e=t.stateNode=new qm),e;case 22:return t=t.stateNode,e=t._retryCache,e===null&&(e=t._retryCache=new qm),e;default:throw Error(_(435,t.tag))}}function tc(t,e){var n=Cv(t);e.forEach(function(i){if(!n.has(i)){n.add(i);var a=Iv.bind(null,t,i);i.then(a,a)}})}function Ce(t,e){var n=e.deletions;if(n!==null)for(var i=0;i<n.length;i++){var a=n[i],r=t,s=e,o=s;t:for(;o!==null;){switch(o.tag){case 27:if(Wi(o.type)){Ot=o.stateNode,Ae=!1;break t}break;case 5:Ot=o.stateNode,Ae=!1;break t;case 3:case 4:Ot=o.stateNode.containerInfo,Ae=!0;break t}o=o.return}if(Ot===null)throw Error(_(160));y6(r,s,a),Ot=null,Ae=!1,r=a.alternate,r!==null&&(r.return=null),a.return=null}if(e.subtreeFlags&13886)for(e=e.child;e!==null;)b6(e,t),e=e.sibling}var vn=null;function b6(t,e){var n=t.alternate,i=t.flags;switch(t.tag){case 0:case 11:case 14:case 15:Ce(e,t),Se(t),i&4&&(Zi(3,t,t.return),Qo(3,t),Zi(5,t,t.return));break;case 1:Ce(e,t),Se(t),i&512&&(Ht||n===null||Rn(n,n.return)),i&64&&ti&&(t=t.updateQueue,t!==null&&(i=t.callbacks,i!==null&&(n=t.shared.hiddenCallbacks,t.shared.hiddenCallbacks=n===null?i:n.concat(i))));break;case 26:var a=vn;if(Ce(e,t),Se(t),i&512&&(Ht||n===null||Rn(n,n.return)),i&4){var r=n!==null?n.memoizedState:null;if(i=t.memoizedState,n===null)if(i===null)if(t.stateNode===null){t:{i=t.type,n=t.memoizedProps,a=a.ownerDocument||a;e:switch(i){case"title":r=a.getElementsByTagName("title")[0],(!r||r[qo]||r[ne]||r.namespaceURI==="http://www.w3.org/2000/svg"||r.hasAttribute("itemprop"))&&(r=a.createElement(i),a.head.insertBefore(r,a.querySelector("head > title"))),re(r,i,n),r[ne]=t,Jt(r),i=r;break t;case"link":var s=gy("link","href",a).get(i+(n.href||""));if(s){for(var o=0;o<s.length;o++)if(r=s[o],r.getAttribute("href")===(n.href==null||n.href===""?null:n.href)&&r.getAttribute("rel")===(n.rel==null?null:n.rel)&&r.getAttribute("title")===(n.title==null?null:n.title)&&r.getAttribute("crossorigin")===(n.crossOrigin==null?null:n.crossOrigin)){s.splice(o,1);break e}}r=a.createElement(i),re(r,i,n),a.head.appendChild(r);break;case"meta":if(s=gy("meta","content",a).get(i+(n.content||""))){for(o=0;o<s.length;o++)if(r=s[o],r.getAttribute("content")===(n.content==null?null:""+n.content)&&r.getAttribute("name")===(n.name==null?null:n.name)&&r.getAttribute("property")===(n.property==null?null:n.property)&&r.getAttribute("http-equiv")===(n.httpEquiv==null?null:n.httpEquiv)&&r.getAttribute("charset")===(n.charSet==null?null:n.charSet)){s.splice(o,1);break e}}r=a.createElement(i),re(r,i,n),a.head.appendChild(r);break;default:throw Error(_(468,i))}r[ne]=t,Jt(r),i=r}t.stateNode=i}else my(a,t.type,t.stateNode);else t.stateNode=hy(a,i,t.memoizedProps);else r!==i?(r===null?n.stateNode!==null&&(n=n.stateNode,n.parentNode.removeChild(n)):r.count--,i===null?my(a,t.type,t.stateNode):hy(a,i,t.memoizedProps)):i===null&&t.stateNode!==null&&pp(t,t.memoizedProps,n.memoizedProps)}break;case 27:Ce(e,t),Se(t),i&512&&(Ht||n===null||Rn(n,n.return)),n!==null&&i&4&&pp(t,t.memoizedProps,n.memoizedProps);break;case 5:if(Ce(e,t),Se(t),i&512&&(Ht||n===null||Rn(n,n.return)),t.flags&32){a=t.stateNode;try{Zr(a,"")}catch(y){vt(t,t.return,y)}}i&4&&t.stateNode!=null&&(a=t.memoizedProps,pp(t,a,n!==null?n.memoizedProps:a)),i&1024&&(hp=!0);break;case 6:if(Ce(e,t),Se(t),i&4){if(t.stateNode===null)throw Error(_(162));i=t.memoizedProps,n=t.stateNode;try{n.nodeValue=i}catch(y){vt(t,t.return,y)}}break;case 3:if(xc=null,a=vn,vn=Vc(e.containerInfo),Ce(e,t),vn=a,Se(t),i&4&&n!==null&&n.memoizedState.isDehydrated)try{as(e.containerInfo)}catch(y){vt(t,t.return,y)}hp&&(hp=!1,k6(t));break;case 4:i=vn,vn=Vc(t.stateNode.containerInfo),Ce(e,t),Se(t),vn=i;break;case 12:Ce(e,t),Se(t);break;case 31:Ce(e,t),Se(t),i&4&&(i=t.updateQueue,i!==null&&(t.updateQueue=null,tc(t,i)));break;case 13:Ce(e,t),Se(t),t.child.flags&8192&&t.memoizedState!==null!=(n!==null&&n.memoizedState!==null)&&(ou=He()),i&4&&(i=t.updateQueue,i!==null&&(t.updateQueue=null,tc(t,i)));break;case 22:a=t.memoizedState!==null;var l=n!==null&&n.memoizedState!==null,c=ti,u=Ht;if(ti=c||a,Ht=u||l,Ce(e,t),Ht=u,ti=c,Se(t),i&8192)t:for(e=t.stateNode,e._visibility=a?e._visibility&-2:e._visibility|1,a&&(n===null||l||ti||Ht||wa(t)),n=null,e=t;;){if(e.tag===5||e.tag===26){if(n===null){l=n=e;try{if(r=l.stateNode,a)s=r.style,typeof s.setProperty=="function"?s.setProperty("display","none","important"):s.display="none";else{o=l.stateNode;var d=l.memoizedProps.style,p=d!=null&&d.hasOwnProperty("display")?d.display:null;o.style.display=p==null||typeof p=="boolean"?"":(""+p).trim()}}catch(y){vt(l,l.return,y)}}}else if(e.tag===6){if(n===null){l=e;try{l.stateNode.nodeValue=a?"":l.memoizedProps}catch(y){vt(l,l.return,y)}}}else if(e.tag===18){if(n===null){l=e;try{var f=l.stateNode;a?cy(f,!0):cy(l.stateNode,!1)}catch(y){vt(l,l.return,y)}}}else if((e.tag!==22&&e.tag!==23||e.memoizedState===null||e===t)&&e.child!==null){e.child.return=e,e=e.child;continue}if(e===t)break t;for(;e.sibling===null;){if(e.return===null||e.return===t)break t;n===e&&(n=null),e=e.return}n===e&&(n=null),e.sibling.return=e.return,e=e.sibling}i&4&&(i=t.updateQueue,i!==null&&(n=i.retryQueue,n!==null&&(i.retryQueue=null,tc(t,n))));break;case 19:Ce(e,t),Se(t),i&4&&(i=t.updateQueue,i!==null&&(t.updateQueue=null,tc(t,i)));break;case 30:break;case 21:break;default:Ce(e,t),Se(t)}}function Se(t){var e=t.flags;if(e&2){try{for(var n,i=t.return;i!==null;){if(f6(i)){n=i;break}i=i.return}if(n==null)throw Error(_(160));switch(n.tag){case 27:var a=n.stateNode,r=fp(t);Lc(t,r,a);break;case 5:var s=n.stateNode;n.flags&32&&(Zr(s,""),n.flags&=-33);var o=fp(t);Lc(t,o,s);break;case 3:case 4:var l=n.stateNode.containerInfo,c=fp(t);ef(t,c,l);break;default:throw Error(_(161))}}catch(u){vt(t,t.return,u)}t.flags&=-3}e&4096&&(t.flags&=-4097)}function k6(t){if(t.subtreeFlags&1024)for(t=t.child;t!==null;){var e=t;k6(e),e.tag===5&&e.flags&1024&&e.stateNode.reset(),t=t.sibling}}function Qn(t,e){if(e.subtreeFlags&8772)for(e=e.child;e!==null;)g6(t,e.alternate,e),e=e.sibling}function wa(t){for(t=t.child;t!==null;){var e=t;switch(e.tag){case 0:case 11:case 14:case 15:Zi(4,e,e.return),wa(e);break;case 1:Rn(e,e.return);var n=e.stateNode;typeof n.componentWillUnmount=="function"&&d6(e,e.return,n),wa(e);break;case 27:Mo(e.stateNode);case 26:case 5:Rn(e,e.return),wa(e);break;case 22:e.memoizedState===null&&wa(e);break;case 30:wa(e);break;default:wa(e)}t=t.sibling}}function Jn(t,e,n){for(n=n&&(e.subtreeFlags&8772)!==0,e=e.child;e!==null;){var i=e.alternate,a=t,r=e,s=r.flags;switch(r.tag){case 0:case 11:case 15:Jn(a,r,n),Qo(4,r);break;case 1:if(Jn(a,r,n),i=r,a=i.stateNode,typeof a.componentDidMount=="function")try{a.componentDidMount()}catch(c){vt(i,i.return,c)}if(i=r,a=i.updateQueue,a!==null){var o=i.stateNode;try{var l=a.shared.hiddenCallbacks;if(l!==null)for(a.shared.hiddenCallbacks=null,a=0;a<l.length;a++)x2(l[a],o)}catch(c){vt(i,i.return,c)}}n&&s&64&&u6(r),Co(r,r.return);break;case 27:h6(r);case 26:case 5:Jn(a,r,n),n&&i===null&&s&4&&p6(r),Co(r,r.return);break;case 12:Jn(a,r,n);break;case 31:Jn(a,r,n),n&&s&4&&x6(a,r);break;case 13:Jn(a,r,n),n&&s&4&&v6(a,r);break;case 22:r.memoizedState===null&&Jn(a,r,n),Co(r,r.return);break;case 30:break;default:Jn(a,r,n)}e=e.sibling}}function e1(t,e){var n=null;t!==null&&t.memoizedState!==null&&t.memoizedState.cachePool!==null&&(n=t.memoizedState.cachePool.pool),t=null,e.memoizedState!==null&&e.memoizedState.cachePool!==null&&(t=e.memoizedState.cachePool.pool),t!==n&&(t!=null&&t.refCount++,n!=null&&Ko(n))}function n1(t,e){t=null,e.alternate!==null&&(t=e.alternate.memoizedState.cache),e=e.memoizedState.cache,e!==t&&(e.refCount++,t!=null&&Ko(t))}function xn(t,e,n,i){if(e.subtreeFlags&10256)for(e=e.child;e!==null;)E6(t,e,n,i),e=e.sibling}function E6(t,e,n,i){var a=e.flags;switch(e.tag){case 0:case 11:case 15:xn(t,e,n,i),a&2048&&Qo(9,e);break;case 1:xn(t,e,n,i);break;case 3:xn(t,e,n,i),a&2048&&(t=null,e.alternate!==null&&(t=e.alternate.memoizedState.cache),e=e.memoizedState.cache,e!==t&&(e.refCount++,t!=null&&Ko(t)));break;case 12:if(a&2048){xn(t,e,n,i),t=e.stateNode;try{var r=e.memoizedProps,s=r.id,o=r.onPostCommit;typeof o=="function"&&o(s,e.alternate===null?"mount":"update",t.passiveEffectDuration,-0)}catch(l){vt(e,e.return,l)}}else xn(t,e,n,i);break;case 31:xn(t,e,n,i);break;case 13:xn(t,e,n,i);break;case 23:break;case 22:r=e.stateNode,s=e.alternate,e.memoizedState!==null?r._visibility&2?xn(t,e,n,i):So(t,e):r._visibility&2?xn(t,e,n,i):(r._visibility|=2,Tr(t,e,n,i,(e.subtreeFlags&10256)!==0||!1)),a&2048&&e1(s,e);break;case 24:xn(t,e,n,i),a&2048&&n1(e.alternate,e);break;default:xn(t,e,n,i)}}function Tr(t,e,n,i,a){for(a=a&&((e.subtreeFlags&10256)!==0||!1),e=e.child;e!==null;){var r=t,s=e,o=n,l=i,c=s.flags;switch(s.tag){case 0:case 11:case 15:Tr(r,s,o,l,a),Qo(8,s);break;case 23:break;case 22:var u=s.stateNode;s.memoizedState!==null?u._visibility&2?Tr(r,s,o,l,a):So(r,s):(u._visibility|=2,Tr(r,s,o,l,a)),a&&c&2048&&e1(s.alternate,s);break;case 24:Tr(r,s,o,l,a),a&&c&2048&&n1(s.alternate,s);break;default:Tr(r,s,o,l,a)}e=e.sibling}}function So(t,e){if(e.subtreeFlags&10256)for(e=e.child;e!==null;){var n=t,i=e,a=i.flags;switch(i.tag){case 22:So(n,i),a&2048&&e1(i.alternate,i);break;case 24:So(n,i),a&2048&&n1(i.alternate,i);break;default:So(n,i)}e=e.sibling}}var go=8192;function Ar(t,e,n){if(t.subtreeFlags&go)for(t=t.child;t!==null;)w6(t,e,n),t=t.sibling}function w6(t,e,n){switch(t.tag){case 26:Ar(t,e,n),t.flags&go&&t.memoizedState!==null&&lb(n,vn,t.memoizedState,t.memoizedProps);break;case 5:Ar(t,e,n);break;case 3:case 4:var i=vn;vn=Vc(t.stateNode.containerInfo),Ar(t,e,n),vn=i;break;case 22:t.memoizedState===null&&(i=t.alternate,i!==null&&i.memoizedState!==null?(i=go,go=16777216,Ar(t,e,n),go=i):Ar(t,e,n));break;default:Ar(t,e,n)}}function C6(t){var e=t.alternate;if(e!==null&&(t=e.child,t!==null)){e.child=null;do e=t.sibling,t.sibling=null,t=e;while(t!==null)}}function oo(t){var e=t.deletions;if((t.flags&16)!==0){if(e!==null)for(var n=0;n<e.length;n++){var i=e[n];Qt=i,A6(i,t)}C6(t)}if(t.subtreeFlags&10256)for(t=t.child;t!==null;)S6(t),t=t.sibling}function S6(t){switch(t.tag){case 0:case 11:case 15:oo(t),t.flags&2048&&Zi(9,t,t.return);break;case 3:oo(t);break;case 12:oo(t);break;case 22:var e=t.stateNode;t.memoizedState!==null&&e._visibility&2&&(t.return===null||t.return.tag!==13)?(e._visibility&=-3,mc(t)):oo(t);break;default:oo(t)}}function mc(t){var e=t.deletions;if((t.flags&16)!==0){if(e!==null)for(var n=0;n<e.length;n++){var i=e[n];Qt=i,A6(i,t)}C6(t)}for(t=t.child;t!==null;){switch(e=t,e.tag){case 0:case 11:case 15:Zi(8,e,e.return),mc(e);break;case 22:n=e.stateNode,n._visibility&2&&(n._visibility&=-3,mc(e));break;default:mc(e)}t=t.sibling}}function A6(t,e){for(;Qt!==null;){var n=Qt;switch(n.tag){case 0:case 11:case 15:Zi(8,n,e);break;case 23:case 22:if(n.memoizedState!==null&&n.memoizedState.cachePool!==null){var i=n.memoizedState.cachePool.pool;i!=null&&i.refCount++}break;case 24:Ko(n.memoizedState.cache)}if(i=n.child,i!==null)i.return=n,Qt=i;else t:for(n=t;Qt!==null;){i=Qt;var a=i.sibling,r=i.return;if(m6(i),i===n){Qt=null;break t}if(a!==null){a.return=r,Qt=a;break t}Qt=r}}}var Sv={getCacheForType:function(t){var e=ae(Yt),n=e.data.get(t);return n===void 0&&(n=t(),e.data.set(t,n)),n},cacheSignal:function(){return ae(Yt).controller.signal}},Av=typeof WeakMap=="function"?WeakMap:Map,ft=0,Ct=null,at=null,ot=0,xt=0,Pe=null,zi=!1,cs=!1,i1=!1,di=0,Lt=0,Qi=0,Ma=0,a1=0,Ue=0,ts=0,Ao=null,Te=null,nf=!1,ou=0,T6=0,Nc=1/0,Pc=null,Hi=null,qt=0,Yi=null,es=null,si=0,af=0,rf=null,M6=null,To=0,sf=null;function Ge(){return(ft&2)!==0&&ot!==0?ot&-ot:V.T!==null?s1():Ly()}function _6(){if(Ue===0)if((ot&536870912)===0||ut){var t=Yl;Yl<<=1,(Yl&3932160)===0&&(Yl=262144),Ue=t}else Ue=536870912;return t=Xe.current,t!==null&&(t.flags|=32),Ue}function Me(t,e,n){(t===Ct&&(xt===2||xt===9)||t.cancelPendingCommit!==null)&&(ns(t,0),Li(t,ot,Ue,!1)),Go(t,n),((ft&2)===0||t!==Ct)&&(t===Ct&&((ft&2)===0&&(Ma|=n),Lt===4&&Li(t,ot,Ue,!1)),Fn(t))}function B6(t,e,n){if((ft&6)!==0)throw Error(_(327));var i=!n&&(e&127)===0&&(e&t.expiredLanes)===0||Vo(t,e),a=i?_v(t,e):gp(t,e,!0),r=i;do{if(a===0){cs&&!i&&Li(t,e,0,!1);break}else{if(n=t.current.alternate,r&&!Tv(n)){a=gp(t,e,!1),r=!1;continue}if(a===2){if(r=e,t.errorRecoveryDisabledLanes&r)var s=0;else s=t.pendingLanes&-536870913,s=s!==0?s:s&536870912?536870912:0;if(s!==0){e=s;t:{var o=t;a=Ao;var l=o.current.memoizedState.isDehydrated;if(l&&(ns(o,s).flags|=256),s=gp(o,s,!1),s!==2){if(i1&&!l){o.errorRecoveryDisabledLanes|=r,Ma|=r,a=4;break t}r=Te,Te=a,r!==null&&(Te===null?Te=r:Te.push.apply(Te,r))}a=s}if(r=!1,a!==2)continue}}if(a===1){ns(t,0),Li(t,e,0,!0);break}t:{switch(i=t,r=a,r){case 0:case 1:throw Error(_(345));case 4:if((e&4194048)!==e)break;case 6:Li(i,e,Ue,!zi);break t;case 2:Te=null;break;case 3:case 5:break;default:throw Error(_(329))}if((e&62914560)===e&&(a=ou+300-He(),10<a)){if(Li(i,e,Ue,!zi),Zc(i,0,!0)!==0)break t;si=e,i.timeoutHandle=Z6(Xm.bind(null,i,n,Te,Pc,nf,e,Ue,Ma,ts,zi,r,"Throttled",-0,0),a);break t}Xm(i,n,Te,Pc,nf,e,Ue,Ma,ts,zi,r,null,-0,0)}}break}while(!0);Fn(t)}function Xm(t,e,n,i,a,r,s,o,l,c,u,d,p,f){if(t.timeoutHandle=-1,d=e.subtreeFlags,d&8192||(d&16785408)===16785408){d={stylesheets:null,count:0,imgCount:0,imgBytes:0,suspenseyImages:[],waitingForImages:!0,waitingForViewTransition:!1,unsuspend:ni},w6(e,r,d);var y=(r&62914560)===r?ou-He():(r&4194048)===r?T6-He():0;if(y=cb(d,y),y!==null){si=r,t.cancelPendingCommit=y(Zm.bind(null,t,e,r,n,i,a,s,o,l,u,d,null,p,f)),Li(t,r,s,!c);return}}Zm(t,e,r,n,i,a,s,o,l)}function Tv(t){for(var e=t;;){var n=e.tag;if((n===0||n===11||n===15)&&e.flags&16384&&(n=e.updateQueue,n!==null&&(n=n.stores,n!==null)))for(var i=0;i<n.length;i++){var a=n[i],r=a.getSnapshot;a=a.value;try{if(!qe(r(),a))return!1}catch{return!1}}if(n=e.child,e.subtreeFlags&16384&&n!==null)n.return=e,e=n;else{if(e===t)break;for(;e.sibling===null;){if(e.return===null||e.return===t)return!0;e=e.return}e.sibling.return=e.return,e=e.sibling}}return!0}function Li(t,e,n,i){e&=~a1,e&=~Ma,t.suspendedLanes|=e,t.pingedLanes&=~e,i&&(t.warmLanes|=e),i=t.expirationTimes;for(var a=e;0<a;){var r=31-Ve(a),s=1<<r;i[r]=-1,a&=~s}n!==0&&Fy(t,n,e)}function lu(){return(ft&6)===0?(Jo(0,!1),!1):!0}function r1(){if(at!==null){if(xt===0)var t=at.return;else t=at,ii=Na=null,Yf(t),Vr=null,Oo=0,t=at;for(;t!==null;)c6(t.alternate,t),t=t.return;at=null}}function ns(t,e){var n=t.timeoutHandle;n!==-1&&(t.timeoutHandle=-1,Vv(n)),n=t.cancelPendingCommit,n!==null&&(t.cancelPendingCommit=null,n()),si=0,r1(),Ct=t,at=n=ai(t.current,null),ot=e,xt=0,Pe=null,zi=!1,cs=Vo(t,e),i1=!1,ts=Ue=a1=Ma=Qi=Lt=0,Te=Ao=null,nf=!1,(e&8)!==0&&(e|=e&32);var i=t.entangledLanes;if(i!==0)for(t=t.entanglements,i&=e;0<i;){var a=31-Ve(i),r=1<<a;e|=t[a],i&=~r}return di=e,tu(),n}function R6(t,e){Q=null,V.H=Lo,e===ls||e===nu?(e=Am(),xt=3):e===Lf?(e=Am(),xt=4):xt=e===Wf?8:e!==null&&typeof e=="object"&&typeof e.then=="function"?6:1,Pe=e,at===null&&(Lt=1,Oc(t,rn(e,t.current)))}function D6(){var t=Xe.current;return t===null?!0:(ot&4194048)===ot?on===null:(ot&62914560)===ot||(ot&536870912)!==0?t===on:!1}function I6(){var t=V.H;return V.H=Lo,t===null?Lo:t}function F6(){var t=V.A;return V.A=Sv,t}function jc(){Lt=4,zi||(ot&4194048)!==ot&&Xe.current!==null||(cs=!0),(Qi&134217727)===0&&(Ma&134217727)===0||Ct===null||Li(Ct,ot,Ue,!1)}function gp(t,e,n){var i=ft;ft|=2;var a=I6(),r=F6();(Ct!==t||ot!==e)&&(Pc=null,ns(t,e)),e=!1;var s=Lt;t:do try{if(xt!==0&&at!==null){var o=at,l=Pe;switch(xt){case 8:r1(),s=6;break t;case 3:case 2:case 9:case 6:Xe.current===null&&(e=!0);var c=xt;if(xt=0,Pe=null,jr(t,o,l,c),n&&cs){s=0;break t}break;default:c=xt,xt=0,Pe=null,jr(t,o,l,c)}}Mv(),s=Lt;break}catch(u){R6(t,u)}while(!0);return e&&t.shellSuspendCounter++,ii=Na=null,ft=i,V.H=a,V.A=r,at===null&&(Ct=null,ot=0,tu()),s}function Mv(){for(;at!==null;)O6(at)}function _v(t,e){var n=ft;ft|=2;var i=I6(),a=F6();Ct!==t||ot!==e?(Pc=null,Nc=He()+500,ns(t,e)):cs=Vo(t,e);t:do try{if(xt!==0&&at!==null){e=at;var r=Pe;e:switch(xt){case 1:xt=0,Pe=null,jr(t,e,r,1);break;case 2:case 9:if(Sm(r)){xt=0,Pe=null,Km(e);break}e=function(){xt!==2&&xt!==9||Ct!==t||(xt=7),Fn(t)},r.then(e,e);break t;case 3:xt=7;break t;case 4:xt=5;break t;case 7:Sm(r)?(xt=0,Pe=null,Km(e)):(xt=0,Pe=null,jr(t,e,r,7));break;case 5:var s=null;switch(at.tag){case 26:s=at.memoizedState;case 5:case 27:var o=at;if(s?e5(s):o.stateNode.complete){xt=0,Pe=null;var l=o.sibling;if(l!==null)at=l;else{var c=o.return;c!==null?(at=c,cu(c)):at=null}break e}}xt=0,Pe=null,jr(t,e,r,5);break;case 6:xt=0,Pe=null,jr(t,e,r,6);break;case 8:r1(),Lt=6;break t;default:throw Error(_(462))}}Bv();break}catch(u){R6(t,u)}while(!0);return ii=Na=null,V.H=i,V.A=a,ft=n,at!==null?0:(Ct=null,ot=0,tu(),Lt)}function Bv(){for(;at!==null&&!W7();)O6(at)}function O6(t){var e=l6(t.alternate,t,di);t.memoizedProps=t.pendingProps,e===null?cu(t):at=e}function Km(t){var e=t,n=e.alternate;switch(e.tag){case 15:case 0:e=Um(n,e,e.pendingProps,e.type,void 0,ot);break;case 11:e=Um(n,e,e.pendingProps,e.type.render,e.ref,ot);break;case 5:Yf(e);default:c6(n,e),e=at=c2(e,di),e=l6(n,e,di)}t.memoizedProps=t.pendingProps,e===null?cu(t):at=e}function jr(t,e,n,i){ii=Na=null,Yf(e),Vr=null,Oo=0;var a=e.return;try{if(xv(t,a,e,n,ot)){Lt=1,Oc(t,rn(n,t.current)),at=null;return}}catch(r){if(a!==null)throw at=a,r;Lt=1,Oc(t,rn(n,t.current)),at=null;return}e.flags&32768?(ut||i===1?t=!0:cs||(ot&536870912)!==0?t=!1:(zi=t=!0,(i===2||i===9||i===3||i===6)&&(i=Xe.current,i!==null&&i.tag===13&&(i.flags|=16384))),z6(e,t)):cu(e)}function cu(t){var e=t;do{if((e.flags&32768)!==0){z6(e,zi);return}t=e.return;var n=kv(e.alternate,e,di);if(n!==null){at=n;return}if(e=e.sibling,e!==null){at=e;return}at=e=t}while(e!==null);Lt===0&&(Lt=5)}function z6(t,e){do{var n=Ev(t.alternate,t);if(n!==null){n.flags&=32767,at=n;return}if(n=t.return,n!==null&&(n.flags|=32768,n.subtreeFlags=0,n.deletions=null),!e&&(t=t.sibling,t!==null)){at=t;return}at=t=n}while(t!==null);Lt=6,at=null}function Zm(t,e,n,i,a,r,s,o,l){t.cancelPendingCommit=null;do uu();while(qt!==0);if((ft&6)!==0)throw Error(_(327));if(e!==null){if(e===t.current)throw Error(_(177));if(r=e.lanes|e.childLanes,r|=Bf,c9(t,n,r,s,o,l),t===Ct&&(at=Ct=null,ot=0),es=e,Yi=t,si=n,af=r,rf=a,M6=i,(e.subtreeFlags&10256)!==0||(e.flags&10256)!==0?(t.callbackNode=null,t.callbackPriority=0,Fv(Cc,function(){return $6(),null})):(t.callbackNode=null,t.callbackPriority=0),i=(e.flags&13878)!==0,(e.subtreeFlags&13878)!==0||i){i=V.T,V.T=null,a=ht.p,ht.p=2,s=ft,ft|=4;try{wv(t,e,n)}finally{ft=s,ht.p=a,V.T=i}}qt=1,L6(),N6(),P6()}}function L6(){if(qt===1){qt=0;var t=Yi,e=es,n=(e.flags&13878)!==0;if((e.subtreeFlags&13878)!==0||n){n=V.T,V.T=null;var i=ht.p;ht.p=2;var a=ft;ft|=4;try{b6(e,t);var r=uf,s=e2(t.containerInfo),o=r.focusedElem,l=r.selectionRange;if(s!==o&&o&&o.ownerDocument&&t2(o.ownerDocument.documentElement,o)){if(l!==null&&_f(o)){var c=l.start,u=l.end;if(u===void 0&&(u=c),"selectionStart"in o)o.selectionStart=c,o.selectionEnd=Math.min(u,o.value.length);else{var d=o.ownerDocument||document,p=d&&d.defaultView||window;if(p.getSelection){var f=p.getSelection(),y=o.textContent.length,x=Math.min(l.start,y),E=l.end===void 0?x:Math.min(l.end,y);!f.extend&&x>E&&(s=E,E=x,x=s);var v=xm(o,x),h=xm(o,E);if(v&&h&&(f.rangeCount!==1||f.anchorNode!==v.node||f.anchorOffset!==v.offset||f.focusNode!==h.node||f.focusOffset!==h.offset)){var b=d.createRange();b.setStart(v.node,v.offset),f.removeAllRanges(),x>E?(f.addRange(b),f.extend(h.node,h.offset)):(b.setEnd(h.node,h.offset),f.addRange(b))}}}}for(d=[],f=o;f=f.parentNode;)f.nodeType===1&&d.push({element:f,left:f.scrollLeft,top:f.scrollTop});for(typeof o.focus=="function"&&o.focus(),o=0;o<d.length;o++){var w=d[o];w.element.scrollLeft=w.left,w.element.scrollTop=w.top}}Xc=!!cf,uf=cf=null}finally{ft=a,ht.p=i,V.T=n}}t.current=e,qt=2}}function N6(){if(qt===2){qt=0;var t=Yi,e=es,n=(e.flags&8772)!==0;if((e.subtreeFlags&8772)!==0||n){n=V.T,V.T=null;var i=ht.p;ht.p=2;var a=ft;ft|=4;try{g6(t,e.alternate,e)}finally{ft=a,ht.p=i,V.T=n}}qt=3}}function P6(){if(qt===4||qt===3){qt=0,t9();var t=Yi,e=es,n=si,i=M6;(e.subtreeFlags&10256)!==0||(e.flags&10256)!==0?qt=5:(qt=0,es=Yi=null,j6(t,t.pendingLanes));var a=t.pendingLanes;if(a===0&&(Hi=null),Ef(n),e=e.stateNode,Ye&&typeof Ye.onCommitFiberRoot=="function")try{Ye.onCommitFiberRoot(Yo,e,void 0,(e.current.flags&128)===128)}catch{}if(i!==null){e=V.T,a=ht.p,ht.p=2,V.T=null;try{for(var r=t.onRecoverableError,s=0;s<i.length;s++){var o=i[s];r(o.value,{componentStack:o.stack})}}finally{V.T=e,ht.p=a}}(si&3)!==0&&uu(),Fn(t),a=t.pendingLanes,(n&261930)!==0&&(a&42)!==0?t===sf?To++:(To=0,sf=t):To=0,Jo(0,!1)}}function j6(t,e){(t.pooledCacheLanes&=e)===0&&(e=t.pooledCache,e!=null&&(t.pooledCache=null,Ko(e)))}function uu(){return L6(),N6(),P6(),$6()}function $6(){if(qt!==5)return!1;var t=Yi,e=af;af=0;var n=Ef(si),i=V.T,a=ht.p;try{ht.p=32>n?32:n,V.T=null,n=rf,rf=null;var r=Yi,s=si;if(qt=0,es=Yi=null,si=0,(ft&6)!==0)throw Error(_(331));var o=ft;if(ft|=4,S6(r.current),E6(r,r.current,s,n),ft=o,Jo(0,!1),Ye&&typeof Ye.onPostCommitFiberRoot=="function")try{Ye.onPostCommitFiberRoot(Yo,r)}catch{}return!0}finally{ht.p=a,V.T=i,j6(t,e)}}function Qm(t,e,n){e=rn(n,e),e=Jp(t.stateNode,e,2),t=Ui(t,e,2),t!==null&&(Go(t,2),Fn(t))}function vt(t,e,n){if(t.tag===3)Qm(t,t,n);else for(;e!==null;){if(e.tag===3){Qm(e,t,n);break}else if(e.tag===1){var i=e.stateNode;if(typeof e.type.getDerivedStateFromError=="function"||typeof i.componentDidCatch=="function"&&(Hi===null||!Hi.has(i))){t=rn(n,t),n=n6(2),i=Ui(e,n,2),i!==null&&(i6(n,i,e,t),Go(i,2),Fn(i));break}}e=e.return}}function mp(t,e,n){var i=t.pingCache;if(i===null){i=t.pingCache=new Av;var a=new Set;i.set(e,a)}else a=i.get(e),a===void 0&&(a=new Set,i.set(e,a));a.has(n)||(i1=!0,a.add(n),t=Rv.bind(null,t,e,n),e.then(t,t))}function Rv(t,e,n){var i=t.pingCache;i!==null&&i.delete(e),t.pingedLanes|=t.suspendedLanes&n,t.warmLanes&=~n,Ct===t&&(ot&n)===n&&(Lt===4||Lt===3&&(ot&62914560)===ot&&300>He()-ou?(ft&2)===0&&ns(t,0):a1|=n,ts===ot&&(ts=0)),Fn(t)}function U6(t,e){e===0&&(e=Iy()),t=La(t,e),t!==null&&(Go(t,e),Fn(t))}function Dv(t){var e=t.memoizedState,n=0;e!==null&&(n=e.retryLane),U6(t,n)}function Iv(t,e){var n=0;switch(t.tag){case 31:case 13:var i=t.stateNode,a=t.memoizedState;a!==null&&(n=a.retryLane);break;case 19:i=t.stateNode;break;case 22:i=t.stateNode._retryCache;break;default:throw Error(_(314))}i!==null&&i.delete(e),U6(t,n)}function Fv(t,e){return bf(t,e)}var $c=null,Mr=null,of=!1,Uc=!1,yp=!1,Ni=0;function Fn(t){t!==Mr&&t.next===null&&(Mr===null?$c=Mr=t:Mr=Mr.next=t),Uc=!0,of||(of=!0,zv())}function Jo(t,e){if(!yp&&Uc){yp=!0;do for(var n=!1,i=$c;i!==null;){if(!e)if(t!==0){var a=i.pendingLanes;if(a===0)var r=0;else{var s=i.suspendedLanes,o=i.pingedLanes;r=(1<<31-Ve(42|t)+1)-1,r&=a&~(s&~o),r=r&201326741?r&201326741|1:r?r|2:0}r!==0&&(n=!0,Jm(i,r))}else r=ot,r=Zc(i,i===Ct?r:0,i.cancelPendingCommit!==null||i.timeoutHandle!==-1),(r&3)===0||Vo(i,r)||(n=!0,Jm(i,r));i=i.next}while(n);yp=!1}}function Ov(){H6()}function H6(){Uc=of=!1;var t=0;Ni!==0&&Yv()&&(t=Ni);for(var e=He(),n=null,i=$c;i!==null;){var a=i.next,r=Y6(i,e);r===0?(i.next=null,n===null?$c=a:n.next=a,a===null&&(Mr=n)):(n=i,(t!==0||(r&3)!==0)&&(Uc=!0)),i=a}qt!==0&&qt!==5||Jo(t,!1),Ni!==0&&(Ni=0)}function Y6(t,e){for(var n=t.suspendedLanes,i=t.pingedLanes,a=t.expirationTimes,r=t.pendingLanes&-62914561;0<r;){var s=31-Ve(r),o=1<<s,l=a[s];l===-1?((o&n)===0||(o&i)!==0)&&(a[s]=l9(o,e)):l<=e&&(t.expiredLanes|=o),r&=~o}if(e=Ct,n=ot,n=Zc(t,t===e?n:0,t.cancelPendingCommit!==null||t.timeoutHandle!==-1),i=t.callbackNode,n===0||t===e&&(xt===2||xt===9)||t.cancelPendingCommit!==null)return i!==null&&i!==null&&Gd(i),t.callbackNode=null,t.callbackPriority=0;if((n&3)===0||Vo(t,n)){if(e=n&-n,e===t.callbackPriority)return e;switch(i!==null&&Gd(i),Ef(n)){case 2:case 8:n=Ry;break;case 32:n=Cc;break;case 268435456:n=Dy;break;default:n=Cc}return i=V6.bind(null,t),n=bf(n,i),t.callbackPriority=e,t.callbackNode=n,e}return i!==null&&i!==null&&Gd(i),t.callbackPriority=2,t.callbackNode=null,2}function V6(t,e){if(qt!==0&&qt!==5)return t.callbackNode=null,t.callbackPriority=0,null;var n=t.callbackNode;if(uu()&&t.callbackNode!==n)return null;var i=ot;return i=Zc(t,t===Ct?i:0,t.cancelPendingCommit!==null||t.timeoutHandle!==-1),i===0?null:(B6(t,i,e),Y6(t,He()),t.callbackNode!=null&&t.callbackNode===n?V6.bind(null,t):null)}function Jm(t,e){if(uu())return null;B6(t,e,!0)}function zv(){Gv(function(){(ft&6)!==0?bf(By,Ov):H6()})}function s1(){if(Ni===0){var t=Qr;t===0&&(t=Hl,Hl<<=1,(Hl&261888)===0&&(Hl=256)),Ni=t}return Ni}function Wm(t){return t==null||typeof t=="symbol"||typeof t=="boolean"?null:typeof t=="function"?t:oc(""+t)}function ty(t,e){var n=e.ownerDocument.createElement("input");return n.name=e.name,n.value=e.value,t.id&&n.setAttribute("form",t.id),e.parentNode.insertBefore(n,e),t=new FormData(t),n.parentNode.removeChild(n),t}function Lv(t,e,n,i,a){if(e==="submit"&&n&&n.stateNode===a){var r=Wm((a[_e]||null).action),s=i.submitter;s&&(e=(e=s[_e]||null)?Wm(e.formAction):s.getAttribute("formAction"),e!==null&&(r=e,s=null));var o=new Qc("action","action",null,i,a);t.push({event:o,listeners:[{instance:null,listener:function(){if(i.defaultPrevented){if(Ni!==0){var l=s?ty(a,s):new FormData(a);Zp(n,{pending:!0,data:l,method:a.method,action:r},null,l)}}else typeof r=="function"&&(o.preventDefault(),l=s?ty(a,s):new FormData(a),Zp(n,{pending:!0,data:l,method:a.method,action:r},r,l))},currentTarget:a}]})}}for(ec=0;ec<Np.length;ec++)nc=Np[ec],ey=nc.toLowerCase(),ny=nc[0].toUpperCase()+nc.slice(1),bn(ey,"on"+ny);var nc,ey,ny,ec;bn(i2,"onAnimationEnd");bn(a2,"onAnimationIteration");bn(r2,"onAnimationStart");bn("dblclick","onDoubleClick");bn("focusin","onFocus");bn("focusout","onBlur");bn(ev,"onTransitionRun");bn(nv,"onTransitionStart");bn(iv,"onTransitionCancel");bn(s2,"onTransitionEnd");Kr("onMouseEnter",["mouseout","mouseover"]);Kr("onMouseLeave",["mouseout","mouseover"]);Kr("onPointerEnter",["pointerout","pointerover"]);Kr("onPointerLeave",["pointerout","pointerover"]);Fa("onChange","change click focusin focusout input keydown keyup selectionchange".split(" "));Fa("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" "));Fa("onBeforeInput",["compositionend","keypress","textInput","paste"]);Fa("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" "));Fa("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" "));Fa("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var No="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),Nv=new Set("beforetoggle cancel close invalid load scroll scrollend toggle".split(" ").concat(No));function G6(t,e){e=(e&4)!==0;for(var n=0;n<t.length;n++){var i=t[n],a=i.event;i=i.listeners;t:{var r=void 0;if(e)for(var s=i.length-1;0<=s;s--){var o=i[s],l=o.instance,c=o.currentTarget;if(o=o.listener,l!==r&&a.isPropagationStopped())break t;r=o,a.currentTarget=c;try{r(a)}catch(u){Ac(u)}a.currentTarget=null,r=l}else for(s=0;s<i.length;s++){if(o=i[s],l=o.instance,c=o.currentTarget,o=o.listener,l!==r&&a.isPropagationStopped())break t;r=o,a.currentTarget=c;try{r(a)}catch(u){Ac(u)}a.currentTarget=null,r=l}}}}function it(t,e){var n=e[Bp];n===void 0&&(n=e[Bp]=new Set);var i=t+"__bubble";n.has(i)||(q6(e,t,2,!1),n.add(i))}function xp(t,e,n){var i=0;e&&(i|=4),q6(n,t,i,e)}var ic="_reactListening"+Math.random().toString(36).slice(2);function o1(t){if(!t[ic]){t[ic]=!0,Ny.forEach(function(n){n!=="selectionchange"&&(Nv.has(n)||xp(n,!1,t),xp(n,!0,t))});var e=t.nodeType===9?t:t.ownerDocument;e===null||e[ic]||(e[ic]=!0,xp("selectionchange",!1,e))}}function q6(t,e,n,i){switch(s5(e)){case 2:var a=pb;break;case 8:a=fb;break;default:a=d1}n=a.bind(null,e,n,t),a=void 0,!Op||e!=="touchstart"&&e!=="touchmove"&&e!=="wheel"||(a=!0),i?a!==void 0?t.addEventListener(e,n,{capture:!0,passive:a}):t.addEventListener(e,n,!0):a!==void 0?t.addEventListener(e,n,{passive:a}):t.addEventListener(e,n,!1)}function vp(t,e,n,i,a){var r=i;if((e&1)===0&&(e&2)===0&&i!==null)t:for(;;){if(i===null)return;var s=i.tag;if(s===3||s===4){var o=i.stateNode.containerInfo;if(o===a)break;if(s===4)for(s=i.return;s!==null;){var l=s.tag;if((l===3||l===4)&&s.stateNode.containerInfo===a)return;s=s.return}for(;o!==null;){if(s=Rr(o),s===null)return;if(l=s.tag,l===5||l===6||l===26||l===27){i=r=s;continue t}o=o.parentNode}}i=i.return}Gy(function(){var c=r,u=Sf(n),d=[];t:{var p=o2.get(t);if(p!==void 0){var f=Qc,y=t;switch(t){case"keypress":if(cc(n)===0)break t;case"keydown":case"keyup":f=I9;break;case"focusin":y="focus",f=Qd;break;case"focusout":y="blur",f=Qd;break;case"beforeblur":case"afterblur":f=Qd;break;case"click":if(n.button===2)break t;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":f=cm;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":f=k9;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":f=z9;break;case i2:case a2:case r2:f=C9;break;case s2:f=N9;break;case"scroll":case"scrollend":f=v9;break;case"wheel":f=j9;break;case"copy":case"cut":case"paste":f=A9;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":f=dm;break;case"toggle":case"beforetoggle":f=U9}var x=(e&4)!==0,E=!x&&(t==="scroll"||t==="scrollend"),v=x?p!==null?p+"Capture":null:p;x=[];for(var h=c,b;h!==null;){var w=h;if(b=w.stateNode,w=w.tag,w!==5&&w!==26&&w!==27||b===null||v===null||(w=Bo(h,v),w!=null&&x.push(Po(h,w,b))),E)break;h=h.return}0<x.length&&(p=new f(p,y,null,n,u),d.push({event:p,listeners:x}))}}if((e&7)===0){t:{if(p=t==="mouseover"||t==="pointerover",f=t==="mouseout"||t==="pointerout",p&&n!==Fp&&(y=n.relatedTarget||n.fromElement)&&(Rr(y)||y[rs]))break t;if((f||p)&&(p=u.window===u?u:(p=u.ownerDocument)?p.defaultView||p.parentWindow:window,f?(y=n.relatedTarget||n.toElement,f=c,y=y?Rr(y):null,y!==null&&(E=Ho(y),x=y.tag,y!==E||x!==5&&x!==27&&x!==6)&&(y=null)):(f=null,y=c),f!==y)){if(x=cm,w="onMouseLeave",v="onMouseEnter",h="mouse",(t==="pointerout"||t==="pointerover")&&(x=dm,w="onPointerLeave",v="onPointerEnter",h="pointer"),E=f==null?p:fo(f),b=y==null?p:fo(y),p=new x(w,h+"leave",f,n,u),p.target=E,p.relatedTarget=b,w=null,Rr(u)===c&&(x=new x(v,h+"enter",y,n,u),x.target=b,x.relatedTarget=E,w=x),E=w,f&&y)e:{for(x=Pv,v=f,h=y,b=0,w=v;w;w=x(w))b++;w=0;for(var B=h;B;B=x(B))w++;for(;0<b-w;)v=x(v),b--;for(;0<w-b;)h=x(h),w--;for(;b--;){if(v===h||h!==null&&v===h.alternate){x=v;break e}v=x(v),h=x(h)}x=null}else x=null;f!==null&&iy(d,p,f,x,!1),y!==null&&E!==null&&iy(d,E,y,x,!0)}}t:{if(p=c?fo(c):window,f=p.nodeName&&p.nodeName.toLowerCase(),f==="select"||f==="input"&&p.type==="file")var j=gm;else if(hm(p))if(Jy)j=J9;else{j=Z9;var T=K9}else f=p.nodeName,!f||f.toLowerCase()!=="input"||p.type!=="checkbox"&&p.type!=="radio"?c&&Cf(c.elementType)&&(j=gm):j=Q9;if(j&&(j=j(t,c))){Qy(d,j,n,u);break t}T&&T(t,p,c),t==="focusout"&&c&&p.type==="number"&&c.memoizedProps.value!=null&&Ip(p,"number",p.value)}switch(T=c?fo(c):window,t){case"focusin":(hm(T)||T.contentEditable==="true")&&(Fr=T,zp=c,xo=null);break;case"focusout":xo=zp=Fr=null;break;case"mousedown":Lp=!0;break;case"contextmenu":case"mouseup":case"dragend":Lp=!1,vm(d,n,u);break;case"selectionchange":if(tv)break;case"keydown":case"keyup":vm(d,n,u)}var P;if(Mf)t:{switch(t){case"compositionstart":var D="onCompositionStart";break t;case"compositionend":D="onCompositionEnd";break t;case"compositionupdate":D="onCompositionUpdate";break t}D=void 0}else Ir?Ky(t,n)&&(D="onCompositionEnd"):t==="keydown"&&n.keyCode===229&&(D="onCompositionStart");D&&(Xy&&n.locale!=="ko"&&(Ir||D!=="onCompositionStart"?D==="onCompositionEnd"&&Ir&&(P=qy()):(Oi=u,Af="value"in Oi?Oi.value:Oi.textContent,Ir=!0)),T=Hc(c,D),0<T.length&&(D=new um(D,t,null,n,u),d.push({event:D,listeners:T}),P?D.data=P:(P=Zy(n),P!==null&&(D.data=P)))),(P=Y9?V9(t,n):G9(t,n))&&(D=Hc(c,"onBeforeInput"),0<D.length&&(T=new um("onBeforeInput","beforeinput",null,n,u),d.push({event:T,listeners:D}),T.data=P)),Lv(d,t,c,n,u)}G6(d,e)})}function Po(t,e,n){return{instance:t,listener:e,currentTarget:n}}function Hc(t,e){for(var n=e+"Capture",i=[];t!==null;){var a=t,r=a.stateNode;if(a=a.tag,a!==5&&a!==26&&a!==27||r===null||(a=Bo(t,n),a!=null&&i.unshift(Po(t,a,r)),a=Bo(t,e),a!=null&&i.push(Po(t,a,r))),t.tag===3)return i;t=t.return}return[]}function Pv(t){if(t===null)return null;do t=t.return;while(t&&t.tag!==5&&t.tag!==27);return t||null}function iy(t,e,n,i,a){for(var r=e._reactName,s=[];n!==null&&n!==i;){var o=n,l=o.alternate,c=o.stateNode;if(o=o.tag,l!==null&&l===i)break;o!==5&&o!==26&&o!==27||c===null||(l=c,a?(c=Bo(n,r),c!=null&&s.unshift(Po(n,c,l))):a||(c=Bo(n,r),c!=null&&s.push(Po(n,c,l)))),n=n.return}s.length!==0&&t.push({event:e,listeners:s})}var jv=/\r\n?/g,$v=/\u0000|\uFFFD/g;function ay(t){return(typeof t=="string"?t:""+t).replace(jv,`
`).replace($v,"")}function X6(t,e){return e=ay(e),ay(t)===e}function bt(t,e,n,i,a,r){switch(n){case"children":typeof i=="string"?e==="body"||e==="textarea"&&i===""||Zr(t,i):(typeof i=="number"||typeof i=="bigint")&&e!=="body"&&Zr(t,""+i);break;case"className":Gl(t,"class",i);break;case"tabIndex":Gl(t,"tabindex",i);break;case"dir":case"role":case"viewBox":case"width":case"height":Gl(t,n,i);break;case"style":Vy(t,i,r);break;case"data":if(e!=="object"){Gl(t,"data",i);break}case"src":case"href":if(i===""&&(e!=="a"||n!=="href")){t.removeAttribute(n);break}if(i==null||typeof i=="function"||typeof i=="symbol"||typeof i=="boolean"){t.removeAttribute(n);break}i=oc(""+i),t.setAttribute(n,i);break;case"action":case"formAction":if(typeof i=="function"){t.setAttribute(n,"javascript:throw new Error('A React form was unexpectedly submitted. If you called form.submit() manually, consider using form.requestSubmit() instead. If you\\'re trying to use event.stopPropagation() in a submit event handler, consider also calling event.preventDefault().')");break}else typeof r=="function"&&(n==="formAction"?(e!=="input"&&bt(t,e,"name",a.name,a,null),bt(t,e,"formEncType",a.formEncType,a,null),bt(t,e,"formMethod",a.formMethod,a,null),bt(t,e,"formTarget",a.formTarget,a,null)):(bt(t,e,"encType",a.encType,a,null),bt(t,e,"method",a.method,a,null),bt(t,e,"target",a.target,a,null)));if(i==null||typeof i=="symbol"||typeof i=="boolean"){t.removeAttribute(n);break}i=oc(""+i),t.setAttribute(n,i);break;case"onClick":i!=null&&(t.onclick=ni);break;case"onScroll":i!=null&&it("scroll",t);break;case"onScrollEnd":i!=null&&it("scrollend",t);break;case"dangerouslySetInnerHTML":if(i!=null){if(typeof i!="object"||!("__html"in i))throw Error(_(61));if(n=i.__html,n!=null){if(a.children!=null)throw Error(_(60));t.innerHTML=n}}break;case"multiple":t.multiple=i&&typeof i!="function"&&typeof i!="symbol";break;case"muted":t.muted=i&&typeof i!="function"&&typeof i!="symbol";break;case"suppressContentEditableWarning":case"suppressHydrationWarning":case"defaultValue":case"defaultChecked":case"innerHTML":case"ref":break;case"autoFocus":break;case"xlinkHref":if(i==null||typeof i=="function"||typeof i=="boolean"||typeof i=="symbol"){t.removeAttribute("xlink:href");break}n=oc(""+i),t.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",n);break;case"contentEditable":case"spellCheck":case"draggable":case"value":case"autoReverse":case"externalResourcesRequired":case"focusable":case"preserveAlpha":i!=null&&typeof i!="function"&&typeof i!="symbol"?t.setAttribute(n,""+i):t.removeAttribute(n);break;case"inert":case"allowFullScreen":case"async":case"autoPlay":case"controls":case"default":case"defer":case"disabled":case"disablePictureInPicture":case"disableRemotePlayback":case"formNoValidate":case"hidden":case"loop":case"noModule":case"noValidate":case"open":case"playsInline":case"readOnly":case"required":case"reversed":case"scoped":case"seamless":case"itemScope":i&&typeof i!="function"&&typeof i!="symbol"?t.setAttribute(n,""):t.removeAttribute(n);break;case"capture":case"download":i===!0?t.setAttribute(n,""):i!==!1&&i!=null&&typeof i!="function"&&typeof i!="symbol"?t.setAttribute(n,i):t.removeAttribute(n);break;case"cols":case"rows":case"size":case"span":i!=null&&typeof i!="function"&&typeof i!="symbol"&&!isNaN(i)&&1<=i?t.setAttribute(n,i):t.removeAttribute(n);break;case"rowSpan":case"start":i==null||typeof i=="function"||typeof i=="symbol"||isNaN(i)?t.removeAttribute(n):t.setAttribute(n,i);break;case"popover":it("beforetoggle",t),it("toggle",t),sc(t,"popover",i);break;case"xlinkActuate":Xn(t,"http://www.w3.org/1999/xlink","xlink:actuate",i);break;case"xlinkArcrole":Xn(t,"http://www.w3.org/1999/xlink","xlink:arcrole",i);break;case"xlinkRole":Xn(t,"http://www.w3.org/1999/xlink","xlink:role",i);break;case"xlinkShow":Xn(t,"http://www.w3.org/1999/xlink","xlink:show",i);break;case"xlinkTitle":Xn(t,"http://www.w3.org/1999/xlink","xlink:title",i);break;case"xlinkType":Xn(t,"http://www.w3.org/1999/xlink","xlink:type",i);break;case"xmlBase":Xn(t,"http://www.w3.org/XML/1998/namespace","xml:base",i);break;case"xmlLang":Xn(t,"http://www.w3.org/XML/1998/namespace","xml:lang",i);break;case"xmlSpace":Xn(t,"http://www.w3.org/XML/1998/namespace","xml:space",i);break;case"is":sc(t,"is",i);break;case"innerText":case"textContent":break;default:(!(2<n.length)||n[0]!=="o"&&n[0]!=="O"||n[1]!=="n"&&n[1]!=="N")&&(n=y9.get(n)||n,sc(t,n,i))}}function lf(t,e,n,i,a,r){switch(n){case"style":Vy(t,i,r);break;case"dangerouslySetInnerHTML":if(i!=null){if(typeof i!="object"||!("__html"in i))throw Error(_(61));if(n=i.__html,n!=null){if(a.children!=null)throw Error(_(60));t.innerHTML=n}}break;case"children":typeof i=="string"?Zr(t,i):(typeof i=="number"||typeof i=="bigint")&&Zr(t,""+i);break;case"onScroll":i!=null&&it("scroll",t);break;case"onScrollEnd":i!=null&&it("scrollend",t);break;case"onClick":i!=null&&(t.onclick=ni);break;case"suppressContentEditableWarning":case"suppressHydrationWarning":case"innerHTML":case"ref":break;case"innerText":case"textContent":break;default:if(!Py.hasOwnProperty(n))t:{if(n[0]==="o"&&n[1]==="n"&&(a=n.endsWith("Capture"),e=n.slice(2,a?n.length-7:void 0),r=t[_e]||null,r=r!=null?r[n]:null,typeof r=="function"&&t.removeEventListener(e,r,a),typeof i=="function")){typeof r!="function"&&r!==null&&(n in t?t[n]=null:t.hasAttribute(n)&&t.removeAttribute(n)),t.addEventListener(e,i,a);break t}n in t?t[n]=i:i===!0?t.setAttribute(n,""):sc(t,n,i)}}}function re(t,e,n){switch(e){case"div":case"span":case"svg":case"path":case"a":case"g":case"p":case"li":break;case"img":it("error",t),it("load",t);var i=!1,a=!1,r;for(r in n)if(n.hasOwnProperty(r)){var s=n[r];if(s!=null)switch(r){case"src":i=!0;break;case"srcSet":a=!0;break;case"children":case"dangerouslySetInnerHTML":throw Error(_(137,e));default:bt(t,e,r,s,n,null)}}a&&bt(t,e,"srcSet",n.srcSet,n,null),i&&bt(t,e,"src",n.src,n,null);return;case"input":it("invalid",t);var o=r=s=a=null,l=null,c=null;for(i in n)if(n.hasOwnProperty(i)){var u=n[i];if(u!=null)switch(i){case"name":a=u;break;case"type":s=u;break;case"checked":l=u;break;case"defaultChecked":c=u;break;case"value":r=u;break;case"defaultValue":o=u;break;case"children":case"dangerouslySetInnerHTML":if(u!=null)throw Error(_(137,e));break;default:bt(t,e,i,u,n,null)}}Uy(t,r,o,l,c,s,a,!1);return;case"select":it("invalid",t),i=s=r=null;for(a in n)if(n.hasOwnProperty(a)&&(o=n[a],o!=null))switch(a){case"value":r=o;break;case"defaultValue":s=o;break;case"multiple":i=o;default:bt(t,e,a,o,n,null)}e=r,n=s,t.multiple=!!i,e!=null?Ur(t,!!i,e,!1):n!=null&&Ur(t,!!i,n,!0);return;case"textarea":it("invalid",t),r=a=i=null;for(s in n)if(n.hasOwnProperty(s)&&(o=n[s],o!=null))switch(s){case"value":i=o;break;case"defaultValue":a=o;break;case"children":r=o;break;case"dangerouslySetInnerHTML":if(o!=null)throw Error(_(91));break;default:bt(t,e,s,o,n,null)}Yy(t,i,a,r);return;case"option":for(l in n)n.hasOwnProperty(l)&&(i=n[l],i!=null)&&(l==="selected"?t.selected=i&&typeof i!="function"&&typeof i!="symbol":bt(t,e,l,i,n,null));return;case"dialog":it("beforetoggle",t),it("toggle",t),it("cancel",t),it("close",t);break;case"iframe":case"object":it("load",t);break;case"video":case"audio":for(i=0;i<No.length;i++)it(No[i],t);break;case"image":it("error",t),it("load",t);break;case"details":it("toggle",t);break;case"embed":case"source":case"link":it("error",t),it("load",t);case"area":case"base":case"br":case"col":case"hr":case"keygen":case"meta":case"param":case"track":case"wbr":case"menuitem":for(c in n)if(n.hasOwnProperty(c)&&(i=n[c],i!=null))switch(c){case"children":case"dangerouslySetInnerHTML":throw Error(_(137,e));default:bt(t,e,c,i,n,null)}return;default:if(Cf(e)){for(u in n)n.hasOwnProperty(u)&&(i=n[u],i!==void 0&&lf(t,e,u,i,n,void 0));return}}for(o in n)n.hasOwnProperty(o)&&(i=n[o],i!=null&&bt(t,e,o,i,n,null))}function Uv(t,e,n,i){switch(e){case"div":case"span":case"svg":case"path":case"a":case"g":case"p":case"li":break;case"input":var a=null,r=null,s=null,o=null,l=null,c=null,u=null;for(f in n){var d=n[f];if(n.hasOwnProperty(f)&&d!=null)switch(f){case"checked":break;case"value":break;case"defaultValue":l=d;default:i.hasOwnProperty(f)||bt(t,e,f,null,i,d)}}for(var p in i){var f=i[p];if(d=n[p],i.hasOwnProperty(p)&&(f!=null||d!=null))switch(p){case"type":r=f;break;case"name":a=f;break;case"checked":c=f;break;case"defaultChecked":u=f;break;case"value":s=f;break;case"defaultValue":o=f;break;case"children":case"dangerouslySetInnerHTML":if(f!=null)throw Error(_(137,e));break;default:f!==d&&bt(t,e,p,f,i,d)}}Dp(t,s,o,l,c,u,r,a);return;case"select":f=s=o=p=null;for(r in n)if(l=n[r],n.hasOwnProperty(r)&&l!=null)switch(r){case"value":break;case"multiple":f=l;default:i.hasOwnProperty(r)||bt(t,e,r,null,i,l)}for(a in i)if(r=i[a],l=n[a],i.hasOwnProperty(a)&&(r!=null||l!=null))switch(a){case"value":p=r;break;case"defaultValue":o=r;break;case"multiple":s=r;default:r!==l&&bt(t,e,a,r,i,l)}e=o,n=s,i=f,p!=null?Ur(t,!!n,p,!1):!!i!=!!n&&(e!=null?Ur(t,!!n,e,!0):Ur(t,!!n,n?[]:"",!1));return;case"textarea":f=p=null;for(o in n)if(a=n[o],n.hasOwnProperty(o)&&a!=null&&!i.hasOwnProperty(o))switch(o){case"value":break;case"children":break;default:bt(t,e,o,null,i,a)}for(s in i)if(a=i[s],r=n[s],i.hasOwnProperty(s)&&(a!=null||r!=null))switch(s){case"value":p=a;break;case"defaultValue":f=a;break;case"children":break;case"dangerouslySetInnerHTML":if(a!=null)throw Error(_(91));break;default:a!==r&&bt(t,e,s,a,i,r)}Hy(t,p,f);return;case"option":for(var y in n)p=n[y],n.hasOwnProperty(y)&&p!=null&&!i.hasOwnProperty(y)&&(y==="selected"?t.selected=!1:bt(t,e,y,null,i,p));for(l in i)p=i[l],f=n[l],i.hasOwnProperty(l)&&p!==f&&(p!=null||f!=null)&&(l==="selected"?t.selected=p&&typeof p!="function"&&typeof p!="symbol":bt(t,e,l,p,i,f));return;case"img":case"link":case"area":case"base":case"br":case"col":case"embed":case"hr":case"keygen":case"meta":case"param":case"source":case"track":case"wbr":case"menuitem":for(var x in n)p=n[x],n.hasOwnProperty(x)&&p!=null&&!i.hasOwnProperty(x)&&bt(t,e,x,null,i,p);for(c in i)if(p=i[c],f=n[c],i.hasOwnProperty(c)&&p!==f&&(p!=null||f!=null))switch(c){case"children":case"dangerouslySetInnerHTML":if(p!=null)throw Error(_(137,e));break;default:bt(t,e,c,p,i,f)}return;default:if(Cf(e)){for(var E in n)p=n[E],n.hasOwnProperty(E)&&p!==void 0&&!i.hasOwnProperty(E)&&lf(t,e,E,void 0,i,p);for(u in i)p=i[u],f=n[u],!i.hasOwnProperty(u)||p===f||p===void 0&&f===void 0||lf(t,e,u,p,i,f);return}}for(var v in n)p=n[v],n.hasOwnProperty(v)&&p!=null&&!i.hasOwnProperty(v)&&bt(t,e,v,null,i,p);for(d in i)p=i[d],f=n[d],!i.hasOwnProperty(d)||p===f||p==null&&f==null||bt(t,e,d,p,i,f)}function ry(t){switch(t){case"css":case"script":case"font":case"img":case"image":case"input":case"link":return!0;default:return!1}}function Hv(){if(typeof performance.getEntriesByType=="function"){for(var t=0,e=0,n=performance.getEntriesByType("resource"),i=0;i<n.length;i++){var a=n[i],r=a.transferSize,s=a.initiatorType,o=a.duration;if(r&&o&&ry(s)){for(s=0,o=a.responseEnd,i+=1;i<n.length;i++){var l=n[i],c=l.startTime;if(c>o)break;var u=l.transferSize,d=l.initiatorType;u&&ry(d)&&(l=l.responseEnd,s+=u*(l<o?1:(o-c)/(l-c)))}if(--i,e+=8*(r+s)/(a.duration/1e3),t++,10<t)break}}if(0<t)return e/t/1e6}return navigator.connection&&(t=navigator.connection.downlink,typeof t=="number")?t:5}var cf=null,uf=null;function Yc(t){return t.nodeType===9?t:t.ownerDocument}function sy(t){switch(t){case"http://www.w3.org/2000/svg":return 1;case"http://www.w3.org/1998/Math/MathML":return 2;default:return 0}}function K6(t,e){if(t===0)switch(e){case"svg":return 1;case"math":return 2;default:return 0}return t===1&&e==="foreignObject"?0:t}function df(t,e){return t==="textarea"||t==="noscript"||typeof e.children=="string"||typeof e.children=="number"||typeof e.children=="bigint"||typeof e.dangerouslySetInnerHTML=="object"&&e.dangerouslySetInnerHTML!==null&&e.dangerouslySetInnerHTML.__html!=null}var bp=null;function Yv(){var t=window.event;return t&&t.type==="popstate"?t===bp?!1:(bp=t,!0):(bp=null,!1)}var Z6=typeof setTimeout=="function"?setTimeout:void 0,Vv=typeof clearTimeout=="function"?clearTimeout:void 0,oy=typeof Promise=="function"?Promise:void 0,Gv=typeof queueMicrotask=="function"?queueMicrotask:typeof oy<"u"?function(t){return oy.resolve(null).then(t).catch(qv)}:Z6;function qv(t){setTimeout(function(){throw t})}function Wi(t){return t==="head"}function ly(t,e){var n=e,i=0;do{var a=n.nextSibling;if(t.removeChild(n),a&&a.nodeType===8)if(n=a.data,n==="/$"||n==="/&"){if(i===0){t.removeChild(a),as(e);return}i--}else if(n==="$"||n==="$?"||n==="$~"||n==="$!"||n==="&")i++;else if(n==="html")Mo(t.ownerDocument.documentElement);else if(n==="head"){n=t.ownerDocument.head,Mo(n);for(var r=n.firstChild;r;){var s=r.nextSibling,o=r.nodeName;r[qo]||o==="SCRIPT"||o==="STYLE"||o==="LINK"&&r.rel.toLowerCase()==="stylesheet"||n.removeChild(r),r=s}}else n==="body"&&Mo(t.ownerDocument.body);n=a}while(n);as(e)}function cy(t,e){var n=t;t=0;do{var i=n.nextSibling;if(n.nodeType===1?e?(n._stashedDisplay=n.style.display,n.style.display="none"):(n.style.display=n._stashedDisplay||"",n.getAttribute("style")===""&&n.removeAttribute("style")):n.nodeType===3&&(e?(n._stashedText=n.nodeValue,n.nodeValue=""):n.nodeValue=n._stashedText||""),i&&i.nodeType===8)if(n=i.data,n==="/$"){if(t===0)break;t--}else n!=="$"&&n!=="$?"&&n!=="$~"&&n!=="$!"||t++;n=i}while(n)}function pf(t){var e=t.firstChild;for(e&&e.nodeType===10&&(e=e.nextSibling);e;){var n=e;switch(e=e.nextSibling,n.nodeName){case"HTML":case"HEAD":case"BODY":pf(n),wf(n);continue;case"SCRIPT":case"STYLE":continue;case"LINK":if(n.rel.toLowerCase()==="stylesheet")continue}t.removeChild(n)}}function Xv(t,e,n,i){for(;t.nodeType===1;){var a=n;if(t.nodeName.toLowerCase()!==e.toLowerCase()){if(!i&&(t.nodeName!=="INPUT"||t.type!=="hidden"))break}else if(i){if(!t[qo])switch(e){case"meta":if(!t.hasAttribute("itemprop"))break;return t;case"link":if(r=t.getAttribute("rel"),r==="stylesheet"&&t.hasAttribute("data-precedence"))break;if(r!==a.rel||t.getAttribute("href")!==(a.href==null||a.href===""?null:a.href)||t.getAttribute("crossorigin")!==(a.crossOrigin==null?null:a.crossOrigin)||t.getAttribute("title")!==(a.title==null?null:a.title))break;return t;case"style":if(t.hasAttribute("data-precedence"))break;return t;case"script":if(r=t.getAttribute("src"),(r!==(a.src==null?null:a.src)||t.getAttribute("type")!==(a.type==null?null:a.type)||t.getAttribute("crossorigin")!==(a.crossOrigin==null?null:a.crossOrigin))&&r&&t.hasAttribute("async")&&!t.hasAttribute("itemprop"))break;return t;default:return t}}else if(e==="input"&&t.type==="hidden"){var r=a.name==null?null:""+a.name;if(a.type==="hidden"&&t.getAttribute("name")===r)return t}else return t;if(t=ln(t.nextSibling),t===null)break}return null}function Kv(t,e,n){if(e==="")return null;for(;t.nodeType!==3;)if((t.nodeType!==1||t.nodeName!=="INPUT"||t.type!=="hidden")&&!n||(t=ln(t.nextSibling),t===null))return null;return t}function Q6(t,e){for(;t.nodeType!==8;)if((t.nodeType!==1||t.nodeName!=="INPUT"||t.type!=="hidden")&&!e||(t=ln(t.nextSibling),t===null))return null;return t}function ff(t){return t.data==="$?"||t.data==="$~"}function hf(t){return t.data==="$!"||t.data==="$?"&&t.ownerDocument.readyState!=="loading"}function Zv(t,e){var n=t.ownerDocument;if(t.data==="$~")t._reactRetry=e;else if(t.data!=="$?"||n.readyState!=="loading")e();else{var i=function(){e(),n.removeEventListener("DOMContentLoaded",i)};n.addEventListener("DOMContentLoaded",i),t._reactRetry=i}}function ln(t){for(;t!=null;t=t.nextSibling){var e=t.nodeType;if(e===1||e===3)break;if(e===8){if(e=t.data,e==="$"||e==="$!"||e==="$?"||e==="$~"||e==="&"||e==="F!"||e==="F")break;if(e==="/$"||e==="/&")return null}}return t}var gf=null;function uy(t){t=t.nextSibling;for(var e=0;t;){if(t.nodeType===8){var n=t.data;if(n==="/$"||n==="/&"){if(e===0)return ln(t.nextSibling);e--}else n!=="$"&&n!=="$!"&&n!=="$?"&&n!=="$~"&&n!=="&"||e++}t=t.nextSibling}return null}function dy(t){t=t.previousSibling;for(var e=0;t;){if(t.nodeType===8){var n=t.data;if(n==="$"||n==="$!"||n==="$?"||n==="$~"||n==="&"){if(e===0)return t;e--}else n!=="/$"&&n!=="/&"||e++}t=t.previousSibling}return null}function J6(t,e,n){switch(e=Yc(n),t){case"html":if(t=e.documentElement,!t)throw Error(_(452));return t;case"head":if(t=e.head,!t)throw Error(_(453));return t;case"body":if(t=e.body,!t)throw Error(_(454));return t;default:throw Error(_(451))}}function Mo(t){for(var e=t.attributes;e.length;)t.removeAttributeNode(e[0]);wf(t)}var cn=new Map,py=new Set;function Vc(t){return typeof t.getRootNode=="function"?t.getRootNode():t.nodeType===9?t:t.ownerDocument}var pi=ht.d;ht.d={f:Qv,r:Jv,D:Wv,C:tb,L:eb,m:nb,X:ab,S:ib,M:rb};function Qv(){var t=pi.f(),e=lu();return t||e}function Jv(t){var e=ss(t);e!==null&&e.tag===5&&e.type==="form"?V2(e):pi.r(t)}var us=typeof document>"u"?null:document;function W6(t,e,n){var i=us;if(i&&typeof e=="string"&&e){var a=an(e);a='link[rel="'+t+'"][href="'+a+'"]',typeof n=="string"&&(a+='[crossorigin="'+n+'"]'),py.has(a)||(py.add(a),t={rel:t,crossOrigin:n,href:e},i.querySelector(a)===null&&(e=i.createElement("link"),re(e,"link",t),Jt(e),i.head.appendChild(e)))}}function Wv(t){pi.D(t),W6("dns-prefetch",t,null)}function tb(t,e){pi.C(t,e),W6("preconnect",t,e)}function eb(t,e,n){pi.L(t,e,n);var i=us;if(i&&t&&e){var a='link[rel="preload"][as="'+an(e)+'"]';e==="image"&&n&&n.imageSrcSet?(a+='[imagesrcset="'+an(n.imageSrcSet)+'"]',typeof n.imageSizes=="string"&&(a+='[imagesizes="'+an(n.imageSizes)+'"]')):a+='[href="'+an(t)+'"]';var r=a;switch(e){case"style":r=is(t);break;case"script":r=ds(t)}cn.has(r)||(t=Rt({rel:"preload",href:e==="image"&&n&&n.imageSrcSet?void 0:t,as:e},n),cn.set(r,t),i.querySelector(a)!==null||e==="style"&&i.querySelector(Wo(r))||e==="script"&&i.querySelector(tl(r))||(e=i.createElement("link"),re(e,"link",t),Jt(e),i.head.appendChild(e)))}}function nb(t,e){pi.m(t,e);var n=us;if(n&&t){var i=e&&typeof e.as=="string"?e.as:"script",a='link[rel="modulepreload"][as="'+an(i)+'"][href="'+an(t)+'"]',r=a;switch(i){case"audioworklet":case"paintworklet":case"serviceworker":case"sharedworker":case"worker":case"script":r=ds(t)}if(!cn.has(r)&&(t=Rt({rel:"modulepreload",href:t},e),cn.set(r,t),n.querySelector(a)===null)){switch(i){case"audioworklet":case"paintworklet":case"serviceworker":case"sharedworker":case"worker":case"script":if(n.querySelector(tl(r)))return}i=n.createElement("link"),re(i,"link",t),Jt(i),n.head.appendChild(i)}}}function ib(t,e,n){pi.S(t,e,n);var i=us;if(i&&t){var a=$r(i).hoistableStyles,r=is(t);e=e||"default";var s=a.get(r);if(!s){var o={loading:0,preload:null};if(s=i.querySelector(Wo(r)))o.loading=5;else{t=Rt({rel:"stylesheet",href:t,"data-precedence":e},n),(n=cn.get(r))&&l1(t,n);var l=s=i.createElement("link");Jt(l),re(l,"link",t),l._p=new Promise(function(c,u){l.onload=c,l.onerror=u}),l.addEventListener("load",function(){o.loading|=1}),l.addEventListener("error",function(){o.loading|=2}),o.loading|=4,yc(s,e,i)}s={type:"stylesheet",instance:s,count:1,state:o},a.set(r,s)}}}function ab(t,e){pi.X(t,e);var n=us;if(n&&t){var i=$r(n).hoistableScripts,a=ds(t),r=i.get(a);r||(r=n.querySelector(tl(a)),r||(t=Rt({src:t,async:!0},e),(e=cn.get(a))&&c1(t,e),r=n.createElement("script"),Jt(r),re(r,"link",t),n.head.appendChild(r)),r={type:"script",instance:r,count:1,state:null},i.set(a,r))}}function rb(t,e){pi.M(t,e);var n=us;if(n&&t){var i=$r(n).hoistableScripts,a=ds(t),r=i.get(a);r||(r=n.querySelector(tl(a)),r||(t=Rt({src:t,async:!0,type:"module"},e),(e=cn.get(a))&&c1(t,e),r=n.createElement("script"),Jt(r),re(r,"link",t),n.head.appendChild(r)),r={type:"script",instance:r,count:1,state:null},i.set(a,r))}}function fy(t,e,n,i){var a=(a=Pi.current)?Vc(a):null;if(!a)throw Error(_(446));switch(t){case"meta":case"title":return null;case"style":return typeof n.precedence=="string"&&typeof n.href=="string"?(e=is(n.href),n=$r(a).hoistableStyles,i=n.get(e),i||(i={type:"style",instance:null,count:0,state:null},n.set(e,i)),i):{type:"void",instance:null,count:0,state:null};case"link":if(n.rel==="stylesheet"&&typeof n.href=="string"&&typeof n.precedence=="string"){t=is(n.href);var r=$r(a).hoistableStyles,s=r.get(t);if(s||(a=a.ownerDocument||a,s={type:"stylesheet",instance:null,count:0,state:{loading:0,preload:null}},r.set(t,s),(r=a.querySelector(Wo(t)))&&!r._p&&(s.instance=r,s.state.loading=5),cn.has(t)||(n={rel:"preload",as:"style",href:n.href,crossOrigin:n.crossOrigin,integrity:n.integrity,media:n.media,hrefLang:n.hrefLang,referrerPolicy:n.referrerPolicy},cn.set(t,n),r||sb(a,t,n,s.state))),e&&i===null)throw Error(_(528,""));return s}if(e&&i!==null)throw Error(_(529,""));return null;case"script":return e=n.async,n=n.src,typeof n=="string"&&e&&typeof e!="function"&&typeof e!="symbol"?(e=ds(n),n=$r(a).hoistableScripts,i=n.get(e),i||(i={type:"script",instance:null,count:0,state:null},n.set(e,i)),i):{type:"void",instance:null,count:0,state:null};default:throw Error(_(444,t))}}function is(t){return'href="'+an(t)+'"'}function Wo(t){return'link[rel="stylesheet"]['+t+"]"}function t5(t){return Rt({},t,{"data-precedence":t.precedence,precedence:null})}function sb(t,e,n,i){t.querySelector('link[rel="preload"][as="style"]['+e+"]")?i.loading=1:(e=t.createElement("link"),i.preload=e,e.addEventListener("load",function(){return i.loading|=1}),e.addEventListener("error",function(){return i.loading|=2}),re(e,"link",n),Jt(e),t.head.appendChild(e))}function ds(t){return'[src="'+an(t)+'"]'}function tl(t){return"script[async]"+t}function hy(t,e,n){if(e.count++,e.instance===null)switch(e.type){case"style":var i=t.querySelector('style[data-href~="'+an(n.href)+'"]');if(i)return e.instance=i,Jt(i),i;var a=Rt({},n,{"data-href":n.href,"data-precedence":n.precedence,href:null,precedence:null});return i=(t.ownerDocument||t).createElement("style"),Jt(i),re(i,"style",a),yc(i,n.precedence,t),e.instance=i;case"stylesheet":a=is(n.href);var r=t.querySelector(Wo(a));if(r)return e.state.loading|=4,e.instance=r,Jt(r),r;i=t5(n),(a=cn.get(a))&&l1(i,a),r=(t.ownerDocument||t).createElement("link"),Jt(r);var s=r;return s._p=new Promise(function(o,l){s.onload=o,s.onerror=l}),re(r,"link",i),e.state.loading|=4,yc(r,n.precedence,t),e.instance=r;case"script":return r=ds(n.src),(a=t.querySelector(tl(r)))?(e.instance=a,Jt(a),a):(i=n,(a=cn.get(r))&&(i=Rt({},n),c1(i,a)),t=t.ownerDocument||t,a=t.createElement("script"),Jt(a),re(a,"link",i),t.head.appendChild(a),e.instance=a);case"void":return null;default:throw Error(_(443,e.type))}else e.type==="stylesheet"&&(e.state.loading&4)===0&&(i=e.instance,e.state.loading|=4,yc(i,n.precedence,t));return e.instance}function yc(t,e,n){for(var i=n.querySelectorAll('link[rel="stylesheet"][data-precedence],style[data-precedence]'),a=i.length?i[i.length-1]:null,r=a,s=0;s<i.length;s++){var o=i[s];if(o.dataset.precedence===e)r=o;else if(r!==a)break}r?r.parentNode.insertBefore(t,r.nextSibling):(e=n.nodeType===9?n.head:n,e.insertBefore(t,e.firstChild))}function l1(t,e){t.crossOrigin==null&&(t.crossOrigin=e.crossOrigin),t.referrerPolicy==null&&(t.referrerPolicy=e.referrerPolicy),t.title==null&&(t.title=e.title)}function c1(t,e){t.crossOrigin==null&&(t.crossOrigin=e.crossOrigin),t.referrerPolicy==null&&(t.referrerPolicy=e.referrerPolicy),t.integrity==null&&(t.integrity=e.integrity)}var xc=null;function gy(t,e,n){if(xc===null){var i=new Map,a=xc=new Map;a.set(n,i)}else a=xc,i=a.get(n),i||(i=new Map,a.set(n,i));if(i.has(t))return i;for(i.set(t,null),n=n.getElementsByTagName(t),a=0;a<n.length;a++){var r=n[a];if(!(r[qo]||r[ne]||t==="link"&&r.getAttribute("rel")==="stylesheet")&&r.namespaceURI!=="http://www.w3.org/2000/svg"){var s=r.getAttribute(e)||"";s=t+s;var o=i.get(s);o?o.push(r):i.set(s,[r])}}return i}function my(t,e,n){t=t.ownerDocument||t,t.head.insertBefore(n,e==="title"?t.querySelector("head > title"):null)}function ob(t,e,n){if(n===1||e.itemProp!=null)return!1;switch(t){case"meta":case"title":return!0;case"style":if(typeof e.precedence!="string"||typeof e.href!="string"||e.href==="")break;return!0;case"link":if(typeof e.rel!="string"||typeof e.href!="string"||e.href===""||e.onLoad||e.onError)break;return e.rel==="stylesheet"?(t=e.disabled,typeof e.precedence=="string"&&t==null):!0;case"script":if(e.async&&typeof e.async!="function"&&typeof e.async!="symbol"&&!e.onLoad&&!e.onError&&e.src&&typeof e.src=="string")return!0}return!1}function e5(t){return!(t.type==="stylesheet"&&(t.state.loading&3)===0)}function lb(t,e,n,i){if(n.type==="stylesheet"&&(typeof i.media!="string"||matchMedia(i.media).matches!==!1)&&(n.state.loading&4)===0){if(n.instance===null){var a=is(i.href),r=e.querySelector(Wo(a));if(r){e=r._p,e!==null&&typeof e=="object"&&typeof e.then=="function"&&(t.count++,t=Gc.bind(t),e.then(t,t)),n.state.loading|=4,n.instance=r,Jt(r);return}r=e.ownerDocument||e,i=t5(i),(a=cn.get(a))&&l1(i,a),r=r.createElement("link"),Jt(r);var s=r;s._p=new Promise(function(o,l){s.onload=o,s.onerror=l}),re(r,"link",i),n.instance=r}t.stylesheets===null&&(t.stylesheets=new Map),t.stylesheets.set(n,e),(e=n.state.preload)&&(n.state.loading&3)===0&&(t.count++,n=Gc.bind(t),e.addEventListener("load",n),e.addEventListener("error",n))}}var kp=0;function cb(t,e){return t.stylesheets&&t.count===0&&vc(t,t.stylesheets),0<t.count||0<t.imgCount?function(n){var i=setTimeout(function(){if(t.stylesheets&&vc(t,t.stylesheets),t.unsuspend){var r=t.unsuspend;t.unsuspend=null,r()}},6e4+e);0<t.imgBytes&&kp===0&&(kp=62500*Hv());var a=setTimeout(function(){if(t.waitingForImages=!1,t.count===0&&(t.stylesheets&&vc(t,t.stylesheets),t.unsuspend)){var r=t.unsuspend;t.unsuspend=null,r()}},(t.imgBytes>kp?50:800)+e);return t.unsuspend=n,function(){t.unsuspend=null,clearTimeout(i),clearTimeout(a)}}:null}function Gc(){if(this.count--,this.count===0&&(this.imgCount===0||!this.waitingForImages)){if(this.stylesheets)vc(this,this.stylesheets);else if(this.unsuspend){var t=this.unsuspend;this.unsuspend=null,t()}}}var qc=null;function vc(t,e){t.stylesheets=null,t.unsuspend!==null&&(t.count++,qc=new Map,e.forEach(ub,t),qc=null,Gc.call(t))}function ub(t,e){if(!(e.state.loading&4)){var n=qc.get(t);if(n)var i=n.get(null);else{n=new Map,qc.set(t,n);for(var a=t.querySelectorAll("link[data-precedence],style[data-precedence]"),r=0;r<a.length;r++){var s=a[r];(s.nodeName==="LINK"||s.getAttribute("media")!=="not all")&&(n.set(s.dataset.precedence,s),i=s)}i&&n.set(null,i)}a=e.instance,s=a.getAttribute("data-precedence"),r=n.get(s)||i,r===i&&n.set(null,a),n.set(s,a),this.count++,i=Gc.bind(this),a.addEventListener("load",i),a.addEventListener("error",i),r?r.parentNode.insertBefore(a,r.nextSibling):(t=t.nodeType===9?t.head:t,t.insertBefore(a,t.firstChild)),e.state.loading|=4}}var jo={$$typeof:ei,Provider:null,Consumer:null,_currentValue:Ca,_currentValue2:Ca,_threadCount:0};function db(t,e,n,i,a,r,s,o,l){this.tag=1,this.containerInfo=t,this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.next=this.pendingContext=this.context=this.cancelPendingCommit=null,this.callbackPriority=0,this.expirationTimes=qd(-1),this.entangledLanes=this.shellSuspendCounter=this.errorRecoveryDisabledLanes=this.expiredLanes=this.warmLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=qd(0),this.hiddenUpdates=qd(null),this.identifierPrefix=i,this.onUncaughtError=a,this.onCaughtError=r,this.onRecoverableError=s,this.pooledCache=null,this.pooledCacheLanes=0,this.formState=l,this.incompleteTransitions=new Map}function n5(t,e,n,i,a,r,s,o,l,c,u,d){return t=new db(t,e,n,s,l,c,u,d,o),e=1,r===!0&&(e|=24),r=$e(3,null,null,e),t.current=r,r.stateNode=t,e=Of(),e.refCount++,t.pooledCache=e,e.refCount++,r.memoizedState={element:i,isDehydrated:n,cache:e},Nf(r),t}function i5(t){return t?(t=Lr,t):Lr}function a5(t,e,n,i,a,r){a=i5(a),i.context===null?i.context=a:i.pendingContext=a,i=$i(e),i.payload={element:n},r=r===void 0?null:r,r!==null&&(i.callback=r),n=Ui(t,i,e),n!==null&&(Me(n,t,e),bo(n,t,e))}function yy(t,e){if(t=t.memoizedState,t!==null&&t.dehydrated!==null){var n=t.retryLane;t.retryLane=n!==0&&n<e?n:e}}function u1(t,e){yy(t,e),(t=t.alternate)&&yy(t,e)}function r5(t){if(t.tag===13||t.tag===31){var e=La(t,67108864);e!==null&&Me(e,t,67108864),u1(t,67108864)}}function xy(t){if(t.tag===13||t.tag===31){var e=Ge();e=kf(e);var n=La(t,e);n!==null&&Me(n,t,e),u1(t,e)}}var Xc=!0;function pb(t,e,n,i){var a=V.T;V.T=null;var r=ht.p;try{ht.p=2,d1(t,e,n,i)}finally{ht.p=r,V.T=a}}function fb(t,e,n,i){var a=V.T;V.T=null;var r=ht.p;try{ht.p=8,d1(t,e,n,i)}finally{ht.p=r,V.T=a}}function d1(t,e,n,i){if(Xc){var a=mf(i);if(a===null)vp(t,e,i,Kc,n),vy(t,i);else if(gb(a,t,e,n,i))i.stopPropagation();else if(vy(t,i),e&4&&-1<hb.indexOf(t)){for(;a!==null;){var r=ss(a);if(r!==null)switch(r.tag){case 3:if(r=r.stateNode,r.current.memoizedState.isDehydrated){var s=ka(r.pendingLanes);if(s!==0){var o=r;for(o.pendingLanes|=2,o.entangledLanes|=2;s;){var l=1<<31-Ve(s);o.entanglements[1]|=l,s&=~l}Fn(r),(ft&6)===0&&(Nc=He()+500,Jo(0,!1))}}break;case 31:case 13:o=La(r,2),o!==null&&Me(o,r,2),lu(),u1(r,2)}if(r=mf(i),r===null&&vp(t,e,i,Kc,n),r===a)break;a=r}a!==null&&i.stopPropagation()}else vp(t,e,i,null,n)}}function mf(t){return t=Sf(t),p1(t)}var Kc=null;function p1(t){if(Kc=null,t=Rr(t),t!==null){var e=Ho(t);if(e===null)t=null;else{var n=e.tag;if(n===13){if(t=Sy(e),t!==null)return t;t=null}else if(n===31){if(t=Ay(e),t!==null)return t;t=null}else if(n===3){if(e.stateNode.current.memoizedState.isDehydrated)return e.tag===3?e.stateNode.containerInfo:null;t=null}else e!==t&&(t=null)}}return Kc=t,null}function s5(t){switch(t){case"beforetoggle":case"cancel":case"click":case"close":case"contextmenu":case"copy":case"cut":case"auxclick":case"dblclick":case"dragend":case"dragstart":case"drop":case"focusin":case"focusout":case"input":case"invalid":case"keydown":case"keypress":case"keyup":case"mousedown":case"mouseup":case"paste":case"pause":case"play":case"pointercancel":case"pointerdown":case"pointerup":case"ratechange":case"reset":case"resize":case"seeked":case"submit":case"toggle":case"touchcancel":case"touchend":case"touchstart":case"volumechange":case"change":case"selectionchange":case"textInput":case"compositionstart":case"compositionend":case"compositionupdate":case"beforeblur":case"afterblur":case"beforeinput":case"blur":case"fullscreenchange":case"focus":case"hashchange":case"popstate":case"select":case"selectstart":return 2;case"drag":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"mousemove":case"mouseout":case"mouseover":case"pointermove":case"pointerout":case"pointerover":case"scroll":case"touchmove":case"wheel":case"mouseenter":case"mouseleave":case"pointerenter":case"pointerleave":return 8;case"message":switch(e9()){case By:return 2;case Ry:return 8;case Cc:case n9:return 32;case Dy:return 268435456;default:return 32}default:return 32}}var yf=!1,Vi=null,Gi=null,qi=null,$o=new Map,Uo=new Map,Ii=[],hb="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset".split(" ");function vy(t,e){switch(t){case"focusin":case"focusout":Vi=null;break;case"dragenter":case"dragleave":Gi=null;break;case"mouseover":case"mouseout":qi=null;break;case"pointerover":case"pointerout":$o.delete(e.pointerId);break;case"gotpointercapture":case"lostpointercapture":Uo.delete(e.pointerId)}}function lo(t,e,n,i,a,r){return t===null||t.nativeEvent!==r?(t={blockedOn:e,domEventName:n,eventSystemFlags:i,nativeEvent:r,targetContainers:[a]},e!==null&&(e=ss(e),e!==null&&r5(e)),t):(t.eventSystemFlags|=i,e=t.targetContainers,a!==null&&e.indexOf(a)===-1&&e.push(a),t)}function gb(t,e,n,i,a){switch(e){case"focusin":return Vi=lo(Vi,t,e,n,i,a),!0;case"dragenter":return Gi=lo(Gi,t,e,n,i,a),!0;case"mouseover":return qi=lo(qi,t,e,n,i,a),!0;case"pointerover":var r=a.pointerId;return $o.set(r,lo($o.get(r)||null,t,e,n,i,a)),!0;case"gotpointercapture":return r=a.pointerId,Uo.set(r,lo(Uo.get(r)||null,t,e,n,i,a)),!0}return!1}function o5(t){var e=Rr(t.target);if(e!==null){var n=Ho(e);if(n!==null){if(e=n.tag,e===13){if(e=Sy(n),e!==null){t.blockedOn=e,nm(t.priority,function(){xy(n)});return}}else if(e===31){if(e=Ay(n),e!==null){t.blockedOn=e,nm(t.priority,function(){xy(n)});return}}else if(e===3&&n.stateNode.current.memoizedState.isDehydrated){t.blockedOn=n.tag===3?n.stateNode.containerInfo:null;return}}}t.blockedOn=null}function bc(t){if(t.blockedOn!==null)return!1;for(var e=t.targetContainers;0<e.length;){var n=mf(t.nativeEvent);if(n===null){n=t.nativeEvent;var i=new n.constructor(n.type,n);Fp=i,n.target.dispatchEvent(i),Fp=null}else return e=ss(n),e!==null&&r5(e),t.blockedOn=n,!1;e.shift()}return!0}function by(t,e,n){bc(t)&&n.delete(e)}function mb(){yf=!1,Vi!==null&&bc(Vi)&&(Vi=null),Gi!==null&&bc(Gi)&&(Gi=null),qi!==null&&bc(qi)&&(qi=null),$o.forEach(by),Uo.forEach(by)}function ac(t,e){t.blockedOn===e&&(t.blockedOn=null,yf||(yf=!0,Xt.unstable_scheduleCallback(Xt.unstable_NormalPriority,mb)))}var rc=null;function ky(t){rc!==t&&(rc=t,Xt.unstable_scheduleCallback(Xt.unstable_NormalPriority,function(){rc===t&&(rc=null);for(var e=0;e<t.length;e+=3){var n=t[e],i=t[e+1],a=t[e+2];if(typeof i!="function"){if(p1(i||n)===null)continue;break}var r=ss(n);r!==null&&(t.splice(e,3),e-=3,Zp(r,{pending:!0,data:a,method:n.method,action:i},i,a))}}))}function as(t){function e(l){return ac(l,t)}Vi!==null&&ac(Vi,t),Gi!==null&&ac(Gi,t),qi!==null&&ac(qi,t),$o.forEach(e),Uo.forEach(e);for(var n=0;n<Ii.length;n++){var i=Ii[n];i.blockedOn===t&&(i.blockedOn=null)}for(;0<Ii.length&&(n=Ii[0],n.blockedOn===null);)o5(n),n.blockedOn===null&&Ii.shift();if(n=(t.ownerDocument||t).$$reactFormReplay,n!=null)for(i=0;i<n.length;i+=3){var a=n[i],r=n[i+1],s=a[_e]||null;if(typeof r=="function")s||ky(n);else if(s){var o=null;if(r&&r.hasAttribute("formAction")){if(a=r,s=r[_e]||null)o=s.formAction;else if(p1(a)!==null)continue}else o=s.action;typeof o=="function"?n[i+1]=o:(n.splice(i,3),i-=3),ky(n)}}}function l5(){function t(r){r.canIntercept&&r.info==="react-transition"&&r.intercept({handler:function(){return new Promise(function(s){return a=s})},focusReset:"manual",scroll:"manual"})}function e(){a!==null&&(a(),a=null),i||setTimeout(n,20)}function n(){if(!i&&!navigation.transition){var r=navigation.currentEntry;r&&r.url!=null&&navigation.navigate(r.url,{state:r.getState(),info:"react-transition",history:"replace"})}}if(typeof navigation=="object"){var i=!1,a=null;return navigation.addEventListener("navigate",t),navigation.addEventListener("navigatesuccess",e),navigation.addEventListener("navigateerror",e),setTimeout(n,100),function(){i=!0,navigation.removeEventListener("navigate",t),navigation.removeEventListener("navigatesuccess",e),navigation.removeEventListener("navigateerror",e),a!==null&&(a(),a=null)}}}function f1(t){this._internalRoot=t}du.prototype.render=f1.prototype.render=function(t){var e=this._internalRoot;if(e===null)throw Error(_(409));var n=e.current,i=Ge();a5(n,i,t,e,null,null)};du.prototype.unmount=f1.prototype.unmount=function(){var t=this._internalRoot;if(t!==null){this._internalRoot=null;var e=t.containerInfo;a5(t.current,2,null,t,null,null),lu(),e[rs]=null}};function du(t){this._internalRoot=t}du.prototype.unstable_scheduleHydration=function(t){if(t){var e=Ly();t={blockedOn:null,target:t,priority:e};for(var n=0;n<Ii.length&&e!==0&&e<Ii[n].priority;n++);Ii.splice(n,0,t),n===0&&o5(t)}};var Ey=wy.version;if(Ey!=="19.2.6")throw Error(_(527,Ey,"19.2.6"));ht.findDOMNode=function(t){var e=t._reactInternals;if(e===void 0)throw typeof t.render=="function"?Error(_(188)):(t=Object.keys(t).join(","),Error(_(268,t)));return t=X7(e),t=t!==null?Ty(t):null,t=t===null?null:t.stateNode,t};var yb={bundleType:0,version:"19.2.6",rendererPackageName:"react-dom",currentDispatcherRef:V,reconcilerVersion:"19.2.6"};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<"u"&&(co=__REACT_DEVTOOLS_GLOBAL_HOOK__,!co.isDisabled&&co.supportsFiber))try{Yo=co.inject(yb),Ye=co}catch{}var co;pu.createRoot=function(t,e){if(!Cy(t))throw Error(_(299));var n=!1,i="",a=W2,r=t6,s=e6;return e!=null&&(e.unstable_strictMode===!0&&(n=!0),e.identifierPrefix!==void 0&&(i=e.identifierPrefix),e.onUncaughtError!==void 0&&(a=e.onUncaughtError),e.onCaughtError!==void 0&&(r=e.onCaughtError),e.onRecoverableError!==void 0&&(s=e.onRecoverableError)),e=n5(t,1,!1,null,null,n,i,null,a,r,s,l5),t[rs]=e.current,o1(t),new f1(e)};pu.hydrateRoot=function(t,e,n){if(!Cy(t))throw Error(_(299));var i=!1,a="",r=W2,s=t6,o=e6,l=null;return n!=null&&(n.unstable_strictMode===!0&&(i=!0),n.identifierPrefix!==void 0&&(a=n.identifierPrefix),n.onUncaughtError!==void 0&&(r=n.onUncaughtError),n.onCaughtError!==void 0&&(s=n.onCaughtError),n.onRecoverableError!==void 0&&(o=n.onRecoverableError),n.formState!==void 0&&(l=n.formState)),e=n5(t,1,!0,e,n??null,i,a,l,r,s,o,l5),e.context=i5(null),n=e.current,i=Ge(),i=kf(i),a=$i(i),a.callback=null,Ui(n,a,i),n=i,e.current.lanes=n,Go(e,n),Fn(e),t[rs]=e.current,o1(t),new du(e)};pu.version="19.2.6"});var p5=An((IT,d5)=>{"use strict";function u5(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(u5)}catch(t){console.error(t)}}u5(),d5.exports=c5()});var a4=An(wu=>{"use strict";var _E=Symbol.for("react.transitional.element"),BE=Symbol.for("react.fragment");function i4(t,e,n){var i=null;if(n!==void 0&&(i=""+n),e.key!==void 0&&(i=""+e.key),"key"in e){n={};for(var a in e)a!=="key"&&(n[a]=e[a])}else n=e;return e=n.ref,{$$typeof:_E,type:t,key:i,ref:e!==void 0?e:null,props:n}}wu.Fragment=BE;wu.jsx=i4;wu.jsxs=i4});var yi=An((NM,r4)=>{"use strict";r4.exports=a4()});var dA={};wi(dA,{TraceMindPlugin:()=>Lu,default:()=>uA});module.exports=x8(dA);var Ke=require("obsidian");var lt=require("obsidian");var yh={providers:[],defaultProviderId:"",agentProviderMapping:{analysis:"",chat:""},localAgentEnabled:!1,exploration:{enabled:!1,availableAgents:[],defaultAgent:""},actionBoard:{enabled:!0,defaultAgent:""}};function wl(t,e){return!(!t.exploration.enabled||t.exploration.availableAgents.length===0||!t.exploration.defaultAgent||e&&!e.features.includes("exploration"))}Ci();var k8=[{test:t=>t.includes("API Key")||t.includes("Invalid API key")||t.includes("invalid x-api-key")||t.includes("Incorrect API key"),prefix:"API Key \u65E0\u6548\u6216\u672A\u914D\u7F6E\uFF0C\u8BF7\u68C0\u67E5 API Key \u662F\u5426\u6B63\u786E"},{test:t=>t.includes("401"),prefix:"\u8BA4\u8BC1\u5931\u8D25 (HTTP 401)\uFF0C\u8BF7\u68C0\u67E5 API Key \u548C\u6743\u9650"},{test:t=>t.includes("403"),prefix:"\u6743\u9650\u4E0D\u8DB3 (HTTP 403)\uFF0C\u8BF7\u68C0\u67E5 API Key \u662F\u5426\u6709\u8BBF\u95EE\u6743\u9650"},{test:t=>t.includes("429"),prefix:"\u8BF7\u6C42\u9891\u7387\u8D85\u9650 (HTTP 429)\uFF0C\u8BF7\u7A0D\u540E\u91CD\u8BD5\u6216\u68C0\u67E5 API \u989D\u5EA6"},{test:t=>t.includes("model")&&(t.includes("not found")||t.includes("does not exist")||t.includes("\u6A21\u578B")),prefix:"\u6A21\u578B\u540D\u79F0\u65E0\u6548\u6216\u4E0D\u53EF\u7528\uFF0C\u8BF7\u68C0\u67E5\u6A21\u578B\u540D\u79F0\u662F\u5426\u6B63\u786E"},{test:t=>(t.includes("fetch failed")||t.includes("Failed to fetch")||t.includes("ENOTFOUND")||t.includes("ECONNREFUSED"))&&(t.includes("localhost:11434")||t.includes("127.0.0.1:11434")),prefix:"\u65E0\u6CD5\u8FDE\u63A5 Ollama\uFF0C\u8BF7\u786E\u8BA4 Ollama \u5DF2\u542F\u52A8 (localhost:11434)"},{test:t=>t.includes("fetch failed")||t.includes("Failed to fetch")||t.includes("ENOTFOUND")||t.includes("ECONNREFUSED"),prefix:"\u7F51\u7EDC\u8FDE\u63A5\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5 Base URL \u548C\u7F51\u7EDC\u8FDE\u63A5"},{test:t=>t.includes("timeout")||t.includes("ETIMEDOUT"),prefix:"\u8FDE\u63A5\u8D85\u65F6\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC\u6216 Base URL \u662F\u5426\u6B63\u786E"}];function vh(t){let e=t instanceof Error?t.message:String(t);for(let n of k8)if(n.test(e))return`${n.prefix}
(${e.slice(0,150)})`;return`\u8FDE\u63A5\u5931\u8D25: ${e.slice(0,200)}`}function bh(t,e,n){let i=t.providers.map(a=>a.id===e?{...a,...n,id:e}:a);return{...t,providers:i}}function kh(t,e){let n=t.providers.filter(r=>r.id!==e),i=t.defaultProviderId;i===e&&(i=n[0]?.id||"");let a={...t.agentProviderMapping};return a.analysis===e&&(a.analysis=""),a.chat===e&&(a.chat=""),{...t,providers:n,defaultProviderId:i,agentProviderMapping:a}}sd();mr();var{spawn:B8}=require("child_process"),Ah="codex",R8=600*1e3;function D8(t,e){let n=["exec","--skip-git-repo-check"];return e?.model&&n.push("--model",e.model),n.push(t),n}var Th={name:"Codex",description:"OpenAI Codex CLI\uFF0C\u672C\u5730\u6267\u884C\u601D\u8003\u63A2\u7D22 Agent action",async detect(){return!!await ge(Ah)},execute(t,e){let n=null,i=!1,a=null,r=null,s=null,o=Date.now();return(async()=>{try{let c=await ge(Ah);if(!c){let x=new Error("\u627E\u4E0D\u5230 codex CLI\uFF0C\u8BF7\u786E\u8BA4\u5DF2\u5B89\u88C5 Codex");s?.(x),r?.({status:"failed",output:"",error:x.message,durationMs:Date.now()-o});return}let u=D8(t,e),d={...process.env,...e?.env};if(n=B8(c,u,{cwd:e?.cwd||process.cwd(),env:d,stdio:["ignore","pipe","pipe"]}),i){n.kill();return}let p=setTimeout(()=>{n&&!n.killed&&(n.kill(),r?.({status:"timeout",output:"",error:"\u6267\u884C\u8D85\u65F6",durationMs:Date.now()-o}))},e?.timeoutMs||R8),f="",y="";n.stdout?.on("data",x=>{let E=x.toString();f+=E,a?.({type:"text",content:E})}),n.stderr?.on("data",x=>{y+=x.toString()}),n.on("error",x=>{clearTimeout(p),s?.(x),r?.({status:"failed",output:f,error:x.message,durationMs:Date.now()-o})}),n.on("close",x=>{clearTimeout(p),!i&&r?.(x===0?{status:"completed",output:f.trim(),durationMs:Date.now()-o}:{status:"failed",output:f.trim(),error:`codex \u9000\u51FA\u7801 ${x}: ${y.slice(0,500)}`,durationMs:Date.now()-o})})}catch(c){s?.(c),r?.({status:"failed",output:"",error:c.message,durationMs:Date.now()-o})}})(),{set onMessage(c){a=c},get onMessage(){return a},set onDone(c){r=c},get onDone(){return r},set onError(c){s=c},get onError(){return s},abort(){i=!0,n&&!n.killed&&n.kill()}}}};ld();mr();var{spawn:z8}=require("child_process"),L8=require("readline"),Si=require("fs"),Ys=require("path"),Bh="opencode",N8=600*1e3;function P8(t,e){let n=["run","--format","json"];return e?.model&&n.push("--model",e.model),n.push(t),n}function j8(t,e,n){let i=t.trim();if(!e||cd(i))return i;if(!i){let o=$8(e,n);return o||i}let a=Y8(i);if(!a)return i;let r=Ys.resolve(e,a),s=Ys.resolve(e);if(r!==s&&!r.startsWith(`${s}${Ys.sep}`)||!Si.existsSync(r)||!Si.statSync(r).isFile())return i;try{let o=Si.readFileSync(r,"utf-8").trim();return cd(o)?o:i}catch{return i}}function $8(t,e){let n=Ys.resolve(t),i=U8(n).filter(a=>H8(a)).map(a=>Ys.join(n,a)).filter(a=>{try{let r=Si.statSync(a);return r.isFile()?typeof e!="number"||r.mtimeMs>=e-1e3:!1}catch{return!1}}).sort((a,r)=>Si.statSync(r).mtimeMs-Si.statSync(a).mtimeMs);for(let a of i)try{let r=Si.readFileSync(a,"utf-8").trim();if(cd(r))return r}catch{continue}return null}function U8(t){try{return Si.readdirSync(t)}catch{return[]}}function H8(t){return/(?:^|[-_])(output|result)\.json$/i.test(t)||/^(decision_tree|brainstorm|brainstorming|mind_map|mindmap|user_map|frame_problem|tracemind)[\w.-]*\.json$/i.test(t)}function cd(t){return t.startsWith("{")||t.startsWith("```json")||t.startsWith("```")}function Y8(t){return[...t.matchAll(/`([^`]+\.json)`|([\w./-]+\.json)/gi)].map(n=>n[1]||n[2]).filter(Boolean)[0]||null}function V8(t){let e=t.part;return!e||e.type!=="text"||typeof e.text!="string"?"":e.text}var Rh={name:"OpenCode",description:"OpenCode \u672C\u5730 Agent\uFF0C\u901A\u8FC7 opencode CLI \u8C03\u7528",async detect(){return!!await ge(Bh)},execute(t,e){let n=null,i=!1,a=null,r=null,s=null,o=Date.now();return(async()=>{try{let c=await ge(Bh);if(!c){let h=new Error("\u627E\u4E0D\u5230 opencode CLI\uFF0C\u8BF7\u786E\u8BA4\u5DF2\u5B89\u88C5 OpenCode");s?.(h),r?.({status:"failed",output:"",error:h.message,durationMs:Date.now()-o});return}let u={...process.env,...e?.env},d=P8(t,e);if(n=z8(c,d,{cwd:e?.cwd||process.cwd(),env:u,stdio:["ignore","pipe","pipe"]}),i){n.kill();return}let p="",f="",y=!1,x=h=>{y||(y=!0,r?.(h))},E=setTimeout(()=>{n&&!n.killed&&n.kill(),x({status:"timeout",output:p.trim(),error:"\u6267\u884C\u8D85\u65F6",durationMs:Date.now()-o})},e?.timeoutMs||N8);L8.createInterface({input:n.stdout,crlfDelay:1/0}).on("line",h=>{let b=h.trim();if(b)try{let w=JSON.parse(b),B=V8(w);w.sessionID&&a?.({type:"status",content:w.type||"running",sessionId:w.sessionID}),B?(p+=B,a?.({type:"text",content:B})):w.part?.type==="tool"?a?.({type:"tool-use",toolName:w.part.title||w.part.command||"opencode-tool"}):w.error&&a?.({type:"error",content:w.error})}catch{p+=h+`
`,a?.({type:"text",content:h+`
`})}}),n.stderr?.on("data",h=>{f+=h.toString()}),n.on("error",h=>{clearTimeout(E),s?.(h),x({status:"failed",output:p.trim(),error:h.message,durationMs:Date.now()-o})}),n.on("close",h=>{clearTimeout(E),!i&&x(h===0?{status:"completed",output:j8(p,e?.cwd,o),durationMs:Date.now()-o}:{status:"failed",output:p.trim(),error:`opencode \u9000\u51FA\u7801 ${h}: ${f.slice(0,500)}`,durationMs:Date.now()-o})})}catch(c){s?.(c),r?.({status:"failed",output:"",error:c.message,durationMs:Date.now()-o})}})(),{set onMessage(c){a=c},get onMessage(){return a},set onDone(c){r=c},get onDone(){return r},set onError(c){s=c},get onError(){return s},abort(){i=!0,n&&!n.killed&&n.kill()}}}};mr();var{spawn:G8}=require("child_process"),q8=require("readline"),Dh="pi",X8=600*1e3;function K8(t,e){let n=["--mode","json"];return e?.model&&n.push("--model",e.model),n.push(t),n}function Z8(t){return typeof t=="string"?t:Array.isArray(t)?t.map(e=>{if(typeof e=="string")return e;if(!e||typeof e!="object")return"";let n=e;return typeof n.text=="string"?n.text:typeof n.content=="string"?n.content:""}).join(""):""}function Q8(t){let e=t.assistantMessageEvent;return t.type==="message_update"&&e?.type==="text_delta"&&typeof e.delta=="string"?e.delta:t.type==="message_update"&&typeof e?.text=="string"?e.text:(t.type==="message_end"||t.type==="turn_end")&&t.message?.role==="assistant"?Z8(t.message.content):""}var Ih={name:"Pi Agent",description:"Pi minimal terminal coding harness\uFF0C\u901A\u8FC7 pi CLI JSON event stream \u8C03\u7528",async detect(){return!!await ge(Dh)},execute(t,e){let n=null,i=!1,a=null,r=null,s=null,o=Date.now();return(async()=>{try{let c=await ge(Dh);if(!c){let b=new Error("\u627E\u4E0D\u5230 pi CLI\uFF0C\u8BF7\u786E\u8BA4\u5DF2\u5B89\u88C5 Pi Agent");s?.(b),r?.({status:"failed",output:"",error:b.message,durationMs:Date.now()-o});return}let u=ad(e?.env),d=K8(t,e);if(n=G8(c,d,{cwd:e?.cwd||process.cwd(),env:u,stdio:["ignore","pipe","pipe"]}),i){n.kill();return}let p="",f="",y=!1,x=!1,E=b=>{x||(x=!0,r?.(b))},v=setTimeout(()=>{n&&!n.killed&&n.kill(),E({status:"timeout",output:p.trim(),error:"\u6267\u884C\u8D85\u65F6",durationMs:Date.now()-o})},e?.timeoutMs||X8);q8.createInterface({input:n.stdout,crlfDelay:1/0}).on("line",b=>{let w=b.trim();if(w)try{let B=JSON.parse(w);if(B.type==="session"&&B.id){a?.({type:"status",content:"session",sessionId:B.id});return}if(B.type==="agent_start"||B.type==="turn_start"){a?.({type:"status",content:B.type});return}if(B.type==="tool_execution_start"){a?.({type:"tool-use",toolName:B.toolName||"pi-tool",toolInput:B.args});return}if(B.type==="tool_execution_end"){a?.({type:B.isError?"error":"tool-result",toolName:B.toolName||"pi-tool"});return}let j=Q8(B);j&&(B.type==="message_update"?(y=!0,p+=j,a?.({type:"text",content:j})):!y&&!p.trim()&&(p+=j,a?.({type:"text",content:j}))),B.errorMessage&&a?.({type:"error",content:B.errorMessage})}catch{p+=b+`
...
\u6682\u65E0\u4E92\u52A8\u8BB0\u5F55
{{/if}}
`;default:return"{{content}}"}}Hn();var dd="Daily/attachments",Lh="md|pdf|docx?|xlsx?|pptx?|txt|csv|json|html?|rtf";function pd(t){return t.replace(/[\\/:*?"<>|]/g,"_").split("").filter(n=>n.charCodeAt(0)>31&&n.charCodeAt(0)!==127).join("").trim()||"attachment"}function Nh(t,e){let n=pd(t),i=n.lastIndexOf("."),a=i>0?n.slice(0,i):n,r=i>0?n.slice(i):"",s=`${dd}/${a}${r}`;if(!e(s))return s;for(let o=1;o<100;o++)if(s=`${dd}/${a}-${o}${r}`,!e(s))return s;return`${dd}/${a}-${Date.now()}${r}`}function Ph(t){return i7(t)?`[[${t}|${t}]]`:`![[${t}]]`}function fd(t){let e=new RegExp(`!\\[\\[([^\\]\\|]+?\\.(?:${Lh})(?:#[^\\]\\|]+)?)(?:\\|[^\\]]*)?\\]\\]`,"gi");return t.replace(e,(n,i)=>`[[${i}|${i}]]`)}function i7(t){return new RegExp(`\\.(?:${Lh})(?:$|#)`,"i").test(t)}function jh(t,e,n,i){let a=t.slice(0,n),r=t.slice(i),s=a.length>0&&a[a.length-1]!==`
`?`
`:"",o=r.length>0&&r[0]!==`
`?`
`:"",l=a+s+e+o+r,c=a.length+s.length+e.length;return{value:l,cursor:c}}var ma="tracemind-logo",$h=`
...
`)}var S7=`\u4F60\u662F\u4E00\u4F4D\u6D1E\u5BDF\u529B\u654F\u9510\u7684\u65E5\u8BB0\u5206\u6790\u4E13\u5BB6\u3002\u7528\u6237\u6BCF\u5929\u8BB0\u5F55\u751F\u6D3B\u548C\u5DE5\u4F5C\u65E5\u8BB0\uFF0C\u4F60\u9700\u8981\u6839\u636E\u5F53\u5929\u7684\u65E5\u8BB0\u5185\u5BB9\uFF0C\u751F\u6210\u4E00\u4EFD\u7ED3\u6784\u5316\u7684"\u4ECA\u65E5\u6D1E\u5BDF"\u62A5\u544A\u3002
...
- \u6BCF\u4E2A\u7AE0\u8282\u5FC5\u987B\u6709\u5B9E\u8D28\u5185\u5BB9\uFF0C\u4E0D\u80FD\u53EA\u5199"\u65E0"
- \u57FA\u4E8E\u63D0\u4F9B\u7684\u65E5\u8BB0\u5185\u5BB9\u8FDB\u884C\u5206\u6790\uFF0C\u4E0D\u8981\u7F16\u9020
- \u4F7F\u7528\u4E2D\u6587`;function dg(t){let e=[];return e.push("## \u7528\u6237\u80CC\u666F"),e.push(t.profileContext||"\u6682\u65E0\u7528\u6237\u80CC\u666F\u4FE1\u606F"),e.push(""),e.push("## \u5B9E\u4F53\u6863\u6848\u6458\u8981"),e.push(t.entityIndexSummary||"\u6682\u65E0\u5B9E\u4F53\u6863\u6848"),e.push(""),e.push("## \u4ECA\u5929\u7684\u65E5\u8BB0"),e.push(t.todayBlocks||"(\u4ECA\u5929\u8FD8\u6CA1\u6709\u5199\u65E5\u8BB0)"),e.push(""),e.push("## \u524D\u4E00\u5929\u7684\u65E5\u8BB0"),e.push(t.yesterdayBlocks||"(\u524D\u4E00\u5929\u6CA1\u6709\u65E5\u8BB0)"),[{role:"system",content:S7},{role:"user",content:e.join(`
`)}]}async function Il(t,e){let n=t+"|||"+e,a=new TextEncoder().encode(n),r=await crypto.subtle.digest("SHA-256",a);return Array.from(new Uint8Array(r)).map(o=>o.toString(16).padStart(2,"0")).join("")}function pg(t){if(t.length===0)return"\u6682\u65E0\u5B9E\u4F53\u6863\u6848";let e=new Map;for(let r of t){let s=r.cardType||r.type||"unknown";e.has(s)||e.set(s,[]),e.get(s).push(r)}let n={person:"\u4EBA\u7269",object:"\u5BA2\u4F53",theme:"\u4E3B\u9898"},i=[],a=["person","object","theme"];for(let r of a){let s=e.get(r);if(!s||s.length===0)continue;let o=[...s].sort((u,d)=>new Date(d.lastUpdated).getTime()-new Date(u.lastUpdated).getTime()).slice(0,20),l=n[r]||r,c=o.map(u=>`${u.name}(${u.maturity||"L0"})`).join(", ");i.push(`${l}(${o.length}): ${c}`)}return i.join("; ")||"\u6682\u65E0\u5B9E\u4F53\u6863\u6848"}function fg(t){return typeof t=="string"?t.trim():""}function Ad(t,e){if(t.action!=="create_task_drafts")return[];let n=Array.isArray(t.tasks)?t.tasks:[],i=[];for(let a of n){let r=a,s=fg(r.title),o=fg(r.description||r.detail||r.summary);if(!(!s||!o)&&(i.push({title:s,description:o,source:e,status:"todo"}),i.length>=8))break}return i}function A7(t){let n=(t.match(/```(?:json)?\s*([\s\S]*?)```/i)?.[1]||t).trim();try{return JSON.parse(n)}catch{let i=n.indexOf("{"),a=n.lastIndexOf("}");if(i>=0&&a>i)return JSON.parse(n.slice(i,a+1));throw new Error("Agent \u8F93\u51FA\u4E2D\u672A\u627E\u5230\u6709\u6548\u4EFB\u52A1 JSON")}}function Td(t,e){let n=A7(t),i=Array.isArray(n)?n:Array.isArray(n.tasks)?n.tasks:[];return Ad({action:"create_task_drafts",tasks:i},e)}function hg(t){return["\u4F60\u662F TraceMind \u7684\u884C\u52A8\u4EFB\u52A1\u89C4\u5212\u52A9\u624B\u3002\u8BF7\u628A\u5F53\u524D\u65E5\u8BB0\u4E2D\u9002\u5408\u63A8\u8FDB\u7684\u4E8B\u9879\u6574\u7406\u6210\u884C\u52A8\u770B\u677F\u4EFB\u52A1\u8349\u7A3F\u3002","","\u8F93\u51FA\u8981\u6C42\uFF1A","- \u53EA\u8F93\u51FA\u5408\u6CD5 JSON\uFF0C\u4E0D\u8981 Markdown\uFF0C\u4E0D\u8981\u89E3\u91CA\u3002",'- JSON \u683C\u5F0F\uFF1A{"tasks":[{"title":"\u4EFB\u52A1\u6807\u9898","description":"\u4EFB\u52A1\u8BF4\u660E"}]}',"- \u4EFB\u52A1\u6570\u91CF\u63A7\u5236\u5728 1-6 \u4E2A\u3002","- title \u8981\u77ED\uFF0C\u50CF\u770B\u677F\u5361\u7247\u6807\u9898\u3002","- description \u8981\u8BF4\u660E\u76EE\u6807\u3001\u8F93\u5165\u6750\u6599\u3001\u671F\u671B\u4EA4\u4ED8\u7269\uFF1B\u5982\u679C\u6D89\u53CA\u94FE\u63A5\u3001\u9644\u4EF6\u3001\u672C\u5730\u6587\u4EF6\uFF0C\u5199\u6E05\u695A\u9700\u8981 agent \u89E3\u6790\u8FD9\u4E9B\u6750\u6599\u3002","- \u4E0D\u8981\u628A\u7EAF\u60F3\u6CD5\u3001\u60C5\u7EEA\u6216\u65E0\u9700\u884C\u52A8\u7684\u5185\u5BB9\u786C\u62C6\u6210\u4EFB\u52A1\u3002","",t.sourceTitle?`\u6765\u6E90\uFF1A${t.sourceTitle}`:"","\u5F53\u524D\u65E5\u8BB0\uFF1A",t.sourceContent||"\uFF08\u7A7A\uFF09","","\u7528\u6237\u8981\u6C42\uFF1A",t.userRequest].filter(Boolean).join(`
`)}function gg(t){return["\u4F60\u662F TraceMind \u7684\u6F5C\u5728\u4EFB\u52A1\u8BC6\u522B\u52A9\u624B\u3002\u8BF7\u4ECE\u65E5\u8BB0\u4E2D\u8BC6\u522B\u662F\u5426\u5B58\u5728\u9002\u5408\u8FDB\u5165\u884C\u52A8\u770B\u677F\u7684\u660E\u786E\u884C\u52A8\u9879\u3002","","\u5224\u65AD\u539F\u5219\uFF1A","- \u4FDD\u5B88\u8BC6\u522B\u3002\u53EA\u6709\u51FA\u73B0\u660E\u786E\u627F\u8BFA\u3001\u5F85\u529E\u3001\u4EA4\u4ED8\u7269\u3001\u8DDF\u8FDB\u4E8B\u9879\u6216\u53EF\u6267\u884C\u52A8\u4F5C\u65F6\u624D\u751F\u6210\u4EFB\u52A1\u3002","- \u4E0D\u8981\u628A\u666E\u901A\u60F3\u6CD5\u3001\u60C5\u7EEA\u3001\u611F\u53D7\u3001\u5224\u65AD\u3001\u7075\u611F\u3001\u4E8B\u5B9E\u8BB0\u5F55\u786C\u8F6C\u6210\u4EFB\u52A1\u3002","- \u5982\u679C\u53EA\u662F\u503C\u5F97\u601D\u8003\u4F46\u6CA1\u6709\u660E\u786E\u884C\u52A8\uFF0C\u4E0D\u8981\u751F\u6210\u4EFB\u52A1\u3002","- \u5982\u679C\u4EFB\u52A1\u6D89\u53CA\u7F51\u9875\u94FE\u63A5\u3001\u9644\u4EF6\u3001\u672C\u5730\u6587\u4EF6\u6216 vault \u6587\u4EF6\uFF0Cdescription \u5FC5\u987B\u5199\u660E\u9700\u8981\u89E3\u6790\u8FD9\u4E9B\u6750\u6599\u3002","- \u6BCF\u4E2A\u4EFB\u52A1\u5E94\u80FD\u88AB\u7528\u6237\u6216\u672C\u5730 Agent \u6267\u884C\uFF0C\u5E76\u6709\u6E05\u6670\u7ED3\u679C\u3002","","\u8F93\u51FA\u8981\u6C42\uFF1A","- \u53EA\u8F93\u51FA\u5408\u6CD5 JSON\uFF0C\u4E0D\u8981 Markdown\uFF0C\u4E0D\u8981\u89E3\u91CA\u3002",'- JSON \u683C\u5F0F\uFF1A{"tasks":[{"title":"\u4EFB\u52A1\u6807\u9898","description":"\u4EFB\u52A1\u8BF4\u660E"}]}','- \u6CA1\u6709\u660E\u786E\u4EFB\u52A1\u65F6\u8F93\u51FA\uFF1A{"tasks":[]}',"- \u4EFB\u52A1\u6570\u91CF\u63A7\u5236\u5728 1-4 \u4E2A\u3002","- title \u8981\u77ED\uFF0C\u50CF\u770B\u677F\u5361\u7247\u6807\u9898\u3002","- description \u8981\u8BF4\u660E\u76EE\u6807\u3001\u8F93\u5165\u6750\u6599\u3001\u671F\u671B\u4EA4\u4ED8\u7269\u3002","",t.sourceTitle?`\u6765\u6E90\uFF1A${t.sourceTitle}`:"","\u5F53\u524D\u65E5\u8BB0\uFF1A",t.sourceContent||"\uFF08\u7A7A\uFF09"].filter(Boolean).join(`
`)}function mg(){return["- create_task_drafts: \u5F53\u7528\u6237\u5E0C\u671B\u201C\u751F\u6210\u4EFB\u52A1/\u62C6\u6210\u884C\u52A8/\u8FDB\u5165\u884C\u52A8\u770B\u677F/\u5B89\u6392\u6267\u884C\u201D\u65F6\u4F7F\u7528\u3002",'  \u683C\u5F0F\uFF1A{"action":"create_task_drafts","tasks":[{"title":"\u4EFB\u52A1\u6807\u9898","description":"\u4EFB\u52A1\u8BF4\u660E\uFF0C\u5305\u542B\u76EE\u6807\u3001\u8F93\u5165\u6750\u6599\u548C\u4EA4\u4ED8\u7269"}]}',"  \u89C4\u5219\uFF1A\u53EA\u751F\u6210\u4EFB\u52A1\u8349\u7A3F\uFF0C\u4E0D\u8981\u76F4\u63A5\u4FDD\u5B58\uFF1BTraceMind \u4F1A\u5C55\u793A\u786E\u8BA4\u5361\u7247\uFF0C\u7531\u7528\u6237\u51B3\u5B9A\u662F\u5426\u52A0\u5165\u884C\u52A8\u770B\u677F\u3002"].join(`
...
\u53EA\u8FD4\u56DE\u5408\u6CD5 JSON\u3002`;try{let s=await i.chat([{role:"user",content:r}],"analysis"),o=this.extractJSON(s.content);return JSON.parse(o)}catch{return{}}}async parseClarificationResponse(e,n){let i=this.plugin.getAIProvider(),a=this.plugin.getUserProfileContext(),r=n.subtype?Qs(n.type,n.subtype)||n.subtype:"",s=r?`${n.type} / ${n.subtype}\uFF08${r}\uFF09`:n.type,o=["\u7528\u6237\u56DE\u7B54\u4E86\u5173\u4E8E\u300C"+n.name+"\u300D\uFF08\u7C7B\u578B\uFF1A"+s+"\uFF09\u7684\u6F84\u6E05\u95EE\u9898\u3002"];a&&(o.push(""),o.push(a),o.push(""),o.push("\u6839\u636E\u4E0A\u8FF0\u7528\u6237\u6863\u6848\uFF0C\u8BF7\u505A\u5408\u7406\u63A8\u65AD\u3002\u4F8B\u5982\uFF1A\u7528\u6237\u56DE\u7B54\u201C\u662F\u540C\u4E8B\u201D\uFF0C\u5219\u516C\u53F8\u5E94\u4E0E\u7528\u6237\u6863\u6848\u4E2D\u7684\u516C\u53F8\u76F8\u540C\u3002\u7528\u6237\u56DE\u7B54\u201C\u662F\u670B\u53CB\u201D\uFF0C\u5219\u5173\u7CFB\u4E3A friend\u3002")),o.push(""),o.push("\u7528\u6237\u56DE\u7B54\uFF1A"+e);let l=o.concat(["\u8BF7\u4ECE\u7528\u6237\u56DE\u7B54\u4E2D\u63D0\u53D6\u5173\u952E\u5C5E\u6027\u4FE1\u606F\u3002","","\u5F53\u524D\u5B9E\u4F53\u7C7B\u578B\u662F "+s+"\uFF0C\u53EF\u7528\u7684\u5C5E\u6027\u540D\u4E3A\uFF1A",ug(n.type,n.subtype),"","=== \u91CD\u8981\uFF1Aattributes \u5FC5\u987B\u662F\u5E73\u94FA\u7684 key-value\uFF0C\u4E0D\u8981\u5D4C\u5957===",'\u9519\u8BEF\u793A\u4F8B\uFF1A{ "person": { "company": "xxx" } }','\u6B63\u786E\u793A\u4F8B\uFF1A{ "company": "xxx", "role": "xxx" }',"","\u8FD4\u56DE\u4E00\u4E2A JSON \u5BF9\u8C61\uFF0C\u4F8B\u5982\u7528\u6237\u8BF4\u201C\u5F20\u4E09\u662F\u5B57\u8282\u8DF3\u52A8\u7684\u4EA7\u54C1\u7ECF\u7406\uFF0C\u662F\u6211\u540C\u4E8B\uFF0C\u53EB\u4ED6\u4E09\u54E5\u201D\uFF0C\u5219\u8FD4\u56DE\uFF1A","{",'  "acknowledgment": "\u660E\u767D\u4E86\uFF0C\u5F20\u4E09\u5728\u5B57\u8282\u8DF3\u52A8\u505A\u4EA7\u54C1\u7ECF\u7406\uFF0C\u662F\u4F60\u540C\u4E8B\u3002",','  "attributes": { "company": "\u5B57\u8282\u8DF3\u52A8", "role": "\u4EA7\u54C1\u7ECF\u7406", "relationship_to_user": "\u540C\u4E8B", "aliases": "\u4E09\u54E5" }',"}","","\u53EA\u8FD4\u56DE\u5408\u6CD5 JSON\uFF0C\u4E0D\u8981 markdown\u3002"]).join(`
...
`,document.head.appendChild(e)}};var G4=require("obsidian");vd();var P4=Le(xa()),j4=Le(p5());var A=Le(xa());qs();var xb=0;function vb(){return`edge-${Date.now()}-${++xb}`}function dt(t){return{id:t.id||vb(),from:t.from,to:t.to,type:t.type,label:t.label,agentRunId:t.agentRunId}}var bb=/https?:\/\/[^\s\]\)）"'，。；;]+/g,kb=/!?\[\[([^\]]+)\]\]/g,Eb=/(?:~|\/Users\/|\/Volumes\/|\/tmp\/)[^\n\r，。；;]+?(?:\.(?:md|pdf|docx?|xlsx?|pptx?|png|jpe?g|gif|webp|svg|txt|csv|json|html?))(?:#[^\s，。；;]+)?/gi,wb=/(?:TraceMind|Daily|Person|Object|Theme|Attachments|attachments|outputs|explorations|files|Files|assets|Assets)\/[^\s\]\)）"'，。；;]+(?:\.(?:md|pdf|docx?|xlsx?|pptx?|png|jpe?g|gif|webp|svg|txt|csv|json|html?))?(?:#[^\s，。；;]+)?/gi;function Cb(t){let e=t.data??{},n=typeof e.materialUrl=="string"?e.materialUrl:"",i=typeof e.materialPath=="string"?e.materialPath:"";return[t.title,t.summary,t.detail,n,i].filter(Boolean).join(`
`)}function Sb(t){return t.replace(/^!/,"").split("|")[0].split("#")[0].trim()}function Ab(t){return t.trim().replace(/[.,，。；;]+$/,"")}function Tb(t){return t.startsWith("/")||t.startsWith("~")?"local_path":"vault_path"}function ps(t,e,n,i,a){let r=Ab(a);if(!r)return;let s=`${i}:${r}`;e.has(s)||(e.add(s),t.push({kind:i,value:r,sourceBlockId:n.id,sourceTitle:n.title}))}function Mb(t){let e=[],n=new Set;return t.forEach(i=>{let a=i.data??{},r=typeof a.materialUrl=="string"?a.materialUrl:"",s=typeof a.materialPath=="string"?a.materialPath:"";r&&ps(e,n,i,"web_url",r),s&&ps(e,n,i,Tb(s),s);let o=Cb(i);for(let l of o.matchAll(bb))ps(e,n,i,"web_url",l[0]);for(let l of o.matchAll(kb))ps(e,n,i,"obsidian_link",Sb(l[1]??""));for(let l of o.matchAll(Eb))ps(e,n,i,"local_path",l[0]);for(let l of o.matchAll(wb))ps(e,n,i,"vault_path",l[0])}),e}function _b(t){switch(t){case"web_url":return"\u7F51\u9875\u94FE\u63A5";case"obsidian_link":return"Obsidian \u94FE\u63A5";case"vault_path":return"Vault \u6587\u4EF6";case"local_path":return"\u672C\u5730\u6587\u4EF6"}}function de(t){let e=Mb(t);return e.length===0?"":["\u5916\u90E8\u6750\u6599\u5904\u7406\u8981\u6C42\uFF1A",...e.map(i=>`- [${_b(i.kind)}] ${i.value}\uFF08\u6765\u81EA\uFF1A${i.sourceTitle} / ${i.sourceBlockId}\uFF09`),"\u5982\u679C\u4F60\u7684\u8FD0\u884C\u73AF\u5883\u53EF\u4EE5\u8BBF\u95EE\u8FD9\u4E9B\u7F51\u9875\u94FE\u63A5\u3001Obsidian \u94FE\u63A5\u3001Vault \u6587\u4EF6\u6216\u672C\u5730\u6587\u4EF6\uFF0C\u8BF7\u4E3B\u52A8\u8BFB\u53D6/\u89E3\u6790\u5176\u5185\u5BB9\uFF0C\u5E76\u628A\u53EF\u9760\u5185\u5BB9\u4F5C\u4E3A\u672C\u6B21\u601D\u8003\u4E0A\u4E0B\u6587\u3002","\u5982\u679C\u6750\u6599\u662F PDF\u3001Office \u6587\u6863\u3001\u56FE\u7247\u3001\u7F51\u9875\u5FEB\u7167\u6216\u5176\u4ED6\u9644\u4EF6\uFF0C\u8BF7\u4F7F\u7528\u4F60\u53EF\u7528\u7684\u672C\u5730\u5DE5\u5177\u6216 skill \u63D0\u53D6\u6587\u5B57\u3001\u6458\u8981\u6216\u5173\u952E\u4FE1\u606F\u3002","\u5982\u679C\u67D0\u4E2A\u6750\u6599\u65E0\u6CD5\u8BBF\u95EE\u3001\u89E3\u6790\u5931\u8D25\u3001\u8DEF\u5F84\u4E0D\u5B58\u5728\u6216\u6743\u9650\u4E0D\u8DB3\uFF0C\u8BF7\u7EE7\u7EED\u57FA\u4E8E\u5DF2\u7ED9\u51FA\u7684 block \u5185\u5BB9\u5B8C\u6210\u4EFB\u52A1\uFF0C\u4F46\u5FC5\u987B\u5728\u76F8\u5173 block \u7684 detail \u4E2D\u7B80\u77ED\u8BF4\u660E\u300C\u6750\u6599\u672A\u80FD\u8BFB\u53D6\uFF1A\u539F\u56E0\u300D\uFF0C\u5E76\u964D\u4F4E\u7ED3\u8BBA\u786E\u5B9A\u6027\u3002","\u4E0D\u8981\u81C6\u9020\u65E0\u6CD5\u8BFB\u53D6\u7684\u6750\u6599\u5185\u5BB9\uFF1B\u65E0\u6CD5\u786E\u8BA4\u65F6\u660E\u786E\u5199\u6210\u5047\u8BBE\u6216\u5F85\u9A8C\u8BC1\u70B9\u3002"].join(`
`)}function f5(t){let e=t.selectedBlocks.some(a=>a.data?.memoryRetrievalEnabled===!0),n=de(t.selectedBlocks),i=t.selectedBlocks.map(a=>{let r=typeof a.data?.promptHint=="string"?a.data.promptHint.trim():"";return[`### ${a.title}`,a.summary||"",a.detail||"",r?`
...
`)}function y5(t){let e=t.selectedBlocks.some(a=>a.data?.memoryRetrievalEnabled===!0),n=de(t.selectedBlocks),i=t.selectedBlocks.map(a=>{let r=typeof a.data?.promptHint=="string"?a.data.promptHint.trim():"";return[`### ${a.title}`,`type: ${a.type}`,a.summary||"",a.detail||"",r?`\u8865\u5145\u63D0\u793A\u8BCD\uFF1A${r}`:"",a.data?.materialUrl?`materialUrl: ${String(a.data.materialUrl)}`:"",a.data?.materialPath?`materialPath: ${String(a.data.materialPath)}`:""].filter(Boolean).join(`
`)}).join(`
...
`)}function x5(t){let e=t.useMemoryRetrieval??t.selectedBlocks.some(a=>a.data?.memoryRetrievalEnabled===!0),n=de(t.selectedBlocks),i=t.selectedBlocks.map(fu).join(`
...
`)}function v5(t){let e=m1(t.nextStage),n=[...t.sourceBlocks,t.currentBlock,t.userReplyBlock],i=t.useMemoryRetrieval??n.some(s=>s.data?.memoryRetrievalEnabled===!0),a=de(n),r=t.sourceBlocks.map(fu).join(`
...
`);return await t.vault.adapter.write(a,s),a}var rl="tracemind-task-board",t0=[{status:"todo",title:"\u5F85\u5904\u7406",hint:"\u5DF2\u786E\u8BA4\uFF0C\u7B49\u5F85\u5904\u7406"},{status:"running",title:"\u6267\u884C\u4E2D",hint:"\u672C\u5730 Agent \u6216\u7528\u6237\u6B63\u5728\u63A8\u8FDB"},{status:"review",title:"\u5F85\u786E\u8BA4",hint:"\u6709\u7ED3\u679C\uFF0C\u7B49\u5F85\u9A8C\u6536"},{status:"done",title:"\u5DF2\u5B8C\u6210",hint:"\u5DF2\u9A8C\u6536\uFF0C\u53EF\u5F52\u6863"}],Ss=class extends Fe.ItemView{plugin;store;tasks=[];selectedTaskId=null;draggingTaskId=null;activeDetailPanel=null;constructor(e,n){super(e),this.plugin=n,this.store=n.getTaskStore()}getViewType(){return rl}getDisplayText(){return"\u884C\u52A8\u770B\u677F"}getIcon(){return"list-checks"}async onOpen(){this.app.workspace.rightSplit.collapse(),await this.refresh()}async refresh(){this.tasks=await this.store.listTasks(),this.render()}render(){this.containerEl.empty(),this.addStyles();let e=this.containerEl.createEl("div",{cls:"tracemind-task-board"}),n=e.createEl("div",{cls:"tracemind-task-board-header"}),i=n.createEl("div");i.createEl("div",{cls:"tracemind-task-board-eyebrow",text:"TraceMind"}),i.createEl("h1",{text:"\u884C\u52A8\u770B\u677F"}),i.createEl("p",{text:"\u628A\u65E5\u8BB0\u91CC\u7684\u60F3\u6CD5\u6574\u7406\u6210\u53EF\u6267\u884C\u4EFB\u52A1\uFF0C\u5FC5\u8981\u65F6\u4EA4\u7ED9\u672C\u5730 Agent \u7EE7\u7EED\u63A8\u8FDB\u3002"});let a=n.createEl("div",{cls:"tracemind-task-header-actions"}),r=this.tasks.filter(l=>l.status==="done").length;r>0&&a.createEl("button",{cls:"tracemind-task-secondary-btn",text:`\u5F52\u6863\u5DF2\u5B8C\u6210 ${r}`}).addEventListener("click",()=>this.archiveDoneTasks()),a.createEl("button",{cls:"tracemind-task-primary-btn",text:"\u65B0\u5EFA\u4EFB\u52A1"}).addEventListener("click",()=>this.createManualTask());let o=e.createEl("div",{cls:"tracemind-task-columns"});for(let l of t0)this.renderColumn(o,l)}renderColumn(e,n){let i=e.createEl("section",{cls:"tracemind-task-column",attr:{"data-status":n.status}}),a=i.createEl("div",{cls:"tracemind-task-column-header"});a.createEl("div",{cls:"tracemind-task-column-title",text:n.title});let r=this.tasks.filter(o=>o.status===n.status);a.createEl("span",{cls:"tracemind-task-count",text:String(r.length)}),i.createEl("div",{cls:"tracemind-task-column-hint",text:n.hint});let s=i.createEl("div",{cls:"tracemind-task-list",attr:{"data-status":n.status}});if(this.bindColumnDrop(s,n.status),r.length===0){s.createEl("div",{cls:"tracemind-task-empty",text:"\u6682\u65E0\u4EFB\u52A1"});return}for(let o of r)this.renderTaskCard(s,o)}renderTaskCard(e,n){let i=e.createEl("div",{cls:`tracemind-task-card${this.selectedTaskId===n.id?" is-selected":""}`,attr:{role:"button",tabindex:"0",draggable:"true","data-task-id":n.id}}),a=i.createEl("div",{cls:"tracemind-task-card-header"});a.createEl("div",{cls:"tracemind-task-card-title",text:n.title}),n.outputPath&&a.createEl("span",{cls:"tracemind-task-card-chip",text:"\u6210\u679C"}),i.createEl("div",{cls:"tracemind-task-card-desc",text:n.description||"\u6682\u65E0\u8BF4\u660E"}),i.createEl("div",{cls:"tracemind-task-card-footer"}).createEl("span",{cls:"tracemind-task-card-source",text:this.formatSource(n)}).setAttr("title",this.formatSource(n)),i.addEventListener("click",o=>{this.draggingTaskId||(o.stopPropagation(),this.selectedTaskId=n.id,this.renderDetail(n))}),i.addEventListener("keydown",o=>{o.key!=="Enter"&&o.key!==" "||(o.preventDefault(),this.selectedTaskId=n.id,this.renderDetail(n))}),i.addEventListener("dragstart",o=>{this.draggingTaskId=n.id,i.addClass("is-dragging"),o.dataTransfer?.setData("text/plain",n.id),o.dataTransfer&&(o.dataTransfer.effectAllowed="move")}),i.addEventListener("dragend",()=>{this.draggingTaskId=null,i.removeClass("is-dragging"),this.clearDragOver()})}bindColumnDrop(e,n){e.addEventListener("dragover",i=>{this.draggingTaskId&&(i.preventDefault(),i.dataTransfer&&(i.dataTransfer.dropEffect="move"),e.addClass("is-drag-over"))}),e.addEventListener("dragleave",i=>{let a=i.relatedTarget;(!a||!e.contains(a))&&e.removeClass("is-drag-over")}),e.addEventListener("drop",async i=>{i.preventDefault(),e.removeClass("is-drag-over");let a=i.dataTransfer?.getData("text/plain")||this.draggingTaskId;a&&await this.moveTaskToStatus(a,n)})}async moveTaskToStatus(e,n){let i=this.tasks.find(r=>r.id===e);if(!i||i.status===n){this.draggingTaskId=null;return}let a=t0.find(r=>r.status===n);await this.store.updateTask(e,{status:n}),this.selectedTaskId=e,this.draggingTaskId=null,new Fe.Notice(`\u4EFB\u52A1\u5DF2\u79FB\u52A8\u5230\uFF1A${a?.title||n}`),await this.refresh()}clearDragOver(){this.containerEl.querySelectorAll(".is-drag-over").forEach(e=>e.removeClass("is-drag-over"))}async archiveDoneTasks(){let e=this.tasks.filter(i=>i.status==="done");if(!(e.length===0||!window.confirm(`\u786E\u5B9A\u5F52\u6863 ${e.length} \u4E2A\u5DF2\u5B8C\u6210\u4EFB\u52A1\u5417\uFF1F\u5F52\u6863\u540E\u9ED8\u8BA4\u770B\u677F\u4E0D\u518D\u663E\u793A\u3002`))){for(let i of e)await this.store.updateTask(i.id,{status:"archived"});new Fe.Notice(`\u5DF2\u5F52\u6863 ${e.length} \u4E2A\u5B8C\u6210\u4EFB\u52A1`),this.selectedTaskId&&e.some(i=>i.id===this.selectedTaskId)&&(this.selectedTaskId=null,this.closeDetail()),await this.refresh()}}renderDetail(e){this.containerEl.querySelector(".tracemind-task-detail")?.remove(),this.containerEl.querySelector(".tracemind-task-detail-backdrop")?.remove();let i=this.containerEl.createEl("div",{cls:"tracemind-task-detail-backdrop"}),a=this.containerEl.createEl("aside",{cls:"tracemind-task-detail"});this.activeDetailPanel=a,i.addEventListener("click",()=>this.closeDetail()),a.createEl("button",{cls:"tracemind-task-detail-close",text:"\u5173\u95ED"}).addEventListener("click",()=>this.closeDetail()),a.createEl("div",{cls:"tracemind-task-detail-kicker",text:"\u4EFB\u52A1\u8BE6\u60C5"}),a.createEl("h2",{text:e.title}),a.createEl("p",{cls:"tracemind-task-detail-desc",text:e.description||"\u6682\u65E0\u8BF4\u660E"});let s=a.createEl("div",{cls:"tracemind-task-detail-field"});s.createEl("span",{text:"\u6765\u6E90"}),s.createEl("strong",{text:this.formatSource(e)});let o=a.createEl("div",{cls:"tracemind-task-status-row"});for(let l of t0)o.createEl("button",{text:l.title,cls:e.status===l.status?"is-active":""}).addEventListener("click",async()=>{await this.store.updateTask(e.id,{status:l.status}),new Fe.Notice(`\u4EFB\u52A1\u5DF2\u79FB\u52A8\u5230\uFF1A${l.title}`),await this.refresh()});if(e.outputPath&&a.createEl("button",{cls:"tracemind-task-output-link",text:`\u6253\u5F00\u6210\u679C\uFF1A${e.outputPath}`}).addEventListener("click",async()=>{let c=this.app.vault.getFileByPath(e.outputPath);c&&await this.app.workspace.getLeaf("tab").openFile(c)}),e.status==="review"){let l=a.createEl("div",{cls:"tracemind-task-review-box"});l.createEl("div",{cls:"tracemind-task-agent-title",text:"\u9A8C\u6536\u7ED3\u679C"}),l.createEl("p",{text:"Agent \u5DF2\u8FD4\u56DE\u7ED3\u679C\u3002\u786E\u8BA4\u65E0\u8BEF\u540E\u53EF\u5B8C\u6210\u4EFB\u52A1\uFF1B\u5982\u679C\u7ED3\u679C\u4E0D\u6EE1\u610F\uFF0C\u53EF\u4EE5\u7528\u4E0A\u6B21\u7684 Agent \u91CD\u65B0\u6267\u884C\u3002"});let c=l.createEl("div",{cls:"tracemind-task-review-actions"});c.createEl("button",{cls:"tracemind-task-confirm-done-btn",text:"\u786E\u8BA4\u5B8C\u6210"}).addEventListener("click",async()=>{await this.store.updateTask(e.id,{status:"done"}),await this.appendProgress(e.id,"system","\u7528\u6237\u5DF2\u786E\u8BA4\u4EFB\u52A1\u5B8C\u6210\u3002"),new Fe.Notice("\u4EFB\u52A1\u5DF2\u786E\u8BA4\u5B8C\u6210"),await this.refresh()});let d=c.createEl("button",{cls:"tracemind-task-rerun-btn",text:"\u91CD\u65B0\u6267\u884C"});d.addEventListener("click",async()=>{let p=e.agent?.providerKey;if(!p){new Fe.Notice("\u8BE5\u4EFB\u52A1\u6CA1\u6709\u4E0A\u6B21\u6267\u884C\u7684 Agent\uFF0C\u8BF7\u5728\u4E0B\u65B9\u9009\u62E9 Agent \u540E\u6267\u884C\u3002");return}await this.executeTask(e,p,d)})}if(e.status==="done"){let l=a.createEl("div",{cls:"tracemind-task-archive-box"});l.createEl("div",{cls:"tracemind-task-agent-title",text:"\u5B8C\u6210\u4EFB\u52A1\u6574\u7406"}),l.createEl("p",{text:"\u5F52\u6863\u540E\u4EFB\u52A1\u4F1A\u4ECE\u9ED8\u8BA4\u770B\u677F\u4E2D\u9690\u85CF\uFF0C\u4EFB\u52A1\u6570\u636E\u4ECD\u4FDD\u7559\u5728 TraceMind/tasks/tasks.json\u3002"}),l.createEl("button",{cls:"tracemind-task-archive-btn",text:"\u5F52\u6863\u4EFB\u52A1"}).addEventListener("click",async()=>{await this.store.updateTask(e.id,{status:"archived"}),await this.appendProgress(e.id,"system","\u4EFB\u52A1\u5DF2\u5F52\u6863\u3002"),new Fe.Notice("\u4EFB\u52A1\u5DF2\u5F52\u6863"),this.closeDetail(),await this.refresh()})}this.renderAgentExecution(a,e),this.renderProgressPanel(a,e)}closeDetail(){this.containerEl.querySelector(".tracemind-task-detail")?.remove(),this.containerEl.querySelector(".tracemind-task-detail-backdrop")?.remove(),this.activeDetailPanel=null}renderAgentExecution(e,n){let i=e.createEl("div",{cls:"tracemind-task-agent-box"});i.createEl("div",{cls:"tracemind-task-agent-title",text:"\u672C\u5730 Agent \u6267\u884C"}),i.createEl("label",{cls:"tracemind-task-form-label",text:"\u8865\u5145\u63D0\u793A\u8BCD"});let a=i.createEl("textarea",{cls:"tracemind-task-textarea",text:n.executionPrompt||"",attr:{placeholder:"\u4F8B\u5982\uFF1A\u91CD\u70B9\u5206\u6790\u98CE\u9669\uFF0C\u8F93\u51FA\u65F6\u6309\u201C\u7ED3\u8BBA / \u4F9D\u636E / \u4E0B\u4E00\u6B65\u201D\u7ED3\u6784\u7EC4\u7EC7\u3002"}});a.addEventListener("change",async()=>{await this.store.updateTask(n.id,{executionPrompt:a.value.trim()}),await this.reloadDetail(n.id)}),this.renderMaterialsEditor(i,n);let r=this.getAvailableAgents();if(r.length===0){i.createEl("p",{text:"\u8BF7\u5148\u5728\u8BBE\u7F6E\u4E2D\u68C0\u6D4B\u5E76\u914D\u7F6E\u672C\u5730 Agent\u3002"});return}let s=i.createEl("div",{cls:"tracemind-task-agent-row"}),o=s.createEl("select"),l=n.agent?.providerKey||this.plugin.settings.actionBoard?.defaultAgent||this.plugin.settings.exploration.defaultAgent||r[0];for(let u of r)o.createEl("option",{value:u,text:this.agentLabel(u)});o.value=r.includes(l)?l:r[0];let c=s.createEl("button",{text:n.status==="running"?"\u6267\u884C\u4E2D...":"\u6267\u884C\u4EFB\u52A1"});n.status==="running"&&c.setAttr("disabled","true"),c.addEventListener("click",()=>this.executeTask(n,o.value,c))}renderMaterialsEditor(e,n){let i=e.createEl("div",{cls:"tracemind-task-materials"});i.createEl("div",{cls:"tracemind-task-agent-title",text:"\u9644\u4EF6\u6750\u6599"});let a=i.createEl("div",{cls:"tracemind-task-material-list"}),r=n.materials||[];if(r.length===0)a.createEl("div",{cls:"tracemind-task-muted",text:"\u6682\u65E0\u6750\u6599\u3002\u53EF\u6DFB\u52A0 vault \u76F8\u5BF9\u8DEF\u5F84\u3001\u672C\u5730\u6587\u4EF6\u8DEF\u5F84\u6216\u7F51\u9875\u94FE\u63A5\u3002"});else for(let c of r){let u=a.createEl("div",{cls:"tracemind-task-material-item"});u.createEl("span",{text:`${c.label||c.kind}: ${c.path}`}),u.createEl("button",{text:"\u5220\u9664"}).addEventListener("click",async()=>{await this.store.updateTask(n.id,{materials:r.filter(p=>p.id!==c.id)}),await this.reloadDetail(n.id)})}let s=i.createEl("div",{cls:"tracemind-task-material-add"}),o=s.createEl("input",{type:"text",attr:{placeholder:"\u7C98\u8D34\u94FE\u63A5\u3001vault \u76F8\u5BF9\u8DEF\u5F84\u6216\u672C\u5730\u6587\u4EF6\u8DEF\u5F84"}});s.createEl("button",{text:"\u6DFB\u52A0"}).addEventListener("click",async()=>{let c=o.value.trim();if(!c)return;let u={id:`mat-${Date.now()}-${Math.random().toString(36).slice(2,7)}`,path:c,kind:this.inferMaterialKind(c)};await this.store.updateTask(n.id,{materials:[...r,u]}),await this.reloadDetail(n.id)})}inferMaterialKind(e){return/^https?:\/\//i.test(e)?"web_url":/^\[\[.+\]\]$/.test(e)?"obsidian_link":e.startsWith("/")||/^[A-Za-z]:[\\/]/.test(e)?"local_path":"vault_path"}renderProgressPanel(e,n){let i=e.createEl("div",{cls:"tracemind-task-progress-box"});i.createEl("div",{cls:"tracemind-task-agent-title",text:"\u4EFB\u52A1\u8FDB\u5C55"});let a=n.progress||[],r=i.createEl("div",{cls:"tracemind-task-progress-list"});if(a.length===0)r.createEl("div",{cls:"tracemind-task-muted",text:"\u6682\u65E0\u8FDB\u5C55\u3002\u53EF\u4EE5\u624B\u5DE5\u8BB0\u5F55\uFF0C\u4E5F\u4F1A\u663E\u793A\u672C\u5730 Agent \u6267\u884C\u8FDB\u5C55\u3002"});else for(let u of a.slice().reverse()){let d=r.createEl("div",{cls:`tracemind-task-progress-entry ${u.author}`}),p=d.createEl("div",{cls:"tracemind-task-progress-meta"});p.createEl("span",{text:this.progressAuthorLabel(u.author)}),p.createEl("span",{text:this.formatProgressTime(u.timestamp)}),d.createEl("div",{cls:"tracemind-task-progress-content",text:u.content})}let s=i.createEl("textarea",{cls:"tracemind-task-textarea",attr:{placeholder:"\u624B\u5DE5\u8BB0\u5F55\u5F53\u524D\u8FDB\u5C55\u3001\u963B\u585E\u70B9\u6216\u4E0B\u4E00\u6B65..."}}),o=i.createEl("div",{cls:"tracemind-task-progress-actions"});o.createEl("button",{cls:"tracemind-task-progress-add",text:"\u8BB0\u5F55\u8FDB\u5C55"}).addEventListener("click",async()=>{let u=s.value.trim();u&&(await this.appendProgress(n.id,"user",u),await this.reloadDetail(n.id))}),o.createEl("button",{cls:"tracemind-task-delete-btn",text:"\u5220\u9664\u4EFB\u52A1"}).addEventListener("click",async()=>{window.confirm(`\u786E\u5B9A\u5220\u9664\u4EFB\u52A1\u201C${n.title}\u201D\u5417\uFF1F\u6B64\u64CD\u4F5C\u4E0D\u53EF\u64A4\u9500\u3002`)&&(await this.store.deleteTask(n.id),new Fe.Notice("\u4EFB\u52A1\u5DF2\u5220\u9664"),this.selectedTaskId=null,this.closeDetail(),await this.refresh())})}progressAuthorLabel(e){return e==="agent"?"Agent":e==="system"?"\u7CFB\u7EDF":"\u624B\u5DE5"}formatProgressTime(e){let n=new Date(e);return Number.isNaN(n.getTime())?e:`${String(n.getMonth()+1).padStart(2,"0")}-${String(n.getDate()).padStart(2,"0")} ${String(n.getHours()).padStart(2,"0")}:${String(n.getMinutes()).padStart(2,"0")}`}async appendProgress(e,n,i){let a=await this.store.getTask(e);if(!a)return null;let r={id:`progress-${Date.now()}-${Math.random().toString(36).slice(2,7)}`,timestamp:new Date().toISOString(),author:n,content:i};return this.store.updateTask(e,{progress:[...a.progress||[],r]})}async reloadDetail(e){this.tasks=await this.store.listTasks();let n=this.tasks.find(i=>i.id===e);n&&this.renderDetail(n)}async executeTask(e,n,i){i.setText("\u6267\u884C\u4E2D..."),i.setAttr("disabled","true");let a=await this.store.updateTask(e.id,{status:"running",agent:{providerKey:n}});await this.appendProgress(e.id,"system",`${this.agentLabel(n)} \u5F00\u59CB\u6267\u884C\u4EFB\u52A1\u3002`),await this.refresh();try{let r=await q4(this.app,a,n);if(await this.store.saveRun(a.id,{id:r.runId,taskId:a.id,providerKey:n,status:r.status,prompt:r.prompt,output:r.output,error:r.error,startedAt:new Date(Date.now()-r.durationMs).toISOString(),finishedAt:new Date().toISOString(),durationMs:r.durationMs}),r.status==="completed"){let s=await K4(this.app,a,r.output);a=await this.store.updateTask(a.id,{status:"review",outputPath:s}),await this.appendProgress(a.id,"system",`\u6267\u884C\u5B8C\u6210\uFF0C\u6210\u679C\u5DF2\u4FDD\u5B58\u5230 ${s}`),new Fe.Notice(`\u4EFB\u52A1\u6267\u884C\u5B8C\u6210\uFF0C\u6210\u679C\u5DF2\u4FDD\u5B58\uFF1A${s}`)}else a=await this.store.updateTask(a.id,{status:"todo"}),await this.appendProgress(a.id,"system",`\u6267\u884C\u5931\u8D25\uFF1A${r.error||r.status}`),new Fe.Notice("\u4EFB\u52A1\u6267\u884C\u5931\u8D25\uFF1A"+(r.error||r.status));this.selectedTaskId=a.id,await this.refresh()}catch(r){await this.store.updateTask(e.id,{status:"todo"}),await this.appendProgress(e.id,"system",`\u6267\u884C\u5931\u8D25\uFF1A${r.message}`),new Fe.Notice("\u4EFB\u52A1\u6267\u884C\u5931\u8D25\uFF1A"+r.message),await this.refresh()}}getAvailableAgents(){let e=this.plugin.settings,n=new Set;e.actionBoard?.defaultAgent&&n.add(e.actionBoard.defaultAgent),e.exploration.defaultAgent&&n.add(e.exploration.defaultAgent);for(let i of e.exploration.availableAgents||[])n.add(i);return Array.from(n)}agentLabel(e){return{codex:"Codex","claude-code":"Claude Code",hermes:"Hermes",opencode:"OpenCode",pi:"Pi Agent"}[e]||e}async createManualTask(){let e=await this.store.createTask({title:"\u65B0\u4EFB\u52A1",description:"\u4ECE\u884C\u52A8\u770B\u677F\u624B\u52A8\u521B\u5EFA\uFF0C\u8BF7\u5728\u540E\u7EED\u7248\u672C\u4E2D\u7F16\u8F91\u5B8C\u5584\u3002",source:{kind:"manual"}});new Fe.Notice("\u5DF2\u521B\u5EFA\u4EFB\u52A1"),this.selectedTaskId=e.id,await this.refresh()}formatSource(e){return e.source?e.source.kind==="diary"?e.source.path||"\u65E5\u8BB0":e.source.kind==="chat"?"AI \u5BF9\u8BDD":e.source.kind==="exploration"?e.source.path||"\u601D\u8003\u63A2\u7D22":e.source.kind==="entity"?e.source.path||"\u5B9E\u4F53\u6863\u6848":e.source.title||"\u624B\u52A8\u521B\u5EFA":"\u624B\u52A8\u521B\u5EFA"}addStyles(){document.getElementById("tracemind-task-board-styles")?.remove();let e=document.createElement("style");e.id="tracemind-task-board-styles",e.textContent=`
    ...
    `,document.head.appendChild(e)}};Ml();Hn();var tx="TraceMind/tasks",Z4="TraceMind/tasks/runs",Tu=`${tx}/tasks.json`;function Q4(){return new Date().toISOString()}function sw(){return`task-${Date.now()}-${Math.random().toString(36).slice(2,8)}`}function J4(t){return JSON.stringify({version:1,tasks:t},null,2)}function W4(t){return t==="inbox"?"todo":t==="todo"||t==="running"||t==="review"||t==="done"||t==="archived"?t:"todo"}var Mu=class{constructor(e){this.app=e}app;async initialize(){await this.ensureFolder(tx),await this.ensureFolder(Z4),await this.exists(Tu)||await this.writeFile(Tu,J4([]))}async listTasks(){return await this.initialize(),this.readTasks()}async getTask(e){return(await this.listTasks()).find(i=>i.id===e)??null}async createTask(e){let n=await this.listTasks(),i=Q4(),a={id:sw(),title:e.title.trim(),description:e.description.trim(),status:W4(e.status),source:e.source,agent:e.agent,createdAt:i,updatedAt:i};return n.unshift(a),await this.writeTasks(n),a}async updateTask(e,n){let i=await this.listTasks(),a=i.findIndex(s=>s.id===e);if(a<0)throw new Error(`Task not found: ${e}`);let r={...i[a],...n,updatedAt:Q4()};return r.status==="done"&&!r.completedAt&&(r.completedAt=r.updatedAt),r.status!=="done"&&r.completedAt&&n.status&&delete r.completedAt,i[a]=r,await this.writeTasks(i),r}async deleteTask(e){let n=await this.listTasks(),i=n.filter(a=>a.id!==e);if(i.length===n.length)throw new Error(`Task not found: ${e}`);await this.writeTasks(i)}async saveRun(e,n){await this.initialize(),await this.writeFile(`${Z4}/${e}-${n.id}.json`,JSON.stringify(n,null,2))}async readTasks(){try{let e=await this.readFile(Tu),n=JSON.parse(e);return Array.isArray(n.tasks)?n.tasks.map(i=>({...i,status:W4(i.status)})):[]}catch{return[]}}async writeTasks(e){await this.writeFile(Tu,J4(e))}async ensureFolder(e){await this.exists(e)||await this.app.vault.adapter.mkdir(e)}async exists(e){let n=this.app.vault.adapter;if(typeof n.exists=="function")return n.exists(e);try{return await this.app.vault.adapter.stat(e),!0}catch{return!1}}readFile(e){return this.app.vault.adapter.read(e)}writeFile(e,n){return this.app.vault.adapter.write(e,n)}};function mx(t){return typeof t>"u"||t===null}function ow(t){return typeof t=="object"&&t!==null}function lw(t){return Array.isArray(t)?t:mx(t)?[]:[t]}function cw(t,e){var n,i,a,r;if(e)for(r=Object.keys(e),n=0,i=r.length;n<i;n+=1)a=r[n],t[a]=e[a];return t}function uw(t,e){var n="",i;for(i=0;i<e;i+=1)n+=t;return n}function dw(t){return t===0&&Number.NEGATIVE_INFINITY===1/t}var pw=mx,fw=ow,hw=lw,gw=uw,mw=dw,yw=cw,Kt={isNothing:pw,isObject:fw,toArray:hw,repeat:gw,isNegativeZero:mw,extend:yw};function yx(t,e){var n="",i=t.reason||"(unknown reason)";return t.mark?(t.mark.name&&(n+='in "'+t.mark.name+'" '),n+="("+(t.mark.line+1)+":"+(t.mark.column+1)+")",!e&&t.mark.snippet&&(n+=`

`+t.mark.snippet),i+" "+n):i}function ol(t,e){Error.call(this),this.name="YAMLException",this.reason=t,this.mark=e,this.message=yx(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}ol.prototype=Object.create(Error.prototype);ol.prototype.constructor=ol;ol.prototype.toString=function(e){return this.name+": "+yx(this,e)};var be=ol;function e0(t,e,n,i,a){var r="",s="",o=Math.floor(a/2)-1;return i-e>o&&(r=" ... ",e=i-o+r.length),n-i>o&&(s=" ...",n=i+o-s.length),{str:r+t.slice(e,n).replace(/\t/g,"\u2192")+s,pos:i-e+r.length}}function n0(t,e){return Kt.repeat(" ",e-t.length)+t}function xw(t,e){if(e=Object.create(e||null),!t.buffer)return null;e.maxLength||(e.maxLength=79),typeof e.indent!="number"&&(e.indent=1),typeof e.linesBefore!="number"&&(e.linesBefore=3),typeof e.linesAfter!="number"&&(e.linesAfter=2);for(var n=/\r?\n|\r|\0/g,i=[0],a=[],r,s=-1;r=n.exec(t.buffer);)a.push(r.index),i.push(r.index+r[0].length),t.position<=r.index&&s<0&&(s=i.length-2);s<0&&(s=i.length-1);var o="",l,c,u=Math.min(t.line+e.linesAfter,a.length).toString().length,d=e.maxLength-(e.indent+u+3);for(l=1;l<=e.linesBefore&&!(s-l<0);l++)c=e0(t.buffer,i[s-l],a[s-l],t.position-(i[s]-i[s-l]),d),o=Kt.repeat(" ",e.indent)+n0((t.line-l+1).toString(),u)+" | "+c.str+`
...
`;return o.replace(/\n$/,"")}var vw=xw,bw=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],kw=["scalar","sequence","mapping"];function Ew(t){var e={};return t!==null&&Object.keys(t).forEach(function(n){t[n].forEach(function(i){e[String(i)]=n})}),e}function ww(t,e){if(e=e||{},Object.keys(e).forEach(function(n){if(bw.indexOf(n)===-1)throw new be('Unknown option "'+n+'" is met in definition of "'+t+'" YAML type.')}),this.options=e,this.tag=t,this.kind=e.kind||null,this.resolve=e.resolve||function(){return!0},this.construct=e.construct||function(n){return n},this.instanceOf=e.instanceOf||null,this.predicate=e.predicate||null,this.represent=e.represent||null,this.representName=e.representName||null,this.defaultStyle=e.defaultStyle||null,this.multi=e.multi||!1,this.styleAliases=Ew(e.styleAliases||null),kw.indexOf(this.kind)===-1)throw new be('Unknown kind "'+this.kind+'" is specified for "'+t+'" YAML type.')}var oe=ww;function ex(t,e){var n=[];return t[e].forEach(function(i){var a=n.length;n.forEach(function(r,s){r.tag===i.tag&&r.kind===i.kind&&r.multi===i.multi&&(a=s)}),n[a]=i}),n}function Cw(){var t={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},e,n;function i(a){a.multi?(t.multi[a.kind].push(a),t.multi.fallback.push(a)):t[a.kind][a.tag]=t.fallback[a.tag]=a}for(e=0,n=arguments.length;e<n;e+=1)arguments[e].forEach(i);return t}function a0(t){return this.extend(t)}a0.prototype.extend=function(e){var n=[],i=[];if(e instanceof oe)i.push(e);else if(Array.isArray(e))i=i.concat(e);else if(e&&(Array.isArray(e.implicit)||Array.isArray(e.explicit)))e.implicit&&(n=n.concat(e.implicit)),e.explicit&&(i=i.concat(e.explicit));else throw new be("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");n.forEach(function(r){if(!(r instanceof oe))throw new be("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(r.loadKind&&r.loadKind!=="scalar")throw new be("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(r.multi)throw new be("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),i.forEach(function(r){if(!(r instanceof oe))throw new be("Specified list of YAML types (or a single Type object) contains a non-Type object.")});var a=Object.create(a0.prototype);return a.implicit=(this.implicit||[]).concat(n),a.explicit=(this.explicit||[]).concat(i),a.compiledImplicit=ex(a,"implicit"),a.compiledExplicit=ex(a,"explicit"),a.compiledTypeMap=Cw(a.compiledImplicit,a.compiledExplicit),a};var xx=a0,vx=new oe("tag:yaml.org,2002:str",{kind:"scalar",construct:function(t){return t!==null?t:""}}),bx=new oe("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(t){return t!==null?t:[]}}),kx=new oe("tag:yaml.org,2002:map",{kind:"mapping",construct:function(t){return t!==null?t:{}}}),Ex=new xx({explicit:[vx,bx,kx]});function Sw(t){if(t===null)return!0;var e=t.length;return e===1&&t==="~"||e===4&&(t==="null"||t==="Null"||t==="NULL")}function Aw(){return null}function Tw(t){return t===null}var wx=new oe("tag:yaml.org,2002:null",{kind:"scalar",resolve:Sw,construct:Aw,predicate:Tw,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"});function Mw(t){if(t===null)return!1;var e=t.length;return e===4&&(t==="true"||t==="True"||t==="TRUE")||e===5&&(t==="false"||t==="False"||t==="FALSE")}function _w(t){return t==="true"||t==="True"||t==="TRUE"}function Bw(t){return Object.prototype.toString.call(t)==="[object Boolean]"}var Cx=new oe("tag:yaml.org,2002:bool",{kind:"scalar",resolve:Mw,construct:_w,predicate:Bw,represent:{lowercase:function(t){return t?"true":"false"},uppercase:function(t){return t?"TRUE":"FALSE"},camelcase:function(t){return t?"True":"False"}},defaultStyle:"lowercase"});function Rw(t){return 48<=t&&t<=57||65<=t&&t<=70||97<=t&&t<=102}function Dw(t){return 48<=t&&t<=55}function Iw(t){return 48<=t&&t<=57}function Fw(t){if(t===null)return!1;var e=t.length,n=0,i=!1,a;if(!e)return!1;if(a=t[n],(a==="-"||a==="+")&&(a=t[++n]),a==="0"){if(n+1===e)return!0;if(a=t[++n],a==="b"){for(n++;n<e;n++)if(a=t[n],a!=="_"){if(a!=="0"&&a!=="1")return!1;i=!0}return i&&a!=="_"}if(a==="x"){for(n++;n<e;n++)if(a=t[n],a!=="_"){if(!Rw(t.charCodeAt(n)))return!1;i=!0}return i&&a!=="_"}if(a==="o"){for(n++;n<e;n++)if(a=t[n],a!=="_"){if(!Dw(t.charCodeAt(n)))return!1;i=!0}return i&&a!=="_"}}if(a==="_")return!1;for(;n<e;n++)if(a=t[n],a!=="_"){if(!Iw(t.charCodeAt(n)))return!1;i=!0}return!(!i||a==="_")}function Ow(t){var e=t,n=1,i;if(e.indexOf("_")!==-1&&(e=e.replace(/_/g,"")),i=e[0],(i==="-"||i==="+")&&(i==="-"&&(n=-1),e=e.slice(1),i=e[0]),e==="0")return 0;if(i==="0"){if(e[1]==="b")return n*parseInt(e.slice(2),2);if(e[1]==="x")return n*parseInt(e.slice(2),16);if(e[1]==="o")return n*parseInt(e.slice(2),8)}return n*parseInt(e,10)}function zw(t){return Object.prototype.toString.call(t)==="[object Number]"&&t%1===0&&!Kt.isNegativeZero(t)}var Sx=new oe("tag:yaml.org,2002:int",{kind:"scalar",resolve:Fw,construct:Ow,predicate:zw,represent:{binary:function(t){return t>=0?"0b"+t.toString(2):"-0b"+t.toString(2).slice(1)},octal:function(t){return t>=0?"0o"+t.toString(8):"-0o"+t.toString(8).slice(1)},decimal:function(t){return t.toString(10)},hexadecimal:function(t){return t>=0?"0x"+t.toString(16).toUpperCase():"-0x"+t.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),Lw=new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function Nw(t){return!(t===null||!Lw.test(t)||t[t.length-1]==="_")}function Pw(t){var e,n;return e=t.replace(/_/g,"").toLowerCase(),n=e[0]==="-"?-1:1,"+-".indexOf(e[0])>=0&&(e=e.slice(1)),e===".inf"?n===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:e===".nan"?NaN:n*parseFloat(e,10)}var jw=/^[-+]?[0-9]+e/;function $w(t,e){var n;if(isNaN(t))switch(e){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===t)switch(e){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===t)switch(e){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(Kt.isNegativeZero(t))return"-0.0";return n=t.toString(10),jw.test(n)?n.replace("e",".e"):n}function Uw(t){return Object.prototype.toString.call(t)==="[object Number]"&&(t%1!==0||Kt.isNegativeZero(t))}var Ax=new oe("tag:yaml.org,2002:float",{kind:"scalar",resolve:Nw,construct:Pw,predicate:Uw,represent:$w,defaultStyle:"lowercase"}),Tx=Ex.extend({implicit:[wx,Cx,Sx,Ax]}),Mx=Tx,_x=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),Bx=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function Hw(t){return t===null?!1:_x.exec(t)!==null||Bx.exec(t)!==null}function Yw(t){var e,n,i,a,r,s,o,l=0,c=null,u,d,p;if(e=_x.exec(t),e===null&&(e=Bx.exec(t)),e===null)throw new Error("Date resolve error");if(n=+e[1],i=+e[2]-1,a=+e[3],!e[4])return new Date(Date.UTC(n,i,a));if(r=+e[4],s=+e[5],o=+e[6],e[7]){for(l=e[7].slice(0,3);l.length<3;)l+="0";l=+l}return e[9]&&(u=+e[10],d=+(e[11]||0),c=(u*60+d)*6e4,e[9]==="-"&&(c=-c)),p=new Date(Date.UTC(n,i,a,r,s,o,l)),c&&p.setTime(p.getTime()-c),p}function Vw(t){return t.toISOString()}var Rx=new oe("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:Hw,construct:Yw,instanceOf:Date,represent:Vw});function Gw(t){return t==="<<"||t===null}var Dx=new oe("tag:yaml.org,2002:merge",{kind:"scalar",resolve:Gw}),c0=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function qw(t){if(t===null)return!1;var e,n,i=0,a=t.length,r=c0;for(n=0;n<a;n++)if(e=r.indexOf(t.charAt(n)),!(e>64)){if(e<0)return!1;i+=6}return i%8===0}function Xw(t){var e,n,i=t.replace(/[\r\n=]/g,""),a=i.length,r=c0,s=0,o=[];for(e=0;e<a;e++)e%4===0&&e&&(o.push(s>>16&255),o.push(s>>8&255),o.push(s&255)),s=s<<6|r.indexOf(i.charAt(e));return n=a%4*6,n===0?(o.push(s>>16&255),o.push(s>>8&255),o.push(s&255)):n===18?(o.push(s>>10&255),o.push(s>>2&255)):n===12&&o.push(s>>4&255),new Uint8Array(o)}function Kw(t){var e="",n=0,i,a,r=t.length,s=c0;for(i=0;i<r;i++)i%3===0&&i&&(e+=s[n>>18&63],e+=s[n>>12&63],e+=s[n>>6&63],e+=s[n&63]),n=(n<<8)+t[i];return a=r%3,a===0?(e+=s[n>>18&63],e+=s[n>>12&63],e+=s[n>>6&63],e+=s[n&63]):a===2?(e+=s[n>>10&63],e+=s[n>>4&63],e+=s[n<<2&63],e+=s[64]):a===1&&(e+=s[n>>2&63],e+=s[n<<4&63],e+=s[64],e+=s[64]),e}function Zw(t){return Object.prototype.toString.call(t)==="[object Uint8Array]"}var Ix=new oe("tag:yaml.org,2002:binary",{kind:"scalar",resolve:qw,construct:Xw,predicate:Zw,represent:Kw}),Qw=Object.prototype.hasOwnProperty,Jw=Object.prototype.toString;function Ww(t){if(t===null)return!0;var e=[],n,i,a,r,s,o=t;for(n=0,i=o.length;n<i;n+=1){if(a=o[n],s=!1,Jw.call(a)!=="[object Object]")return!1;for(r in a)if(Qw.call(a,r))if(!s)s=!0;else return!1;if(!s)return!1;if(e.indexOf(r)===-1)e.push(r);else return!1}return!0}function tC(t){return t!==null?t:[]}var Fx=new oe("tag:yaml.org,2002:omap",{kind:"sequence",resolve:Ww,construct:tC}),eC=Object.prototype.toString;function nC(t){if(t===null)return!0;var e,n,i,a,r,s=t;for(r=new Array(s.length),e=0,n=s.length;e<n;e+=1){if(i=s[e],eC.call(i)!=="[object Object]"||(a=Object.keys(i),a.length!==1))return!1;r[e]=[a[0],i[a[0]]]}return!0}function iC(t){if(t===null)return[];var e,n,i,a,r,s=t;for(r=new Array(s.length),e=0,n=s.length;e<n;e+=1)i=s[e],a=Object.keys(i),r[e]=[a[0],i[a[0]]];return r}var Ox=new oe("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:nC,construct:iC}),aC=Object.prototype.hasOwnProperty;function rC(t){if(t===null)return!0;var e,n=t;for(e in n)if(aC.call(n,e)&&n[e]!==null)return!1;return!0}function sC(t){return t!==null?t:{}}var zx=new oe("tag:yaml.org,2002:set",{kind:"mapping",resolve:rC,construct:sC}),u0=Mx.extend({implicit:[Rx,Dx],explicit:[Ix,Fx,Ox,zx]}),ua=Object.prototype.hasOwnProperty,_u=1,Lx=2,Nx=3,Bu=4,i0=1,oC=2,nx=3,lC=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,cC=/[\x85\u2028\u2029]/,uC=/[,\[\]\{\}]/,Px=/^(?:!|!!|![a-z\-]+!)$/i,jx=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function ix(t){return Object.prototype.toString.call(t)}function jn(t){return t===10||t===13}function sr(t){return t===9||t===32}function Oe(t){return t===9||t===32||t===10||t===13}function Ts(t){return t===44||t===91||t===93||t===123||t===125}function dC(t){var e;return 48<=t&&t<=57?t-48:(e=t|32,97<=e&&e<=102?e-97+10:-1)}function pC(t){return t===120?2:t===117?4:t===85?8:0}function fC(t){return 48<=t&&t<=57?t-48:-1}function ax(t){return t===48?"\0":t===97?"\x07":t===98?"\b":t===116||t===9?"	":t===110?`
`:t===118?"\v":t===102?"\f":t===114?"\r":t===101?"\x1B":t===32?" ":t===34?'"':t===47?"/":t===92?"\\":t===78?"\x85":t===95?"\xA0":t===76?"\u2028":t===80?"\u2029":""}function hC(t){return t<=65535?String.fromCharCode(t):String.fromCharCode((t-65536>>10)+55296,(t-65536&1023)+56320)}function $x(t,e,n){e==="__proto__"?Object.defineProperty(t,e,{configurable:!0,enumerable:!0,writable:!0,value:n}):t[e]=n}var Ux=new Array(256),Hx=new Array(256);for(rr=0;rr<256;rr++)Ux[rr]=ax(rr)?1:0,Hx[rr]=ax(rr);var rr;function gC(t,e){this.input=t,this.filename=e.filename||null,this.schema=e.schema||u0,this.onWarning=e.onWarning||null,this.legacy=e.legacy||!1,this.json=e.json||!1,this.listener=e.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=t.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function Yx(t,e){var n={name:t.filename,buffer:t.input.slice(0,-1),position:t.position,line:t.line,column:t.position-t.lineStart};return n.snippet=vw(n),new be(e,n)}function U(t,e){throw Yx(t,e)}function Ru(t,e){t.onWarning&&t.onWarning.call(null,Yx(t,e))}var rx={YAML:function(e,n,i){var a,r,s;e.version!==null&&U(e,"duplication of %YAML directive"),i.length!==1&&U(e,"YAML directive accepts exactly one argument"),a=/^([0-9]+)\.([0-9]+)$/.exec(i[0]),a===null&&U(e,"ill-formed argument of the YAML directive"),r=parseInt(a[1],10),s=parseInt(a[2],10),r!==1&&U(e,"unacceptable YAML version of the document"),e.version=i[0],e.checkLineBreaks=s<2,s!==1&&s!==2&&Ru(e,"unsupported YAML version of the document")},TAG:function(e,n,i){var a,r;i.length!==2&&U(e,"TAG directive accepts exactly two arguments"),a=i[0],r=i[1],Px.test(a)||U(e,"ill-formed tag handle (first argument) of the TAG directive"),ua.call(e.tagMap,a)&&U(e,'there is a previously declared suffix for "'+a+'" tag handle'),jx.test(r)||U(e,"ill-formed tag prefix (second argument) of the TAG directive");try{r=decodeURIComponent(r)}catch{U(e,"tag prefix is malformed: "+r)}e.tagMap[a]=r}};function ca(t,e,n,i){var a,r,s,o;if(e<n){if(o=t.input.slice(e,n),i)for(a=0,r=o.length;a<r;a+=1)s=o.charCodeAt(a),s===9||32<=s&&s<=1114111||U(t,"expected valid JSON character");else lC.test(o)&&U(t,"the stream contains non-printable characters");t.result+=o}}function sx(t,e,n,i){var a,r,s,o;for(Kt.isObject(n)||U(t,"cannot merge mappings; the provided source object is unacceptable"),a=Object.keys(n),s=0,o=a.length;s<o;s+=1)r=a[s],ua.call(e,r)||($x(e,r,n[r]),i[r]=!0)}function Ms(t,e,n,i,a,r,s,o,l){var c,u;if(Array.isArray(a))for(a=Array.prototype.slice.call(a),c=0,u=a.length;c<u;c+=1)Array.isArray(a[c])&&U(t,"nested arrays are not supported inside keys"),typeof a=="object"&&ix(a[c])==="[object Object]"&&(a[c]="[object Object]");if(typeof a=="object"&&ix(a)==="[object Object]"&&(a="[object Object]"),a=String(a),e===null&&(e={}),i==="tag:yaml.org,2002:merge")if(Array.isArray(r))for(c=0,u=r.length;c<u;c+=1)sx(t,e,r[c],n);else sx(t,e,r,n);else!t.json&&!ua.call(n,a)&&ua.call(e,a)&&(t.line=s||t.line,t.lineStart=o||t.lineStart,t.position=l||t.position,U(t,"duplicated mapping key")),$x(e,a,r),delete n[a];return e}function d0(t){var e;e=t.input.charCodeAt(t.position),e===10?t.position++:e===13?(t.position++,t.input.charCodeAt(t.position)===10&&t.position++):U(t,"a line break is expected"),t.line+=1,t.lineStart=t.position,t.firstTabInLine=-1}function Gt(t,e,n){for(var i=0,a=t.input.charCodeAt(t.position);a!==0;){for(;sr(a);)a===9&&t.firstTabInLine===-1&&(t.firstTabInLine=t.position),a=t.input.charCodeAt(++t.position);if(e&&a===35)do a=t.input.charCodeAt(++t.position);while(a!==10&&a!==13&&a!==0);if(jn(a))for(d0(t),a=t.input.charCodeAt(t.position),i++,t.lineIndent=0;a===32;)t.lineIndent++,a=t.input.charCodeAt(++t.position);else break}return n!==-1&&i!==0&&t.lineIndent<n&&Ru(t,"deficient indentation"),i}function Fu(t){var e=t.position,n;return n=t.input.charCodeAt(e),!!((n===45||n===46)&&n===t.input.charCodeAt(e+1)&&n===t.input.charCodeAt(e+2)&&(e+=3,n=t.input.charCodeAt(e),n===0||Oe(n)))}function p0(t,e){e===1?t.result+=" ":e>1&&(t.result+=Kt.repeat(`
`,e-1))}function mC(t,e,n){var i,a,r,s,o,l,c,u,d=t.kind,p=t.result,f;if(f=t.input.charCodeAt(t.position),Oe(f)||Ts(f)||f===35||f===38||f===42||f===33||f===124||f===62||f===39||f===34||f===37||f===64||f===96||(f===63||f===45)&&(a=t.input.charCodeAt(t.position+1),Oe(a)||n&&Ts(a)))return!1;for(t.kind="scalar",t.result="",r=s=t.position,o=!1;f!==0;){if(f===58){if(a=t.input.charCodeAt(t.position+1),Oe(a)||n&&Ts(a))break}else if(f===35){if(i=t.input.charCodeAt(t.position-1),Oe(i))break}else{if(t.position===t.lineStart&&Fu(t)||n&&Ts(f))break;if(jn(f))if(l=t.line,c=t.lineStart,u=t.lineIndent,Gt(t,!1,-1),t.lineIndent>=e){o=!0,f=t.input.charCodeAt(t.position);continue}else{t.position=s,t.line=l,t.lineStart=c,t.lineIndent=u;break}}o&&(ca(t,r,s,!1),p0(t,t.line-l),r=s=t.position,o=!1),sr(f)||(s=t.position+1),f=t.input.charCodeAt(++t.position)}return ca(t,r,s,!1),t.result?!0:(t.kind=d,t.result=p,!1)}function yC(t,e){var n,i,a;if(n=t.input.charCodeAt(t.position),n!==39)return!1;for(t.kind="scalar",t.result="",t.position++,i=a=t.position;(n=t.input.charCodeAt(t.position))!==0;)if(n===39)if(ca(t,i,t.position,!0),n=t.input.charCodeAt(++t.position),n===39)i=t.position,t.position++,a=t.position;else return!0;else jn(n)?(ca(t,i,a,!0),p0(t,Gt(t,!1,e)),i=a=t.position):t.position===t.lineStart&&Fu(t)?U(t,"unexpected end of the document within a single quoted scalar"):(t.position++,a=t.position);U(t,"unexpected end of the stream within a single quoted scalar")}function xC(t,e){var n,i,a,r,s,o;if(o=t.input.charCodeAt(t.position),o!==34)return!1;for(t.kind="scalar",t.result="",t.position++,n=i=t.position;(o=t.input.charCodeAt(t.position))!==0;){if(o===34)return ca(t,n,t.position,!0),t.position++,!0;if(o===92){if(ca(t,n,t.position,!0),o=t.input.charCodeAt(++t.position),jn(o))Gt(t,!1,e);else if(o<256&&Ux[o])t.result+=Hx[o],t.position++;else if((s=pC(o))>0){for(a=s,r=0;a>0;a--)o=t.input.charCodeAt(++t.position),(s=dC(o))>=0?r=(r<<4)+s:U(t,"expected hexadecimal character");t.result+=hC(r),t.position++}else U(t,"unknown escape sequence");n=i=t.position}else jn(o)?(ca(t,n,i,!0),p0(t,Gt(t,!1,e)),n=i=t.position):t.position===t.lineStart&&Fu(t)?U(t,"unexpected end of the document within a double quoted scalar"):(t.position++,i=t.position)}U(t,"unexpected end of the stream within a double quoted scalar")}function vC(t,e){var n=!0,i,a,r,s=t.tag,o,l=t.anchor,c,u,d,p,f,y=Object.create(null),x,E,v,h;if(h=t.input.charCodeAt(t.position),h===91)u=93,f=!1,o=[];else if(h===123)u=125,f=!0,o={};else return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=o),h=t.input.charCodeAt(++t.position);h!==0;){if(Gt(t,!0,e),h=t.input.charCodeAt(t.position),h===u)return t.position++,t.tag=s,t.anchor=l,t.kind=f?"mapping":"sequence",t.result=o,!0;n?h===44&&U(t,"expected the node content, but found ','"):U(t,"missed comma between flow collection entries"),E=x=v=null,d=p=!1,h===63&&(c=t.input.charCodeAt(t.position+1),Oe(c)&&(d=p=!0,t.position++,Gt(t,!0,e))),i=t.line,a=t.lineStart,r=t.position,_s(t,e,_u,!1,!0),E=t.tag,x=t.result,Gt(t,!0,e),h=t.input.charCodeAt(t.position),(p||t.line===i)&&h===58&&(d=!0,h=t.input.charCodeAt(++t.position),Gt(t,!0,e),_s(t,e,_u,!1,!0),v=t.result),f?Ms(t,o,y,E,x,v,i,a,r):d?o.push(Ms(t,null,y,E,x,v,i,a,r)):o.push(x),Gt(t,!0,e),h=t.input.charCodeAt(t.position),h===44?(n=!0,h=t.input.charCodeAt(++t.position)):n=!1}U(t,"unexpected end of the stream within a flow collection")}function bC(t,e){var n,i,a=i0,r=!1,s=!1,o=e,l=0,c=!1,u,d;if(d=t.input.charCodeAt(t.position),d===124)i=!1;else if(d===62)i=!0;else return!1;for(t.kind="scalar",t.result="";d!==0;)if(d=t.input.charCodeAt(++t.position),d===43||d===45)i0===a?a=d===43?nx:oC:U(t,"repeat of a chomping mode identifier");else if((u=fC(d))>=0)u===0?U(t,"bad explicit indentation width of a block scalar; it cannot be less than one"):s?U(t,"repeat of an indentation width identifier"):(o=e+u-1,s=!0);else break;if(sr(d)){do d=t.input.charCodeAt(++t.position);while(sr(d));if(d===35)do d=t.input.charCodeAt(++t.position);while(!jn(d)&&d!==0)}for(;d!==0;){for(d0(t),t.lineIndent=0,d=t.input.charCodeAt(t.position);(!s||t.lineIndent<o)&&d===32;)t.lineIndent++,d=t.input.charCodeAt(++t.position);if(!s&&t.lineIndent>o&&(o=t.lineIndent),jn(d)){l++;continue}if(t.lineIndent<o){a===nx?t.result+=Kt.repeat(`
...
`,r?1+l:l),r=!0,s=!0,l=0,n=t.position;!jn(d)&&d!==0;)d=t.input.charCodeAt(++t.position);ca(t,n,t.position,!1)}return!0}function ox(t,e){var n,i=t.tag,a=t.anchor,r=[],s,o=!1,l;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=r),l=t.input.charCodeAt(t.position);l!==0&&(t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,U(t,"tab characters must not be used in indentation")),!(l!==45||(s=t.input.charCodeAt(t.position+1),!Oe(s))));){if(o=!0,t.position++,Gt(t,!0,-1)&&t.lineIndent<=e){r.push(null),l=t.input.charCodeAt(t.position);continue}if(n=t.line,_s(t,e,Nx,!1,!0),r.push(t.result),Gt(t,!0,-1),l=t.input.charCodeAt(t.position),(t.line===n||t.lineIndent>e)&&l!==0)U(t,"bad indentation of a sequence entry");else if(t.lineIndent<e)break}return o?(t.tag=i,t.anchor=a,t.kind="sequence",t.result=r,!0):!1}function kC(t,e,n){var i,a,r,s,o,l,c=t.tag,u=t.anchor,d={},p=Object.create(null),f=null,y=null,x=null,E=!1,v=!1,h;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=d),h=t.input.charCodeAt(t.position);h!==0;){if(!E&&t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,U(t,"tab characters must not be used in indentation")),i=t.input.charCodeAt(t.position+1),r=t.line,(h===63||h===58)&&Oe(i))h===63?(E&&(Ms(t,d,p,f,y,null,s,o,l),f=y=x=null),v=!0,E=!0,a=!0):E?(E=!1,a=!0):U(t,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),t.position+=1,h=i;else{if(s=t.line,o=t.lineStart,l=t.position,!_s(t,n,Lx,!1,!0))break;if(t.line===r){for(h=t.input.charCodeAt(t.position);sr(h);)h=t.input.charCodeAt(++t.position);if(h===58)h=t.input.charCodeAt(++t.position),Oe(h)||U(t,"a whitespace character is expected after the key-value separator within a block mapping"),E&&(Ms(t,d,p,f,y,null,s,o,l),f=y=x=null),v=!0,E=!1,a=!1,f=t.tag,y=t.result;else if(v)U(t,"can not read an implicit mapping pair; a colon is missed");else return t.tag=c,t.anchor=u,!0}else if(v)U(t,"can not read a block mapping entry; a multiline key may not be an implicit key");else return t.tag=c,t.anchor=u,!0}if((t.line===r||t.lineIndent>e)&&(E&&(s=t.line,o=t.lineStart,l=t.position),_s(t,e,Bu,!0,a)&&(E?y=t.result:x=t.result),E||(Ms(t,d,p,f,y,x,s,o,l),f=y=x=null),Gt(t,!0,-1),h=t.input.charCodeAt(t.position)),(t.line===r||t.lineIndent>e)&&h!==0)U(t,"bad indentation of a mapping entry");else if(t.lineIndent<e)break}return E&&Ms(t,d,p,f,y,null,s,o,l),v&&(t.tag=c,t.anchor=u,t.kind="mapping",t.result=d),v}function EC(t){var e,n=!1,i=!1,a,r,s;if(s=t.input.charCodeAt(t.position),s!==33)return!1;if(t.tag!==null&&U(t,"duplication of a tag property"),s=t.input.charCodeAt(++t.position),s===60?(n=!0,s=t.input.charCodeAt(++t.position)):s===33?(i=!0,a="!!",s=t.input.charCodeAt(++t.position)):a="!",e=t.position,n){do s=t.input.charCodeAt(++t.position);while(s!==0&&s!==62);t.position<t.length?(r=t.input.slice(e,t.position),s=t.input.charCodeAt(++t.position)):U(t,"unexpected end of the stream within a verbatim tag")}else{for(;s!==0&&!Oe(s);)s===33&&(i?U(t,"tag suffix cannot contain exclamation marks"):(a=t.input.slice(e-1,t.position+1),Px.test(a)||U(t,"named tag handle cannot contain such characters"),i=!0,e=t.position+1)),s=t.input.charCodeAt(++t.position);r=t.input.slice(e,t.position),uC.test(r)&&U(t,"tag suffix cannot contain flow indicator characters")}r&&!jx.test(r)&&U(t,"tag name cannot contain such characters: "+r);try{r=decodeURIComponent(r)}catch{U(t,"tag name is malformed: "+r)}return n?t.tag=r:ua.call(t.tagMap,a)?t.tag=t.tagMap[a]+r:a==="!"?t.tag="!"+r:a==="!!"?t.tag="tag:yaml.org,2002:"+r:U(t,'undeclared tag handle "'+a+'"'),!0}function wC(t){var e,n;if(n=t.input.charCodeAt(t.position),n!==38)return!1;for(t.anchor!==null&&U(t,"duplication of an anchor property"),n=t.input.charCodeAt(++t.position),e=t.position;n!==0&&!Oe(n)&&!Ts(n);)n=t.input.charCodeAt(++t.position);return t.position===e&&U(t,"name of an anchor node must contain at least one character"),t.anchor=t.input.slice(e,t.position),!0}function CC(t){var e,n,i;if(i=t.input.charCodeAt(t.position),i!==42)return!1;for(i=t.input.charCodeAt(++t.position),e=t.position;i!==0&&!Oe(i)&&!Ts(i);)i=t.input.charCodeAt(++t.position);return t.position===e&&U(t,"name of an alias node must contain at least one character"),n=t.input.slice(e,t.position),ua.call(t.anchorMap,n)||U(t,'unidentified alias "'+n+'"'),t.result=t.anchorMap[n],Gt(t,!0,-1),!0}function _s(t,e,n,i,a){var r,s,o,l=1,c=!1,u=!1,d,p,f,y,x,E;if(t.listener!==null&&t.listener("open",t),t.tag=null,t.anchor=null,t.kind=null,t.result=null,r=s=o=Bu===n||Nx===n,i&&Gt(t,!0,-1)&&(c=!0,t.lineIndent>e?l=1:t.lineIndent===e?l=0:t.lineIndent<e&&(l=-1)),l===1)for(;EC(t)||wC(t);)Gt(t,!0,-1)?(c=!0,o=r,t.lineIndent>e?l=1:t.lineIndent===e?l=0:t.lineIndent<e&&(l=-1)):o=!1;if(o&&(o=c||a),(l===1||Bu===n)&&(_u===n||Lx===n?x=e:x=e+1,E=t.position-t.lineStart,l===1?o&&(ox(t,E)||kC(t,E,x))||vC(t,x)?u=!0:(s&&bC(t,x)||yC(t,x)||xC(t,x)?u=!0:CC(t)?(u=!0,(t.tag!==null||t.anchor!==null)&&U(t,"alias node should not have any properties")):mC(t,x,_u===n)&&(u=!0,t.tag===null&&(t.tag="?")),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):l===0&&(u=o&&ox(t,E))),t.tag===null)t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);else if(t.tag==="?"){for(t.result!==null&&t.kind!=="scalar"&&U(t,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+t.kind+'"'),d=0,p=t.implicitTypes.length;d<p;d+=1)if(y=t.implicitTypes[d],y.resolve(t.result)){t.result=y.construct(t.result),t.tag=y.tag,t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);break}}else if(t.tag!=="!"){if(ua.call(t.typeMap[t.kind||"fallback"],t.tag))y=t.typeMap[t.kind||"fallback"][t.tag];else for(y=null,f=t.typeMap.multi[t.kind||"fallback"],d=0,p=f.length;d<p;d+=1)if(t.tag.slice(0,f[d].tag.length)===f[d].tag){y=f[d];break}y||U(t,"unknown tag !<"+t.tag+">"),t.result!==null&&y.kind!==t.kind&&U(t,"unacceptable node kind for !<"+t.tag+'> tag; it should be "'+y.kind+'", not "'+t.kind+'"'),y.resolve(t.result,t.tag)?(t.result=y.construct(t.result,t.tag),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):U(t,"cannot resolve a node with !<"+t.tag+"> explicit tag")}return t.listener!==null&&t.listener("close",t),t.tag!==null||t.anchor!==null||u}function SC(t){var e=t.position,n,i,a,r=!1,s;for(t.version=null,t.checkLineBreaks=t.legacy,t.tagMap=Object.create(null),t.anchorMap=Object.create(null);(s=t.input.charCodeAt(t.position))!==0&&(Gt(t,!0,-1),s=t.input.charCodeAt(t.position),!(t.lineIndent>0||s!==37));){for(r=!0,s=t.input.charCodeAt(++t.position),n=t.position;s!==0&&!Oe(s);)s=t.input.charCodeAt(++t.position);for(i=t.input.slice(n,t.position),a=[],i.length<1&&U(t,"directive name must not be less than one character in length");s!==0;){for(;sr(s);)s=t.input.charCodeAt(++t.position);if(s===35){do s=t.input.charCodeAt(++t.position);while(s!==0&&!jn(s));break}if(jn(s))break;for(n=t.position;s!==0&&!Oe(s);)s=t.input.charCodeAt(++t.position);a.push(t.input.slice(n,t.position))}s!==0&&d0(t),ua.call(rx,i)?rx[i](t,i,a):Ru(t,'unknown document directive "'+i+'"')}if(Gt(t,!0,-1),t.lineIndent===0&&t.input.charCodeAt(t.position)===45&&t.input.charCodeAt(t.position+1)===45&&t.input.charCodeAt(t.position+2)===45?(t.position+=3,Gt(t,!0,-1)):r&&U(t,"directives end mark is expected"),_s(t,t.lineIndent-1,Bu,!1,!0),Gt(t,!0,-1),t.checkLineBreaks&&cC.test(t.input.slice(e,t.position))&&Ru(t,"non-ASCII line breaks are interpreted as content"),t.documents.push(t.result),t.position===t.lineStart&&Fu(t)){t.input.charCodeAt(t.position)===46&&(t.position+=3,Gt(t,!0,-1));return}if(t.position<t.length-1)U(t,"end of the stream or a document separator is expected");else return}function Vx(t,e){t=String(t),e=e||{},t.length!==0&&(t.charCodeAt(t.length-1)!==10&&t.charCodeAt(t.length-1)!==13&&(t+=`
`),t.charCodeAt(0)===65279&&(t=t.slice(1)));var n=new gC(t,e),i=t.indexOf("\0");for(i!==-1&&(n.position=i,U(n,"null byte is not allowed in input")),n.input+="\0";n.input.charCodeAt(n.position)===32;)n.lineIndent+=1,n.position+=1;for(;n.position<n.length-1;)SC(n);return n.documents}function AC(t,e,n){e!==null&&typeof e=="object"&&typeof n>"u"&&(n=e,e=null);var i=Vx(t,n);if(typeof e!="function")return i;for(var a=0,r=i.length;a<r;a+=1)e(i[a])}function TC(t,e){var n=Vx(t,e);if(n.length!==0){if(n.length===1)return n[0];throw new be("expected a single document in the stream, but found more")}}var MC=AC,_C=TC,Gx={loadAll:MC,load:_C},qx=Object.prototype.toString,Xx=Object.prototype.hasOwnProperty,f0=65279,BC=9,ll=10,RC=13,DC=32,IC=33,FC=34,r0=35,OC=37,zC=38,LC=39,NC=42,Kx=44,PC=45,Du=58,jC=61,$C=62,UC=63,HC=64,Zx=91,Qx=93,YC=96,Jx=123,VC=124,Wx=125,fe={};fe[0]="\\0";fe[7]="\\a";fe[8]="\\b";fe[9]="\\t";fe[10]="\\n";fe[11]="\\v";fe[12]="\\f";fe[13]="\\r";fe[27]="\\e";fe[34]='\\"';fe[92]="\\\\";fe[133]="\\N";fe[160]="\\_";fe[8232]="\\L";fe[8233]="\\P";var GC=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],qC=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function XC(t,e){var n,i,a,r,s,o,l;if(e===null)return{};for(n={},i=Object.keys(e),a=0,r=i.length;a<r;a+=1)s=i[a],o=String(e[s]),s.slice(0,2)==="!!"&&(s="tag:yaml.org,2002:"+s.slice(2)),l=t.compiledTypeMap.fallback[s],l&&Xx.call(l.styleAliases,o)&&(o=l.styleAliases[o]),n[s]=o;return n}function KC(t){var e,n,i;if(e=t.toString(16).toUpperCase(),t<=255)n="x",i=2;else if(t<=65535)n="u",i=4;else if(t<=4294967295)n="U",i=8;else throw new be("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+n+Kt.repeat("0",i-e.length)+e}var ZC=1,cl=2;function QC(t){this.schema=t.schema||u0,this.indent=Math.max(1,t.indent||2),this.noArrayIndent=t.noArrayIndent||!1,this.skipInvalid=t.skipInvalid||!1,this.flowLevel=Kt.isNothing(t.flowLevel)?-1:t.flowLevel,this.styleMap=XC(this.schema,t.styles||null),this.sortKeys=t.sortKeys||!1,this.lineWidth=t.lineWidth||80,this.noRefs=t.noRefs||!1,this.noCompatMode=t.noCompatMode||!1,this.condenseFlow=t.condenseFlow||!1,this.quotingType=t.quotingType==='"'?cl:ZC,this.forceQuotes=t.forceQuotes||!1,this.replacer=typeof t.replacer=="function"?t.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function lx(t,e){for(var n=Kt.repeat(" ",e),i=0,a=-1,r="",s,o=t.length;i<o;)a=t.indexOf(`
`,i),a===-1?(s=t.slice(i),i=o):(s=t.slice(i,a+1),i=a+1),s.length&&s!==`
`&&(r+=n),r+=s;return r}function s0(t,e){return`
`+Kt.repeat(" ",t.indent*e)}function JC(t,e){var n,i,a;for(n=0,i=t.implicitTypes.length;n<i;n+=1)if(a=t.implicitTypes[n],a.resolve(e))return!0;return!1}function Iu(t){return t===DC||t===BC}function ul(t){return 32<=t&&t<=126||161<=t&&t<=55295&&t!==8232&&t!==8233||57344<=t&&t<=65533&&t!==f0||65536<=t&&t<=1114111}function cx(t){return ul(t)&&t!==f0&&t!==RC&&t!==ll}function ux(t,e,n){var i=cx(t),a=i&&!Iu(t);return(n?i:i&&t!==Kx&&t!==Zx&&t!==Qx&&t!==Jx&&t!==Wx)&&t!==r0&&!(e===Du&&!a)||cx(e)&&!Iu(e)&&t===r0||e===Du&&a}function WC(t){return ul(t)&&t!==f0&&!Iu(t)&&t!==PC&&t!==UC&&t!==Du&&t!==Kx&&t!==Zx&&t!==Qx&&t!==Jx&&t!==Wx&&t!==r0&&t!==zC&&t!==NC&&t!==IC&&t!==VC&&t!==jC&&t!==$C&&t!==LC&&t!==FC&&t!==OC&&t!==HC&&t!==YC}function tS(t){return!Iu(t)&&t!==Du}function sl(t,e){var n=t.charCodeAt(e),i;return n>=55296&&n<=56319&&e+1<t.length&&(i=t.charCodeAt(e+1),i>=56320&&i<=57343)?(n-55296)*1024+i-56320+65536:n}function t3(t){var e=/^\n* /;return e.test(t)}var e3=1,o0=2,n3=3,i3=4,As=5;function eS(t,e,n,i,a,r,s,o){var l,c=0,u=null,d=!1,p=!1,f=i!==-1,y=-1,x=WC(sl(t,0))&&tS(sl(t,t.length-1));if(e||s)for(l=0;l<t.length;c>=65536?l+=2:l++){if(c=sl(t,l),!ul(c))return As;x=x&&ux(c,u,o),u=c}else{for(l=0;l<t.length;c>=65536?l+=2:l++){if(c=sl(t,l),c===ll)d=!0,f&&(p=p||l-y-1>i&&t[y+1]!==" ",y=l);else if(!ul(c))return As;x=x&&ux(c,u,o),u=c}p=p||f&&l-y-1>i&&t[y+1]!==" "}return!d&&!p?x&&!s&&!a(t)?e3:r===cl?As:o0:n>9&&t3(t)?As:s?r===cl?As:o0:p?i3:n3}function nS(t,e,n,i,a){t.dump=(function(){if(e.length===0)return t.quotingType===cl?'""':"''";if(!t.noCompatMode&&(GC.indexOf(e)!==-1||qC.test(e)))return t.quotingType===cl?'"'+e+'"':"'"+e+"'";var r=t.indent*Math.max(1,n),s=t.lineWidth===-1?-1:Math.max(Math.min(t.lineWidth,40),t.lineWidth-r),o=i||t.flowLevel>-1&&n>=t.flowLevel;function l(c){return JC(t,c)}switch(eS(e,o,t.indent,s,l,t.quotingType,t.forceQuotes&&!i,a)){case e3:return e;case o0:return"'"+e.replace(/'/g,"''")+"'";case n3:return"|"+dx(e,t.indent)+px(lx(e,r));case i3:return">"+dx(e,t.indent)+px(lx(iS(e,s),r));case As:return'"'+aS(e)+'"';default:throw new be("impossible error: invalid scalar style")}})()}function dx(t,e){var n=t3(t)?String(e):"",i=t[t.length-1]===`
`,a=i&&(t[t.length-2]===`
`||t===`
`),r=a?"+":i?"":"-";return n+r+`
`}function px(t){return t[t.length-1]===`
`?t.slice(0,-1):t}function iS(t,e){for(var n=/(\n+)([^\n]*)/g,i=(function(){var c=t.indexOf(`
`);return c=c!==-1?c:t.length,n.lastIndex=c,fx(t.slice(0,c),e)})(),a=t[0]===`
`||t[0]===" ",r,s;s=n.exec(t);){var o=s[1],l=s[2];r=l[0]===" ",i+=o+(!a&&!r&&l!==""?`
`:"")+fx(l,e),a=r}return i}function fx(t,e){if(t===""||t[0]===" ")return t;for(var n=/ [^ ]/g,i,a=0,r,s=0,o=0,l="";i=n.exec(t);)o=i.index,o-a>e&&(r=s>a?s:o,l+=`
`+t.slice(a,r),a=r+1),s=o;return l+=`
`,t.length-a>e&&s>a?l+=t.slice(a,s)+`
`+t.slice(s+1):l+=t.slice(a),l.slice(1)}function aS(t){for(var e="",n=0,i,a=0;a<t.length;n>=65536?a+=2:a++)n=sl(t,a),i=fe[n],!i&&ul(n)?(e+=t[a],n>=65536&&(e+=t[a+1])):e+=i||KC(n);return e}function rS(t,e,n){var i="",a=t.tag,r,s,o;for(r=0,s=n.length;r<s;r+=1)o=n[r],t.replacer&&(o=t.replacer.call(n,String(r),o)),(xi(t,e,o,!1,!1)||typeof o>"u"&&xi(t,e,null,!1,!1))&&(i!==""&&(i+=","+(t.condenseFlow?"":" ")),i+=t.dump);t.tag=a,t.dump="["+i+"]"}function hx(t,e,n,i){var a="",r=t.tag,s,o,l;for(s=0,o=n.length;s<o;s+=1)l=n[s],t.replacer&&(l=t.replacer.call(n,String(s),l)),(xi(t,e+1,l,!0,!0,!1,!0)||typeof l>"u"&&xi(t,e+1,null,!0,!0,!1,!0))&&((!i||a!=="")&&(a+=s0(t,e)),t.dump&&ll===t.dump.charCodeAt(0)?a+="-":a+="- ",a+=t.dump);t.tag=r,t.dump=a||"[]"}function sS(t,e,n){var i="",a=t.tag,r=Object.keys(n),s,o,l,c,u;for(s=0,o=r.length;s<o;s+=1)u="",i!==""&&(u+=", "),t.condenseFlow&&(u+='"'),l=r[s],c=n[l],t.replacer&&(c=t.replacer.call(n,l,c)),xi(t,e,l,!1,!1)&&(t.dump.length>1024&&(u+="? "),u+=t.dump+(t.condenseFlow?'"':"")+":"+(t.condenseFlow?"":" "),xi(t,e,c,!1,!1)&&(u+=t.dump,i+=u));t.tag=a,t.dump="{"+i+"}"}function oS(t,e,n,i){var a="",r=t.tag,s=Object.keys(n),o,l,c,u,d,p;if(t.sortKeys===!0)s.sort();else if(typeof t.sortKeys=="function")s.sort(t.sortKeys);else if(t.sortKeys)throw new be("sortKeys must be a boolean or a function");for(o=0,l=s.length;o<l;o+=1)p="",(!i||a!=="")&&(p+=s0(t,e)),c=s[o],u=n[c],t.replacer&&(u=t.replacer.call(n,c,u)),xi(t,e+1,c,!0,!0,!0)&&(d=t.tag!==null&&t.tag!=="?"||t.dump&&t.dump.length>1024,d&&(t.dump&&ll===t.dump.charCodeAt(0)?p+="?":p+="? "),p+=t.dump,d&&(p+=s0(t,e)),xi(t,e+1,u,!0,d)&&(t.dump&&ll===t.dump.charCodeAt(0)?p+=":":p+=": ",p+=t.dump,a+=p));t.tag=r,t.dump=a||"{}"}function gx(t,e,n){var i,a,r,s,o,l;for(a=n?t.explicitTypes:t.implicitTypes,r=0,s=a.length;r<s;r+=1)if(o=a[r],(o.instanceOf||o.predicate)&&(!o.instanceOf||typeof e=="object"&&e instanceof o.instanceOf)&&(!o.predicate||o.predicate(e))){if(n?o.multi&&o.representName?t.tag=o.representName(e):t.tag=o.tag:t.tag="?",o.represent){if(l=t.styleMap[o.tag]||o.defaultStyle,qx.call(o.represent)==="[object Function]")i=o.represent(e,l);else if(Xx.call(o.represent,l))i=o.represent[l](e,l);else throw new be("!<"+o.tag+'> tag resolver accepts not "'+l+'" style');t.dump=i}return!0}return!1}function xi(t,e,n,i,a,r,s){t.tag=null,t.dump=n,gx(t,n,!1)||gx(t,n,!0);var o=qx.call(t.dump),l=i,c;i&&(i=t.flowLevel<0||t.flowLevel>e);var u=o==="[object Object]"||o==="[object Array]",d,p;if(u&&(d=t.duplicates.indexOf(n),p=d!==-1),(t.tag!==null&&t.tag!=="?"||p||t.indent!==2&&e>0)&&(a=!1),p&&t.usedDuplicates[d])t.dump="*ref_"+d;else{if(u&&p&&!t.usedDuplicates[d]&&(t.usedDuplicates[d]=!0),o==="[object Object]")i&&Object.keys(t.dump).length!==0?(oS(t,e,t.dump,a),p&&(t.dump="&ref_"+d+t.dump)):(sS(t,e,t.dump),p&&(t.dump="&ref_"+d+" "+t.dump));else if(o==="[object Array]")i&&t.dump.length!==0?(t.noArrayIndent&&!s&&e>0?hx(t,e-1,t.dump,a):hx(t,e,t.dump,a),p&&(t.dump="&ref_"+d+t.dump)):(rS(t,e,t.dump),p&&(t.dump="&ref_"+d+" "+t.dump));else if(o==="[object String]")t.tag!=="?"&&nS(t,t.dump,e,r,l);else{if(o==="[object Undefined]")return!1;if(t.skipInvalid)return!1;throw new be("unacceptable kind of an object to dump "+o)}t.tag!==null&&t.tag!=="?"&&(c=encodeURI(t.tag[0]==="!"?t.tag.slice(1):t.tag).replace(/!/g,"%21"),t.tag[0]==="!"?c="!"+c:c.slice(0,18)==="tag:yaml.org,2002:"?c="!!"+c.slice(18):c="!<"+c+">",t.dump=c+" "+t.dump)}return!0}function lS(t,e){var n=[],i=[],a,r;for(l0(t,n,i),a=0,r=i.length;a<r;a+=1)e.duplicates.push(n[i[a]]);e.usedDuplicates=new Array(r)}function l0(t,e,n){var i,a,r;if(t!==null&&typeof t=="object")if(a=e.indexOf(t),a!==-1)n.indexOf(a)===-1&&n.push(a);else if(e.push(t),Array.isArray(t))for(a=0,r=t.length;a<r;a+=1)l0(t[a],e,n);else for(i=Object.keys(t),a=0,r=i.length;a<r;a+=1)l0(t[i[a]],e,n)}function cS(t,e){e=e||{};var n=new QC(e);n.noRefs||lS(t,n);var i=t;return n.replacer&&(i=n.replacer.call({"":i},"",i)),xi(n,0,i,!0,!0)?n.dump+`
`:""}var uS=cS,dS={dump:uS};function h0(t,e){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+e+" instead, which is now safe by default.")}}var pS=oe,fS=xx,hS=Ex,gS=Tx,mS=Mx,yS=u0,xS=Gx.load,vS=Gx.loadAll,bS=dS.dump,kS=be,ES={binary:Ix,float:Ax,map:kx,null:wx,pairs:Ox,set:zx,timestamp:Rx,bool:Cx,int:Sx,merge:Dx,omap:Fx,seq:bx,str:vx},wS=h0("safeLoad","load"),CS=h0("safeLoadAll","loadAll"),SS=h0("safeDump","dump"),or={Type:pS,Schema:fS,FAILSAFE_SCHEMA:hS,JSON_SCHEMA:gS,CORE_SCHEMA:mS,DEFAULT_SCHEMA:yS,load:xS,loadAll:vS,dump:bS,YAMLException:kS,types:ES,safeLoad:wS,safeLoadAll:CS,safeDump:SS};function dl(t){let e=0;for(let n=0;n<t.length;n++){let i=t.charCodeAt(n);e=(e<<5)-e+i,e=e&e}return Math.abs(e).toString(16).padStart(8,"0").slice(0,8)}var g0={P0:1.5,P1:1,P2:.5};function m0(t,e){let n=typeof e.subtype=="string"?e.subtype:void 0,i=Gn(t,n,e),a=Vn(t,n),r=a.p0.length===0||a.p0.every(l=>Qe(i,l)),s=a.p1.some(l=>Qe(i,l)),o=a.p2.some(l=>Qe(i,l));return r&&s&&o?"L3":r&&s?"L2":r?"L1":"L0"}function a3(t,e,n,i=1){let a=typeof e.subtype=="string"?e.subtype:void 0,r=Gn(t,a,e),s=Vn(t,a);if(![...s.p0,...s.p1,...s.p2].some(c=>Qe(r,c)))return 0;let l=0;if(s.p0.length>0){let c=s.p0.filter(u=>Qe(r,u)).length;l+=c/s.p0.length*g0.P0}if(s.p1.length>0){let c=s.p1.filter(u=>Qe(r,u)).length;l+=c/s.p1.length*g0.P1}if(s.p2.length>0){let c=s.p2.filter(u=>Qe(r,u)).length;l+=c/s.p2.length*g0.P2}return l*i*(1+Math.log1p(n))}var y0={create(t){let e=new Date().toISOString();return{id:dl(t.name),userId:t.userId||"",cardType:t.cardType,name:t.name,aliases:t.aliases||[],attributes:t.attributes||{},relatedPeople:[],relatedObjects:[],relatedThemes:[],evidenceEntryIds:[],confidence:.5,maturity:m0(t.cardType,t.attributes||{}),status:"needs_confirmation",lifecycle:"candidate",importance:0,createdAt:e,lastUpdated:e}}};var AS=or.dump,TS=or.load,Ou="---";function lr(t){let e={id:t.id,name:t.name,type:t.cardType,maturity:t.maturity,confidence:t.confidence,status:t.status,aliases:t.aliases,createdAt:t.createdAt,lastUpdated:t.lastUpdated};for(let[s,o]of Object.entries(t.attributes))o!=null&&(e[s]=o);let n=[`# ${t.name}`,""],i=DS(t);i.length>0&&(n.push("## \u57FA\u672C\u4FE1\u606F"),n.push(...i),n.push(""));let a=t.attributes.interactions||[];if(a.length>0){n.push("## \u4E92\u52A8\u8BB0\u5F55");for(let s of a.slice(-5)){let o=s.timestamp?new Date(s.timestamp).toISOString().split("T")[0]:"";n.push("- "+o+" "+s.content)}n.push("")}else t.attributes.interactions;let r=AS(e).trim();return`${Ou}
${r}
${Ou}

${n.join(`
`)}`}var MS=new Set(["L0","L1","L2","L3"]);function _S(t){return typeof t=="string"&&MS.has(t)}function Bs(t){let n=BS(t).frontmatter,i=n.type,a=Array.isArray(n.aliases)?n.aliases:[],r=new Set(["needs_confirmation","observing","active","archived"]),s=new Set(["id","name","type","maturity","confidence","aliases","createdAt","lastUpdated","lifecycle","importance","userId","relatedPeople","relatedObjects","relatedThemes","evidenceEntryIds"]),o=n.status,l=o!=null&&r.has(o),c={};for(let[p,f]of Object.entries(n))f!=null&&(s.has(p)||p==="status"&&l||(c[p]=f));let u=typeof c.subtype=="string"?c.subtype:void 0;Dl(i,u,n,c);let d=Gn(i,u,c);return{id:n.id||dl(n.name),userId:"",cardType:i,name:n.name,aliases:a,attributes:d,relatedPeople:[],relatedObjects:[],relatedThemes:[],evidenceEntryIds:[],confidence:typeof n.confidence=="number"?n.confidence:.5,maturity:_S(n.maturity)?n.maturity:"L0",status:l?o:"needs_confirmation",lifecycle:"candidate",importance:0,createdAt:n.createdAt||new Date().toISOString(),lastUpdated:n.lastUpdated||new Date().toISOString()}}function BS(t){let e=t.trim();if(!e.startsWith(Ou))return{frontmatter:{},body:e};let n=e.indexOf(Ou,3);if(n===-1)return{frontmatter:{},body:e};let i=e.slice(3,n).trim(),a=e.slice(n+3).trim();return{frontmatter:TS(i)||{},body:a}}function RS(t,e){let n=new Map,i=Tn(t);for(let a of i.commonAttributes)n.set(a.key,a.label);if(e&&i.subtypes?.[e])for(let a of i.subtypes[e].attributes)n.has(a.key)||n.set(a.key,a.label);return n}function r3(t,e){if(t[e.key]!=null&&t[e.key]!=="")return t[e.key];if(e.aliases){for(let n of e.aliases)if(t[n]!=null&&t[n]!=="")return t[n]}}function x0(t){if(Array.isArray(t))return t.map(String).join(", ");if(typeof t=="object"&&t!==null)try{return JSON.stringify(t)}catch{return""}return String(t)}function DS(t){let e=[],n=t.attributes,i=typeof n.subtype=="string"?n.subtype:void 0,a=Vn(t.cardType,i),r=RS(t.cardType,i),s=Tn(t.cardType),o=new Map;for(let d of s.commonAttributes)o.set(d.key,d);if(i&&s.subtypes?.[i])for(let d of s.subtypes[i].attributes)o.has(d.key)||o.set(d.key,d);if((t.cardType==="object"||t.cardType==="theme")&&n.subtype){let d=Qs(t.cardType,n.subtype)||n.subtype;e.push("- \u7C7B\u578B\uFF1A"+d)}let l=new Set(["subtype"]),c=[...a.p0,...a.p1];for(let d of c){if(l.has(d))continue;let p=o.get(d);if(!p)continue;let f=r3(n,p);if(f!==void 0){let y=r.get(d)||d;e.push(`- ${y}\uFF1A${x0(f)}`),l.add(d)}}for(let d of a.p2){if(l.has(d))continue;let p=o.get(d);if(!p)continue;let f=r3(n,p);if(f!==void 0){let y=r.get(d)||d;e.push(`- ${y}\uFF1A${x0(f)}`),l.add(d)}}let u=new Set(o.keys());for(let d of o.values())if(d.aliases)for(let p of d.aliases)u.add(p);for(let[d,p]of Object.entries(n))l.has(d)||u.has(d)||d==="interactions"||d==="relatedEntities"||p!=null&&p!==""&&(e.push(`- ${d}\uFF1A${x0(p)}`),l.add(d));return e}Hn();function IS(t){switch(t){case"person":return"Person/";case"object":return"Object/";case"theme":return"Theme/";default:return""}}function FS(t){return t.replace(/[\\/<>:"|?*]/g,"_").trim()}function s3(t,e){return`${IS(e)}${FS(t)||"unnamed"}.md`}function o3(t){let e=OS(t.type);return{path:s3(t.title,e),cardType:e,sanitizedName:t.title}}function OS(t){return t==="person"?"person":t==="object"?"object":t==="theme"?"theme":t==="project"||t==="thing"?"object":t==="idea"||t==="knowledge"?"theme":"object"}var cr={name:"",occupation:"",company:"",city:"",skills:[],roles:[],relationships:[],goals:[],focusAreas:[],lastUpdated:new Date().toISOString().split("T")[0]};function l3(t){let e={...cr},n=t.match(/^---\n([\s\S]*?)\n---/);if(n)try{let i=or.load(n[1]);i&&(typeof i.name=="string"&&(e.name=i.name),typeof i.occupation=="string"&&(e.occupation=i.occupation),typeof i.company=="string"&&(e.company=i.company),typeof i.city=="string"&&(e.city=i.city),Array.isArray(i.skills)&&(e.skills=i.skills.map(String)),Array.isArray(i.roles)&&(e.roles=i.roles.map(String)),Array.isArray(i.relationships)&&(e.relationships=i.relationships.map(String)),Array.isArray(i.goals)&&(e.goals=i.goals.map(String)),Array.isArray(i.focusAreas)&&(e.focusAreas=i.focusAreas.map(String)))}catch{}return!e.name&&!e.company?zS(t):e}function zS(t){let e={...cr},n=t.split(`
`),i="";for(let a of n){let r=a.trim();if(r.startsWith("## ")){i=r.slice(3);continue}if(i==="\u57FA\u672C\u4FE1\u606F"&&r.startsWith("- ")){let s=r.slice(2),[o,...l]=s.split("\uFF1A"),c=l.join("\uFF1A");o==="\u59D3\u540D"&&(e.name=c),(o==="\u804C\u4E1A"||o==="\u804C\u4F4D")&&(e.occupation=c),(o==="\u516C\u53F8/\u7EC4\u7EC7"||o==="\u516C\u53F8")&&(e.company=c),o==="\u57CE\u5E02"&&(e.city=c)}if(r.startsWith("- ")&&!r.includes("\uFF1A")){let s=r.slice(2);if(s==="_\u6682\u65E0_")continue;i==="\u6280\u80FD\u4E0E\u4E13\u4E1A"&&e.skills.push(s),i==="\u89D2\u8272\u4E0E\u5173\u7CFB"&&e.roles.push(s),i==="\u76EE\u6807\u4E0E\u8BA1\u5212"&&e.goals.push(s),i==="\u5173\u6CE8\u9886\u57DF"&&e.focusAreas.push(s)}if(r.startsWith("- \u5173\u7CFB\uFF1A")&&i==="\u89D2\u8272\u4E0E\u5173\u7CFB"){let s=r.slice(5);s!=="_\u6682\u65E0_"&&e.relationships.push(s)}}return e}var LS="TraceMind/PROFILE.md";async function c3(t){let e=t.vault.getFileByPath(LS);if(!e)return{...cr};try{let n=await t.vault.read(e);return l3(n)}catch{return{...cr}}}Ci();function NS(t,e,n){let i="\u4F60\u662F\u4E00\u4E2A\u7CBE\u51C6\u7684\u5B9E\u4F53\u63D0\u53D6\u548C\u65E5\u8BB0\u5206\u7C7B\u4E13\u5BB6\u3002\u8BF7\u5BF9\u4EE5\u4E0B\u65E5\u8BB0\u6587\u672C\u8FDB\u884C\u5206\u6790\u3002";return n&&(i+=`
...
\u65E5\u8BB0\u6587\u672C\uFF1A
${t}`,i}function PS(t){let e=["person","object","theme"];try{let n=t.trim(),i=n.indexOf('{"entities"');if(i>=0){let l=0,c=i;for(let u=i;u<n.length;u++)if(n[u]==="{")l++;else if(n[u]==="}"&&(l--,l===0)){c=u+1;break}n=n.slice(i,c),console.log('[TraceMind] parseLLM: extracted JSON via {"entities"} pattern:',n.substring(0,200))}else{let l=n.lastIndexOf(">");if(l>=0&&l>n.length*.3){let u=n.slice(l+1).trim();u.startsWith("{")&&(n=u)}console.log("[TraceMind] parseLLM: after tag removal (first 200):",n.substring(0,200));let c=n.match(/```(?:json)?\s*\n?([\s\S]*?)```/);if(c&&(n=c[1].trim()),!n.startsWith("{")){let u=n.indexOf("{"),d=n.lastIndexOf("}");u!==-1&&d!==-1&&(n=n.slice(u,d+1))}console.log("[TraceMind] parseLLM: final JSON (first 200):",n.substring(0,200))}let a=JSON.parse(n);if(console.log("[TraceMind] parseLLM: parsed JSON:",JSON.stringify(a).substring(0,200)),!a.entities||!Array.isArray(a.entities))return{entities:[]};let r=["\u5DE5\u4F5C","\u751F\u6D3B","\u5B66\u4E60","\u8FD0\u52A8","\u5176\u4ED6"],s=typeof a.domain=="string"&&r.includes(a.domain)?a.domain:void 0,o=[];for(let l of a.entities)!l.name||typeof l.name!="string"||l.name.trim()===""||e.includes(l.type)&&o.push({name:l.name.trim(),type:l.type,subtype:l.type==="object"&&l.subtype==="task"?"matter":l.subtype,confidence:typeof l.confidence=="number"?l.confidence:.5});return{domain:s,entities:o}}catch{return{entities:[]}}}async function u3(t,e){let n=e.provider||"openai",i={provider:n,apiKey:e.apiKey,model:e.model,baseUrl:e.baseUrl,enableThinking:e.enableThinking,reasoningEffort:e.reasoningEffort},a=ga(i);if(!a.valid)throw new Error(a.error);console.log("[TraceMind] LLM extract called, provider:",n,"baseUrl:",e.baseUrl,"model:",e.model);let r=NS(t,e.profileContext,e.extraContext);console.log("[TraceMind] LLM prompt:",r.substring(0,200));let s=Hs(i,[{role:"user",content:r}]);console.log("[TraceMind] LLM URL:",s.url);let o=await fetch(s.url,{method:s.method||"POST",headers:s.headers,body:s.body});if(console.log("[TraceMind] LLM response status:",o.status),!o.ok)throw await Us(o);let l=await o.json(),c=Sl(n,l);console.log("[TraceMind] LLM raw response:",c.content);let u=PS(c.content);return console.log("[TraceMind] LLM parsed: domain=",u.domain,"entities=",u.entities.length,u.entities),u}Ci();var jS={L0:30,L1:20,L2:10,L3:10},$S={P0:10,P1:5,P2:2};function US(t){let e=jS[t.maturityLevel]??10;return t.attributePriority&&(e+=$S[t.attributePriority]??2),t.type==="new_entity"&&(e+=10),e}function v0(t,e,n,i){let a=[],r=typeof n.subtype=="string"?n.subtype:void 0,s=Gn(t,r,n),o=Vn(t,r);for(let l of o.p0)Qe(s,l)||a.push({type:"missing_attribute",entityName:"",entityType:t,maturityLevel:e,attributePriority:"P0",missingAttribute:l,score:0,description:`Missing P0 attribute: ${l}`});for(let l of o.p1)Qe(s,l)||a.push({type:"missing_attribute",entityName:"",entityType:t,maturityLevel:e,attributePriority:"P1",missingAttribute:l,score:0,description:`Missing P1 attribute: ${l}`});for(let l of o.p2)Qe(s,l)||a.push({type:"missing_attribute",entityName:"",entityType:t,maturityLevel:e,attributePriority:"P2",missingAttribute:l,score:0,description:`Missing P2 attribute: ${l}`});e!=="L0"&&i.length===0&&a.push({type:"missing_relation",entityName:"",entityType:t,maturityLevel:e,attributePriority:"P1",score:0,description:"No relations established"});for(let l of a)l.score=US(l);return a.sort((l,c)=>c.score-l.score)}var HS=5,d3={company:"\u8FD9\u4E2A**\u516C\u53F8/\u7EC4\u7EC7**\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u4E1A\u52A1\u9886\u57DF\u3001\u5408\u4F5C\u5173\u7CFB\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002",project:"\u8FD9\u4E2A**\u9879\u76EE**\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5F53\u524D\u72B6\u6001\u3001\u65F6\u95F4\u8282\u70B9\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002",matter:"\u8FD9\u4E2A**\u4E8B\u9879**\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5F53\u524D\u72B6\u6001\u3001\u4E0B\u4E00\u6B65\u3001\u6240\u5C5E\u9879\u76EE\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002",task:"\u8FD9\u4E2A**\u4E8B\u9879**\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5F53\u524D\u72B6\u6001\u3001\u4E0B\u4E00\u6B65\u3001\u6240\u5C5E\u9879\u76EE\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002",product:"\u8FD9\u4E2A**\u4EA7\u54C1**\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5F53\u524D\u72B6\u6001\u3001\u5173\u952E\u7279\u6027\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002",technology:"\u8FD9\u4E2A**\u6280\u672F**\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5F53\u524D\u72B6\u6001\u3001\u4E3B\u8981\u7528\u9014\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002",document:"\u8FD9\u4E2A**\u6587\u6863**\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5F53\u524D\u72B6\u6001\u3001\u4E3B\u8981\u7528\u9014\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002",location:"\u8FD9\u4E2A**\u5730\u70B9**\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5728\u54EA\u91CC\u3001\u6709\u4EC0\u4E48\u7279\u522B\u4E4B\u5904\u7B49\u3002"},p3={friction:"\u8FD9\u4E2A**\u6469\u64E6**\u80FD\u804A\u804A\u5417\uFF1F\u6BD4\u5982\u662F\u4EC0\u4E48\u5BFC\u81F4\u7684\u3001\u6301\u7EED\u591A\u4E45\u4E86\u3001\u5F71\u54CD\u6709\u591A\u5927\uFF1F",goal:"\u8FD9\u4E2A**\u76EE\u6807**\u80FD\u804A\u804A\u5417\uFF1F\u6BD4\u5982\u76EE\u524D\u8FDB\u5C55\u3001\u4E0B\u4E00\u6B65\u8BA1\u5212\u3001\u6709\u4EC0\u4E48\u963B\u7887\uFF1F",judgment:"\u8FD9\u4E2A**\u5224\u65AD**\u80FD\u804A\u804A\u5417\uFF1F\u6BD4\u5982\u57FA\u4E8E\u4EC0\u4E48\u5F62\u6210\u7684\u3001\u6709\u591A\u5927\u628A\u63E1\uFF1F",idea:"\u8FD9\u4E2A**\u60F3\u6CD5**\u80FD\u804A\u804A\u5417\uFF1F\u6BD4\u5982\u600E\u4E48\u4EA7\u751F\u7684\u3001\u6709\u6CA1\u6709\u66F4\u5177\u4F53\u7684\u601D\u8003\uFF1F"};function f3(t,e){return t.type==="new_entity"?t.entityType==="object"&&e&&d3[e]?`${t.entityName} ${d3[e]}`:t.entityType==="object"?`${t.entityName} \u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5F53\u524D\u72B6\u6001\u3001\u65F6\u95F4\u8282\u70B9\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002`:t.entityType==="theme"&&e&&p3[e]?`${t.entityName} ${p3[e]}`:t.entityType==="theme"?`${t.entityName} \u80FD\u804A\u804A\u5417\uFF1F\u6BD4\u5982\u8FD9\u4E2A\u60C5\u51B5\u5F71\u54CD\u6709\u591A\u5927\u3001\u6301\u7EED\u591A\u4E45\u4E86\uFF1F`:t.entityType==="person"?`${t.entityName} \u662F\u8C01\uFF1F\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5728\u54EA\u5BB6\u516C\u53F8\u3001\u4EC0\u4E48\u804C\u4F4D\u3001\u548C\u4F60\u7684\u5173\u7CFB\u7B49\u3002`:`${t.entityName} \u662F\u4EC0\u4E48\uFF1F`:t.type==="missing_attribute"&&t.missingAttribute?{company:t.entityName+" \u5728\u54EA\u4E2A\u516C\u53F8\u6216\u7EC4\u7EC7\u5DE5\u4F5C\uFF1F",role:t.entityName+" \u7684\u804C\u4F4D\u6216\u89D2\u8272\u662F\u4EC0\u4E48\uFF1F",relationship_to_user:"\u4F60\u548C "+t.entityName+" \u662F\u4EC0\u4E48\u5173\u7CFB\uFF1F",responsibility:t.entityName+" \u8D1F\u8D23\u4EC0\u4E48\u5DE5\u4F5C\uFF1F",workingStyle:t.entityName+" \u7684\u534F\u4F5C\u98CE\u683C\u662F\u600E\u6837\u7684\uFF1F",subtype:t.entityName+" \u662F\u4EC0\u4E48\u7C7B\u578B\uFF1F\u6BD4\u5982\u9879\u76EE\u3001\u4E8B\u9879\u3001\u4EA7\u54C1\u7B49\uFF1F",stage:t.entityName+" \u5F53\u524D\u5904\u4E8E\u4EC0\u4E48\u9636\u6BB5\uFF1F",owner:t.entityName+" \u7684\u8D1F\u8D23\u4EBA\u662F\u8C01\uFF1F",taskStatus:t.entityName+" \u5F53\u524D\u7684\u72B6\u6001\u662F\u4EC0\u4E48\uFF1F",nextAction:t.entityName+" \u7684\u4E0B\u4E00\u6B65\u884C\u52A8\u662F\u4EC0\u4E48\uFF1F",dueDate:t.entityName+" \u6709\u622A\u6B62\u65E5\u671F\u5417\uFF1F",assignee:t.entityName+" \u7531\u8C01\u8D1F\u8D23\uFF1F",parentProject:t.entityName+" \u5C5E\u4E8E\u54EA\u4E2A\u9879\u76EE\uFF1F",useCase:t.entityName+" \u7684\u4E3B\u8981\u7528\u9014\u662F\u4EC0\u4E48\uFF1F",adoptionStatus:t.entityName+" \u5F53\u524D\u91C7\u7528\u72B6\u6001\u5982\u4F55\uFF1F",description:"\u5173\u4E8E "+t.entityName+" \u6709\u4EC0\u4E48\u8865\u5145\u4FE1\u606F\uFF1F",trigger:t.entityName+" \u7684\u89E6\u53D1\u6761\u4EF6\u662F\u4EC0\u4E48\uFF1F",impact:t.entityName+" \u6709\u4EC0\u4E48\u5F71\u54CD\uFF1F",frequency:t.entityName+" \u51FA\u73B0\u7684\u9891\u7387\u5982\u4F55\uFF1F",possibleCause:t.entityName+" \u53EF\u80FD\u7684\u539F\u56E0\u662F\u4EC0\u4E48\uFF1F",claim:t.entityName+" \u7684\u5177\u4F53\u4E3B\u5F20\u662F\u4EC0\u4E48\uFF1F",judgmentConfidence:"\u4F60\u5BF9 "+t.entityName+" \u7684\u786E\u4FE1\u5EA6\u5982\u4F55\uFF1F",evidence:t.entityName+" \u6709\u4EC0\u4E48\u8BC1\u636E\u652F\u6301\uFF1F",counterEvidence:t.entityName+" \u6709\u53CD\u9762\u7684\u8BC1\u636E\u5417\uFF1F",desiredOutcome:t.entityName+" \u671F\u671B\u7684\u7ED3\u679C\u662F\u4EC0\u4E48\uFF1F",currentState:t.entityName+" \u5F53\u524D\u8FDB\u5C55\u5982\u4F55\uFF1F",coreIdea:t.entityName+" \u7684\u6838\u5FC3\u60F3\u6CD5\u662F\u4EC0\u4E48\uFF1F"}[t.missingAttribute]||`\u5173\u4E8E ${t.entityName} \u7684 ${t.missingAttribute} \u4FE1\u606F\u662F\u4EC0\u4E48\uFF1F`:t.type==="missing_relation"?`${t.entityName} \u548C\u4EC0\u4E48\u5176\u4ED6\u5B9E\u4F53\u6709\u5173\u8054\uFF1F`:t.type==="recurring_pattern"?`${t.entityName} \u5DF2\u7ECF\u591A\u6B21\u51FA\u73B0\uFF0C\u5B83\u4EE3\u8868\u4EC0\u4E48\uFF1F`:`\u8BF7\u63D0\u4F9B\u66F4\u591A\u5173\u4E8E ${t.entityName} \u7684\u4FE1\u606F\u3002`}function YS(t,e){for(let[n,i]of e)if(i.cardType===t.type&&i.name===t.name)return{cardId:n,maturity:i.maturity};return null}function da(t){return t.trim().toLowerCase()}function VS(t,e){if(!t||!e)return 0;let n=Array.from({length:t.length+1},()=>Array(e.length+1).fill(0)),i=0;for(let a=1;a<=t.length;a++)for(let r=1;r<=e.length;r++)t[a-1]===e[r-1]&&(n[a][r]=n[a-1][r-1]+1,i=Math.max(i,n[a][r]));return i}function GS(t,e=[],n=3){let i=da(t.name);if(!i)return[];let a=[];for(let r of e){if(r.cardType!==t.type)continue;let s=[r.name,...r.aliases||[]].map(da).filter(Boolean);if(s.some(c=>c===i))continue;let o=0,l="";for(let c of s){if(i.length>=3&&c.includes(i)){let p=i.length/Math.max(i.length,c.length);o=Math.max(o,.82+p*.1),l="\u5F53\u524D\u63D0\u53CA\u662F\u5DF2\u6709\u6863\u6848\u540D\u79F0\u7684\u4E00\u90E8\u5206";continue}if(c.length>=3&&i.includes(c)){let p=c.length/Math.max(i.length,c.length),f=c.length<=4&&i.length>c.length?p:.7+p*.1;o=Math.max(o,f),l="\u5DF2\u6709\u6863\u6848\u540D\u79F0\u662F\u5F53\u524D\u63D0\u53CA\u7684\u4E00\u90E8\u5206";continue}let u=VS(i,c),d=u>=4?u/Math.min(i.length,c.length)*.75+u/Math.max(i.length,c.length)*.2:0;d>o&&(o=d,l="\u540D\u79F0\u6709\u8F83\u957F\u91CD\u53E0\u7247\u6BB5")}o>=.45&&a.push({id:r.id,name:r.name,type:r.cardType,filePath:r.filePath,score:Number(o.toFixed(2)),reason:l})}return a.sort((r,s)=>s.score-r.score||r.name.length-s.name.length).slice(0,n)}function qS(t,e=[]){let n=da(t.name);if(!n)return null;for(let i of e)if(i.cardType===t.type&&da(i.name)===n)return i;for(let i of e)if(i.cardType===t.type&&(i.aliases||[]).some(a=>da(a)===n))return i;return null}function XS(t,e=[]){let n=[],i=new Map;for(let a of t){let r=qS(a,e),s=r?{...a,name:r.name,type:r.cardType,subtype:a.subtype||r.subtype}:a,o=`${s.type}:${da(s.name)}`,l=i.get(o);if(l===void 0){i.set(o,n.length),n.push(s);continue}let c=n[l];n[l]={...c,confidence:Math.max(c.confidence??.5,s.confidence??.5),subtype:c.subtype||s.subtype}}return n}function KS(t,e){let n=da(t);return n?e.filter(i=>{let a=da(i.name);return!!a&&n.includes(a)}):[]}function ZS(t){return t.replace(/!?\[\[([^\]\|#]+(?:\.(?:md|pdf|docx?|xlsx?|pptx?|png|jpe?g|gif|webp|svg|txt|csv|json|html?))(?:#[^\]\|]+)?)(?:\|[^\]]*)?\]\]/gi," ").replace(/\[[^\]]+\]\((?:https?:\/\/|file:\/\/|\/|~\/|[A-Za-z]:\\|(?:TraceMind|Daily|Person|Object|Theme|Attachments|attachments|outputs|explorations|files|Files|assets|Assets)\/)[^)]+\)/gi," ").replace(/\bhttps?:\/\/[^\s\]\)）"'，。；;]+/gi," ").replace(/\bfile:\/\/[^\s\]\)）"'，。；;]+/gi," ").replace(/(?:^|[\s（(:：])(?:~\/|\/Users\/|\/Volumes\/|\/private\/|\/tmp\/)[^\s\]\)）"'，。；;]+/gi," ").replace(/\b[A-Za-z]:\\[^\s\]\)）"'，。；;]+/g," ").replace(/\b(?:TraceMind|Daily|Person|Object|Theme|Attachments|attachments|outputs|explorations|files|Files|assets|Assets)\/[^\s\]\)）"'，。；;]+(?:\.(?:md|pdf|docx?|xlsx?|pptx?|png|jpe?g|gif|webp|svg|txt|csv|json|html?))(?:#[^\s\]\)）"'，。；;]+)?/gi," ").replace(/[ \t]{2,}/g," ").replace(/\n{3,}/g,`

`).trim()}var pl=class{static analyzeBlock(e,n){return console.warn("[TraceMind] analyzeBlock (sync) is deprecated, use analyzeBlockAsync for LLM extraction"),{entities:[],newEntities:[],existingEntities:[],hasClarifications:!1,gapCount:0}}static async analyzeBlockAsync(e,n,i,a,r){let s=[],o;if(i&&ga({provider:i.provider||"openai",apiKey:i.apiKey,model:i.model,baseUrl:i.baseUrl}).valid){console.log("[TraceMind] LLM config:",{baseUrl:i.baseUrl,model:i.model,hasApiKey:!!i.apiKey});try{let u={...i,extraContext:r,profileContext:i.profileContext},d=ZS(e),p=await u3(d,u);console.log("[TraceMind] LLM extracted:",p.entities.length,p.entities,"domain:",p.domain);let f=KS(d,p.entities.map(y=>({...y})));f.length!==p.entities.length&&console.log("[TraceMind] LLM extracted entities filtered by source mentions:",{before:p.entities.map(y=>y.name),after:f.map(y=>y.name)}),s=XS(f,a),o=p.domain}catch(u){console.warn("[TraceMind] LLM extraction failed:",u.message)}}else console.log("[TraceMind] No LLM config provided, skipping extraction");let c=QS(s,n,a);return c.domainCategory=o,c}static summarizeResult(e){if(e.entities.length===0)return"\u672A\u68C0\u6D4B\u5230\u9700\u8981\u5173\u6CE8\u7684\u5B9E\u4F53\u3002";let n=[];if(e.newEntities.length>0){let i=e.newEntities.map(a=>a.name).join("\u3001");n.push(`\u53D1\u73B0 ${e.newEntities.length} \u4E2A\u65B0\u5B9E\u4F53\uFF1A${i}`)}if(e.existingEntities.length>0){let i=e.existingEntities.map(a=>a.name).join("\u3001");n.push(`\u63D0\u53CA ${e.existingEntities.length} \u4E2A\u5DF2\u6709\u5B9E\u4F53\uFF1A${i}`)}return e.hasClarifications&&n.push("\u9700\u8981\u8FDB\u4E00\u6B65\u6F84\u6E05\u4FE1\u606F\u3002"),n.join(`
`)}};function QS(t,e,n=[]){let i=[];for(let o of t){let l=YS(o,e),c=o.subtype?{subtype:o.subtype}:{},u=l?.maturity??m0(o.type,c),d=a3(o.type,c,0),p=[];if(l){let x=v0(o.type,u,c,[]);p.push(...x)}else{p.push({type:"new_entity",entityName:o.name,entityType:o.type,maturityLevel:"L0",attributePriority:"P0",score:40,description:`New entity: ${o.name}`});let x=v0(o.type,"L0",c,[]);p.push(...x)}let f=p.slice(0,2).map(x=>f3(x,o.subtype)),y={...o,isNew:!l,existingCardId:l?.cardId,maturity:u,priorityScore:d,clarificationQuestions:f,knowledgeGaps:p,similarCandidates:l?[]:GS(o,n)};i.push(y)}i.sort((o,l)=>o.isNew!==l.isNew?o.isNew?-1:1:l.priorityScore-o.priorityScore);let a=i.slice(0,HS),r=a.flatMap(o=>o.knowledgeGaps??[]),s=r.sort((o,l)=>l.score-o.score)[0];return{entities:a,newEntities:a.filter(o=>o.isNew),existingEntities:a.filter(o=>!o.isNew),hasClarifications:a.some(o=>o.isNew),gapCount:r.length,firstQuestion:s?f3(s):void 0}}var JS=or.load,WS=new Set(["L0","L1","L2","L3"]),b0=new Set(["id","name","type","subtype","maturity","confidence","aliases","createdAt","lastUpdated","lifecycle","importance","userId","relatedPeople","relatedObjects","relatedThemes","evidenceEntryIds","interactions","filePath","relationCount","summary"]);function pa(t,e){let n=tA(t),i=n?.name;i||(i=e.split("/").pop()?.replace(".md","")||"");let a=n?.type||"person",r=n?.maturity,s=r&&WS.has(r)?r:"L0",o=typeof n?.confidence=="number"?n.confidence:.5,l=Array.isArray(n?.aliases)?n.aliases:[],c=n?.summary,u=n?.subtype,d={};if(n)for(let[x,E]of Object.entries(n))!b0.has(x)&&E!=null&&(d[x]=E);Dl(a,u,n||{},d);let p=Gn(a,u,d),f=c||p.summary||d.context||void 0,y={};for(let[x,E]of Object.entries(p))!b0.has(x)&&E!=null&&(y[x]=E);for(let[x,E]of Object.entries(d))!b0.has(x)&&E!=null&&(!(x in p)||p[x]==null)&&(y[x]=E);return{id:n?.id||dl(i),name:i,cardType:a,type:eA(a),subtype:u,summary:f,maturity:s,confidence:o,filePath:e,aliases:l,relationCount:0,lastUpdated:n?.lastUpdated||new Date().toISOString(),metadata:Object.keys(y).length>0?y:void 0}}function h3(t){let e=[];for(let n of t)if(n.content.trim())try{let i=pa(n.content,n.path);e.push(i)}catch{}return{entries:e,lastRebuild:new Date().toISOString()}}function tA(t){let e=t.trim();if(!e.startsWith("---"))return null;let n=e.indexOf("---",3);if(n===-1)return null;let i=e.slice(3,n).trim();return JS(i)||null}function eA(t){switch(t){case"person":return"person";case"object":return"thing";case"theme":return"idea";default:return"thing"}}function g3(t,e){let n=e.trim().toLowerCase();return n&&t.entries.find(i=>i.name.toLowerCase()===n||i.aliases.some(a=>a.toLowerCase()===n))||null}function ur(t,e){let n=t.entries.findIndex(a=>a.id===e.id),i=[...t.entries];return n>=0?i[n]=e:i.push(e),{entries:i,lastRebuild:t.lastRebuild}}function m3(t){return JSON.stringify(t,null,2)}function y3(t){let e=JSON.parse(t);return{entries:e.entries||[],lastRebuild:e.lastRebuild||new Date().toISOString()}}Hn();var Rs="TraceMind/index/entity-index.json";async function x3(t,e){await Ne(t,Rs);let n=m3(e),i=t.vault.getFileByPath(Rs);if(i)await t.vault.modify(i,n);else try{await t.vault.create(Rs,n)}catch(a){let r=t.vault.getFileByPath(Rs);if(r){await t.vault.modify(r,n);return}if(a.message.includes("File already exists")){await t.vault.adapter.write(Rs,n);return}throw a}}async function v3(t){let e=t.vault.getFileByPath(Rs);if(!e)return null;try{return y3(await t.vault.read(e))}catch{return null}}function b3(t){let e=JSON.parse(t);return{blockId:e.blockId,content:e.content,messages:e.messages||[],analysisResult:e.analysisResult,clarificationPhase:e.clarificationPhase,clarificationIndex:e.clarificationIndex,skippedEntityNames:Array.isArray(e.skippedEntityNames)?e.skippedEntityNames:[],createdAt:e.createdAt,updatedAt:e.updatedAt,currentPhase:e.currentPhase||"analysis"}}var nA="TraceMind/sessions";function k0(t){return`${nA}/${t}.json`}function k3(t){return b3(t)}var En=require("obsidian");Hn();var dr=["Daily","Person","Object","Theme","TraceMind","TraceMind/sessions","TraceMind/index","TraceMind/insights","TraceMind/tasks","TraceMind/tasks/runs"],he="TraceMind/PROFILE.md";function E3(t){let e=[];for(let n of dr)t.exists(n)||e.push(`\u76EE\u5F55: ${n}`);return t.exists(he)||e.push(`\u6863\u6848: ${he}`),e}function E0(t){let e=[];for(let i of dr){let a=t.getType(i);a===null?e.push({type:"missing_dir",path:i,expected:"folder",actual:"unknown",label:`\u76EE\u5F55\u7F3A\u5931: ${i}`,repairable:!0}):a!=="folder"&&e.push({type:"wrong_type",path:i,expected:"folder",actual:a,label:`\u8DEF\u5F84\u7C7B\u578B\u9519\u8BEF: ${i}\uFF08\u5E94\u4E3A\u76EE\u5F55\uFF0C\u5B9E\u9645\u4E3A${a==="file"?"\u6587\u4EF6":"\u672A\u77E5"}\uFF09`,repairable:!1})}let n=t.getType(he);return n===null?e.push({type:"missing_file",path:he,expected:"file",actual:"unknown",label:`\u6863\u6848\u7F3A\u5931: ${he}`,repairable:!0}):n!=="file"&&e.push({type:"wrong_type",path:he,expected:"file",actual:n,label:`\u8DEF\u5F84\u7C7B\u578B\u9519\u8BEF: ${he}\uFF08\u5E94\u4E3A\u6587\u4EF6\uFF0C\u5B9E\u9645\u4E3A${n==="folder"?"\u76EE\u5F55":"\u672A\u77E5"}\uFF09`,repairable:!1}),e}async function w0(t){try{return await t.stat(he)===null}catch{return!0}}function w3(t,e){new C0(t,e).open()}var iA=`---
name: ""
occupation: ""
company: ""
city: ""
...
`+i.map(a=>`  - ${a}`).join(`
`));return}this.close(),await this.onComplete()})})}async initializeAll(){for(let n of dr)await xr(this.app,n);this.dirsCreated=!0,this.app.vault.getAbstractFileByPath(he)?this.profileCreated=!0:(await this.app.vault.create(he,iA),this.profileCreated=!0)}validateStructure(){return E3({exists:e=>this.app.vault.getAbstractFileByPath(e)!==null})}showStatus(e){this.statusEl&&(this.statusEl.style.whiteSpace="pre-line",this.statusEl.setText(e))}clearStatus(){this.statusEl&&this.statusEl.setText("")}onClose(){let{contentEl:e}=this;e.empty()}};function C3(t,e,n,i,a){new S0(t,e,n,i,a).open()}var S0=class extends En.Modal{issues;onRepair;onSkip;onComplete;listEl=null;constructor(e,n,i,a,r){super(e),this.issues=n,this.onRepair=i,this.onSkip=a,this.onComplete=r}onOpen(){let{contentEl:e}=this;e.createEl("h2",{text:"TraceMind Vault \u7ED3\u6784\u9700\u8981\u4FEE\u6B63"}),e.createEl("p",{text:"\u68C0\u6D4B\u5230\u5FC5\u8981\u76EE\u5F55\u6216\u6863\u6848\u7F3A\u5931/\u5F02\u5E38\uFF1A"}),this.listEl=e.createEl("ul"),this.renderIssues(),new En.Setting(e).addButton(n=>{n.setButtonText("\u4FEE\u6B63").setCta().onClick(async()=>{this.issues=await this.onRepair(),this.issues.length===0?(new En.Notice("TraceMind Vault \u7ED3\u6784\u5DF2\u4FEE\u6B63"),this.close(),await this.onComplete()):this.renderIssues()})}).addButton(n=>{n.setButtonText("\u6682\u4E0D\u4FEE\u6B63").onClick(()=>{new En.Notice("\u7ED3\u6784\u672A\u4FEE\u6B63\uFF0C\u90E8\u5206\u529F\u80FD\u53EF\u80FD\u4E0D\u53EF\u7528"),this.close(),this.onSkip()})})}renderIssues(){if(this.listEl){this.listEl.empty();for(let e of this.issues){let n=this.listEl.createEl("li",{text:e.label});e.repairable||n.createEl("span",{text:"\uFF08\u9700\u624B\u52A8\u5904\u7406\uFF09",cls:"tracemind-repair-warning",attr:{style:"color: #e74c3c"}})}}}onClose(){this.contentEl.empty()}};var aA=/^---\n([\s\S]*?)\n---\n?/;function S3(t){let e=t.match(aA);if(!e)return null;let n=e[1],i=t.slice(e[0].length),a={};for(let c of n.split(`
`)){let u=c.indexOf(":");if(u===-1)continue;let d=c.slice(0,u).trim(),p=c.slice(u+1).trim();d&&p&&(a[d]=p)}let r=a.date,s=a.contentHash,o=a.generatedAt,l=parseInt(a.blockCount||"0",10);return!r||!s||!o||!i.trim()?null:{date:r,content:i.trim(),contentHash:s,generatedAt:o,blockCount:l}}function A3(t){return`${["---",`date: ${t.date}`,`generatedAt: ${t.generatedAt}`,`contentHash: ${t.contentHash}`,`blockCount: ${t.blockCount}`,"---"].join(`
`)}

${t.content}
`}function zu(t){return`TraceMind/insights/${t}.md`}Hn();async function T3(t,e){let n=zu(e.date);await Ne(t,n);let i=A3(e),a=t.vault.getFileByPath(n);return a?await t.vault.modify(a,i):await t.vault.create(n,i),n}Ci();var M3=/^###\s+(\d{2}:\d{2})\s+(.+)$/m,rA=/<!--\s*TM:([a-z0-9]+)\s*-->/;function sA(){return Math.random().toString(16).slice(2,10).padStart(8,"0")}function A0(t){let e=[],n=t.split(`
`),i=0;for(;i<n.length;){let r=n[i].match(M3);if(r){let s=r[1],l=r[2].trim().split(/\s+/).filter(d=>d.startsWith("#")).map(d=>d.slice(1));i++;let c=[],u=[];for(;i<n.length;){let d=n[i];if(d.match(M3))break;if(!d.trim()){i++;continue}let p=d.match(rA);if(p){let f=p[1];e.push({timestamp:s,content:c.join(`
...
`).trim(),tags:l,blockId:sA(),children:u})}}else i++}return e}function _3(t,e){if(t.length<=1)return[];let n=e&&t.includes(e)?e:t[0];return t.filter(i=>i!==n)}var oA=dr,Lu=class extends Ke.Plugin{settings;userProfile={...cr};analysisService=pl;entityIndex={entries:[],lastRebuild:""};entityManager;sessionManager;aiProvider;taskStore;aiAnalysisView;blockEditorView;calendarView;explorationCanvasView;taskBoardView;async onload(){console.log("TraceMind: loading...");try{await this.loadSettings(),this.userProfile=await c3(this.app),og(),this.entityManager=new T0(this.app,this),this.sessionManager=new M0(this.app),this.aiProvider=new _0(this),this.taskStore=new Mu(this.app),await this.sessionManager.initialize(),await this.taskStore.initialize(),this.registerView(Yn,e=>(this.blockEditorView=new Ks(e,this),this.blockEditorView)),this.registerView(vr,e=>(this.aiAnalysisView=new Fl(e,this),this.aiAnalysisView)),this.registerView(Js,e=>(this.calendarView=new zl(e,this),this.calendarView.setOnDateClick(n=>this.navigateToDate(n)),this.calendarView)),this.registerView(ar,e=>(this.explorationCanvasView=new la(e,this),this.explorationCanvasView)),this.registerView(rl,e=>(this.taskBoardView=new Ss(e,this),this.taskBoardView)),this.addSettingTab(new Al(this.app,this)),(0,Ke.addIcon)(ma,$h),this.addRibbonIcon(ma,"\u6253\u5F00 TraceMind",()=>{this.openTracemindView()}),this.addRibbonIcon("calendar","\u6253\u5F00\u65E5\u5386",()=>{this.openCalendarView()}),this.addCommand({id:"open-tracemind",name:"\u6253\u5F00 TraceMind \u89C6\u56FE",callback:()=>this.openTracemindView()}),this.addCommand({id:"open-calendar",name:"\u6253\u5F00\u65E5\u5386",callback:()=>this.openCalendarView()}),this.addCommand({id:"open-exploration-canvas",name:"TraceMind: \u6253\u5F00\u601D\u8003\u63A2\u7D22\u767D\u677F",callback:()=>this.openExplorationCanvas()}),this.addCommand({id:"open-action-board",name:"TraceMind: \u6253\u5F00\u884C\u52A8\u770B\u677F",callback:()=>this.openActionBoard()}),this.addCommand({id:"analyze-block",name:"\u5206\u6790\u5F53\u524D\u65E5\u8BB0\u5757",callback:()=>this.analyzeCurrentBlock()}),this.addCommand({id:"rebuild-index",name:"\u91CD\u5EFA\u5B9E\u4F53\u7D22\u5F15",callback:()=>this.rebuildEntityIndexCommand()}),this.registerEvent(this.app.workspace.on("editor-change",()=>{this.onEditorChange()})),this.registerEvent(this.app.workspace.on("file-open",e=>{this.maybeOpenTraceMindCanvas(e)})),this.registerEvent(this.app.workspace.on("active-leaf-change",()=>{this.syncTraceMindSidebars().catch(console.error)})),console.log("TraceMind: loaded successfully"),await w0(this.app.vault.adapter)?w3(this.app,async()=>{await this.ensureVaultStructure(),await this.rebuildEntityIndex()}):(await this.ensureVaultStructure(),await this.initializeEntityIndex()),this.scheduleVaultStructureCheck(),this.app.workspace.onLayoutReady(()=>{this.pruneDuplicateAIAnalysisPanels().then(()=>this.syncTraceMindSidebars()).catch(console.error)})}catch(e){console.error("TraceMind: Failed to load",e),new Ke.Notice("TraceMind \u52A0\u8F7D\u5931\u8D25: "+e.message)}}onunload(){console.log("TraceMind: unloading...")}async loadSettings(){let e=await this.loadData();this.settings={...yh,...e};for(let n of this.settings.providers)n.providerType||(n.baseUrl?.includes("anthropic.com")?n.providerType="anthropic":n.baseUrl?.includes("localhost:11434")||n.baseUrl?.includes("127.0.0.1:11434")?n.providerType="ollama":n.providerType="openai")}async saveSettings(){await this.saveData(this.settings)}async ensureVaultStructure(){for(let e of oA)await xr(this.app,e);console.log("TraceMind: vault structure ensured")}autoAnalysisTimer=null;onEditorChange(){this.autoAnalysisTimer&&clearTimeout(this.autoAnalysisTimer),this.autoAnalysisTimer=setTimeout(()=>{this.autoAnalysisTimer=null},2e3)}async rebuildEntityIndexCommand(){await this.rebuildEntityIndex(),new Ke.Notice(`\u5B9E\u4F53\u7D22\u5F15\u5DF2\u91CD\u5EFA: ${this.entityIndex.entries.length} \u4E2A\u5B9E\u4F53`)}async initializeEntityIndex(){let e=await v3(this.app);if(e&&e.entries.length>0){this.entityIndex=e,console.log(`TraceMind: loaded entity index with ${e.entries.length} entries from file`);return}await this.rebuildEntityIndex({persist:!0})}async rebuildEntityIndex(e={persist:!0}){let n=["Person","Object","Theme"],i=[];for(let a of n)try{let r=await this.app.vault.adapter.list(a+"/");for(let s of r.files)if(s.endsWith(".md")){let o=await this.app.vault.adapter.read(s);i.push({path:s,content:o})}}catch{}this.entityIndex=h3(i),console.log(`TraceMind: entity index rebuilt with ${this.entityIndex.entries.length} entries`),e.persist&&await this.persistEntityIndex()}scheduleVaultStructureCheck(){setTimeout(()=>{let e=E0({getType:n=>{let i=this.app.vault.getAbstractFileByPath(n);return i?i.children!==void 0?"folder":"file":null}});e.length!==0&&C3(this.app,e,async()=>{for(let n of e)n.repairable&&(n.type==="missing_dir"?await xr(this.app,n.path):n.type==="missing_file"&&n.path===he&&(this.app.vault.getAbstractFileByPath(he)||await this.app.vault.create(he,`---
name: ""
occupation: ""
company: ""
city: ""
