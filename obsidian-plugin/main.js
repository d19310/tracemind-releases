"use strict";var an=Object.create;var pe=Object.defineProperty;var sn=Object.getOwnPropertyDescriptor;var on=Object.getOwnPropertyNames;var ln=Object.getPrototypeOf,cn=Object.prototype.hasOwnProperty;var he=(e,t)=>()=>(e&&(t=e(e=0)),t);var J=(e,t)=>{for(var i in t)pe(e,i,{get:t[i],enumerable:!0})},yt=(e,t,i,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of on(t))!cn.call(e,r)&&r!==i&&pe(e,r,{get:()=>t[r],enumerable:!(n=sn(t,r))||n.enumerable});return e};var un=(e,t,i)=>(i=e!=null?an(ln(e)):{},yt(t||!e||!e.__esModule?pe(i,"default",{value:e,enumerable:!0}):i,e)),dn=e=>yt(pe({},"__esModule",{value:!0}),e);var Oe={};J(Oe,{buildRequest:()=>_e,chat:()=>fe,extractStreamDelta:()=>Le,parseResponse:()=>xt,streamChat:()=>Re,validateConfig:()=>pn});function pn(e){return e.provider?!e.apiKey||e.apiKey.trim()===""?{valid:!1,error:"apiKey is required"}:!e.model||e.model.trim()===""?{valid:!1,error:"model is required"}:{valid:!0}:{valid:!1,error:"provider is required"}}function _e(e,t){let i=t.find(r=>r.role==="system"),n=t.filter(r=>r.role!=="system");switch(e.provider){case"openai":{let r=(e.baseUrl||"https://api.openai.com").replace(/\/+$/,""),s=r.endsWith("/v1")?"/chat/completions":"/v1/chat/completions";return{url:`${r}${s}`,method:"POST",headers:{Authorization:`Bearer ${e.apiKey}`,"Content-Type":"application/json"},body:JSON.stringify({model:e.model,messages:t})}}case"anthropic":return{url:e.baseUrl||"https://api.anthropic.com/v1/messages",method:"POST",headers:{"x-api-key":e.apiKey,"anthropic-version":"2023-06-01","Content-Type":"application/json"},body:JSON.stringify({model:e.model,system:i?.content,messages:n.map(r=>({role:r.role,content:r.content}))})};default:{let s=(e.baseUrl||(e.provider==="ollama"?"http://localhost:11434":"")).replace(/\/+$/,""),a=s.endsWith("/v1")?"/chat/completions":"/v1/chat/completions";return{url:`${s}${a}`,method:"POST",headers:{"Content-Type":"application/json",...e.apiKey?{Authorization:`Bearer ${e.apiKey}`}:{}},body:JSON.stringify({model:e.model,messages:t})}}}}async function fe(e,t){let i=_e(t,e),n=await fetch(i.url,{method:i.method||"POST",headers:i.headers,body:i.body});if(!n.ok){let a=await n.text();throw new Error(`HTTP ${n.status}: ${a}`)}let r=await n.json();return{content:xt(t.provider,r).content}}function Le(e,t){if(!t.startsWith("data: "))return"";let i=t.slice(6).trim();if(!i||i==="[DONE]")return"";try{let n=JSON.parse(i);if(e==="anthropic")return n.type==="content_block_delta"&&n.delta?.text?n.delta.text:"";let r=n.choices;return r&&r.length>0&&r[0].delta?.content?r[0].delta.content:""}catch{return""}}async function Re(e,t,i){try{let n=_e(t,e),r=JSON.parse(n.body||"{}");r.stream=!0;let s={...n.headers,Accept:"text/event-stream"},a=await fetch(n.url,{method:n.method||"POST",headers:s,body:JSON.stringify(r)});if(!a.ok){let d=await a.text();throw new Error(`HTTP ${a.status}: ${d}`)}if(!a.body)throw new Error("Response body is null \u2014 streaming not supported");let o=a.body.getReader(),l=new TextDecoder,c="",u="";for(;;){let{done:d,value:p}=await o.read();if(d)break;u+=l.decode(p,{stream:!0});let h=u.split(`
`);u=h.pop()||"";for(let g of h){let f=g.trim();if(!f)continue;let m=Le(t.provider,f);m&&(c+=m,i.onDelta(m))}}if(u.trim()){let d=Le(t.provider,u.trim());d&&(c+=d,i.onDelta(d))}i.onDone(c)}catch(n){i.onError(n)}}function xt(e,t){switch(e){case"openai":{let i=t.choices;if(!i||i.length===0)throw new Error("Empty response from OpenAI");return{role:"assistant",content:i[0].message.content}}case"anthropic":{let i=t.content;if(!i||i.length===0)throw new Error("Empty response from Anthropic");return{role:"assistant",content:i[0].text}}default:{let i=t.choices;if(!i||i.length===0)throw new Error("Empty response from AI provider");return{role:"assistant",content:i[0].message.content}}}}var V=he(()=>{"use strict"});var Ne={};J(Ne,{resolveExecutable:()=>N});async function N(e){let{execSync:t}=require("child_process"),{homedir:i}=require("os"),n=i(),r=[`${n}/.local/bin/${e}`,`${n}/.npm-global/bin/${e}`,`/usr/local/bin/${e}`,`/opt/homebrew/bin/${e}`,e];for(let s of r)try{return t(`"${s}" --version 2>&1`,{encoding:"utf-8",timeout:5e3}),s}catch{continue}return null}var X=he(()=>{"use strict"});var It={};J(It,{hermesProvider:()=>wn});var vn,En,Mt,bn,wn,Bt=he(()=>{"use strict";X();({spawn:vn}=require("child_process")),En=require("readline"),Mt="hermes",bn=600*1e3,wn={name:"Hermes",description:"\u5F00\u6E90 AI agent \u6846\u67B6\uFF0C\u652F\u6301\u591A provider\uFF0C\u901A\u8FC7 hermes CLI \u8C03\u7528",async detect(){let e=await N(Mt);if(!e)return!1;try{let{execSync:t}=require("child_process"),i=t(`${e} --version 2>&1`,{encoding:"utf-8",timeout:1e4});return/Hermes Agent/i.test(i)}catch{return!1}},execute(e,t){let i=null,n=!1,r=null,s=null,a=null,o=Date.now();return(async()=>{try{let c=await N(Mt);if(!c){let m=new Error("\u627E\u4E0D\u5230 hermes CLI\uFF0C\u8BF7\u786E\u8BA4\u5DF2\u5B89\u88C5 Hermes Agent");a?.(m),s?.({status:"failed",output:"",error:m.message,durationMs:Date.now()-o});return}let u=["-z",e];t?.model&&u.unshift("-m",t.model);let d={...process.env,...t?.env};if(i=vn(c,u,{env:d,cwd:t?.cwd||process.cwd(),stdio:["ignore","pipe","pipe"]}),n){i.kill();return}i.on("error",m=>{a?.(m),s?.({status:"failed",output:"",error:m.message,durationMs:Date.now()-o})});let p=setTimeout(()=>{i&&!i.killed&&(i.kill(),s?.({status:"timeout",output:"",error:"\u6267\u884C\u8D85\u65F6",durationMs:Date.now()-o}))},t?.timeoutMs||bn),h="",g=En.createInterface({input:i.stdout,crlfDelay:1/0});g.on("line",m=>{h+=m+`
`,r?.({type:"text",content:m+`
`})}),g.on("close",()=>{clearTimeout(p),s?.({status:"completed",output:h.trim(),durationMs:Date.now()-o})});let f="";i.stderr&&i.stderr.on("data",m=>{f+=m.toString()}),i.on("close",m=>{clearTimeout(p),m!==0&&h===""&&s?.({status:"failed",output:"",error:`hermes \u9000\u51FA\u7801 ${m}: ${f.slice(0,500)}`,durationMs:Date.now()-o})})}catch(c){a?.(c),s?.({status:"failed",output:"",error:c.message,durationMs:Date.now()-o})}})(),{set onMessage(c){r=c},get onMessage(){return r},set onDone(c){s=c},get onDone(){return s},set onError(c){a=c},get onError(){return a},abort(){n=!0,i&&!i.killed&&i.kill()}}}}});var Pt={};J(Pt,{claudeCodeProvider:()=>Tn});var kn,Cn,Dt,An,Tn,Lt=he(()=>{"use strict";X();({spawn:kn}=require("child_process")),Cn=require("readline"),Dt="claude",An=600*1e3,Tn={name:"Claude Code",description:"Anthropic \u51FA\u54C1\u7684\u672C\u5730 AI \u7F16\u7A0B agent\uFF0C\u901A\u8FC7 claude CLI \u8C03\u7528",async detect(){let e=await N(Dt);if(!e)return!1;try{let{execSync:t}=await import("node:child_process"),i=t(`${e} --version 2>&1`,{encoding:"utf-8",timeout:1e4});return/[Cc]laude|[0-9]+\.[0-9]+\.[0-9]+/.test(i)}catch{return!1}},execute(e,t){let i=null,n=!1,r=null,s=null,a=null,o=Date.now(),l=t?.timeoutMs||An;return(async()=>{try{let u=await N(Dt);if(!u){let x=new Error("\u627E\u4E0D\u5230 claude CLI\uFF0C\u8BF7\u786E\u8BA4\u5DF2\u5B89\u88C5 Claude Code");a?.(x),s?.({status:"failed",output:"",error:x.message,durationMs:Date.now()-o});return}let d=["-p","--output-format","stream-json","--input-format","stream-json","--verbose"];t?.model&&d.push("--model",t.model);let p={...process.env};if(t?.env&&Object.assign(p,t.env),i=kn(u,d,{env:p,cwd:t?.cwd||process.cwd(),stdio:["pipe","pipe","pipe"]}),n){i.kill();return}i.on("error",x=>{a?.(x),s?.({status:"failed",output:"",error:x.message,durationMs:Date.now()-o})});let h=setTimeout(()=>{i&&!i.killed&&(i.kill(),s?.({status:"timeout",output:"",error:"\u6267\u884C\u8D85\u65F6",durationMs:Date.now()-o}))},l),g=Cn.createInterface({input:i.stdout,crlfDelay:1/0}),f="",m="";g.on("line",x=>{if(x.trim())try{let M=JSON.parse(x);switch(M.type){case"system":M.session_id&&(f=M.session_id),M.subtype==="init"&&r?.({type:"status",content:"running",sessionId:f});break;case"assistant":{let Pe=M.message?.content||[];for(let S of Pe)S.type==="text"&&S.text?(m+=S.text,r?.({type:"text",content:S.text})):S.type==="tool_use"&&r?.({type:"tool-use",toolName:S.name,toolInput:S.input});break}case"user":{let Pe=M.message?.content||[];for(let S of Pe)S.type==="tool_use"&&S.name&&r?.({type:"tool-result",toolName:S.name});break}case"result":clearTimeout(h);let mt=M.is_error||M.subtype==="error_during_execution",rn=M.output||m;s?.({status:mt?"failed":"completed",output:rn,error:mt?M.output||"\u672A\u77E5\u9519\u8BEF":void 0,durationMs:Date.now()-o});break}}catch{}}),g.on("close",()=>{clearTimeout(h),n||s?.({status:"completed",output:m,durationMs:Date.now()-o})});let v=JSON.stringify({type:"user",message:{role:"user",content:e}});i.stdin.write(v+`
`),i.stdin.end()}catch(u){a?.(u),s?.({status:"failed",output:"",error:u.message,durationMs:Date.now()-o})}})(),{set onMessage(u){r=u},get onMessage(){return r},set onDone(u){s=u},get onDone(){return s},set onError(u){a=u},get onError(){return a},abort(){n=!0,i&&!i.killed&&i.kill()}}}}});var Is={};J(Is,{TraceMindPlugin:()=>De,default:()=>Ms});module.exports=dn(Is);var B=require("obsidian");var b=require("obsidian");V();V();var ge=class extends b.PluginSettingTab{plugin;constructor(t,i){super(t,i),this.plugin=i}display(){let{containerEl:t}=this;t.empty(),t.createEl("h2",{text:"TraceMind \u8BBE\u7F6E"}),t.createEl("h3",{text:"AI Provider"});let i="",n="",r="",s="",a=!1,o="";new b.Setting(t).setName("\u540D\u79F0").setDesc("Provider \u663E\u793A\u540D\u79F0").addText(p=>{p.setPlaceholder("My GPT-4").onChange(h=>{i=h})}),new b.Setting(t).setName("\u6A21\u578B").setDesc("\u6A21\u578B\u540D\u79F0\uFF0C\u5982 gpt-4\u3001qwen-plus").addText(p=>{p.setPlaceholder("gpt-4").onChange(h=>{n=h})}),new b.Setting(t).setName("Base URL").setDesc("OpenAI \u517C\u5BB9 API \u5730\u5740").addText(p=>{p.setPlaceholder("https://api.openai.com/v1").onChange(h=>{r=h})}),new b.Setting(t).setName("API Key").setDesc("API \u5BC6\u94A5").addText(p=>{p.setPlaceholder("").onChange(h=>{s=h}),p.inputEl.type="password"}),new b.Setting(t).setName("\u601D\u8003\u6A21\u5F0F").setDesc('\u5F00\u542F\u540E\u8BF7\u6C42\u4F53\u5E26\u4E0A {"thinking":{"type":"enabled"}}').addToggle(p=>{p.setValue(a).onChange(h=>{a=h})}),new b.Setting(t).setName("Reasoning Effort").setDesc("\u90E8\u5206\u6A21\u578B\u652F\u6301 high \u6216 max").addDropdown(p=>{p.addOption("","\u9ED8\u8BA4").addOption("high","high").addOption("max","max").setValue(o).onChange(h=>{o=h})}),new b.Setting(t).addButton(p=>{p.setButtonText("\u6DFB\u52A0 Provider"),p.setCta(),p.onClick(async()=>{if(!i||!n||!r){new b.Notice("\u8BF7\u586B\u5199\u540D\u79F0\u3001\u6A21\u578B\u548C Base URL");return}let h=`provider-${Date.now()}`;this.plugin.settings.providers.push({id:h,name:i,model:n,baseUrl:r,apiKey:s,enableThinking:a,reasoningEffort:o}),await this.plugin.saveSettings(),this.display(),new b.Notice("Provider \u5DF2\u6DFB\u52A0")})});for(let p=0;p<this.plugin.settings.providers.length;p++){let h=this.plugin.settings.providers[p],g=this.plugin.settings.defaultProviderId===h.id,f=new b.Setting(t).setName(`${h.name}${g?" (\u9ED8\u8BA4)":""}`).setDesc(`${h.baseUrl} / ${h.model}${h.enableThinking?" / thinking:on":""}${h.reasoningEffort?` / reasoning:${h.reasoningEffort}`:""}`);f.addToggle(m=>{m.setTooltip("\u8BBE\u4E3A\u9ED8\u8BA4").setValue(g).onChange(async v=>{v&&(this.plugin.settings.defaultProviderId=h.id),await this.plugin.saveSettings(),this.display()})}),f.addToggle(m=>{m.setTooltip("\u601D\u8003\u6A21\u5F0F").setValue(h.enableThinking??!1).onChange(async v=>{h.enableThinking=v,await this.plugin.saveSettings()})}),f.addDropdown(m=>{m.addOption("","\u9ED8\u8BA4").addOption("high","high").addOption("max","max").setValue(h.reasoningEffort||"").onChange(async v=>{h.reasoningEffort=v,await this.plugin.saveSettings()})}),f.addButton(m=>{m.setButtonText("\u6D4B\u8BD5"),m.onClick(async()=>{new b.Notice("\u6B63\u5728\u6D4B\u8BD5...");try{let v=await fe([{role:"user",content:"\u4F60\u597D"}],{provider:h.baseUrl?.includes("anthropic.com")?"anthropic":"openai",apiKey:h.apiKey,model:h.model,baseUrl:h.baseUrl});new b.Notice("\u8FDE\u63A5\u6210\u529F: "+v.content.substring(0,50))}catch(v){new b.Notice("\u8FDE\u63A5\u5931\u8D25: "+v.message)}})}),f.addButton(m=>{m.setButtonText("\u5220\u9664"),m.onClick(async()=>{this.plugin.settings.providers.splice(p,1),this.plugin.settings.defaultProviderId===h.id&&(this.plugin.settings.defaultProviderId=this.plugin.settings.providers[0]?.id||"");let v=this.plugin.settings.agentProviderMapping;v.analysis===h.id&&(v.analysis=""),v.chat===h.id&&(v.chat=""),await this.plugin.saveSettings(),this.display()})})}this.plugin.settings.providers.length===0&&t.createEl("p",{text:"\u6682\u65E0 Provider\uFF0C\u8BF7\u6DFB\u52A0\u4E00\u4E2A",cls:"lifewiki-no-providers"}),t.createEl("h3",{text:"Agent \u914D\u7F6E"});let l=this.plugin.settings.agentProviderMapping,c={};for(let p of this.plugin.settings.providers)c[p.id]=p.name;new b.Setting(t).setName("AI \u5206\u6790").setDesc("\u65E5\u8BB0\u5206\u6790\u4F7F\u7528\u7684 AI Provider").addDropdown(p=>{p.addOption("","\u4F7F\u7528\u9ED8\u8BA4 Provider");for(let[h,g]of Object.entries(c))p.addOption(h,g);p.setValue(l.analysis).onChange(async h=>{this.plugin.settings.agentProviderMapping.analysis=h,await this.plugin.saveSettings()})}),new b.Setting(t).setName("AI \u804A\u5929").setDesc("\u804A\u5929\u4F7F\u7528\u7684 AI Provider").addDropdown(p=>{p.addOption("","\u4F7F\u7528\u9ED8\u8BA4 Provider");for(let[h,g]of Object.entries(c))p.addOption(h,g);p.setValue(l.chat).onChange(async h=>{this.plugin.settings.agentProviderMapping.chat=h,await this.plugin.saveSettings()})}),t.createEl("h3",{text:"\u672C\u5730 Agent"}),t.createEl("p",{text:"\u542F\u7528\u540E\uFF0C\u5728\u804A\u5929\u6A21\u5F0F\u7684\u8F93\u5165\u6846\u5DE6\u4FA7\u53EF\u9009\u62E9\u672C\u5730\u5B89\u88C5\u7684 AI agent CLI\uFF08Claude Code\u3001Hermes \u7B49\uFF09\u3002",cls:"setting-item-description"});let u=t.createEl("div",{cls:"tracemind-agent-status"});new b.Setting(t).setName("\u542F\u7528\u672C\u5730 Agent").setDesc("\u5F00\u542F\u540E\u7CFB\u7EDF\u5C06\u68C0\u6D4B\u672C\u673A\u5B89\u88C5\u7684 agent CLI\uFF0C\u5E76\u5728\u804A\u5929\u8F93\u5165\u6846\u5DE6\u4FA7\u63D0\u4F9B\u9009\u62E9\u5668").addToggle(p=>{p.setValue(this.plugin.settings.localAgentEnabled).onChange(async h=>{this.plugin.settings.localAgentEnabled=h,await this.plugin.saveSettings(),h?this.detectAndShowAgents(u):u.empty()})}),this.plugin.settings.localAgentEnabled&&this.detectAndShowAgents(u);let d=document.createElement("style");d.textContent=`
		...
		`,t.appendChild(d)}async detectAndShowAgents(t){t.empty();let{resolveExecutable:i}=await Promise.resolve().then(()=>(X(),Ne)),n=[{key:"claude-code",name:"Claude Code",binary:"claude"},{key:"hermes",name:"Hermes",binary:"hermes"}];for(let r of n){let s=t.createEl("div",{cls:"tracemind-agent-row"}),o=!!await i(r.binary);s.createEl("span",{cls:`tracemind-agent-dot ${o?"available":"unavailable"}`}).setText(o?"\u{1F7E2}":"\u{1F534}"),s.createEl("span",{text:`${r.name} ${o?"\u2014 \u5DF2\u68C0\u6D4B\u5230":"\u2014 \u672A\u68C0\u6D4B\u5230\uFF0C\u8BF7\u786E\u8BA4\u5DF2\u5B89\u88C5"}`,cls:"tracemind-agent-label"})}}};var vt={providers:[],defaultProviderId:"",agentProviderMapping:{analysis:"",chat:""},localAgentEnabled:!1};var E=require("obsidian");var $e=require("obsidian"),hn=".lifewiki/templates";async function fn(e,t){let i=`templates/${t}`,n=e.getAbstractFileByPath(i);if(n instanceof $e.TFile)return await e.read(n);let r=`${hn}/${t}`;return n=e.getAbstractFileByPath(r),n instanceof $e.TFile?await e.read(n):null}function Z(e,t){return t.split(".").reduce((i,n)=>i?.[n],e)}function gn(e,t){let i=e,n=/\{\{#if\s+([^}]+)\}\}([\s\S]*?)\{\{\/if\}\}/g;i=i.replace(n,(s,a,o)=>{if(!Z(t,a.trim())){let u=o.split(/\{\{else\}\}/);return u.length>1?u[1].trim():""}return o.split(/\{\{else\}\}/)[0].trim()});let r=/\{\{#each\s+([^}]+)\}\}([\s\S]*?)\{\{\/each\}\}/g;return i=i.replace(r,(s,a,o)=>{let l=Z(t,a.trim());return!Array.isArray(l)||l.length===0?"":l.map(c=>{let u=o;return u=u.replace(/\{\{this\.([^}]+)\}\}/g,(d,p)=>Z(c,p.trim())??""),u=u.replace(/\{\{([^#\/][^}]*?)\}\}/g,(d,p)=>{let h=p.trim();return h==="this"?String(c):Z(c,h)??""}),(typeof c=="string"||typeof c=="number")&&(u=u.replace(/\{\{this\}\}/g,String(c))),u}).join("")}),i}function mn(e,t){let i=e,n=/\{\{([^#\/][^}]*?)\}\}/g;return i=i.replace(n,(r,s)=>{let a=s.trim(),o=Z(t,a);return o==null?"":typeof o=="object"?JSON.stringify(o):String(o)}),i}async function Et(e,t,i){let n=await fn(e,t);n===null&&(console.warn(`[TemplateLoader] Template not found: ${t}, falling back to default`),n=yn(t,i));let r=gn(n,i);return r=mn(r,i),r}function yn(e,t){switch(e.replace("-template.md","")){case"journal":return`# ${t.date||"Untitled"}
...
`).trim(),n.children=[...s],this.blocks.push(n),a=null),n={id:je(l[0]),timestamp:l[1],source:l[2],category:He(ye(l[3])),content:"",children:[],parentId:null},r=[],s=[]),n&&!a){let c=o.trim(),u=c.match(/^<!-- ([a-f0-9-]+) -->$/);if(u){a=u[1];continue}let d=c.match(/^<sub[^>]*>([a-f0-9-]+)<\/sub>$/i);if(d){a=d[1];continue}}if(o.startsWith("- ")&&n){let c=o.match(/^- (\d{2}:\d{2})?\s+(.+?)\s*(?:<!-- ([a-f0-9-]+) -->)?$/);if(c){let u=c[1]||"",d=(c[2]||"").replace(/<!--[\s\S]*?-->/g,"").replace(/<sub[^>]*>[\s\S]*?<\/sub>/gi,"").trim(),p=c[3]||je(o);if(d){s.push({id:p,timestamp:u,content:d,parentId:n.id});continue}}else{let u=o.substring(2).replace(/<!--[\s\S]*?-->/g,"").replace(/<sub[^>]*>[\s\S]*?<\/sub>/gi,"").trim();u&&s.push({id:je(o),timestamp:"",content:u,parentId:n.id});continue}}if(o.trim()&&n&&!o.startsWith("#")&&!o.startsWith(">")){let c=o.trim().replace(/<!--[\s\S]*?-->/g,"").replace(/<sub[^>]*>[\s\S]*?<\/sub>/gi,"").trim();c&&r.push(c)}}n&&(a&&(n.id=a),n.content=r.join(`
...
`),o=`### ${t.timestamp} [${t.source}] ${me(t.category)}`,l=-1;for(let g=0;g<a.length;g++)if(a[g].includes(o)){l=g;break}if(l===-1)return null;let c=a.length;for(let g=l+1;g<a.length;g++)if(a[g].startsWith("### ")){c=g;break}let u=new Date,d=`${u.getHours().toString().padStart(2,"0")}:${u.getMinutes().toString().padStart(2,"0")}`,p=bt(),h=`- ${d} ${i} <!-- ${p} -->`;return a.splice(c,0,h),await this.app.vault.modify(r,a.join(`
...
`))}async submitBlock(t){let i=t.value.trim();if(!i||this.isLoading)return;this.isLoading=!0;let n=new Date,r=`${n.getHours().toString().padStart(2,"0")}:${n.getMinutes().toString().padStart(2,"0")}`,s={id:bt(),timestamp:r,source:"TraceMind",category:"\u5F85\u5206\u6790",content:i,children:[],parentId:null};this.blocks.push(s),t.value="",this.inputValue="",this.renderBlocks(),await this.appendBlockToFile(s),await this.startAIAnalysis(s),this.isLoading=!1}async appendBlockToFile(t){let i=`Daily/${this.currentDate}.md`,n=this.app.vault.getAbstractFileByPath(i);if(n instanceof E.TFile||this.app.vault.getAbstractFileByPath("Daily")instanceof E.TFolder||await this.app.vault.createFolder("Daily"),(!n||!(n instanceof E.TFile))&&(n=this.app.vault.getAbstractFileByPath(`${this.currentDate}.md`)),!(n instanceof E.TFile)){let o=await Et(this.app.vault,"journal-template.md",{date:this.currentDate})+`
...
`)){let p=d.indexOf(":");if(p>0){let h=d.slice(0,p).trim(),g=d.slice(p+1).trim();h&&g&&h!=="id"&&h!=="name"&&l.push(h+": "+g)}}let c=a.replace(/^---\n[\s\S]*?\n---\n?/,"").trim(),u="=== "+s.name+` \u6863\u6848\u6458\u8981 ===
\u7C7B\u578B\uFF1A`+s.cardType+`
...
`+e.slice(a+1):l+=e.slice(r),l.slice(1)}function Ca(e){for(var t="",i=0,n,r=0;r<e.length;i>=65536?r+=2:r++)i=re(e,r),n=A[i],!n&&le(i)?(t+=e[r],i>=65536&&(t+=e[r+1])):t+=n||ga(i);return t}function Aa(e,t,i){var n="",r=e.tag,s,a,o;for(s=0,a=i.length;s<a;s+=1)o=i[s],e.replacer&&(o=e.replacer.call(i,String(s),o)),(L(e,t,o,!1,!1)||typeof o>"u"&&L(e,t,null,!1,!1))&&(n!==""&&(n+=","+(e.condenseFlow?"":" ")),n+=e.dump);e.tag=r,e.dump="["+n+"]"}function Gt(e,t,i,n){var r="",s=e.tag,a,o,l;for(a=0,o=i.length;a<o;a+=1)l=i[a],e.replacer&&(l=e.replacer.call(i,String(a),l)),(L(e,t+1,l,!0,!0,!1,!0)||typeof l>"u"&&L(e,t+1,null,!0,!0,!1,!0))&&((!n||r!=="")&&(r+=qe(e,t)),e.dump&&se===e.dump.charCodeAt(0)?r+="-":r+="- ",r+=e.dump);e.tag=s,e.dump=r||"[]"}function Ta(e,t,i){var n="",r=e.tag,s=Object.keys(i),a,o,l,c,u;for(a=0,o=s.length;a<o;a+=1)u="",n!==""&&(u+=", "),e.condenseFlow&&(u+='"'),l=s[a],c=i[l],e.replacer&&(c=e.replacer.call(i,l,c)),L(e,t,l,!1,!1)&&(e.dump.length>1024&&(u+="? "),u+=e.dump+(e.condenseFlow?'"':"")+":"+(e.condenseFlow?"":" "),L(e,t,c,!1,!1)&&(u+=e.dump,n+=u));e.tag=r,e.dump="{"+n+"}"}function Fa(e,t,i,n){var r="",s=e.tag,a=Object.keys(i),o,l,c,u,d,p;if(e.sortKeys===!0)a.sort();else if(typeof e.sortKeys=="function")a.sort(e.sortKeys);else if(e.sortKeys)throw new T("sortKeys must be a boolean or a function");for(o=0,l=a.length;o<l;o+=1)p="",(!n||r!=="")&&(p+=qe(e,t)),c=a[o],u=i[c],e.replacer&&(u=e.replacer.call(i,c,u)),L(e,t+1,c,!0,!0,!0)&&(d=e.tag!==null&&e.tag!=="?"||e.dump&&e.dump.length>1024,d&&(e.dump&&se===e.dump.charCodeAt(0)?p+="?":p+="? "),p+=e.dump,d&&(p+=qe(e,t)),L(e,t+1,u,!0,d)&&(e.dump&&se===e.dump.charCodeAt(0)?p+=":":p+=": ",p+=e.dump,r+=p));e.tag=s,e.dump=r||"{}"}function Qt(e,t,i){var n,r,s,a,o,l;for(r=i?e.explicitTypes:e.implicitTypes,s=0,a=r.length;s<a;s+=1)if(o=r[s],(o.instanceOf||o.predicate)&&(!o.instanceOf||typeof t=="object"&&t instanceof o.instanceOf)&&(!o.predicate||o.predicate(t))){if(i?o.multi&&o.representName?e.tag=o.representName(t):e.tag=o.tag:e.tag="?",o.represent){if(l=e.styleMap[o.tag]||o.defaultStyle,Si.call(o.represent)==="[object Function]")n=o.represent(t,l);else if(Mi.call(o.represent,l))n=o.represent[l](t,l);else throw new T("!<"+o.tag+'> tag resolver accepts not "'+l+'" style');e.dump=n}return!0}return!1}function L(e,t,i,n,r,s,a){e.tag=null,e.dump=i,Qt(e,i,!1)||Qt(e,i,!0);var o=Si.call(e.dump),l=n,c;n&&(n=e.flowLevel<0||e.flowLevel>t);var u=o==="[object Object]"||o==="[object Array]",d,p;if(u&&(d=e.duplicates.indexOf(i),p=d!==-1),(e.tag!==null&&e.tag!=="?"||p||e.indent!==2&&t>0)&&(r=!1),p&&e.usedDuplicates[d])e.dump="*ref_"+d;else{if(u&&p&&!e.usedDuplicates[d]&&(e.usedDuplicates[d]=!0),o==="[object Object]")n&&Object.keys(e.dump).length!==0?(Fa(e,t,e.dump,r),p&&(e.dump="&ref_"+d+e.dump)):(Ta(e,t,e.dump),p&&(e.dump="&ref_"+d+" "+e.dump));else if(o==="[object Array]")n&&e.dump.length!==0?(e.noArrayIndent&&!a&&t>0?Gt(e,t-1,e.dump,r):Gt(e,t,e.dump,r),p&&(e.dump="&ref_"+d+e.dump)):(Aa(e,t,e.dump),p&&(e.dump="&ref_"+d+" "+e.dump));else if(o==="[object String]")e.tag!=="?"&&wa(e,e.dump,t,s,l);else{if(o==="[object Undefined]")return!1;if(e.skipInvalid)return!1;throw new T("unacceptable kind of an object to dump "+o)}e.tag!==null&&e.tag!=="?"&&(c=encodeURI(e.tag[0]==="!"?e.tag.slice(1):e.tag).replace(/!/g,"%21"),e.tag[0]==="!"?c="!"+c:c.slice(0,18)==="tag:yaml.org,2002:"?c="!!"+c.slice(18):c="!<"+c+">",e.dump=c+" "+e.dump)}return!0}function Sa(e,t){var i=[],n=[],r,s;for(Qe(e,i,n),r=0,s=n.length;r<s;r+=1)t.duplicates.push(i[n[r]]);t.usedDuplicates=new Array(s)}function Qe(e,t,i){var n,r,s;if(e!==null&&typeof e=="object")if(r=t.indexOf(e),r!==-1)i.indexOf(r)===-1&&i.push(r);else if(t.push(e),Array.isArray(e))for(r=0,s=e.length;r<s;r+=1)Qe(e[r],t,i);else for(n=Object.keys(e),r=0,s=n.length;r<s;r+=1)Qe(e[n[r]],t,i)}function Ma(e,t){t=t||{};var i=new ya(t);i.noRefs||Sa(e,i);var n=e;return i.replacer&&(n=i.replacer.call({"":n},"",n)),L(i,0,n,!0,!0)?i.dump+`
`:""}var Ia=Ma,Ba={dump:Ia};function it(e,t){return function(){throw new Error("Function yaml."+e+" is removed in js-yaml 4. Use yaml."+t+" instead, which is now safe by default.")}}var Da=C,Pa=Zt,La=ni,_a=li,Ra=ci,Oa=Xe,Na=Fi.load,$a=Fi.loadAll,ja=Ba.dump,Ha=T,Ua={binary:fi,float:oi,map:ii,null:ri,pairs:mi,set:yi,timestamp:pi,bool:ai,int:si,merge:hi,omap:gi,seq:ti,str:ei},za=it("safeLoad","load"),Va=it("safeLoadAll","loadAll"),Ya=it("safeDump","dump"),H={Type:Da,Schema:Pa,FAILSAFE_SCHEMA:La,JSON_SCHEMA:_a,CORE_SCHEMA:Ra,DEFAULT_SCHEMA:Oa,load:Na,loadAll:$a,dump:ja,YAMLException:Ha,types:Ua,safeLoad:za,safeLoadAll:Va,safeDump:Ya};var U={name:"",occupation:"",company:"",city:"",skills:[],roles:[],relationships:[],goals:[],focusAreas:[],lastUpdated:new Date().toISOString().split("T")[0]};function $i(e){let t={...U},i=e.match(/^---\n([\s\S]*?)\n---/);if(i)try{let n=H.load(i[1]);n&&(typeof n.name=="string"&&(t.name=n.name),typeof n.occupation=="string"&&(t.occupation=n.occupation),typeof n.company=="string"&&(t.company=n.company),typeof n.city=="string"&&(t.city=n.city),Array.isArray(n.skills)&&(t.skills=n.skills.map(String)),Array.isArray(n.roles)&&(t.roles=n.roles.map(String)),Array.isArray(n.relationships)&&(t.relationships=n.relationships.map(String)),Array.isArray(n.goals)&&(t.goals=n.goals.map(String)),Array.isArray(n.focusAreas)&&(t.focusAreas=n.focusAreas.map(String)))}catch{}return!t.name&&!t.company?Ka(e):t}function Ka(e){let t={...U},i=e.split(`
`),n="";for(let r of i){let s=r.trim();if(s.startsWith("## ")){n=s.slice(3);continue}if(n==="\u57FA\u672C\u4FE1\u606F"&&s.startsWith("- ")){let a=s.slice(2),[o,...l]=a.split("\uFF1A"),c=l.join("\uFF1A");o==="\u59D3\u540D"&&(t.name=c),(o==="\u804C\u4E1A"||o==="\u804C\u4F4D")&&(t.occupation=c),(o==="\u516C\u53F8/\u7EC4\u7EC7"||o==="\u516C\u53F8")&&(t.company=c),o==="\u57CE\u5E02"&&(t.city=c)}if(s.startsWith("- ")&&!s.includes("\uFF1A")){let a=s.slice(2);if(a==="_\u6682\u65E0_")continue;n==="\u6280\u80FD\u4E0E\u4E13\u4E1A"&&t.skills.push(a),n==="\u89D2\u8272\u4E0E\u5173\u7CFB"&&t.roles.push(a),n==="\u76EE\u6807\u4E0E\u8BA1\u5212"&&t.goals.push(a),n==="\u5173\u6CE8\u9886\u57DF"&&t.focusAreas.push(a)}if(s.startsWith("- \u5173\u7CFB\uFF1A")&&n==="\u89D2\u8272\u4E0E\u5173\u7CFB"){let a=s.slice(5);a!=="_\u6682\u65E0_"&&t.relationships.push(a)}}return t}var Wa="TraceMind/PROFILE.md";async function ji(e){let t=e.vault.getFileByPath(Wa);if(!t)return{...U};try{let i=await e.vault.read(t);return $i(i)}catch{return{...U}}}function ce(e){let t=0;for(let i=0;i<e.length;i++){let n=e.charCodeAt(i);t=(t<<5)-t+n,t=t&t}return Math.abs(t).toString(16).padStart(8,"0").slice(0,8)}var qa=["company","role","relationship_to_user"],Ga=["responsibility","communicationStyle"],Qa=["personality","preferences","skills"],Ja=["subtype","status"],Xa=["deadline","description"],Za=["priority","goals"],es=["subtype"],ts=["occurrenceCount","context"],is=["context"],ns={company:"P0",project:"P0",task:"P0",product:"P1",technology:"P1",document:"P2",location:"P2",other:"P2"},ho=Object.keys(ns);var nt={P0:1.5,P1:1,P2:.5},Ie={person:{p0:qa,p1:Ga,p2:Qa},object:{p0:Ja,p1:Xa,p2:Za},theme:{p0:es,p1:ts,p2:is}};function rt(e,t){let i=Ie[e],n=i.p0.length===0||i.p0.every(a=>t[a]!=null),r=i.p1.some(a=>t[a]!=null),s=i.p2.some(a=>t[a]!=null);return n&&r&&s?"L3":n&&r?"L2":n?"L1":"L0"}function Hi(e,t,i,n=1){let r=Ie[e];if(r.p0.length+r.p1.length+r.p2.length===0)return 0;let s=0,a=r.p0.filter(c=>t[c]!=null).length,o=a/Math.max(r.p0.length,1),l=a===0&&r.p0.length>0?r.p0.length/3*.5:o;if(s+=l*nt.P0,r.p1.length>0){let c=r.p1.filter(u=>t[u]!=null).length;s+=c/r.p1.length*nt.P1}if(r.p2.length>0){let c=r.p2.filter(u=>t[u]!=null).length;s+=c/r.p2.length*nt.P2}return s*n*(1+Math.log1p(i))}var at={create(e){let t=new Date().toISOString();return{id:ce(e.name),userId:e.userId||"",cardType:e.cardType,name:e.name,aliases:e.aliases||[],attributes:e.attributes||{},relatedPeople:[],relatedObjects:[],relatedThemes:[],evidenceEntryIds:[],confidence:.5,maturity:rt(e.cardType,e.attributes||{}),status:"needs_confirmation",lifecycle:"candidate",importance:0,createdAt:t,lastUpdated:t}}};var rs=H.dump,as=H.load,Be="---";function G(e){let t={id:e.id,name:e.name,type:e.cardType,maturity:e.maturity,confidence:e.confidence,status:e.status,aliases:e.aliases,createdAt:e.createdAt,lastUpdated:e.lastUpdated};for(let[a,o]of Object.entries(e.attributes))o!=null&&(t[a]=o);let i=[`# ${e.name}`,""],n=os(e);n.length>0&&(i.push("## \u57FA\u672C\u4FE1\u606F"),i.push(...n),i.push(""));let r=e.attributes.interactions||[];if(r.length>0){i.push("## \u4E92\u52A8\u8BB0\u5F55");for(let a of r.slice(-5)){let o=a.timestamp?new Date(a.timestamp).toISOString().split("T")[0]:"";i.push("- "+o+" "+a.content)}i.push("")}else e.attributes.interactions;let s=rs(t).trim();return`${Be}
${s}
${Be}
