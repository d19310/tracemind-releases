"use strict";var ke=Object.defineProperty;var Fi=Object.getOwnPropertyDescriptor;var Bi=Object.getOwnPropertyNames;var Pi=Object.prototype.hasOwnProperty;var Li=(e,t)=>()=>(e&&(t=e(e=0)),t);var tt=(e,t)=>{for(var i in t)ke(e,i,{get:t[i],enumerable:!0})},Di=(e,t,i,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of Bi(t))!Pi.call(e,r)&&r!==i&&ke(e,r,{get:()=>t[r],enumerable:!(n=Fi(t,r))||n.enumerable});return e};var _i=e=>Di(ke({},"__esModule",{value:!0}),e);var rt={};tt(rt,{buildRequest:()=>it,chat:()=>se,parseResponse:()=>nt,validateConfig:()=>Ri});function Ri(e){return e.provider?!e.apiKey||e.apiKey.trim()===""?{valid:!1,error:"apiKey is required"}:!e.model||e.model.trim()===""?{valid:!1,error:"model is required"}:{valid:!0}:{valid:!1,error:"provider is required"}}function it(e,t){let i=t.find(r=>r.role==="system"),n=t.filter(r=>r.role!=="system");switch(e.provider){case"openai":{let r=(e.baseUrl||"https://api.openai.com").replace(/\/+$/,""),s=r.endsWith("/v1")?"/chat/completions":"/v1/chat/completions";return{url:`${r}${s}`,method:"POST",headers:{Authorization:`Bearer ${e.apiKey}`,"Content-Type":"application/json"},body:JSON.stringify({model:e.model,messages:t})}}case"anthropic":return{url:e.baseUrl||"https://api.anthropic.com/v1/messages",method:"POST",headers:{"x-api-key":e.apiKey,"anthropic-version":"2023-06-01","Content-Type":"application/json"},body:JSON.stringify({model:e.model,system:i?.content,messages:n.map(r=>({role:r.role,content:r.content}))})};default:{let s=(e.baseUrl||(e.provider==="ollama"?"http://localhost:11434":"")).replace(/\/+$/,""),a=s.endsWith("/v1")?"/chat/completions":"/v1/chat/completions";return{url:`${s}${a}`,method:"POST",headers:{"Content-Type":"application/json",...e.apiKey?{Authorization:`Bearer ${e.apiKey}`}:{}},body:JSON.stringify({model:e.model,messages:t})}}}}async function se(e,t){let i=it(t,e),n=await fetch(i.url,{method:i.method||"POST",headers:i.headers,body:i.body});if(!n.ok){let a=await n.text();throw new Error(`HTTP ${n.status}: ${a}`)}let r=await n.json();return{content:nt(t.provider,r).content}}function nt(e,t){switch(e){case"openai":{let i=t.choices;if(!i||i.length===0)throw new Error("Empty response from OpenAI");return{role:"assistant",content:i[0].message.content}}case"anthropic":{let i=t.content;if(!i||i.length===0)throw new Error("Empty response from Anthropic");return{role:"assistant",content:i[0].text}}default:{let i=t.choices;if(!i||i.length===0)throw new Error("Empty response from AI provider");return{role:"assistant",content:i[0].message.content}}}}var oe=Li(()=>{"use strict"});var Va={};tt(Va,{TraceMindPlugin:()=>Ee,default:()=>Ua});module.exports=_i(Va);var I=require("obsidian");var E=require("obsidian");oe();oe();var le=class extends E.PluginSettingTab{plugin;constructor(t,i){super(t,i),this.plugin=i}display(){let{containerEl:t}=this;t.empty(),t.createEl("h2",{text:"TraceMind \u8BBE\u7F6E"}),t.createEl("h3",{text:"AI Provider"});let i="",n="",r="",s="",a=!1,o="";new E.Setting(t).setName("\u540D\u79F0").setDesc("Provider \u663E\u793A\u540D\u79F0").addText(u=>{u.setPlaceholder("My GPT-4").onChange(d=>{i=d})}),new E.Setting(t).setName("\u6A21\u578B").setDesc("\u6A21\u578B\u540D\u79F0\uFF0C\u5982 gpt-4\u3001qwen-plus").addText(u=>{u.setPlaceholder("gpt-4").onChange(d=>{n=d})}),new E.Setting(t).setName("Base URL").setDesc("OpenAI \u517C\u5BB9 API \u5730\u5740").addText(u=>{u.setPlaceholder("https://api.openai.com/v1").onChange(d=>{r=d})}),new E.Setting(t).setName("API Key").setDesc("API \u5BC6\u94A5").addText(u=>{u.setPlaceholder("").onChange(d=>{s=d}),u.inputEl.type="password"}),new E.Setting(t).setName("\u601D\u8003\u6A21\u5F0F").setDesc('\u5F00\u542F\u540E\u8BF7\u6C42\u4F53\u5E26\u4E0A {"thinking":{"type":"enabled"}}').addToggle(u=>{u.setValue(a).onChange(d=>{a=d})}),new E.Setting(t).setName("Reasoning Effort").setDesc("\u90E8\u5206\u6A21\u578B\u652F\u6301 high \u6216 max").addDropdown(u=>{u.addOption("","\u9ED8\u8BA4").addOption("high","high").addOption("max","max").setValue(o).onChange(d=>{o=d})}),new E.Setting(t).addButton(u=>{u.setButtonText("\u6DFB\u52A0 Provider"),u.setCta(),u.onClick(async()=>{if(!i||!n||!r){new E.Notice("\u8BF7\u586B\u5199\u540D\u79F0\u3001\u6A21\u578B\u548C Base URL");return}let d=`provider-${Date.now()}`;this.plugin.settings.providers.push({id:d,name:i,model:n,baseUrl:r,apiKey:s,enableThinking:a,reasoningEffort:o}),await this.plugin.saveSettings(),this.display(),new E.Notice("Provider \u5DF2\u6DFB\u52A0")})});for(let u=0;u<this.plugin.settings.providers.length;u++){let d=this.plugin.settings.providers[u],p=this.plugin.settings.defaultProviderId===d.id,h=new E.Setting(t).setName(`${d.name}${p?" (\u9ED8\u8BA4)":""}`).setDesc(`${d.baseUrl} / ${d.model}${d.enableThinking?" / thinking:on":""}${d.reasoningEffort?` / reasoning:${d.reasoningEffort}`:""}`);h.addToggle(g=>{g.setTooltip("\u8BBE\u4E3A\u9ED8\u8BA4").setValue(p).onChange(async f=>{f&&(this.plugin.settings.defaultProviderId=d.id),await this.plugin.saveSettings(),this.display()})}),h.addToggle(g=>{g.setTooltip("\u601D\u8003\u6A21\u5F0F").setValue(d.enableThinking??!1).onChange(async f=>{d.enableThinking=f,await this.plugin.saveSettings()})}),h.addDropdown(g=>{g.addOption("","\u9ED8\u8BA4").addOption("high","high").addOption("max","max").setValue(d.reasoningEffort||"").onChange(async f=>{d.reasoningEffort=f,await this.plugin.saveSettings()})}),h.addButton(g=>{g.setButtonText("\u6D4B\u8BD5"),g.onClick(async()=>{new E.Notice("\u6B63\u5728\u6D4B\u8BD5...");try{let f=await se([{role:"user",content:"\u4F60\u597D"}],{provider:d.baseUrl?.includes("anthropic.com")?"anthropic":"openai",apiKey:d.apiKey,model:d.model,baseUrl:d.baseUrl});new E.Notice("\u8FDE\u63A5\u6210\u529F: "+f.content.substring(0,50))}catch(f){new E.Notice("\u8FDE\u63A5\u5931\u8D25: "+f.message)}})}),h.addButton(g=>{g.setButtonText("\u5220\u9664"),g.onClick(async()=>{this.plugin.settings.providers.splice(u,1),this.plugin.settings.defaultProviderId===d.id&&(this.plugin.settings.defaultProviderId=this.plugin.settings.providers[0]?.id||"");let f=this.plugin.settings.agentProviderMapping;f.analysis===d.id&&(f.analysis=""),f.chat===d.id&&(f.chat=""),await this.plugin.saveSettings(),this.display()})})}this.plugin.settings.providers.length===0&&t.createEl("p",{text:"\u6682\u65E0 Provider\uFF0C\u8BF7\u6DFB\u52A0\u4E00\u4E2A",cls:"lifewiki-no-providers"}),t.createEl("h3",{text:"Agent \u914D\u7F6E"});let l=this.plugin.settings.agentProviderMapping,c={};for(let u of this.plugin.settings.providers)c[u.id]=u.name;new E.Setting(t).setName("AI \u5206\u6790").setDesc("\u65E5\u8BB0\u5206\u6790\u4F7F\u7528\u7684 AI Provider").addDropdown(u=>{u.addOption("","\u4F7F\u7528\u9ED8\u8BA4 Provider");for(let[d,p]of Object.entries(c))u.addOption(d,p);u.setValue(l.analysis).onChange(async d=>{this.plugin.settings.agentProviderMapping.analysis=d,await this.plugin.saveSettings()})}),new E.Setting(t).setName("AI \u804A\u5929").setDesc("\u804A\u5929\u4F7F\u7528\u7684 AI Provider").addDropdown(u=>{u.addOption("","\u4F7F\u7528\u9ED8\u8BA4 Provider");for(let[d,p]of Object.entries(c))u.addOption(d,p);u.setValue(l.chat).onChange(async d=>{this.plugin.settings.agentProviderMapping.chat=d,await this.plugin.saveSettings()})})}};var at={providers:[],defaultProviderId:"",agentProviderMapping:{analysis:"",chat:""}};var v=require("obsidian");var Ce=require("obsidian"),Oi=".lifewiki/templates";async function Ni(e,t){let i=`templates/${t}`,n=e.getAbstractFileByPath(i);if(n instanceof Ce.TFile)return await e.read(n);let r=`${Oi}/${t}`;return n=e.getAbstractFileByPath(r),n instanceof Ce.TFile?await e.read(n):null}function W(e,t){return t.split(".").reduce((i,n)=>i?.[n],e)}function $i(e,t){let i=e,n=/\{\{#if\s+([^}]+)\}\}([\s\S]*?)\{\{\/if\}\}/g;i=i.replace(n,(s,a,o)=>{if(!W(t,a.trim())){let u=o.split(/\{\{else\}\}/);return u.length>1?u[1].trim():""}return o.split(/\{\{else\}\}/)[0].trim()});let r=/\{\{#each\s+([^}]+)\}\}([\s\S]*?)\{\{\/each\}\}/g;return i=i.replace(r,(s,a,o)=>{let l=W(t,a.trim());return!Array.isArray(l)||l.length===0?"":l.map(c=>{let u=o;return u=u.replace(/\{\{this\.([^}]+)\}\}/g,(d,p)=>W(c,p.trim())??""),u=u.replace(/\{\{([^#\/][^}]*?)\}\}/g,(d,p)=>{let h=p.trim();return h==="this"?String(c):W(c,h)??""}),(typeof c=="string"||typeof c=="number")&&(u=u.replace(/\{\{this\}\}/g,String(c))),u}).join("")}),i}function ji(e,t){let i=e,n=/\{\{([^#\/][^}]*?)\}\}/g;return i=i.replace(n,(r,s)=>{let a=s.trim(),o=W(t,a);return o==null?"":typeof o=="object"?JSON.stringify(o):String(o)}),i}async function st(e,t,i){let n=await Ni(e,t);n===null&&(console.warn(`[TemplateLoader] Template not found: ${t}, falling back to default`),n=Hi(t,i));let r=$i(n,i);return r=ji(r,i),r}function Hi(e,t){switch(e.replace("-template.md","")){case"journal":return`# ${t.date||"Untitled"}
...
`).trim(),n.children=[...s],this.blocks.push(n),a=null),n={id:Te(l[0]),timestamp:l[1],source:l[2],category:Ae(ue(l[3])),content:"",children:[],parentId:null},r=[],s=[]),n&&!a){let c=o.trim(),u=c.match(/^<!-- ([a-f0-9-]+) -->$/);if(u){a=u[1];continue}let d=c.match(/^<sub[^>]*>([a-f0-9-]+)<\/sub>$/i);if(d){a=d[1];continue}}if(o.startsWith("- ")&&n){let c=o.match(/^- (\d{2}:\d{2})?\s+(.+?)\s*(?:<!-- ([a-f0-9-]+) -->)?$/);if(c){let u=c[1]||"",d=(c[2]||"").replace(/<!--[\s\S]*?-->/g,"").replace(/<sub[^>]*>[\s\S]*?<\/sub>/gi,"").trim(),p=c[3]||Te(o);if(d){s.push({id:p,timestamp:u,content:d,parentId:n.id});continue}}else{let u=o.substring(2).replace(/<!--[\s\S]*?-->/g,"").replace(/<sub[^>]*>[\s\S]*?<\/sub>/gi,"").trim();u&&s.push({id:Te(o),timestamp:"",content:u,parentId:n.id});continue}}if(o.trim()&&n&&!o.startsWith("#")&&!o.startsWith(">")){let c=o.trim().replace(/<!--[\s\S]*?-->/g,"").replace(/<sub[^>]*>[\s\S]*?<\/sub>/gi,"").trim();c&&r.push(c)}}n&&(a&&(n.id=a),n.content=r.join(`
`).trim(),n.children=s,this.blocks.push(n))}renderBlocks(){if(this.contentContainer){if(this.contentContainer.empty(),this.flowLineEl=this.contentContainer.createEl("div",{cls:"flow-line"}),this.blocks.length===0){this.renderEmptyState();return}for(let t of this.blocks)this.renderBlock(t);this.extendFlowLine(),this.isAppendMode||setTimeout(()=>{this.scrollToLastBlock()},100)}}extendFlowLine(){!this.flowLineEl||!this.contentContainer||setTimeout(()=>{if(!this.flowLineEl||!this.contentContainer)return;let t=Array.from(this.contentContainer.querySelectorAll(".lifewiki-block, .lifewiki-block-group"));if(t.length===0)return;let i=0;for(let n of t){let r=n.offsetTop+n.offsetHeight;r>i&&(i=r)}this.flowLineEl.style.height=`${i+30}px`},50)}scrollToLastBlock(){this.contentContainer&&(this.contentContainer.scrollTop=this.contentContainer.scrollHeight)}scrollBlockIntoView(t,i=!1){setTimeout(()=>{let n=i?`[data-child-id="${t}"]`:`[data-block-id="${t}"]`;this.contentContainer?.querySelector(n)?.scrollIntoView({block:"center",behavior:"smooth"})},50)}renderBlock(t){if(!this.contentContainer)return;let i=t.id===this.selectedBlockId,n=t.id===this.editModeBlockId,r=t.children.length>0,s=r?"lifewiki-block-group":"lifewiki-block";i&&(s+=" selected"),n&&(s+=" editing");let a=this.contentContainer.createEl("div",{cls:s,attr:{"data-block-id":t.id}}),o=a.createEl("div",{cls:"lifewiki-block-card"});if(n){let l=o.createEl("div",{cls:"lifewiki-main-wrapper"});l.createEl("span",{text:t.timestamp,cls:"lifewiki-block-timestamp"});let c=l.createEl("textarea",{cls:"lifewiki-edit-textarea",attr:{placeholder:"\u8F93\u5165\u5185\u5BB9..."}});c.value=t.content,c.dataset.field="content";let u=l.createEl("input",{cls:"lifewiki-edit-input",attr:{value:t.category,placeholder:"#\u6807\u7B7E"}});u.dataset.field="category",this.editTagInput=u,this.editContentTextarea=c}else if(t.content){let l=o.createEl("span",{cls:"lifewiki-main-wrapper"});l.createEl("span",{text:t.timestamp,cls:"lifewiki-block-timestamp"}),l.createEl("span",{text:t.content,cls:"lifewiki-block-content"});let c=l.createEl("div",{cls:"lifewiki-block-tags"});for(let u of ue(t.category))c.createEl("a",{text:`#${u}`,cls:"tag lifewiki-block-tag",attr:{href:`#${u}`,"data-tag":u}})}if(r){let l=a.createEl("div",{cls:"lifewiki-block-children"});for(let c of t.children){let u=c.id===this.selectedBlockId,d=this.editingChildId===c.id,p=l.createEl("div",{cls:"lifewiki-block-child"+(u?" selected":"")+(d?" editing":""),attr:{"data-child-id":c.id}}),h=p.createEl("div",{cls:"lifewiki-block-child-card"});c.timestamp&&h.createEl("span",{text:c.timestamp,cls:"lifewiki-block-child-timestamp"});let g=h.createEl("div",{cls:"lifewiki-block-child-body"});if(d){let f=g.createEl("textarea",{cls:"lifewiki-edit-textarea",attr:{placeholder:"\u8F93\u5165\u5185\u5BB9..."}});f.value=c.content,this.editContentTextarea=f}else g.createEl("div",{text:c.content,cls:"lifewiki-block-child-content"});p.addEventListener("click",f=>{f.stopPropagation(),this.isEditMode||this.selectChildBlock(c.id,t.id)}),h.addEventListener("dblclick",f=>{f.stopPropagation(),this.startChildEditMode(c.id,t.id)}),p.addEventListener("contextmenu",f=>{f.preventDefault(),f.stopPropagation(),this.selectChildBlock(c.id,t.id),this.showContextMenu(c.id,t.id,!0,f.clientX,f.clientY)})}}i&&this.selectedBlockId===t.id&&this.childInputEl&&a.appendChild(this.childInputEl),o.addEventListener("click",()=>{this.isEditMode||this.selectBlock(t.id)}),o.addEventListener("dblclick",()=>{this.startEditMode(t.id)}),o.addEventListener("contextmenu",l=>{l.preventDefault(),l.stopPropagation(),this.selectBlock(t.id),this.showContextMenu(t.id,null,!1,l.clientX,l.clientY)})}selectBlock(t){this.childInputEl=null,this.isEditMode=!1,this.editModeBlockId=null,this.selectedBlockId=t,this.isAppendMode=!0,this.appendModeBlockId=t,this.updateInputAreaForAppendMode(),this.renderBlocks();let i=this.blocks.find(n=>n.id===t);if(i){this.selectedBlockContent=i.content;let n=this.plugin.getAIAnalysisView();n&&(n.setMode("analysis"),n.setActiveBlock(t,i.content))}}selectChildBlock(t,i){this.childInputEl=null,this.isEditMode=!1,this.editModeBlockId=null,this.selectedBlockId=t,this.isAppendMode=!1,this.appendModeBlockId=null,this.renderBlocks();let n=this.blocks.find(r=>r.id===i);if(n){this.selectedBlockContent=n.content;let r=this.plugin.getAIAnalysisView();r&&(r.setMode("analysis"),r.setActiveBlock(t,n.content,i))}}showContextMenu(t,i,n,r,s){let a=document.querySelector(".lifewiki-context-menu");a&&a.remove();let o=document.createElement("div");o.className="lifewiki-context-menu",o.style.left=`${r}px`,o.style.top=`${s}px`;let l=this.plugin.getSessionManager(),c=i||t,u=l.getSession(c,i)!==null,d="";if(n){let g=this.blocks.find(f=>f.id===i);if(g){let f=g.children.length;d=f>1?` (\u5171 ${f} \u4E2A\u5B50Block)`:""}}else{let g=this.blocks.find(f=>f.id===t);g&&g.children.length>0&&(d=` (\u542B ${g.children.length} \u4E2A\u5B50Block)`)}let p=document.createElement("div");if(p.className="lifewiki-context-menu-item danger",p.textContent=n?"\u5220\u9664\u6B64\u5B50Block":`\u5220\u9664\u65E5\u8BB0Block${d}`,p.addEventListener("click",()=>{o.remove(),this.confirmAndDeleteBlock(t,i,n,!1)}),o.appendChild(p),u&&!n){let g=document.createElement("div");g.className="lifewiki-context-menu-item danger",g.textContent=`\u5220\u9664Block\u53CA\u4F1A\u8BDD\u8BB0\u5F55${d}`,g.addEventListener("click",()=>{o.remove(),this.confirmAndDeleteBlock(t,i,n,!0)}),o.appendChild(g)}document.body.appendChild(o);let h=g=>{o.contains(g.target)||(o.remove(),document.removeEventListener("click",h))};setTimeout(()=>document.addEventListener("click",h),0)}async confirmAndDeleteBlock(t,i,n,r){let s="",a=0;if(n){let l=this.blocks.find(c=>c.id===i);l&&(a=l.children.length),s="\u786E\u5B9A\u8981\u5220\u9664\u8FD9\u4E2A\u5B50Block\u5417\uFF1F",a>1&&(s+=`
...
\u4F1A\u8BDD\u8BB0\u5F55\u5C06\u88AB\u6C38\u4E45\u5220\u9664\u3002`)}confirm(s)&&await this.deleteBlock(t,i,n,r)}async deleteBlock(t,i,n,r){try{if(n&&i?await this.deleteChildBlockFromFile(t,i):await this.deleteParentBlockFromFile(t,r),r){let a=this.plugin.getSessionManager(),o=i||t;await a.clearSession(o)}await this.loadBlocks(),this.renderBlocks(),this.selectedBlockId=null,this.selectedBlockContent=null;let s=this.plugin.getAIAnalysisView();s&&s.setActiveBlock(null,null)}catch(s){console.error("[LifeWiki] Error deleting block:",s),alert("\u5220\u9664\u5931\u8D25: "+(s instanceof Error?s.message:"\u672A\u77E5\u9519\u8BEF"))}}async deleteChildBlockFromFile(t,i){let n=`Daily/${this.currentDate}.md`,r=this.app.vault.getAbstractFileByPath(n);if((!r||!(r instanceof v.TFile))&&(r=this.app.vault.getAbstractFileByPath(`${this.currentDate}.md`)),(!r||!(r instanceof v.TFile))&&(r=this.app.vault.getAbstractFileByPath(`${G}/${this.currentDate}.md`)),!(r instanceof v.TFile))return;let a=(await this.app.vault.read(r)).split(`
`),o=new RegExp(`^- \\d{2}:\\d{2}\\s.+<!-- ${t} -->`),l=a.filter(u=>!u.match(o));await this.app.vault.modify(r,l.join(`
`));let c=this.blocks.find(u=>u.id===i);c&&(c.children=c.children.filter(u=>u.id!==t))}async deleteParentBlockFromFile(t,i){let n=`Daily/${this.currentDate}.md`,r=this.app.vault.getAbstractFileByPath(n);if((!r||!(r instanceof v.TFile))&&(r=this.app.vault.getAbstractFileByPath(`${this.currentDate}.md`)),(!r||!(r instanceof v.TFile))&&(r=this.app.vault.getAbstractFileByPath(`${G}/${this.currentDate}.md`)),!(r instanceof v.TFile))return;let a=(await this.app.vault.read(r)).split(`
...
`))}async submitBlock(t){let i=t.value.trim();if(!i||this.isLoading)return;this.isLoading=!0;let n=new Date,r=`${n.getHours().toString().padStart(2,"0")}:${n.getMinutes().toString().padStart(2,"0")}`,s={id:ot(),timestamp:r,source:"TraceMind",category:"\u5F85\u5206\u6790",content:i,children:[],parentId:null};this.blocks.push(s),t.value="",this.inputValue="",this.renderBlocks(),await this.appendBlockToFile(s),await this.startAIAnalysis(s),this.isLoading=!1}async appendBlockToFile(t){let i=`Daily/${this.currentDate}.md`,n=this.app.vault.getAbstractFileByPath(i);if(n instanceof v.TFile||this.app.vault.getAbstractFileByPath("Daily")instanceof v.TFolder||await this.app.vault.createFolder("Daily"),(!n||!(n instanceof v.TFile))&&(n=this.app.vault.getAbstractFileByPath(`${this.currentDate}.md`)),!(n instanceof v.TFile)){let o=await st(this.app.vault,"journal-template.md",{date:this.currentDate})+`
...
`)});let d=i.getChatSession().messages,p=await n.chat([a,...d],"chat"),h=this.stripThinking(p.content);h&&(await this.streamChatMessage(h),i.addChatMessage({role:"assistant",content:h}))}}else c.text&&(await this.streamChatMessage(c.text),i.addChatMessage({role:"assistant",content:c.text}))}}catch(n){console.error("AI chat error:",n),this.hideThinkingIndicator(),this.addChatMessage("assistant","\u62B1\u6B49\uFF0CAI \u54CD\u5E94\u5931\u8D25: "+n.message)}this.isLoading=!1,this.updateSendBtnState()}async handleEntityArchiving(t){let i=this.plugin.getEntityManager();if(i)for(let n of t)try{let r={status:"active",source:"diary"};n.type==="person"?(r.person_kind=/公司|组织|机构|团队/.test(n.smallType||n.context)?"\u7EC4\u7EC7":"\u4E2A\u4EBA",/同事|朋友|客户|供应商|合作伙伴|合作方/.test(n.smallType)&&(r.relationship_to_user=n.smallType)):n.type==="object"?(r.subtype=n.smallType||"other",n.context&&(r.description=n.context)):n.type==="theme"&&(r.subtype=n.smallType||"domain");let s=n.context||`\u4ECE\u65E5\u8BB0\u4E2D\u5F52\u6863\u7684${n.type}`;await i.createEntity({type:n.type,title:n.name,titleRaw:n.name,aliases:[],tags:[],summary:s,confidence:.8,verificationStatus:"verified",createdAt:new Date().toISOString(),createdBy:"ai",lastUpdated:new Date().toISOString(),relatedEntities:[],interactions:[{timestamp:new Date().toISOString(),type:"ai_analysis",content:`\u5F52\u6863\u4E3A${n.smallType}\uFF1A${n.context||"\u65E0"}`,sourceBlockId:this.activeBlockId||void 0}],metadata:r})}catch(r){console.error(`[AIAnalysisPanel] Failed to create entity ${n.name}:`,r)}}async handleEntityUpdate(t){let i=this.plugin.getEntityManager();if(i)for(let n of t)try{let r=i.getEntity(n.entityId);if(!r)continue;let s={lastUpdated:new Date().toISOString()},a=[...r.interactions??[]];for(let o of n.updates)if(o.field.startsWith("metadata.")){let l=o.field.replace("metadata.","");s.metadata={...r.metadata,[l]:o.value}}else o.field==="interactions"?(a.push({timestamp:new Date().toISOString(),type:"ai_analysis",content:o.value,sourceBlockId:this.activeBlockId||void 0}),s.interactions=a):o.field==="summary"&&(s.summary=o.value);await i.updateEntity(n.entityId,s)}catch(r){console.error(`[AIAnalysisPanel] Failed to update entity ${n.name}:`,r)}}async handleRelations(t){let i=this.plugin.getEntityManager();if(i)for(let n of t)try{let r=i.findEntity(n.from),s=i.findEntity(n.to);if(!r||!s)continue;let a=r.relatedEntities||[],o={entityId:s.id,relation:n.relation,context:n.context||`\u901A\u8FC7\u65E5\u8BB0\u5206\u6790\u5EFA\u7ACB\u5173\u7CFB\uFF1A${n.from}\u662F${n.to}\u7684${n.relation}`};a.some(c=>c.entityId===s.id&&c.relation===o.relation)||await i.updateEntity(r.id,{relatedEntities:[...a,o],lastUpdated:new Date().toISOString()})}catch(r){console.error("[AIAnalysisPanel] Failed to create relation:",r)}}async updateBlockCategory(t,i){try{let n=this.app.workspace.getLeavesOfType(F);if(n.length===0)return;let r=n[0].view;if(!r)return;let s=r.getBlockById(t);if(!s)return;(s.category==="\u5F85\u5206\u6790"||s.category!==i)&&(s.category=i,await r.saveBlockToFile(s),console.log(`[AIAnalysisPanel] Updated block ${t} category to ${i}`))}catch(n){console.error("[AIAnalysisPanel] Failed to update block category:",n)}}async showEntityConfirmationDialog(t){if(this.chatMessagesEl)for(let i of t){let n=this.chatMessagesEl.createEl("div",{cls:"lifewiki-entity-confirm"});n.createEl("div",{cls:"lifewiki-entity-confirm-title",text:`\u8BC6\u522B\u5230\u65B0${this.getEntityTypeLabel(i.inferredType)}: **${i.name}**`}),n.createEl("div",{cls:"lifewiki-entity-confirm-reason",text:i.reason||"\u4ECE\u65E5\u8BB0\u4E2D\u53D1\u73B0"});let r=n.createEl("div",{cls:"lifewiki-entity-confirm-buttons"}),s=r.createEl("button",{cls:"lifewiki-entity-confirm-btn archive",text:"\u5F52\u6863",attr:{type:"button"}}),a=r.createEl("button",{cls:"lifewiki-entity-confirm-btn skip",text:"\u8DF3\u8FC7",attr:{type:"button"}});s.addEventListener("click",async()=>{await this.archiveEntity(i),n.remove()}),a.addEventListener("click",()=>{n.remove()})}}getEntityTypeLabel(t){return{person:"\u4EBA\u8109",object:"\u5BA2\u4F53",theme:"\u4E3B\u9898"}[t]||"\u5B9E\u4F53"}maturityLabel(t){return t}async archiveEntity(t){let i=this.plugin.getEntityManager();if(!i)return;let r={person:"person",object:"object",theme:"theme"}[t.inferredType]||"person";try{await i.createEntity({type:r,title:t.name,titleRaw:t.name,aliases:[],tags:[],summary:t.reason||"\u4ECE\u65E5\u8BB0\u4E2D\u5F52\u6863",confidence:.8,verificationStatus:"verified",createdAt:new Date().toISOString(),createdBy:"ai",lastUpdated:new Date().toISOString(),relatedEntities:[],interactions:[{timestamp:new Date().toISOString(),type:"ai_analysis",content:`\u5F52\u6863\uFF1A${t.reason||"\u4ECE\u65E5\u8BB0\u4E2D\u53D1\u73B0"}`,sourceBlockId:this.activeBlockId||void 0}],metadata:{status:"active",source:"diary"}}),this.addChatMessage("assistant",`\u5DF2\u5F52\u6863 **${t.name}**`)}catch(s){console.error("[AIAnalysisPanel] Failed to archive entity:",s),this.addChatMessage("assistant","\u5F52\u6863\u5931\u8D25")}}async onClose(){}};var ft=require("obsidian"),Q="tracemind-calendar",fe=class extends ft.ItemView{plugin;currentMonth;onDateClickCallback=null;constructor(t,i){super(t),this.plugin=i,this.currentMonth={year:new Date().getFullYear(),month:new Date().getMonth()}}getViewType(){return Q}getDisplayText(){return"\u65E5\u5386"}getIcon(){return"calendar"}async onOpen(){this.renderCalendar()}async onClose(){}setOnDateClick(t){this.onDateClickCallback=t}async handleDateClick(t){this.onDateClickCallback&&this.onDateClickCallback(t)}getMonthDays(t,i){let n=new Date(t,i,1),r=new Date(t,i+1,0),s=[],a=n.getDay();for(let l=a-1;l>=0;l--){let c=new Date(t,i,-l);s.push(c)}for(let l=1;l<=r.getDate();l++)s.push(new Date(t,i,l));let o=42-s.length;for(let l=1;l<=o;l++)s.push(new Date(t,i+1,l));return s}isToday(t){let i=new Date;return t.getFullYear()===i.getFullYear()&&t.getMonth()===i.getMonth()&&t.getDate()===i.getDate()}isCurrentMonth(t){return t.getFullYear()===this.currentMonth.year&&t.getMonth()===this.currentMonth.month}getNextMonth(t,i){return i===11?{year:t+1,month:0}:{year:t,month:i+1}}getPrevMonth(t,i){return i===0?{year:t-1,month:11}:{year:t,month:i-1}}async diaryExistsForDate(t){try{let i=`Daily/${t}.md`,n=this.app.vault.getAbstractFileByPath(i);return n!=null}catch{return!1}}async goToNextMonth(){this.currentMonth=this.getNextMonth(this.currentMonth.year,this.currentMonth.month),this.renderCalendar()}async goToPrevMonth(){this.currentMonth=this.getPrevMonth(this.currentMonth.year,this.currentMonth.month),this.renderCalendar()}async goToToday(){let t=new Date;this.currentMonth={year:t.getFullYear(),month:t.getMonth()},this.renderCalendar()}async renderCalendar(){let t=this.containerEl;t.empty(),this.addStyles();let i=t.createEl("div",{cls:"tracemind-calendar"});this.renderHeader(i),this.renderWeekdayHeader(i),await this.renderDays(i)}renderHeader(t){let i=t.createEl("div",{cls:"lifewiki-calendar-header"});i.createEl("button",{cls:"lifewiki-calendar-nav-btn",text:"\u2039"}).addEventListener("click",()=>this.goToPrevMonth()),i.createEl("span",{cls:"lifewiki-calendar-title",text:this.getMonthTitle()}).addEventListener("click",()=>this.goToToday()),i.createEl("button",{cls:"lifewiki-calendar-nav-btn",text:"\u203A"}).addEventListener("click",()=>this.goToNextMonth())}renderWeekdayHeader(t){let i=["\u65E5","\u4E00","\u4E8C","\u4E09","\u56DB","\u4E94","\u516D"],n=t.createEl("div",{cls:"lifewiki-calendar-weekdays"});for(let r of i)n.createEl("div",{cls:"lifewiki-calendar-weekday",text:r})}async renderDays(t){let i=this.getMonthDays(this.currentMonth.year,this.currentMonth.month),n=t.createEl("div",{cls:"lifewiki-calendar-grid"});for(let r of i){let s=await this.createDayElement(r,n);n.appendChild(s)}}async createDayElement(t,i){let n=i.createEl("div",{cls:"lifewiki-calendar-day"}),r=this.isCurrentMonth(t),s=this.isToday(t);r||n.addClass("lifewiki-calendar-day-other-month"),s&&n.addClass("lifewiki-calendar-day-today");let a=this.formatDate(t);await this.diaryExistsForDate(a)&&n.addClass("lifewiki-calendar-day-has-diary");let l=n.createEl("span",{cls:"lifewiki-calendar-day-num",text:String(t.getDate())});return n.addEventListener("click",()=>{this.handleDateClick(t)}),n}getMonthTitle(){let t=["\u4E00\u6708","\u4E8C\u6708","\u4E09\u6708","\u56DB\u6708","\u4E94\u6708","\u516D\u6708","\u4E03\u6708","\u516B\u6708","\u4E5D\u6708","\u5341\u6708","\u5341\u4E00\u6708","\u5341\u4E8C\u6708"];return`${this.currentMonth.year}\u5E74 ${t[this.currentMonth.month]}`}formatDate(t){let i=t.getFullYear(),n=String(t.getMonth()+1).padStart(2,"0"),r=String(t.getDate()).padStart(2,"0");return`${i}-${n}-${r}`}addStyles(){let t="lifewiki-calendar-styles";if(document.getElementById(t))return;let i=document.createElement("style");i.id=t,i.textContent=`
		...
		`,document.head.appendChild(i)}};async function J(e,t){e.vault.getAbstractFileByPath(t)||await e.vault.createFolder(t)}function It(e){return typeof e>"u"||e===null}function Ui(e){return typeof e=="object"&&e!==null}function Vi(e){return Array.isArray(e)?e:It(e)?[]:[e]}function zi(e,t){var i,n,r,s;if(t)for(s=Object.keys(t),i=0,n=s.length;i<n;i+=1)r=s[i],e[r]=t[r];return e}function Yi(e,t){var i="",n;for(n=0;n<t;n+=1)i+=e;return i}function Ki(e){return e===0&&Number.NEGATIVE_INFINITY===1/e}var Wi=It,Gi=Ui,qi=Vi,Qi=Yi,Ji=Ki,Xi=zi,k={isNothing:Wi,isObject:Gi,toArray:qi,repeat:Qi,isNegativeZero:Ji,extend:Xi};function Ft(e,t){var i="",n=e.reason||"(unknown reason)";return e.mark?(e.mark.name&&(i+='in "'+e.mark.name+'" '),i+="("+(e.mark.line+1)+":"+(e.mark.column+1)+")",!t&&e.mark.snippet&&(i+=`

`+e.mark.snippet),n+" "+i):n}function Z(e,t){Error.call(this),this.name="YAMLException",this.reason=e,this.mark=t,this.message=Ft(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}Z.prototype=Object.create(Error.prototype);Z.prototype.constructor=Z;Z.prototype.toString=function(t){return this.name+": "+Ft(this,t)};var A=Z;function Fe(e,t,i,n,r){var s="",a="",o=Math.floor(r/2)-1;return n-t>o&&(s=" ... ",t=n-o+s.length),i-n>o&&(a=" ...",i=n+o-a.length),{str:s+e.slice(t,i).replace(/\t/g,"\u2192")+a,pos:n-t+s.length}}function Be(e,t){return k.repeat(" ",t-e.length)+e}function Zi(e,t){if(t=Object.create(t||null),!e.buffer)return null;t.maxLength||(t.maxLength=79),typeof t.indent!="number"&&(t.indent=1),typeof t.linesBefore!="number"&&(t.linesBefore=3),typeof t.linesAfter!="number"&&(t.linesAfter=2);for(var i=/\r?\n|\r|\0/g,n=[0],r=[],s,a=-1;s=i.exec(e.buffer);)r.push(s.index),n.push(s.index+s[0].length),e.position<=s.index&&a<0&&(a=n.length-2);a<0&&(a=n.length-1);var o="",l,c,u=Math.min(e.line+t.linesAfter,r.length).toString().length,d=t.maxLength-(t.indent+u+3);for(l=1;l<=t.linesBefore&&!(a-l<0);l++)c=Fe(e.buffer,n[a-l],r[a-l],e.position-(n[a]-n[a-l]),d),o=k.repeat(" ",t.indent)+Be((e.line-l+1).toString(),u)+" | "+c.str+`
`+o;for(c=Fe(e.buffer,n[a],r[a],e.position,d),o+=k.repeat(" ",t.indent)+Be((e.line+1).toString(),u)+" | "+c.str+`
`,o+=k.repeat("-",t.indent+u+3+c.pos)+`^
`,l=1;l<=t.linesAfter&&!(a+l>=r.length);l++)c=Fe(e.buffer,n[a+l],r[a+l],e.position-(n[a]-n[a+l]),d),o+=k.repeat(" ",t.indent)+Be((e.line+l+1).toString(),u)+" | "+c.str+`
`;return o.replace(/\n$/,"")}var en=Zi,tn=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],nn=["scalar","sequence","mapping"];function rn(e){var t={};return e!==null&&Object.keys(e).forEach(function(i){e[i].forEach(function(n){t[String(n)]=i})}),t}function an(e,t){if(t=t||{},Object.keys(t).forEach(function(i){if(tn.indexOf(i)===-1)throw new A('Unknown option "'+i+'" is met in definition of "'+e+'" YAML type.')}),this.options=t,this.tag=e,this.kind=t.kind||null,this.resolve=t.resolve||function(){return!0},this.construct=t.construct||function(i){return i},this.instanceOf=t.instanceOf||null,this.predicate=t.predicate||null,this.represent=t.represent||null,this.representName=t.representName||null,this.defaultStyle=t.defaultStyle||null,this.multi=t.multi||!1,this.styleAliases=rn(t.styleAliases||null),nn.indexOf(this.kind)===-1)throw new A('Unknown kind "'+this.kind+'" is specified for "'+e+'" YAML type.')}var C=an;function ht(e,t){var i=[];return e[t].forEach(function(n){var r=i.length;i.forEach(function(s,a){s.tag===n.tag&&s.kind===n.kind&&s.multi===n.multi&&(r=a)}),i[r]=n}),i}function sn(){var e={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},t,i;function n(r){r.multi?(e.multi[r.kind].push(r),e.multi.fallback.push(r)):e[r.kind][r.tag]=e.fallback[r.tag]=r}for(t=0,i=arguments.length;t<i;t+=1)arguments[t].forEach(n);return e}function Le(e){return this.extend(e)}Le.prototype.extend=function(t){var i=[],n=[];if(t instanceof C)n.push(t);else if(Array.isArray(t))n=n.concat(t);else if(t&&(Array.isArray(t.implicit)||Array.isArray(t.explicit)))t.implicit&&(i=i.concat(t.implicit)),t.explicit&&(n=n.concat(t.explicit));else throw new A("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");i.forEach(function(s){if(!(s instanceof C))throw new A("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(s.loadKind&&s.loadKind!=="scalar")throw new A("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(s.multi)throw new A("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),n.forEach(function(s){if(!(s instanceof C))throw new A("Specified list of YAML types (or a single Type object) contains a non-Type object.")});var r=Object.create(Le.prototype);return r.implicit=(this.implicit||[]).concat(i),r.explicit=(this.explicit||[]).concat(n),r.compiledImplicit=ht(r,"implicit"),r.compiledExplicit=ht(r,"explicit"),r.compiledTypeMap=sn(r.compiledImplicit,r.compiledExplicit),r};var Bt=Le,Pt=new C("tag:yaml.org,2002:str",{kind:"scalar",construct:function(e){return e!==null?e:""}}),Lt=new C("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(e){return e!==null?e:[]}}),Dt=new C("tag:yaml.org,2002:map",{kind:"mapping",construct:function(e){return e!==null?e:{}}}),_t=new Bt({explicit:[Pt,Lt,Dt]});function on(e){if(e===null)return!0;var t=e.length;return t===1&&e==="~"||t===4&&(e==="null"||e==="Null"||e==="NULL")}function ln(){return null}function cn(e){return e===null}var Rt=new C("tag:yaml.org,2002:null",{kind:"scalar",resolve:on,construct:ln,predicate:cn,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"});function un(e){if(e===null)return!1;var t=e.length;return t===4&&(e==="true"||e==="True"||e==="TRUE")||t===5&&(e==="false"||e==="False"||e==="FALSE")}function dn(e){return e==="true"||e==="True"||e==="TRUE"}function pn(e){return Object.prototype.toString.call(e)==="[object Boolean]"}var Ot=new C("tag:yaml.org,2002:bool",{kind:"scalar",resolve:un,construct:dn,predicate:pn,represent:{lowercase:function(e){return e?"true":"false"},uppercase:function(e){return e?"TRUE":"FALSE"},camelcase:function(e){return e?"True":"False"}},defaultStyle:"lowercase"});function fn(e){return 48<=e&&e<=57||65<=e&&e<=70||97<=e&&e<=102}function hn(e){return 48<=e&&e<=55}function gn(e){return 48<=e&&e<=57}function mn(e){if(e===null)return!1;var t=e.length,i=0,n=!1,r;if(!t)return!1;if(r=e[i],(r==="-"||r==="+")&&(r=e[++i]),r==="0"){if(i+1===t)return!0;if(r=e[++i],r==="b"){for(i++;i<t;i++)if(r=e[i],r!=="_"){if(r!=="0"&&r!=="1")return!1;n=!0}return n&&r!=="_"}if(r==="x"){for(i++;i<t;i++)if(r=e[i],r!=="_"){if(!fn(e.charCodeAt(i)))return!1;n=!0}return n&&r!=="_"}if(r==="o"){for(i++;i<t;i++)if(r=e[i],r!=="_"){if(!hn(e.charCodeAt(i)))return!1;n=!0}return n&&r!=="_"}}if(r==="_")return!1;for(;i<t;i++)if(r=e[i],r!=="_"){if(!gn(e.charCodeAt(i)))return!1;n=!0}return!(!n||r==="_")}function yn(e){var t=e,i=1,n;if(t.indexOf("_")!==-1&&(t=t.replace(/_/g,"")),n=t[0],(n==="-"||n==="+")&&(n==="-"&&(i=-1),t=t.slice(1),n=t[0]),t==="0")return 0;if(n==="0"){if(t[1]==="b")return i*parseInt(t.slice(2),2);if(t[1]==="x")return i*parseInt(t.slice(2),16);if(t[1]==="o")return i*parseInt(t.slice(2),8)}return i*parseInt(t,10)}function xn(e){return Object.prototype.toString.call(e)==="[object Number]"&&e%1===0&&!k.isNegativeZero(e)}var Nt=new C("tag:yaml.org,2002:int",{kind:"scalar",resolve:mn,construct:yn,predicate:xn,represent:{binary:function(e){return e>=0?"0b"+e.toString(2):"-0b"+e.toString(2).slice(1)},octal:function(e){return e>=0?"0o"+e.toString(8):"-0o"+e.toString(8).slice(1)},decimal:function(e){return e.toString(10)},hexadecimal:function(e){return e>=0?"0x"+e.toString(16).toUpperCase():"-0x"+e.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),vn=new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function bn(e){return!(e===null||!vn.test(e)||e[e.length-1]==="_")}function wn(e){var t,i;return t=e.replace(/_/g,"").toLowerCase(),i=t[0]==="-"?-1:1,"+-".indexOf(t[0])>=0&&(t=t.slice(1)),t===".inf"?i===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:t===".nan"?NaN:i*parseFloat(t,10)}var En=/^[-+]?[0-9]+e/;function kn(e,t){var i;if(isNaN(e))switch(t){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===e)switch(t){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===e)switch(t){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(k.isNegativeZero(e))return"-0.0";return i=e.toString(10),En.test(i)?i.replace("e",".e"):i}function Cn(e){return Object.prototype.toString.call(e)==="[object Number]"&&(e%1!==0||k.isNegativeZero(e))}var $t=new C("tag:yaml.org,2002:float",{kind:"scalar",resolve:bn,construct:wn,predicate:Cn,represent:kn,defaultStyle:"lowercase"}),jt=_t.extend({implicit:[Rt,Ot,Nt,$t]}),Ht=jt,Ut=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),Vt=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function Tn(e){return e===null?!1:Ut.exec(e)!==null||Vt.exec(e)!==null}function An(e){var t,i,n,r,s,a,o,l=0,c=null,u,d,p;if(t=Ut.exec(e),t===null&&(t=Vt.exec(e)),t===null)throw new Error("Date resolve error");if(i=+t[1],n=+t[2]-1,r=+t[3],!t[4])return new Date(Date.UTC(i,n,r));if(s=+t[4],a=+t[5],o=+t[6],t[7]){for(l=t[7].slice(0,3);l.length<3;)l+="0";l=+l}return t[9]&&(u=+t[10],d=+(t[11]||0),c=(u*60+d)*6e4,t[9]==="-"&&(c=-c)),p=new Date(Date.UTC(i,n,r,s,a,o,l)),c&&p.setTime(p.getTime()-c),p}function Sn(e){return e.toISOString()}var zt=new C("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:Tn,construct:An,instanceOf:Date,represent:Sn});function Mn(e){return e==="<<"||e===null}var Yt=new C("tag:yaml.org,2002:merge",{kind:"scalar",resolve:Mn}),Ne=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function In(e){if(e===null)return!1;var t,i,n=0,r=e.length,s=Ne;for(i=0;i<r;i++)if(t=s.indexOf(e.charAt(i)),!(t>64)){if(t<0)return!1;n+=6}return n%8===0}function Fn(e){var t,i,n=e.replace(/[\r\n=]/g,""),r=n.length,s=Ne,a=0,o=[];for(t=0;t<r;t++)t%4===0&&t&&(o.push(a>>16&255),o.push(a>>8&255),o.push(a&255)),a=a<<6|s.indexOf(n.charAt(t));return i=r%4*6,i===0?(o.push(a>>16&255),o.push(a>>8&255),o.push(a&255)):i===18?(o.push(a>>10&255),o.push(a>>2&255)):i===12&&o.push(a>>4&255),new Uint8Array(o)}function Bn(e){var t="",i=0,n,r,s=e.length,a=Ne;for(n=0;n<s;n++)n%3===0&&n&&(t+=a[i>>18&63],t+=a[i>>12&63],t+=a[i>>6&63],t+=a[i&63]),i=(i<<8)+e[n];return r=s%3,r===0?(t+=a[i>>18&63],t+=a[i>>12&63],t+=a[i>>6&63],t+=a[i&63]):r===2?(t+=a[i>>10&63],t+=a[i>>4&63],t+=a[i<<2&63],t+=a[64]):r===1&&(t+=a[i>>2&63],t+=a[i<<4&63],t+=a[64],t+=a[64]),t}function Pn(e){return Object.prototype.toString.call(e)==="[object Uint8Array]"}var Kt=new C("tag:yaml.org,2002:binary",{kind:"scalar",resolve:In,construct:Fn,predicate:Pn,represent:Bn}),Ln=Object.prototype.hasOwnProperty,Dn=Object.prototype.toString;function _n(e){if(e===null)return!0;var t=[],i,n,r,s,a,o=e;for(i=0,n=o.length;i<n;i+=1){if(r=o[i],a=!1,Dn.call(r)!=="[object Object]")return!1;for(s in r)if(Ln.call(r,s))if(!a)a=!0;else return!1;if(!a)return!1;if(t.indexOf(s)===-1)t.push(s);else return!1}return!0}function Rn(e){return e!==null?e:[]}var Wt=new C("tag:yaml.org,2002:omap",{kind:"sequence",resolve:_n,construct:Rn}),On=Object.prototype.toString;function Nn(e){if(e===null)return!0;var t,i,n,r,s,a=e;for(s=new Array(a.length),t=0,i=a.length;t<i;t+=1){if(n=a[t],On.call(n)!=="[object Object]"||(r=Object.keys(n),r.length!==1))return!1;s[t]=[r[0],n[r[0]]]}return!0}function $n(e){if(e===null)return[];var t,i,n,r,s,a=e;for(s=new Array(a.length),t=0,i=a.length;t<i;t+=1)n=a[t],r=Object.keys(n),s[t]=[r[0],n[r[0]]];return s}var Gt=new C("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:Nn,construct:$n}),jn=Object.prototype.hasOwnProperty;function Hn(e){if(e===null)return!0;var t,i=e;for(t in i)if(jn.call(i,t)&&i[t]!==null)return!1;return!0}function Un(e){return e!==null?e:{}}var qt=new C("tag:yaml.org,2002:set",{kind:"mapping",resolve:Hn,construct:Un}),$e=Ht.extend({implicit:[zt,Yt],explicit:[Kt,Wt,Gt,qt]}),D=Object.prototype.hasOwnProperty,he=1,Qt=2,Jt=3,ge=4,Pe=1,Vn=2,gt=3,zn=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Yn=/[\x85\u2028\u2029]/,Kn=/[,\[\]\{\}]/,Xt=/^(?:!|!!|![a-z\-]+!)$/i,Zt=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function mt(e){return Object.prototype.toString.call(e)}function M(e){return e===10||e===13}function R(e){return e===9||e===32}function S(e){return e===9||e===32||e===10||e===13}function U(e){return e===44||e===91||e===93||e===123||e===125}function Wn(e){var t;return 48<=e&&e<=57?e-48:(t=e|32,97<=t&&t<=102?t-97+10:-1)}function Gn(e){return e===120?2:e===117?4:e===85?8:0}function qn(e){return 48<=e&&e<=57?e-48:-1}function yt(e){return e===48?"\0":e===97?"\x07":e===98?"\b":e===116||e===9?"	":e===110?`
`:e===118?"\v":e===102?"\f":e===114?"\r":e===101?"\x1B":e===32?" ":e===34?'"':e===47?"/":e===92?"\\":e===78?"\x85":e===95?"\xA0":e===76?"\u2028":e===80?"\u2029":""}function Qn(e){return e<=65535?String.fromCharCode(e):String.fromCharCode((e-65536>>10)+55296,(e-65536&1023)+56320)}function ei(e,t,i){t==="__proto__"?Object.defineProperty(e,t,{configurable:!0,enumerable:!0,writable:!0,value:i}):e[t]=i}var ti=new Array(256),ii=new Array(256);for(_=0;_<256;_++)ti[_]=yt(_)?1:0,ii[_]=yt(_);var _;function Jn(e,t){this.input=e,this.filename=t.filename||null,this.schema=t.schema||$e,this.onWarning=t.onWarning||null,this.legacy=t.legacy||!1,this.json=t.json||!1,this.listener=t.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=e.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function ni(e,t){var i={name:e.filename,buffer:e.input.slice(0,-1),position:e.position,line:e.line,column:e.position-e.lineStart};return i.snippet=en(i),new A(t,i)}function m(e,t){throw ni(e,t)}function me(e,t){e.onWarning&&e.onWarning.call(null,ni(e,t))}var xt={YAML:function(t,i,n){var r,s,a;t.version!==null&&m(t,"duplication of %YAML directive"),n.length!==1&&m(t,"YAML directive accepts exactly one argument"),r=/^([0-9]+)\.([0-9]+)$/.exec(n[0]),r===null&&m(t,"ill-formed argument of the YAML directive"),s=parseInt(r[1],10),a=parseInt(r[2],10),s!==1&&m(t,"unacceptable YAML version of the document"),t.version=n[0],t.checkLineBreaks=a<2,a!==1&&a!==2&&me(t,"unsupported YAML version of the document")},TAG:function(t,i,n){var r,s;n.length!==2&&m(t,"TAG directive accepts exactly two arguments"),r=n[0],s=n[1],Xt.test(r)||m(t,"ill-formed tag handle (first argument) of the TAG directive"),D.call(t.tagMap,r)&&m(t,'there is a previously declared suffix for "'+r+'" tag handle'),Zt.test(s)||m(t,"ill-formed tag prefix (second argument) of the TAG directive");try{s=decodeURIComponent(s)}catch{m(t,"tag prefix is malformed: "+s)}t.tagMap[r]=s}};function L(e,t,i,n){var r,s,a,o;if(t<i){if(o=e.input.slice(t,i),n)for(r=0,s=o.length;r<s;r+=1)a=o.charCodeAt(r),a===9||32<=a&&a<=1114111||m(e,"expected valid JSON character");else zn.test(o)&&m(e,"the stream contains non-printable characters");e.result+=o}}function vt(e,t,i,n){var r,s,a,o;for(k.isObject(i)||m(e,"cannot merge mappings; the provided source object is unacceptable"),r=Object.keys(i),a=0,o=r.length;a<o;a+=1)s=r[a],D.call(t,s)||(ei(t,s,i[s]),n[s]=!0)}function V(e,t,i,n,r,s,a,o,l){var c,u;if(Array.isArray(r))for(r=Array.prototype.slice.call(r),c=0,u=r.length;c<u;c+=1)Array.isArray(r[c])&&m(e,"nested arrays are not supported inside keys"),typeof r=="object"&&mt(r[c])==="[object Object]"&&(r[c]="[object Object]");if(typeof r=="object"&&mt(r)==="[object Object]"&&(r="[object Object]"),r=String(r),t===null&&(t={}),n==="tag:yaml.org,2002:merge")if(Array.isArray(s))for(c=0,u=s.length;c<u;c+=1)vt(e,t,s[c],i);else vt(e,t,s,i);else!e.json&&!D.call(i,r)&&D.call(t,r)&&(e.line=a||e.line,e.lineStart=o||e.lineStart,e.position=l||e.position,m(e,"duplicated mapping key")),ei(t,r,s),delete i[r];return t}function je(e){var t;t=e.input.charCodeAt(e.position),t===10?e.position++:t===13?(e.position++,e.input.charCodeAt(e.position)===10&&e.position++):m(e,"a line break is expected"),e.line+=1,e.lineStart=e.position,e.firstTabInLine=-1}function w(e,t,i){for(var n=0,r=e.input.charCodeAt(e.position);r!==0;){for(;R(r);)r===9&&e.firstTabInLine===-1&&(e.firstTabInLine=e.position),r=e.input.charCodeAt(++e.position);if(t&&r===35)do r=e.input.charCodeAt(++e.position);while(r!==10&&r!==13&&r!==0);if(M(r))for(je(e),r=e.input.charCodeAt(e.position),n++,e.lineIndent=0;r===32;)e.lineIndent++,r=e.input.charCodeAt(++e.position);else break}return i!==-1&&n!==0&&e.lineIndent<i&&me(e,"deficient indentation"),n}function ve(e){var t=e.position,i;return i=e.input.charCodeAt(t),!!((i===45||i===46)&&i===e.input.charCodeAt(t+1)&&i===e.input.charCodeAt(t+2)&&(t+=3,i=e.input.charCodeAt(t),i===0||S(i)))}function He(e,t){t===1?e.result+=" ":t>1&&(e.result+=k.repeat(`
`,t-1))}function Xn(e,t,i){var n,r,s,a,o,l,c,u,d=e.kind,p=e.result,h;if(h=e.input.charCodeAt(e.position),S(h)||U(h)||h===35||h===38||h===42||h===33||h===124||h===62||h===39||h===34||h===37||h===64||h===96||(h===63||h===45)&&(r=e.input.charCodeAt(e.position+1),S(r)||i&&U(r)))return!1;for(e.kind="scalar",e.result="",s=a=e.position,o=!1;h!==0;){if(h===58){if(r=e.input.charCodeAt(e.position+1),S(r)||i&&U(r))break}else if(h===35){if(n=e.input.charCodeAt(e.position-1),S(n))break}else{if(e.position===e.lineStart&&ve(e)||i&&U(h))break;if(M(h))if(l=e.line,c=e.lineStart,u=e.lineIndent,w(e,!1,-1),e.lineIndent>=t){o=!0,h=e.input.charCodeAt(e.position);continue}else{e.position=a,e.line=l,e.lineStart=c,e.lineIndent=u;break}}o&&(L(e,s,a,!1),He(e,e.line-l),s=a=e.position,o=!1),R(h)||(a=e.position+1),h=e.input.charCodeAt(++e.position)}return L(e,s,a,!1),e.result?!0:(e.kind=d,e.result=p,!1)}function Zn(e,t){var i,n,r;if(i=e.input.charCodeAt(e.position),i!==39)return!1;for(e.kind="scalar",e.result="",e.position++,n=r=e.position;(i=e.input.charCodeAt(e.position))!==0;)if(i===39)if(L(e,n,e.position,!0),i=e.input.charCodeAt(++e.position),i===39)n=e.position,e.position++,r=e.position;else return!0;else M(i)?(L(e,n,r,!0),He(e,w(e,!1,t)),n=r=e.position):e.position===e.lineStart&&ve(e)?m(e,"unexpected end of the document within a single quoted scalar"):(e.position++,r=e.position);m(e,"unexpected end of the stream within a single quoted scalar")}function er(e,t){var i,n,r,s,a,o;if(o=e.input.charCodeAt(e.position),o!==34)return!1;for(e.kind="scalar",e.result="",e.position++,i=n=e.position;(o=e.input.charCodeAt(e.position))!==0;){if(o===34)return L(e,i,e.position,!0),e.position++,!0;if(o===92){if(L(e,i,e.position,!0),o=e.input.charCodeAt(++e.position),M(o))w(e,!1,t);else if(o<256&&ti[o])e.result+=ii[o],e.position++;else if((a=Gn(o))>0){for(r=a,s=0;r>0;r--)o=e.input.charCodeAt(++e.position),(a=Wn(o))>=0?s=(s<<4)+a:m(e,"expected hexadecimal character");e.result+=Qn(s),e.position++}else m(e,"unknown escape sequence");i=n=e.position}else M(o)?(L(e,i,n,!0),He(e,w(e,!1,t)),i=n=e.position):e.position===e.lineStart&&ve(e)?m(e,"unexpected end of the document within a double quoted scalar"):(e.position++,n=e.position)}m(e,"unexpected end of the stream within a double quoted scalar")}function tr(e,t){var i=!0,n,r,s,a=e.tag,o,l=e.anchor,c,u,d,p,h,g=Object.create(null),f,y,b,x;if(x=e.input.charCodeAt(e.position),x===91)u=93,h=!1,o=[];else if(x===123)u=125,h=!0,o={};else return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=o),x=e.input.charCodeAt(++e.position);x!==0;){if(w(e,!0,t),x=e.input.charCodeAt(e.position),x===u)return e.position++,e.tag=a,e.anchor=l,e.kind=h?"mapping":"sequence",e.result=o,!0;i?x===44&&m(e,"expected the node content, but found ','"):m(e,"missed comma between flow collection entries"),y=f=b=null,d=p=!1,x===63&&(c=e.input.charCodeAt(e.position+1),S(c)&&(d=p=!0,e.position++,w(e,!0,t))),n=e.line,r=e.lineStart,s=e.position,z(e,t,he,!1,!0),y=e.tag,f=e.result,w(e,!0,t),x=e.input.charCodeAt(e.position),(p||e.line===n)&&x===58&&(d=!0,x=e.input.charCodeAt(++e.position),w(e,!0,t),z(e,t,he,!1,!0),b=e.result),h?V(e,o,g,y,f,b,n,r,s):d?o.push(V(e,null,g,y,f,b,n,r,s)):o.push(f),w(e,!0,t),x=e.input.charCodeAt(e.position),x===44?(i=!0,x=e.input.charCodeAt(++e.position)):i=!1}m(e,"unexpected end of the stream within a flow collection")}function ir(e,t){var i,n,r=Pe,s=!1,a=!1,o=t,l=0,c=!1,u,d;if(d=e.input.charCodeAt(e.position),d===124)n=!1;else if(d===62)n=!0;else return!1;for(e.kind="scalar",e.result="";d!==0;)if(d=e.input.charCodeAt(++e.position),d===43||d===45)Pe===r?r=d===43?gt:Vn:m(e,"repeat of a chomping mode identifier");else if((u=qn(d))>=0)u===0?m(e,"bad explicit indentation width of a block scalar; it cannot be less than one"):a?m(e,"repeat of an indentation width identifier"):(o=t+u-1,a=!0);else break;if(R(d)){do d=e.input.charCodeAt(++e.position);while(R(d));if(d===35)do d=e.input.charCodeAt(++e.position);while(!M(d)&&d!==0)}for(;d!==0;){for(je(e),e.lineIndent=0,d=e.input.charCodeAt(e.position);(!a||e.lineIndent<o)&&d===32;)e.lineIndent++,d=e.input.charCodeAt(++e.position);if(!a&&e.lineIndent>o&&(o=e.lineIndent),M(d)){l++;continue}if(e.lineIndent<o){r===gt?e.result+=k.repeat(`
`,s?1+l:l):r===Pe&&s&&(e.result+=`
`);break}for(n?R(d)?(c=!0,e.result+=k.repeat(`
`,s?1+l:l)):c?(c=!1,e.result+=k.repeat(`
`,l+1)):l===0?s&&(e.result+=" "):e.result+=k.repeat(`
`,l):e.result+=k.repeat(`
`,s?1+l:l),s=!0,a=!0,l=0,i=e.position;!M(d)&&d!==0;)d=e.input.charCodeAt(++e.position);L(e,i,e.position,!1)}return!0}function bt(e,t){var i,n=e.tag,r=e.anchor,s=[],a,o=!1,l;if(e.firstTabInLine!==-1)return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=s),l=e.input.charCodeAt(e.position);l!==0&&(e.firstTabInLine!==-1&&(e.position=e.firstTabInLine,m(e,"tab characters must not be used in indentation")),!(l!==45||(a=e.input.charCodeAt(e.position+1),!S(a))));){if(o=!0,e.position++,w(e,!0,-1)&&e.lineIndent<=t){s.push(null),l=e.input.charCodeAt(e.position);continue}if(i=e.line,z(e,t,Jt,!1,!0),s.push(e.result),w(e,!0,-1),l=e.input.charCodeAt(e.position),(e.line===i||e.lineIndent>t)&&l!==0)m(e,"bad indentation of a sequence entry");else if(e.lineIndent<t)break}return o?(e.tag=n,e.anchor=r,e.kind="sequence",e.result=s,!0):!1}function nr(e,t,i){var n,r,s,a,o,l,c=e.tag,u=e.anchor,d={},p=Object.create(null),h=null,g=null,f=null,y=!1,b=!1,x;if(e.firstTabInLine!==-1)return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=d),x=e.input.charCodeAt(e.position);x!==0;){if(!y&&e.firstTabInLine!==-1&&(e.position=e.firstTabInLine,m(e,"tab characters must not be used in indentation")),n=e.input.charCodeAt(e.position+1),s=e.line,(x===63||x===58)&&S(n))x===63?(y&&(V(e,d,p,h,g,null,a,o,l),h=g=f=null),b=!0,y=!0,r=!0):y?(y=!1,r=!0):m(e,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),e.position+=1,x=n;else{if(a=e.line,o=e.lineStart,l=e.position,!z(e,i,Qt,!1,!0))break;if(e.line===s){for(x=e.input.charCodeAt(e.position);R(x);)x=e.input.charCodeAt(++e.position);if(x===58)x=e.input.charCodeAt(++e.position),S(x)||m(e,"a whitespace character is expected after the key-value separator within a block mapping"),y&&(V(e,d,p,h,g,null,a,o,l),h=g=f=null),b=!0,y=!1,r=!1,h=e.tag,g=e.result;else if(b)m(e,"can not read an implicit mapping pair; a colon is missed");else return e.tag=c,e.anchor=u,!0}else if(b)m(e,"can not read a block mapping entry; a multiline key may not be an implicit key");else return e.tag=c,e.anchor=u,!0}if((e.line===s||e.lineIndent>t)&&(y&&(a=e.line,o=e.lineStart,l=e.position),z(e,t,ge,!0,r)&&(y?g=e.result:f=e.result),y||(V(e,d,p,h,g,f,a,o,l),h=g=f=null),w(e,!0,-1),x=e.input.charCodeAt(e.position)),(e.line===s||e.lineIndent>t)&&x!==0)m(e,"bad indentation of a mapping entry");else if(e.lineIndent<t)break}return y&&V(e,d,p,h,g,null,a,o,l),b&&(e.tag=c,e.anchor=u,e.kind="mapping",e.result=d),b}function rr(e){var t,i=!1,n=!1,r,s,a;if(a=e.input.charCodeAt(e.position),a!==33)return!1;if(e.tag!==null&&m(e,"duplication of a tag property"),a=e.input.charCodeAt(++e.position),a===60?(i=!0,a=e.input.charCodeAt(++e.position)):a===33?(n=!0,r="!!",a=e.input.charCodeAt(++e.position)):r="!",t=e.position,i){do a=e.input.charCodeAt(++e.position);while(a!==0&&a!==62);e.position<e.length?(s=e.input.slice(t,e.position),a=e.input.charCodeAt(++e.position)):m(e,"unexpected end of the stream within a verbatim tag")}else{for(;a!==0&&!S(a);)a===33&&(n?m(e,"tag suffix cannot contain exclamation marks"):(r=e.input.slice(t-1,e.position+1),Xt.test(r)||m(e,"named tag handle cannot contain such characters"),n=!0,t=e.position+1)),a=e.input.charCodeAt(++e.position);s=e.input.slice(t,e.position),Kn.test(s)&&m(e,"tag suffix cannot contain flow indicator characters")}s&&!Zt.test(s)&&m(e,"tag name cannot contain such characters: "+s);try{s=decodeURIComponent(s)}catch{m(e,"tag name is malformed: "+s)}return i?e.tag=s:D.call(e.tagMap,r)?e.tag=e.tagMap[r]+s:r==="!"?e.tag="!"+s:r==="!!"?e.tag="tag:yaml.org,2002:"+s:m(e,'undeclared tag handle "'+r+'"'),!0}function ar(e){var t,i;if(i=e.input.charCodeAt(e.position),i!==38)return!1;for(e.anchor!==null&&m(e,"duplication of an anchor property"),i=e.input.charCodeAt(++e.position),t=e.position;i!==0&&!S(i)&&!U(i);)i=e.input.charCodeAt(++e.position);return e.position===t&&m(e,"name of an anchor node must contain at least one character"),e.anchor=e.input.slice(t,e.position),!0}function sr(e){var t,i,n;if(n=e.input.charCodeAt(e.position),n!==42)return!1;for(n=e.input.charCodeAt(++e.position),t=e.position;n!==0&&!S(n)&&!U(n);)n=e.input.charCodeAt(++e.position);return e.position===t&&m(e,"name of an alias node must contain at least one character"),i=e.input.slice(t,e.position),D.call(e.anchorMap,i)||m(e,'unidentified alias "'+i+'"'),e.result=e.anchorMap[i],w(e,!0,-1),!0}function z(e,t,i,n,r){var s,a,o,l=1,c=!1,u=!1,d,p,h,g,f,y;if(e.listener!==null&&e.listener("open",e),e.tag=null,e.anchor=null,e.kind=null,e.result=null,s=a=o=ge===i||Jt===i,n&&w(e,!0,-1)&&(c=!0,e.lineIndent>t?l=1:e.lineIndent===t?l=0:e.lineIndent<t&&(l=-1)),l===1)for(;rr(e)||ar(e);)w(e,!0,-1)?(c=!0,o=s,e.lineIndent>t?l=1:e.lineIndent===t?l=0:e.lineIndent<t&&(l=-1)):o=!1;if(o&&(o=c||r),(l===1||ge===i)&&(he===i||Qt===i?f=t:f=t+1,y=e.position-e.lineStart,l===1?o&&(bt(e,y)||nr(e,y,f))||tr(e,f)?u=!0:(a&&ir(e,f)||Zn(e,f)||er(e,f)?u=!0:sr(e)?(u=!0,(e.tag!==null||e.anchor!==null)&&m(e,"alias node should not have any properties")):Xn(e,f,he===i)&&(u=!0,e.tag===null&&(e.tag="?")),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):l===0&&(u=o&&bt(e,y))),e.tag===null)e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);else if(e.tag==="?"){for(e.result!==null&&e.kind!=="scalar"&&m(e,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+e.kind+'"'),d=0,p=e.implicitTypes.length;d<p;d+=1)if(g=e.implicitTypes[d],g.resolve(e.result)){e.result=g.construct(e.result),e.tag=g.tag,e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);break}}else if(e.tag!=="!"){if(D.call(e.typeMap[e.kind||"fallback"],e.tag))g=e.typeMap[e.kind||"fallback"][e.tag];else for(g=null,h=e.typeMap.multi[e.kind||"fallback"],d=0,p=h.length;d<p;d+=1)if(e.tag.slice(0,h[d].tag.length)===h[d].tag){g=h[d];break}g||m(e,"unknown tag !<"+e.tag+">"),e.result!==null&&g.kind!==e.kind&&m(e,"unacceptable node kind for !<"+e.tag+'> tag; it should be "'+g.kind+'", not "'+e.kind+'"'),g.resolve(e.result,e.tag)?(e.result=g.construct(e.result,e.tag),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):m(e,"cannot resolve a node with !<"+e.tag+"> explicit tag")}return e.listener!==null&&e.listener("close",e),e.tag!==null||e.anchor!==null||u}function or(e){var t=e.position,i,n,r,s=!1,a;for(e.version=null,e.checkLineBreaks=e.legacy,e.tagMap=Object.create(null),e.anchorMap=Object.create(null);(a=e.input.charCodeAt(e.position))!==0&&(w(e,!0,-1),a=e.input.charCodeAt(e.position),!(e.lineIndent>0||a!==37));){for(s=!0,a=e.input.charCodeAt(++e.position),i=e.position;a!==0&&!S(a);)a=e.input.charCodeAt(++e.position);for(n=e.input.slice(i,e.position),r=[],n.length<1&&m(e,"directive name must not be less than one character in length");a!==0;){for(;R(a);)a=e.input.charCodeAt(++e.position);if(a===35){do a=e.input.charCodeAt(++e.position);while(a!==0&&!M(a));break}if(M(a))break;for(i=e.position;a!==0&&!S(a);)a=e.input.charCodeAt(++e.position);r.push(e.input.slice(i,e.position))}a!==0&&je(e),D.call(xt,n)?xt[n](e,n,r):me(e,'unknown document directive "'+n+'"')}if(w(e,!0,-1),e.lineIndent===0&&e.input.charCodeAt(e.position)===45&&e.input.charCodeAt(e.position+1)===45&&e.input.charCodeAt(e.position+2)===45?(e.position+=3,w(e,!0,-1)):s&&m(e,"directives end mark is expected"),z(e,e.lineIndent-1,ge,!1,!0),w(e,!0,-1),e.checkLineBreaks&&Yn.test(e.input.slice(t,e.position))&&me(e,"non-ASCII line breaks are interpreted as content"),e.documents.push(e.result),e.position===e.lineStart&&ve(e)){e.input.charCodeAt(e.position)===46&&(e.position+=3,w(e,!0,-1));return}if(e.position<e.length-1)m(e,"end of the stream or a document separator is expected");else return}function ri(e,t){e=String(e),t=t||{},e.length!==0&&(e.charCodeAt(e.length-1)!==10&&e.charCodeAt(e.length-1)!==13&&(e+=`
`),e.charCodeAt(0)===65279&&(e=e.slice(1)));var i=new Jn(e,t),n=e.indexOf("\0");for(n!==-1&&(i.position=n,m(i,"null byte is not allowed in input")),i.input+="\0";i.input.charCodeAt(i.position)===32;)i.lineIndent+=1,i.position+=1;for(;i.position<i.length-1;)or(i);return i.documents}function lr(e,t,i){t!==null&&typeof t=="object"&&typeof i>"u"&&(i=t,t=null);var n=ri(e,i);if(typeof t!="function")return n;for(var r=0,s=n.length;r<s;r+=1)t(n[r])}function cr(e,t){var i=ri(e,t);if(i.length!==0){if(i.length===1)return i[0];throw new A("expected a single document in the stream, but found more")}}var ur=lr,dr=cr,ai={loadAll:ur,load:dr},si=Object.prototype.toString,oi=Object.prototype.hasOwnProperty,Ue=65279,pr=9,ee=10,fr=13,hr=32,gr=33,mr=34,De=35,yr=37,xr=38,vr=39,br=42,li=44,wr=45,ye=58,Er=61,kr=62,Cr=63,Tr=64,ci=91,ui=93,Ar=96,di=123,Sr=124,pi=125,T={};T[0]="\\0";T[7]="\\a";T[8]="\\b";T[9]="\\t";T[10]="\\n";T[11]="\\v";T[12]="\\f";T[13]="\\r";T[27]="\\e";T[34]='\\"';T[92]="\\\\";T[133]="\\N";T[160]="\\_";T[8232]="\\L";T[8233]="\\P";var Mr=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],Ir=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function Fr(e,t){var i,n,r,s,a,o,l;if(t===null)return{};for(i={},n=Object.keys(t),r=0,s=n.length;r<s;r+=1)a=n[r],o=String(t[a]),a.slice(0,2)==="!!"&&(a="tag:yaml.org,2002:"+a.slice(2)),l=e.compiledTypeMap.fallback[a],l&&oi.call(l.styleAliases,o)&&(o=l.styleAliases[o]),i[a]=o;return i}function Br(e){var t,i,n;if(t=e.toString(16).toUpperCase(),e<=255)i="x",n=2;else if(e<=65535)i="u",n=4;else if(e<=4294967295)i="U",n=8;else throw new A("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+i+k.repeat("0",n-t.length)+t}var Pr=1,te=2;function Lr(e){this.schema=e.schema||$e,this.indent=Math.max(1,e.indent||2),this.noArrayIndent=e.noArrayIndent||!1,this.skipInvalid=e.skipInvalid||!1,this.flowLevel=k.isNothing(e.flowLevel)?-1:e.flowLevel,this.styleMap=Fr(this.schema,e.styles||null),this.sortKeys=e.sortKeys||!1,this.lineWidth=e.lineWidth||80,this.noRefs=e.noRefs||!1,this.noCompatMode=e.noCompatMode||!1,this.condenseFlow=e.condenseFlow||!1,this.quotingType=e.quotingType==='"'?te:Pr,this.forceQuotes=e.forceQuotes||!1,this.replacer=typeof e.replacer=="function"?e.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function wt(e,t){for(var i=k.repeat(" ",t),n=0,r=-1,s="",a,o=e.length;n<o;)r=e.indexOf(`
`,n),r===-1?(a=e.slice(n),n=o):(a=e.slice(n,r+1),n=r+1),a.length&&a!==`
`&&(s+=i),s+=a;return s}function _e(e,t){return`
`+k.repeat(" ",e.indent*t)}function Dr(e,t){var i,n,r;for(i=0,n=e.implicitTypes.length;i<n;i+=1)if(r=e.implicitTypes[i],r.resolve(t))return!0;return!1}function xe(e){return e===hr||e===pr}function ie(e){return 32<=e&&e<=126||161<=e&&e<=55295&&e!==8232&&e!==8233||57344<=e&&e<=65533&&e!==Ue||65536<=e&&e<=1114111}function Et(e){return ie(e)&&e!==Ue&&e!==fr&&e!==ee}function kt(e,t,i){var n=Et(e),r=n&&!xe(e);return(i?n:n&&e!==li&&e!==ci&&e!==ui&&e!==di&&e!==pi)&&e!==De&&!(t===ye&&!r)||Et(t)&&!xe(t)&&e===De||t===ye&&r}function _r(e){return ie(e)&&e!==Ue&&!xe(e)&&e!==wr&&e!==Cr&&e!==ye&&e!==li&&e!==ci&&e!==ui&&e!==di&&e!==pi&&e!==De&&e!==xr&&e!==br&&e!==gr&&e!==Sr&&e!==Er&&e!==kr&&e!==vr&&e!==mr&&e!==yr&&e!==Tr&&e!==Ar}function Rr(e){return!xe(e)&&e!==ye}function X(e,t){var i=e.charCodeAt(t),n;return i>=55296&&i<=56319&&t+1<e.length&&(n=e.charCodeAt(t+1),n>=56320&&n<=57343)?(i-55296)*1024+n-56320+65536:i}function fi(e){var t=/^\n* /;return t.test(e)}var hi=1,Re=2,gi=3,mi=4,H=5;function Or(e,t,i,n,r,s,a,o){var l,c=0,u=null,d=!1,p=!1,h=n!==-1,g=-1,f=_r(X(e,0))&&Rr(X(e,e.length-1));if(t||a)for(l=0;l<e.length;c>=65536?l+=2:l++){if(c=X(e,l),!ie(c))return H;f=f&&kt(c,u,o),u=c}else{for(l=0;l<e.length;c>=65536?l+=2:l++){if(c=X(e,l),c===ee)d=!0,h&&(p=p||l-g-1>n&&e[g+1]!==" ",g=l);else if(!ie(c))return H;f=f&&kt(c,u,o),u=c}p=p||h&&l-g-1>n&&e[g+1]!==" "}return!d&&!p?f&&!a&&!r(e)?hi:s===te?H:Re:i>9&&fi(e)?H:a?s===te?H:Re:p?mi:gi}function Nr(e,t,i,n,r){e.dump=(function(){if(t.length===0)return e.quotingType===te?'""':"''";if(!e.noCompatMode&&(Mr.indexOf(t)!==-1||Ir.test(t)))return e.quotingType===te?'"'+t+'"':"'"+t+"'";var s=e.indent*Math.max(1,i),a=e.lineWidth===-1?-1:Math.max(Math.min(e.lineWidth,40),e.lineWidth-s),o=n||e.flowLevel>-1&&i>=e.flowLevel;function l(c){return Dr(e,c)}switch(Or(t,o,e.indent,a,l,e.quotingType,e.forceQuotes&&!n,r)){case hi:return t;case Re:return"'"+t.replace(/'/g,"''")+"'";case gi:return"|"+Ct(t,e.indent)+Tt(wt(t,s));case mi:return">"+Ct(t,e.indent)+Tt(wt($r(t,a),s));case H:return'"'+jr(t)+'"';default:throw new A("impossible error: invalid scalar style")}})()}function Ct(e,t){var i=fi(e)?String(t):"",n=e[e.length-1]===`
`,r=n&&(e[e.length-2]===`
`||e===`
`),s=r?"+":n?"":"-";return i+s+`
`}function Tt(e){return e[e.length-1]===`
`?e.slice(0,-1):e}function $r(e,t){for(var i=/(\n+)([^\n]*)/g,n=(function(){var c=e.indexOf(`
`);return c=c!==-1?c:e.length,i.lastIndex=c,At(e.slice(0,c),t)})(),r=e[0]===`
`||e[0]===" ",s,a;a=i.exec(e);){var o=a[1],l=a[2];s=l[0]===" ",n+=o+(!r&&!s&&l!==""?`
`:"")+At(l,t),r=s}return n}function At(e,t){if(e===""||e[0]===" ")return e;for(var i=/ [^ ]/g,n,r=0,s,a=0,o=0,l="";n=i.exec(e);)o=n.index,o-r>t&&(s=a>r?a:o,l+=`
`+e.slice(r,s),r=s+1),a=o;return l+=`
`,e.length-r>t&&a>r?l+=e.slice(r,a)+`
`+e.slice(a+1):l+=e.slice(r),l.slice(1)}function jr(e){for(var t="",i=0,n,r=0;r<e.length;i>=65536?r+=2:r++)i=X(e,r),n=T[i],!n&&ie(i)?(t+=e[r],i>=65536&&(t+=e[r+1])):t+=n||Br(i);return t}function Hr(e,t,i){var n="",r=e.tag,s,a,o;for(s=0,a=i.length;s<a;s+=1)o=i[s],e.replacer&&(o=e.replacer.call(i,String(s),o)),(B(e,t,o,!1,!1)||typeof o>"u"&&B(e,t,null,!1,!1))&&(n!==""&&(n+=","+(e.condenseFlow?"":" ")),n+=e.dump);e.tag=r,e.dump="["+n+"]"}function St(e,t,i,n){var r="",s=e.tag,a,o,l;for(a=0,o=i.length;a<o;a+=1)l=i[a],e.replacer&&(l=e.replacer.call(i,String(a),l)),(B(e,t+1,l,!0,!0,!1,!0)||typeof l>"u"&&B(e,t+1,null,!0,!0,!1,!0))&&((!n||r!=="")&&(r+=_e(e,t)),e.dump&&ee===e.dump.charCodeAt(0)?r+="-":r+="- ",r+=e.dump);e.tag=s,e.dump=r||"[]"}function Ur(e,t,i){var n="",r=e.tag,s=Object.keys(i),a,o,l,c,u;for(a=0,o=s.length;a<o;a+=1)u="",n!==""&&(u+=", "),e.condenseFlow&&(u+='"'),l=s[a],c=i[l],e.replacer&&(c=e.replacer.call(i,l,c)),B(e,t,l,!1,!1)&&(e.dump.length>1024&&(u+="? "),u+=e.dump+(e.condenseFlow?'"':"")+":"+(e.condenseFlow?"":" "),B(e,t,c,!1,!1)&&(u+=e.dump,n+=u));e.tag=r,e.dump="{"+n+"}"}function Vr(e,t,i,n){var r="",s=e.tag,a=Object.keys(i),o,l,c,u,d,p;if(e.sortKeys===!0)a.sort();else if(typeof e.sortKeys=="function")a.sort(e.sortKeys);else if(e.sortKeys)throw new A("sortKeys must be a boolean or a function");for(o=0,l=a.length;o<l;o+=1)p="",(!n||r!=="")&&(p+=_e(e,t)),c=a[o],u=i[c],e.replacer&&(u=e.replacer.call(i,c,u)),B(e,t+1,c,!0,!0,!0)&&(d=e.tag!==null&&e.tag!=="?"||e.dump&&e.dump.length>1024,d&&(e.dump&&ee===e.dump.charCodeAt(0)?p+="?":p+="? "),p+=e.dump,d&&(p+=_e(e,t)),B(e,t+1,u,!0,d)&&(e.dump&&ee===e.dump.charCodeAt(0)?p+=":":p+=": ",p+=e.dump,r+=p));e.tag=s,e.dump=r||"{}"}function Mt(e,t,i){var n,r,s,a,o,l;for(r=i?e.explicitTypes:e.implicitTypes,s=0,a=r.length;s<a;s+=1)if(o=r[s],(o.instanceOf||o.predicate)&&(!o.instanceOf||typeof t=="object"&&t instanceof o.instanceOf)&&(!o.predicate||o.predicate(t))){if(i?o.multi&&o.representName?e.tag=o.representName(t):e.tag=o.tag:e.tag="?",o.represent){if(l=e.styleMap[o.tag]||o.defaultStyle,si.call(o.represent)==="[object Function]")n=o.represent(t,l);else if(oi.call(o.represent,l))n=o.represent[l](t,l);else throw new A("!<"+o.tag+'> tag resolver accepts not "'+l+'" style');e.dump=n}return!0}return!1}function B(e,t,i,n,r,s,a){e.tag=null,e.dump=i,Mt(e,i,!1)||Mt(e,i,!0);var o=si.call(e.dump),l=n,c;n&&(n=e.flowLevel<0||e.flowLevel>t);var u=o==="[object Object]"||o==="[object Array]",d,p;if(u&&(d=e.duplicates.indexOf(i),p=d!==-1),(e.tag!==null&&e.tag!=="?"||p||e.indent!==2&&t>0)&&(r=!1),p&&e.usedDuplicates[d])e.dump="*ref_"+d;else{if(u&&p&&!e.usedDuplicates[d]&&(e.usedDuplicates[d]=!0),o==="[object Object]")n&&Object.keys(e.dump).length!==0?(Vr(e,t,e.dump,r),p&&(e.dump="&ref_"+d+e.dump)):(Ur(e,t,e.dump),p&&(e.dump="&ref_"+d+" "+e.dump));else if(o==="[object Array]")n&&e.dump.length!==0?(e.noArrayIndent&&!a&&t>0?St(e,t-1,e.dump,r):St(e,t,e.dump,r),p&&(e.dump="&ref_"+d+e.dump)):(Hr(e,t,e.dump),p&&(e.dump="&ref_"+d+" "+e.dump));else if(o==="[object String]")e.tag!=="?"&&Nr(e,e.dump,t,s,l);else{if(o==="[object Undefined]")return!1;if(e.skipInvalid)return!1;throw new A("unacceptable kind of an object to dump "+o)}e.tag!==null&&e.tag!=="?"&&(c=encodeURI(e.tag[0]==="!"?e.tag.slice(1):e.tag).replace(/!/g,"%21"),e.tag[0]==="!"?c="!"+c:c.slice(0,18)==="tag:yaml.org,2002:"?c="!!"+c.slice(18):c="!<"+c+">",e.dump=c+" "+e.dump)}return!0}function zr(e,t){var i=[],n=[],r,s;for(Oe(e,i,n),r=0,s=n.length;r<s;r+=1)t.duplicates.push(i[n[r]]);t.usedDuplicates=new Array(s)}function Oe(e,t,i){var n,r,s;if(e!==null&&typeof e=="object")if(r=t.indexOf(e),r!==-1)i.indexOf(r)===-1&&i.push(r);else if(t.push(e),Array.isArray(e))for(r=0,s=e.length;r<s;r+=1)Oe(e[r],t,i);else for(n=Object.keys(e),r=0,s=n.length;r<s;r+=1)Oe(e[n[r]],t,i)}function Yr(e,t){t=t||{};var i=new Lr(t);i.noRefs||zr(e,i);var n=e;return i.replacer&&(n=i.replacer.call({"":n},"",n)),B(i,0,n,!0,!0)?i.dump+`
`:""}var Kr=Yr,Wr={dump:Kr};function Ve(e,t){return function(){throw new Error("Function yaml."+e+" is removed in js-yaml 4. Use yaml."+t+" instead, which is now safe by default.")}}var Gr=C,qr=Bt,Qr=_t,Jr=jt,Xr=Ht,Zr=$e,ea=ai.load,ta=ai.loadAll,ia=Wr.dump,na=A,ra={binary:Kt,float:$t,map:Dt,null:Rt,pairs:Gt,set:qt,timestamp:zt,bool:Ot,int:Nt,merge:Yt,omap:Wt,seq:Lt,str:Pt},aa=Ve("safeLoad","load"),sa=Ve("safeLoadAll","loadAll"),oa=Ve("safeDump","dump"),O={Type:Gr,Schema:qr,FAILSAFE_SCHEMA:Qr,JSON_SCHEMA:Jr,CORE_SCHEMA:Xr,DEFAULT_SCHEMA:Zr,load:ea,loadAll:ta,dump:ia,YAMLException:na,types:ra,safeLoad:aa,safeLoadAll:sa,safeDump:oa};var N={name:"",occupation:"",company:"",city:"",skills:[],roles:[],relationships:[],goals:[],focusAreas:[],lastUpdated:new Date().toISOString().split("T")[0]};function yi(e){let t={...N},i=e.match(/^---\n([\s\S]*?)\n---/);if(i)try{let n=O.load(i[1]);n&&(typeof n.name=="string"&&(t.name=n.name),typeof n.occupation=="string"&&(t.occupation=n.occupation),typeof n.company=="string"&&(t.company=n.company),typeof n.city=="string"&&(t.city=n.city),Array.isArray(n.skills)&&(t.skills=n.skills.map(String)),Array.isArray(n.roles)&&(t.roles=n.roles.map(String)),Array.isArray(n.relationships)&&(t.relationships=n.relationships.map(String)),Array.isArray(n.goals)&&(t.goals=n.goals.map(String)),Array.isArray(n.focusAreas)&&(t.focusAreas=n.focusAreas.map(String)))}catch{}return!t.name&&!t.company?la(e):t}function la(e){let t={...N},i=e.split(`
`),n="";for(let r of i){let s=r.trim();if(s.startsWith("## ")){n=s.slice(3);continue}if(n==="\u57FA\u672C\u4FE1\u606F"&&s.startsWith("- ")){let a=s.slice(2),[o,...l]=a.split("\uFF1A"),c=l.join("\uFF1A");o==="\u59D3\u540D"&&(t.name=c),(o==="\u804C\u4E1A"||o==="\u804C\u4F4D")&&(t.occupation=c),(o==="\u516C\u53F8/\u7EC4\u7EC7"||o==="\u516C\u53F8")&&(t.company=c),o==="\u57CE\u5E02"&&(t.city=c)}if(s.startsWith("- ")&&!s.includes("\uFF1A")){let a=s.slice(2);if(a==="_\u6682\u65E0_")continue;n==="\u6280\u80FD\u4E0E\u4E13\u4E1A"&&t.skills.push(a),n==="\u89D2\u8272\u4E0E\u5173\u7CFB"&&t.roles.push(a),n==="\u76EE\u6807\u4E0E\u8BA1\u5212"&&t.goals.push(a),n==="\u5173\u6CE8\u9886\u57DF"&&t.focusAreas.push(a)}if(s.startsWith("- \u5173\u7CFB\uFF1A")&&n==="\u89D2\u8272\u4E0E\u5173\u7CFB"){let a=s.slice(5);a!=="_\u6682\u65E0_"&&t.relationships.push(a)}}return t}var ca="TraceMind/PROFILE.md";async function xi(e){let t=e.vault.getFileByPath(ca);if(!t)return{...N};try{let i=await e.vault.read(t);return yi(i)}catch{return{...N}}}function ne(e){let t=0;for(let i=0;i<e.length;i++){let n=e.charCodeAt(i);t=(t<<5)-t+n,t=t&t}return Math.abs(t).toString(16).padStart(8,"0").slice(0,8)}var ua=["company","role","relationship_to_user"],da=["responsibility","communicationStyle"],pa=["personality","preferences","skills"],fa=["subtype","status"],ha=["deadline","description"],ga=["priority","goals"],ma=["subtype"],ya=["occurrenceCount","context"],xa=["goals","emotions"],va={project:"P0",task:"P0",product:"P1",technology:"P1",document:"P2",location:"P2",other:"P2"},ws=Object.keys(va);var ze={P0:1.5,P1:1,P2:.5},be={person:{p0:ua,p1:da,p2:pa},object:{p0:fa,p1:ha,p2:ga},theme:{p0:ma,p1:ya,p2:xa}};function Ye(e,t){let i=be[e],n=i.p0.length===0||i.p0.every(a=>t[a]!=null),r=i.p1.some(a=>t[a]!=null),s=i.p2.some(a=>t[a]!=null);return n&&r&&s?"L3":n&&r?"L2":n?"L1":"L0"}function vi(e,t,i,n=1){let r=be[e];if(r.p0.length+r.p1.length+r.p2.length===0)return 0;let s=0,a=r.p0.filter(c=>t[c]!=null).length,o=a/Math.max(r.p0.length,1),l=a===0&&r.p0.length>0?r.p0.length/3*.5:o;if(s+=l*ze.P0,r.p1.length>0){let c=r.p1.filter(u=>t[u]!=null).length;s+=c/r.p1.length*ze.P1}if(r.p2.length>0){let c=r.p2.filter(u=>t[u]!=null).length;s+=c/r.p2.length*ze.P2}return s*n*(1+Math.log1p(i))}var Ke={create(e){let t=new Date().toISOString();return{id:ne(e.name),userId:e.userId||"",cardType:e.cardType,name:e.name,aliases:e.aliases||[],attributes:e.attributes||{},relatedPeople:[],relatedObjects:[],relatedThemes:[],evidenceEntryIds:[],confidence:.5,maturity:Ye(e.cardType,e.attributes||{}),status:"needs_confirmation",lifecycle:"candidate",importance:0,createdAt:t,lastUpdated:t}}};var ba=O.dump,wa=O.load,we="---";function Y(e){let t={id:e.id,name:e.name,type:e.cardType,maturity:e.maturity,confidence:e.confidence,status:e.status,aliases:e.aliases,createdAt:e.createdAt,lastUpdated:e.lastUpdated};for(let[a,o]of Object.entries(e.attributes))o!=null&&(t[a]=o);let i=[`# ${e.name}`,""],n=ka(e);n.length>0&&(i.push("## \u57FA\u672C\u4FE1\u606F"),i.push(...n),i.push(""));let r=e.attributes.interactions||[];if(r.length>0){i.push("## \u4E92\u52A8\u8BB0\u5F55");for(let a of r.slice(-5)){let o=a.timestamp?new Date(a.timestamp).toISOString().split("T")[0]:"";i.push("- "+o+" "+a.content)}i.push("")}else e.attributes.interactions;let s=ba(t).trim();return`${we}
${s}
${we}

${i.join(`
`)}`}function re(e){let t=Ea(e),i=t.frontmatter,n=t.body,r=i.type,s=Array.isArray(i.aliases)?i.aliases:[],a=new Set(["id","name","type","maturity","confidence","status","aliases","createdAt","lastUpdated","lifecycle","importance","userId","relatedPeople","relatedObjects","relatedThemes","evidenceEntryIds"]),o={};for(let[l,c]of Object.entries(i))!a.has(l)&&c!=null&&(o[l]=c);return{id:i.id||ne(i.name),userId:"",cardType:r,name:i.name,aliases:s,attributes:o,relatedPeople:[],relatedObjects:[],relatedThemes:[],evidenceEntryIds:[],confidence:i.confidence??.5,maturity:i.maturity??"L0",status:i.status??"needs_confirmation",lifecycle:"candidate",importance:0,createdAt:i.createdAt||new Date().toISOString(),lastUpdated:i.lastUpdated||new Date().toISOString()}}function Ea(e){let t=e.trim();if(!t.startsWith(we))return{frontmatter:{},body:t};let i=t.indexOf(we,3);if(i===-1)return{frontmatter:{},body:t};let n=t.slice(3,i).trim(),r=t.slice(i+3).trim();return{frontmatter:wa(n)||{},body:r}}function ka(e){let t=[];return e.cardType==="person"&&(e.attributes.company&&t.push("- \u516C\u53F8\uFF1A"+e.attributes.company),e.attributes.role&&t.push("- \u804C\u4F4D\uFF1A"+e.attributes.role),e.attributes.relationship_to_user&&t.push("- \u5173\u7CFB\uFF1A"+e.attributes.relationship_to_user),e.attributes.responsibility&&t.push("- \u804C\u8D23\uFF1A"+e.attributes.responsibility)),e.cardType==="object"&&(e.attributes.subtype&&t.push("- \u7C7B\u578B\uFF1A"+e.attributes.subtype),e.attributes.status&&t.push("- \u72B6\u6001\uFF1A"+e.attributes.status),e.attributes.deadline&&t.push("- \u622A\u6B62\u65E5\u671F\uFF1A"+e.attributes.deadline)),e.cardType==="theme"&&(e.attributes.subtype&&t.push("- \u7C7B\u578B\uFF1A"+e.attributes.subtype),e.attributes.occurrenceCount&&t.push("- \u51FA\u73B0\u6B21\u6570\uFF1A"+e.attributes.occurrenceCount)),t}function Ca(e,t){let i=`\u4F60\u662F\u4E00\u4E2A\u7CBE\u51C6\u7684\u5B9E\u4F53\u63D0\u53D6\u548C\u65E5\u8BB0\u5206\u7C7B\u4E13\u5BB6\u3002\u8BF7\u5BF9\u4EE5\u4E0B\u65E5\u8BB0\u6587\u672C\u8FDB\u884C\u5206\u6790\u3002
...
${dt()}`;if(t){let n=t.includes("\u5DF2\u77E5\u5B9E\u4F53");i+=`
...
\u65E5\u8BB0\u6587\u672C\uFF1A
${e}`,i}function Ta(e){let t=["person","object","theme"];try{let i=e.trim(),n=i.indexOf('{"entities"');if(n>=0){let l=0,c=n;for(let u=n;u<i.length;u++)if(i[u]==="{")l++;else if(i[u]==="}"&&(l--,l===0)){c=u+1;break}i=i.slice(n,c),console.log('[TraceMind] parseLLM: extracted JSON via {"entities"} pattern:',i.substring(0,200))}else{let l=i.lastIndexOf(">");if(l>=0&&l>i.length*.3){let u=i.slice(l+1).trim();u.startsWith("{")&&(i=u)}console.log("[TraceMind] parseLLM: after tag removal (first 200):",i.substring(0,200));let c=i.match(/```(?:json)?\s*\n?([\s\S]*?)```/);if(c&&(i=c[1].trim()),!i.startsWith("{")){let u=i.indexOf("{"),d=i.lastIndexOf("}");u!==-1&&d!==-1&&(i=i.slice(u,d+1))}console.log("[TraceMind] parseLLM: final JSON (first 200):",i.substring(0,200))}let r=JSON.parse(i);if(console.log("[TraceMind] parseLLM: parsed JSON:",JSON.stringify(r).substring(0,200)),!r.entities||!Array.isArray(r.entities))return{entities:[]};let s=["\u5DE5\u4F5C","\u751F\u6D3B","\u5B66\u4E60","\u8FD0\u52A8","\u5176\u4ED6"],a=typeof r.domain=="string"&&s.includes(r.domain)?r.domain:void 0,o=[];for(let l of r.entities)!l.name||typeof l.name!="string"||l.name.trim()===""||t.includes(l.type)&&o.push({name:l.name.trim(),type:l.type,subtype:l.subtype,confidence:typeof l.confidence=="number"?l.confidence:.5});return{domain:a,entities:o}}catch{return{entities:[]}}}async function bi(e,t){console.log("[TraceMind] LLM extract called, baseUrl:",t.baseUrl,"model:",t.model);let i=Ca(e,t.profileContext),n=t.baseUrl.replace(/\/+$/,""),r=n.endsWith("/v1")||n.endsWith("/chat/completions")?n.endsWith("/chat/completions")?n:`${n}/chat/completions`:`${n}/v1/chat/completions`;console.log("[TraceMind] LLM URL:",r),console.log("[TraceMind] LLM prompt:",i.substring(0,200));let s=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t.apiKey}`},body:JSON.stringify({model:t.model,messages:[{role:"user",content:i}],temperature:0,max_tokens:2e3})});if(console.log("[TraceMind] LLM response status:",s.status),!s.ok){let u=await s.text();throw new Error(`LLM extraction failed: HTTP ${s.status} - ${u}`)}let l=(await s.json()).choices?.[0]?.message?.content??"";console.log("[TraceMind] LLM raw response:",l);let c=Ta(l);return console.log("[TraceMind] LLM parsed: domain=",c.domain,"entities=",c.entities.length,c.entities),c}var Aa={L0:30,L1:20,L2:10,L3:10},Sa={P0:10,P1:5,P2:2};function Ma(e){let t=Aa[e.maturityLevel]??10;return e.attributePriority&&(t+=Sa[e.attributePriority]??2),e.type==="new_entity"&&(t+=10),t}function We(e,t,i,n){let r=[],s=be[e];for(let a of s.p0)i[a]==null&&r.push({type:"missing_attribute",entityName:"",entityType:e,maturityLevel:t,attributePriority:"P0",missingAttribute:a,score:0,description:`Missing P0 attribute: ${a}`});for(let a of s.p1)i[a]==null&&r.push({type:"missing_attribute",entityName:"",entityType:e,maturityLevel:t,attributePriority:"P1",missingAttribute:a,score:0,description:`Missing P1 attribute: ${a}`});for(let a of s.p2)i[a]==null&&r.push({type:"missing_attribute",entityName:"",entityType:e,maturityLevel:t,attributePriority:"P2",missingAttribute:a,score:0,description:`Missing P2 attribute: ${a}`});t!=="L0"&&n.length===0&&r.push({type:"missing_relation",entityName:"",entityType:e,maturityLevel:t,attributePriority:"P1",score:0,description:"No relations established"});for(let a of r)a.score=Ma(a);return r.sort((a,o)=>o.score-a.score)}function Ia(e){let t={children:new Map,fail:null,output:[]};for(let n of e){let r=t;for(let s of n.text){let a=r.children.get(s);a||(a={children:new Map,fail:null,output:[]},r.children.set(s,a)),r=a}r.output.push({entityName:n.entityName,entityId:n.entityId,matchType:n.matchType,patternLen:n.text.length})}let i=[];for(let n of t.children.values())n.fail=t,i.push(n);for(;i.length>0;){let n=i.shift();for(let[r,s]of n.children){i.push(s);let a=n.fail;for(;a!==null&&!a.children.has(r);)a=a.fail;s.fail=a&&a.children.get(r)||t,s.fail&&s.output.push(...s.fail.output)}}return t}function Fa(e,t){let i=[],n=new Set,r=e;for(let s=0;s<t.length;s++){let a=t[s];for(;r!==e&&!r.children.has(a);)r=r.fail;let o=r.children.get(a);o?r=o:r=e;for(let l of r.output){let c=l.entityId+":"+l.matchType;n.has(c)||(n.add(c),i.push({matchedText:t.slice(s-l.patternLen+1,s+1),entityName:l.entityName,entityId:l.entityId,matchType:l.matchType,position:s-l.patternLen+1}))}}return i}function wi(e,t){if(t.length===0)return[];let i=[];for(let r of t){r.name.length>=2&&i.push({text:r.name,entityName:r.name,entityId:r.id,matchType:"exact"});for(let s of r.aliases||[])s.length>=2&&i.push({text:s,entityName:r.name,entityId:r.id,matchType:"alias"});if(r.name.length>=2){let s=r.name.slice(0,Math.min(3,r.name.length));i.filter(o=>o.entityId===r.id&&o.text===s).length===0&&s.length>=2&&i.push({text:s,entityName:r.name,entityId:r.id,matchType:"prefix"})}}i.sort((r,s)=>s.text.length-r.text.length);let n=Ia(i);return Fa(n,e)}var Ba=5;function Ei(e){return e.type==="new_entity"?{person:e.entityName+" \u662F\u8C01\uFF1F\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5728\u54EA\u5BB6\u516C\u53F8\u3001\u4EC0\u4E48\u804C\u4F4D\u3001\u548C\u4F60\u7684\u5173\u7CFB\u7B49\u3002",object:e.entityName+" \u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5F53\u524D\u72B6\u6001\u3001\u65F6\u95F4\u8282\u70B9\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002",theme:e.entityName+" \u80FD\u804A\u804A\u5417\uFF1F\u6BD4\u5982\u8FD9\u4E2A\u60C5\u51B5\u5F71\u54CD\u6709\u591A\u5927\u3001\u6301\u7EED\u591A\u4E45\u4E86\uFF1F"}[e.entityType]||e.entityName+" \u662F\u4EC0\u4E48\uFF1F":e.type==="missing_attribute"&&e.missingAttribute?{company:e.entityName+" \u5728\u54EA\u4E2A\u516C\u53F8\u6216\u7EC4\u7EC7\u5DE5\u4F5C\uFF1F",role:e.entityName+" \u7684\u804C\u4F4D\u6216\u89D2\u8272\u662F\u4EC0\u4E48\uFF1F",relationship_to_user:"\u4F60\u548C "+e.entityName+" \u662F\u4EC0\u4E48\u5173\u7CFB\uFF1F",responsibility:e.entityName+" \u8D1F\u8D23\u4EC0\u4E48\u5DE5\u4F5C\uFF1F",status:e.entityName+" \u5F53\u524D\u7684\u72B6\u6001\u662F\u4EC0\u4E48\uFF1F",deadline:e.entityName+" \u6709\u622A\u6B62\u65E5\u671F\u6216\u65F6\u95F4\u8282\u70B9\u5417\uFF1F"}[e.missingAttribute]||`\u5173\u4E8E ${e.entityName} \u7684 ${e.missingAttribute} \u4FE1\u606F\u662F\u4EC0\u4E48\uFF1F`:e.type==="missing_relation"?`${e.entityName} \u548C\u4EC0\u4E48\u5176\u4ED6\u5B9E\u4F53\u6709\u5173\u8054\uFF1F`:e.type==="recurring_pattern"?`${e.entityName} \u5DF2\u7ECF\u591A\u6B21\u51FA\u73B0\uFF0C\u5B83\u4EE3\u8868\u4EC0\u4E48\uFF1F`:`\u8BF7\u63D0\u4F9B\u66F4\u591A\u5173\u4E8E ${e.entityName} \u7684\u4FE1\u606F\u3002`}function Pa(e,t){for(let[i,n]of t)if(n.name===e.name)return{cardId:i,maturity:n.maturity};return null}var ae=class{static analyzeBlock(t,i){return console.warn("[TraceMind] analyzeBlock (sync) is deprecated, use analyzeBlockAsync for LLM extraction"),{entities:[],newEntities:[],existingEntities:[],hasClarifications:!1,gapCount:0}}static async analyzeBlockAsync(t,i,n,r){let s=r&&r.length>0?wi(t,r):[],a=[...new Set(s.map(f=>f.entityName))],o=new Set(s.map(f=>f.entityId)),l=r&&r.length>0?r.filter(f=>{if(o.has(f.id))return!0;for(let y=0;y<=f.name.length-2;y++)if(t.includes(f.name.slice(y,y+2)))return!0;for(let y of f.aliases||[])for(let b=0;b<=y.length-2;b++)if(t.includes(y.slice(b,b+2)))return!0;return!1}).slice(0,10):[],c=l.length>0?l.map(f=>{let y=f.aliases&&f.aliases.length>0?"\uFF08\u522B\u540D\uFF1A"+f.aliases.join("\u3001")+"\uFF09":"";return f.name+y+" ["+f.cardType+"]"}).join("\u3001"):"";console.log("[TraceMind] AC scan found",s.length,"matches,",l.length,"candidates for LLM:",c);let u=[],d;if(n&&n.apiKey&&n.baseUrl&&n.model){console.log("[TraceMind] LLM config:",{baseUrl:n.baseUrl,model:n.model,hasApiKey:!!n.apiKey});try{let f={...n,profileContext:n.profileContext?n.profileContext+(c?`

\u5DF2\u77E5\u5B9E\u4F53\uFF08\u5DF2\u5EFA\u6863\uFF0C\u4E0D\u8981\u91CD\u590D\u63D0\u53D6\uFF0C\u6CE8\u610F\u76F8\u4F3C\u540D\u79F0\uFF09\uFF1A`+c:""):c?`

\u5DF2\u77E5\u5B9E\u4F53\uFF08\u5DF2\u5EFA\u6863\uFF0C\u4E0D\u8981\u91CD\u590D\u63D0\u53D6\uFF0C\u6CE8\u610F\u76F8\u4F3C\u540D\u79F0\uFF09\uFF1A`+c:""},y=await bi(t,f);console.log("[TraceMind] LLM extracted:",y.entities.length,y.entities,"domain:",y.domain),u=y.entities.map(b=>({...b})),d=y.domain}catch(f){console.warn("[TraceMind] LLM extraction failed:",f.message)}}else console.log("[TraceMind] No LLM config provided, skipping extraction");let p=new Set(u.map(f=>f.name)),h=new Set;for(let f of s)if(!h.has(f.entityName)&&(h.add(f.entityName),!p.has(f.entityName))){let y=r?.find(b=>b.name===f.entityName);y&&u.push({name:f.entityName,type:y.cardType,confidence:.9})}let g=La(u,i);return g.domainCategory=d,g}static summarizeResult(t){if(t.entities.length===0)return"\u672A\u68C0\u6D4B\u5230\u9700\u8981\u5173\u6CE8\u7684\u5B9E\u4F53\u3002";let i=[];if(t.newEntities.length>0){let n=t.newEntities.map(r=>r.name).join("\u3001");i.push(`\u53D1\u73B0 ${t.newEntities.length} \u4E2A\u65B0\u5B9E\u4F53\uFF1A${n}`)}if(t.existingEntities.length>0){let n=t.existingEntities.map(r=>r.name).join("\u3001");i.push(`\u63D0\u53CA ${t.existingEntities.length} \u4E2A\u5DF2\u6709\u5B9E\u4F53\uFF1A${n}`)}return t.hasClarifications&&i.push("\u9700\u8981\u8FDB\u4E00\u6B65\u6F84\u6E05\u4FE1\u606F\u3002"),i.join(`
`)}};function La(e,t){let i=[];for(let a of e){let o=Pa(a,t),l=a.subtype?{subtype:a.subtype}:{},c=o?.maturity??Ye(a.type,l),u=vi(a.type,l,0),d=[];if(o){let f=We(a.type,c,l,[]);d.push(...f)}else{d.push({type:"new_entity",entityName:a.name,entityType:a.type,maturityLevel:"L0",attributePriority:"P0",score:40,description:`New entity: ${a.name}`});let f=We(a.type,"L0",l,[]);d.push(...f)}let h=d.filter(f=>f.type!=="missing_attribute"||f.missingAttribute!=="subtype").slice(0,2).map(Ei),g={...a,isNew:!o,existingCardId:o?.cardId,maturity:c,priorityScore:u,clarificationQuestions:h,knowledgeGaps:d};i.push(g)}i.sort((a,o)=>a.isNew!==o.isNew?a.isNew?-1:1:o.priorityScore-a.priorityScore);let n=i.slice(0,Ba),r=n.flatMap(a=>a.knowledgeGaps??[]),s=r.sort((a,o)=>o.score-a.score)[0];return{entities:n,newEntities:n.filter(a=>a.isNew),existingEntities:n.filter(a=>!a.isNew),hasClarifications:n.some(a=>a.isNew),gapCount:r.length,firstQuestion:s?Ei(s):void 0}}var Da=O.load;function $(e,t){let i=_a(e),n=i?.name;n||(n=t.split("/").pop()?.replace(".md","")||"");let r=i?.type||"person",s=i?.maturity||"L0",a=i?.confidence??.5,o=Array.isArray(i?.aliases)?i.aliases:[];return{id:i?.id||ne(n),name:n,cardType:r,type:Ra(r),subtype:i?.subtype,maturity:s,confidence:a,filePath:t,aliases:o,relationCount:0,lastUpdated:i?.lastUpdated||new Date().toISOString()}}function ki(e){let t=[];for(let i of e)if(i.content.trim())try{let n=$(i.content,i.path);t.push(n)}catch{}return{entries:t,lastRebuild:new Date().toISOString()}}function _a(e){let t=e.trim();if(!t.startsWith("---"))return null;let i=t.indexOf("---",3);if(i===-1)return null;let n=t.slice(3,i).trim();return Da(n)||null}function Ra(e){switch(e){case"person":return"person";case"object":return"thing";case"theme":return"idea";default:return"thing"}}function Ci(e,t){let i=t.toLowerCase();return e.entries.filter(n=>n.name.toLowerCase().includes(i)||n.aliases.some(r=>r.toLowerCase().includes(i)))}function K(e,t){let i=e.entries.findIndex(r=>r.id===t.id),n=[...e.entries];return i>=0?n[i]=t:n.push(t),{entries:n,lastRebuild:e.lastRebuild}}function Ti(e){let t=JSON.parse(e);return{blockId:t.blockId,content:t.content,messages:t.messages||[],analysisResult:t.analysisResult,createdAt:t.createdAt,updatedAt:t.updatedAt,currentPhase:t.currentPhase||"analysis"}}var Oa="TraceMind/sessions";function Ge(e){return`${Oa}/${e}.json`}function Ai(e){return Ti(e)}var P=require("obsidian");var qe=["Daily","Person","Object","Theme","TraceMind"],Si="TraceMind/PROFILE.md";async function Qe(e){try{return await e.stat(Si)===null}catch{return!0}}function Mi(e,t){new Je(e,t).open()}var Je=class extends P.Modal{onComplete;constructor(t,i){super(t),this.onComplete=i}onOpen(){let{contentEl:t}=this;t.createEl("h2",{text:"\u6B22\u8FCE\u4F7F\u7528 TraceMind"}),t.createEl("p",{text:"TraceMind \u5C06\u5E2E\u52A9\u4F60\u4ECE\u65E5\u8BB0\u4E2D\u81EA\u52A8\u8BC6\u522B\u548C\u6574\u7406\u77E5\u8BC6\u5B9E\u4F53\u3002\u8BF7\u5148\u5B8C\u6210\u521D\u59CB\u8BBE\u7F6E\u3002"});let i=t.createEl("div",{cls:"tracemind-steps"});t.createEl("h3",{text:"\u6B65\u9AA4 1\uFF1A\u521B\u5EFA\u76EE\u5F55\u7ED3\u6784"}),new P.Setting(t).setName("\u521B\u5EFA\u77E5\u8BC6\u76EE\u5F55").setDesc("\u521B\u5EFA Daily\u3001Person\u3001Object\u3001Theme \u76EE\u5F55").addButton(n=>{n.setButtonText("\u521B\u5EFA\u76EE\u5F55"),n.onClick(async()=>{for(let r of qe)await J(this.app,r);n.setButtonText("\u5DF2\u5B8C\u6210"),n.setDisabled(!0),new P.Notice("\u76EE\u5F55\u521B\u5EFA\u5B8C\u6210")})}),t.createEl("h3",{text:"\u6B65\u9AA4 2\uFF1A\u521B\u5EFA\u7528\u6237\u6863\u6848"}),new P.Setting(t).setName("\u521D\u59CB\u5316 PROFILE.md").setDesc("\u5728 TraceMind \u76EE\u5F55\u4E0B\u521B\u5EFA\u7528\u6237\u6863\u6848\u6587\u4EF6").addButton(n=>{n.setButtonText("\u521B\u5EFA\u6863\u6848"),n.onClick(async()=>{await this.app.vault.create("TraceMind/PROFILE.md",`---
name: ""
occupation: ""
company: ""
city: ""
...
## \u5173\u6CE8\u9886\u57DF
- _\u6682\u65E0_
`),n.setButtonText("\u5DF2\u5B8C\u6210"),n.setDisabled(!0),new P.Notice("\u6863\u6848\u521B\u5EFA\u5B8C\u6210")})}),t.createEl("h3",{text:"\u6B65\u9AA4 3\uFF1A\u5F00\u59CB\u4F7F\u7528"}),new P.Setting(t).setName("\u5B8C\u6210\u8BBE\u7F6E").setDesc("\u8BBE\u7F6E\u5B8C\u6210\u540E\uFF0C\u4F60\u53EF\u4EE5\u5F00\u59CB\u4F7F\u7528 TraceMind \u4E86").addButton(n=>{n.setButtonText("\u5B8C\u6210"),n.setCta(),n.onClick(async()=>{this.close(),await this.onComplete()})})}onClose(){let{contentEl:t}=this;t.empty()}};var Na=["Daily","Person","Object","Theme","TraceMind/sessions","TraceMind/index"],Ee=class extends I.Plugin{settings;userProfile={...N};analysisService=ae;entityIndex={entries:[],lastRebuild:""};entityManager;sessionManager;aiProvider;aiAnalysisView;blockEditorView;calendarView;async onload(){console.log("TraceMind: loading...");try{await this.loadSettings(),await this.ensureVaultStructure(),await this.rebuildEntityIndex(),this.userProfile=await xi(this.app),await ut(t=>this.app.vault.adapter.read(t),async(t,i)=>{await J(this.app,"TraceMind"),await this.app.vault.create(t,i)}),this.entityManager=new Xe(this.app,this),this.sessionManager=new Ze(this.app),this.aiProvider=new et(this),await this.sessionManager.initialize(),this.registerView(F,t=>(this.blockEditorView=new de(t,this),this.blockEditorView)),this.registerView(q,t=>(this.aiAnalysisView=new pe(t,this),this.aiAnalysisView)),this.registerView(Q,t=>(this.calendarView=new fe(t,this),this.calendarView.setOnDateClick(i=>this.navigateToDate(i)),this.calendarView)),this.addSettingTab(new le(this.app,this)),this.addRibbonIcon("brain","\u6253\u5F00 TraceMind",()=>{this.openTracemindView()}),this.addRibbonIcon("calendar","\u6253\u5F00\u65E5\u5386",()=>{this.openCalendarView()}),this.addCommand({id:"open-tracemind",name:"\u6253\u5F00 TraceMind \u89C6\u56FE",callback:()=>this.openTracemindView()}),this.addCommand({id:"open-calendar",name:"\u6253\u5F00\u65E5\u5386",callback:()=>this.openCalendarView()}),this.addCommand({id:"analyze-block",name:"\u5206\u6790\u5F53\u524D\u65E5\u8BB0\u5757",callback:()=>this.analyzeCurrentBlock()}),this.addCommand({id:"rebuild-index",name:"\u91CD\u5EFA\u5B9E\u4F53\u7D22\u5F15",callback:()=>this.rebuildEntityIndexCommand()}),this.registerEvent(this.app.workspace.on("editor-change",()=>{this.onEditorChange()})),new I.Notice("TraceMind \u5DF2\u52A0\u8F7D"),console.log("TraceMind: loaded successfully"),await Qe(this.app.vault.adapter)?Mi(this.app,async()=>{await this.ensureVaultStructure()}):await this.ensureVaultStructure()}catch(t){console.error("TraceMind: Failed to load",t),new I.Notice("TraceMind \u52A0\u8F7D\u5931\u8D25: "+t.message)}}onunload(){console.log("TraceMind: unloading...")}async loadSettings(){let t=await this.loadData();this.settings={...at,...t}}async saveSettings(){await this.saveData(this.settings)}async ensureVaultStructure(){for(let t of Na)await J(this.app,t);console.log("TraceMind: vault structure ensured")}autoAnalysisTimer=null;onEditorChange(){this.autoAnalysisTimer&&clearTimeout(this.autoAnalysisTimer),this.autoAnalysisTimer=setTimeout(()=>{this.autoAnalysisTimer=null},2e3)}async rebuildEntityIndexCommand(){await this.rebuildEntityIndex(),new I.Notice(`\u5B9E\u4F53\u7D22\u5F15\u5DF2\u91CD\u5EFA: ${this.entityIndex.entries.length} \u4E2A\u5B9E\u4F53`)}async rebuildEntityIndex(){let t=["Person","Object","Theme"],i=[];for(let n of t)try{let r=await this.app.vault.adapter.list(n+"/");for(let s of r.files)if(s.endsWith(".md")){let a=await this.app.vault.adapter.read(s);i.push({path:s,content:a})}}catch{}this.entityIndex=ki(i),console.log(`TraceMind: entity index rebuilt with ${this.entityIndex.entries.length} entries`)}async navigateToDate(t){this.app.workspace.getLeavesOfType(F).length===0&&await this.openTracemindView();let n=this.app.workspace.getLeavesOfType(F);for(let r of n){let s=r.view;s.currentDate!==void 0&&typeof s.loadCurrentDay=="function"&&(s.currentDate=t,await s.loadCurrentDay())}}async openCalendarView(){let{workspace:t}=this.app,i=t.getLeavesOfType(Q);if(i.length>0)t.revealLeaf(i[0]);else{let n=t.getRightLeaf(!1);n&&(await n.setViewState({type:Q,active:!0}),t.revealLeaf(n))}}async openTracemindView(){let{workspace:t}=this.app,i=t.getLeavesOfType(F);if(i.length>0)t.revealLeaf(i[0]);else{let r=t.getLeaf(!1);r&&(await r.setViewState({type:F,active:!0}),t.revealLeaf(r))}if(t.getLeavesOfType(q).length===0){let r=t.getRightLeaf(!1);r&&(await r.setViewState({type:q,active:!0}),t.revealLeaf(r))}}async openBlockEditor(){return this.openTracemindView()}async analyzeCurrentBlock(){let t=this.app.workspace.getActiveFile();if(!t){new I.Notice("\u8BF7\u5148\u6253\u5F00\u4E00\u4E2A\u65E5\u8BB0\u6587\u4EF6");return}let i=await this.app.vault.read(t),n=t.basename;console.log("[TraceMind] analyzeCurrentBlock file:",t.path,"content length:",i.length),console.log("[TraceMind] analyzeCurrentBlock content preview:",i.substring(0,300));try{let r=await this.aiProvider.analyzeBlock(i,n);new I.Notice(`\u5206\u6790\u5B8C\u6210: \u68C0\u6D4B\u5230 ${r.entities.length} \u4E2A\u5B9E\u4F53`),console.log("[TraceMind] analyzeCurrentBlock: tmResult:",r),this.updateAIAnalysis(r)}catch(r){new I.Notice("\u5206\u6790\u5931\u8D25: "+r.message),console.error("TraceMind: analysis error",r)}}getAIAnalysisView(){return this.aiAnalysisView}getBlockEditorView(){return this.blockEditorView}getCalendarView(){return this.calendarView}getEntityManager(){return this.entityManager}getSessionManager(){return this.sessionManager}getAIProvider(){return this.aiProvider}getUserProfile(){return this.userProfile}getUserProfileContext(){let t=this.userProfile,i=[];return t.name&&i.push("\u59D3\u540D\uFF1A"+t.name),t.occupation&&i.push("\u804C\u4E1A\uFF1A"+t.occupation),t.company&&i.push("\u516C\u53F8/\u7EC4\u7EC7\uFF1A"+t.company),t.city&&i.push("\u57CE\u5E02\uFF1A"+t.city),t.skills.length>0&&i.push("\u6280\u80FD\uFF1A"+t.skills.join("\u3001")),t.relationships.length>0&&i.push("\u5173\u7CFB\uFF1A"+t.relationships.join("\u3001")),t.goals.length>0&&i.push("\u76EE\u6807\uFF1A"+t.goals.join("\u3001")),t.focusAreas.length>0&&i.push("\u5173\u6CE8\u9886\u57DF\uFF1A"+t.focusAreas.join("\u3001")),i.length===0?"":`\u7528\u6237\u6863\u6848\uFF1A
`+i.map(function(n){return"- "+n}).join(`
`)}buildAnalysisResult(t,i,n){return Ii(t,i,n)}updateAIAnalysis(t){this.aiAnalysisView&&this.aiAnalysisView.updateAnalysis(t)}};function Ii(e,t,i,n){let r=[],s=[],a=[],o={people:r,objects:s,dimensions:a},l={person:"people",object:"objects",theme:"dimensions"},c=[];for(let u of e){let d=l[u.type],p=i.indexOf(u.name),h=u.name;if(p>=0){let g=Math.max(0,p-20),f=Math.min(i.length,p+u.name.length+30),y=i.slice(g,f);g>0&&(y="..."+y),f<i.length&&(y+="..."),h=y}o[d].push({type:u.type,name:u.name,confidence:u.confidence??.5,context:h,isArchived:!!u.existingCardId,newEntity:u.isNew,maturity:u.maturity,priorityScore:u.priorityScore,clarificationQuestions:u.clarificationQuestions}),u.isNew&&c.push(u.name)}return{blockId:t,timestamp:new Date().toISOString(),category:c.length>0?"\u5F85\u786E\u8BA4":n||"\u5DE5\u4F5C",areas:n?[n]:[],entities:{people:r,objects:s,dimensions:a},needsConfirmation:c,aiResponse:$a(e)}}function $a(e){let t=[];for(let i of e)i.clarificationQuestions.length>0&&t.push(`\u5173\u4E8E ${i.name}\uFF1A${i.clarificationQuestions[0]}`);return t.length===0?`\u68C0\u6D4B\u5230\u4EE5\u4E0B\u5B9E\u4F53\uFF1A${e.map(n=>n.name).join("\u3001")}\u3002`:t.join(`
`)}var Xe=class{constructor(t,i){this.app=t;this.plugin=i}app;plugin;findEntity(t){let i=Ci(this.plugin.entityIndex,t);return i.find(r=>r.name.toLowerCase()===t.toLowerCase())||i[0]||null}getEntity(t){return this.plugin.entityIndex.entries.find(i=>i.id===t)||null}async createEntity(t){let i=ja(t.type),n=t.aliases||[],r=Ke.create({name:t.title,cardType:i,attributes:t.metadata||{},aliases:n});t.interactions&&Array.isArray(t.interactions)&&(r.attributes.interactions=t.interactions);let s=Y(r),o=`${Ha(i)}${t.title}.md`;this.app.vault.getFileByPath(o)||await this.app.vault.create(o,s);let c=$(s,o);return this.plugin.entityIndex=K(this.plugin.entityIndex,c),{...t,id:c.id}}async updateEntity(t,i){let n=this.getEntity(t);if(!n)return;let r=this.app.vault.getFileByPath(n.filePath);if(!r)return;let s=await this.app.vault.read(r),a=re(s);for(let[c,u]of Object.entries(i))c==="lastUpdated"?a.lastUpdated=u:c==="interactions"?a.attributes.interactions=u:c==="aliases"&&Array.isArray(u)?a.aliases=u:a.attributes[c]=u;a.lastUpdated=i.lastUpdated||new Date().toISOString();let o=Y(a);await this.app.vault.modify(r,o);let l=$(o,n.filePath);this.plugin.entityIndex=K(this.plugin.entityIndex,l)}wikifyContent(t){let i=t;i=i.replace(/\[\[(Person|Object|Theme)\/(?:\[\[(?:Person|Object|Theme)\/[^\]]+\]\])\|([^\]]+)\]\]/g,"[[$1/$2|$2]]");let r=[...this.plugin.entityIndex.entries].sort((a,o)=>o.name.length-a.name.length),s=[];for(let a of r){let o=a.cardType==="person"?"Person":a.cardType==="object"?"Object":"Theme";a.name.length>=2&&s.push({term:a.name,name:a.name,folder:o});for(let l of a.aliases||[])l.length>=2&&s.push({term:l,name:a.name,folder:o})}s.sort((a,o)=>o.term.length-a.term.length);for(let a of s){let o=a.term.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");if(!new RegExp("(?<!\\[\\[)"+o+"(?!\\]\\|)").test(i))continue;let l="[["+a.folder+"/"+a.name+"|"+a.term+"]]",c=new RegExp("(?<!\\[\\[)"+o+"(?!\\]\\|)","g");i=i.replace(c,l)}return i}async refreshWikilinks(t){let i=this.getEntity(t);if(!i)return;let n=this.app.vault.getFileByPath(i.filePath);if(!n)return;let r=await this.app.vault.read(n),s=re(r),a=s.attributes.interactions||[],o=!1;for(let l of a)if(l.content&&typeof l.content=="string"){let c=this.wikifyContent(l.content);c!==l.content&&(l.content=c,o=!0)}if(o){s.attributes.interactions=a;let l=Y(s);await this.app.vault.modify(n,l);let c=$(l,i.filePath);this.plugin.entityIndex=K(this.plugin.entityIndex,c)}}async addInteraction(t,i){let n=this.getEntity(t);if(!n)return;let r=this.app.vault.getFileByPath(n.filePath);if(!r)return;let s=await this.app.vault.read(r),a=re(s),o=a.attributes.interactions||[];o.push(i),a.attributes.interactions=o,a.lastUpdated=new Date().toISOString();let l=Y(a);await this.app.vault.modify(r,l);let c=$(l,n.filePath);this.plugin.entityIndex=K(this.plugin.entityIndex,c)}async linkRelatedEntities(t){if(!(t.length<2))for(let i of t){let n=this.findEntity(i.name);if(!n)continue;let r=this.app.vault.getFileByPath(n.filePath);if(!r)continue;let s=await this.app.vault.read(r),a=re(s);for(let c of t)c.name!==i.name&&(c.type==="person"?a.relatedPeople.includes(c.name)||a.relatedPeople.push(c.name):c.type==="object"?a.relatedObjects.includes(c.name)||a.relatedObjects.push(c.name):c.type==="theme"&&(a.relatedThemes.includes(c.name)||a.relatedThemes.push(c.name)));let o=Y(a);await this.app.vault.modify(r,o);let l=$(o,n.filePath);this.plugin.entityIndex=K(this.plugin.entityIndex,l)}}async enrichEntity(t,i){return i}buildEntityIndex(){let t=new Map;for(let i of this.plugin.entityIndex.entries)t.set(i.id,new Set([i.name,...i.aliases]));return t}},Ze=class{constructor(t){this.app=t}app;cache=new Map;chatSession={blockId:"chat:global",messages:[],createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};async initialize(){try{let t=await this.app.vault.adapter.list("TraceMind/sessions/");for(let i of t.files)if(i.endsWith(".json")){let n=await this.app.vault.adapter.read(i),r=Ai(n);this.cache.set(r.blockId,this.toViewSession(r))}}catch{}}getSession(t,i){return this.cache.get(t)||null}getOrCreateSession(t,i){let n=this.cache.get(t);if(n)return n;let r={blockId:t,content:"",messages:[],analysisResult:null,reviewCards:{},createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),currentPhase:"detection"};return this.cache.set(t,r),r}setContent(t,i,n){let r=this.getOrCreateSession(t,n);r.content=i,r.updatedAt=new Date().toISOString(),this.writeSession(t,r)}setSession(t,i,n){let r=this.getOrCreateSession(t,n),s={...r,...i,blockId:t,updatedAt:new Date().toISOString(),analysisResult:i.analysisResult??r.analysisResult};return this.cache.set(t,s),this.writeSession(t,s),s}setAnalysisResult(t,i,n){let r=this.getOrCreateSession(t,n);r.analysisResult=i,r.updatedAt=new Date().toISOString(),r.currentPhase="complete",this.cache.set(t,r),this.writeSession(t,r)}addMessage(t,i,n){let r=this.getOrCreateSession(t,n);r.messages.push(i),r.updatedAt=new Date().toISOString(),this.cache.set(t,r),this.writeSession(t,r)}addChatMessage(t){this.chatSession.messages.push(t),this.chatSession.updatedAt=new Date().toISOString()}getChatSession(){return this.chatSession}clearChatSession(){this.chatSession={blockId:"chat:global",messages:[],createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()}}async clearSession(t){this.cache.delete(t);try{let i=this.app.vault.getFileByPath(Ge(t));i&&await this.app.vault.delete(i)}catch{}}updateReviewCard(t,i,n,r){let s=this.getOrCreateSession(t,r);s.reviewCards||(s.reviewCards={}),s.reviewCards[i]={status:n.status||"pending",supplement:n.supplement,updatedAt:new Date().toISOString()},s.updatedAt=new Date().toISOString(),this.cache.set(t,s),this.writeSession(t,s)}writeSession(t,i){try{let n=Ge(t),r={blockId:i.blockId,content:i.content,messages:i.messages,createdAt:i.createdAt,updatedAt:i.updatedAt,currentPhase:i.currentPhase};i.analysisResult&&(r.analysisResult=i.analysisResult);let s=JSON.stringify(r,null,2),a=this.app.vault.getFileByPath(n);a?this.app.vault.modify(a,s):this.app.vault.create(n,s)}catch(n){console.error("TraceMind: failed to write session",n)}}toViewSession(t){return{blockId:t.blockId,content:t.content,messages:t.messages,analysisResult:t.analysisResult??null,reviewCards:t.reviewCards??{},createdAt:t.createdAt,updatedAt:t.updatedAt,currentPhase:t.currentPhase||"detection"}}},et=class{constructor(t){this.plugin=t}plugin;isReady(){let{settings:t}=this.plugin;if(!t.defaultProviderId)return!1;let i=t.providers.find(n=>n.id===t.defaultProviderId);return!!i&&!!i.apiKey&&!!i.baseUrl}async chat(t,i){let n=this.getProviderForContext(i??"chat");if(!n)throw new Error("No AI provider configured");let{chat:r}=await Promise.resolve().then(()=>(oe(),rt));return{content:(await r(t.map(a=>({role:a.role,content:a.content})),{provider:"openai",apiKey:n.apiKey,model:n.model,baseUrl:n.baseUrl})).content,usage:{promptTokens:0,completionTokens:0,totalTokens:0}}}async analyzeBlock(t,i=""){let n=new Map;for(let l of this.plugin.entityIndex.entries)n.set(l.id,{name:l.name,cardType:l.type,maturity:l.maturity||"L0"});console.log("[TraceMind] analyzeBlock: loaded",n.size,"existing cards from index");let r=this.getProviderForContext("analysis");if(!r)return console.warn("[TraceMind] analyzeBlock: no AI provider configured, cannot extract entities"),new I.Notice("\u8BF7\u5148\u5728\u8BBE\u7F6E\u4E2D\u914D\u7F6E AI Provider"),{entities:[],newEntities:[],existingEntities:[],hasClarifications:!1,gapCount:0};console.log("[TraceMind] analyzeBlock: using LLM extraction, provider:",r.name);let s=this.plugin.getUserProfileContext(),a=await ae.analyzeBlockAsync(t,n,{apiKey:r.apiKey||"",model:r.model||"gpt-4",baseUrl:r.baseUrl||"",profileContext:s||void 0},this.plugin.entityIndex.entries);console.log("[TraceMind] analyzeBlock result entities:",a.entities.length,a);let o=Ii(a.entities,i,t,a.domainCategory);return{...o,analysisResult:o}}getProviderForContext(t){let{settings:i}=this.plugin,n=i.agentProviderMapping,r=t==="analysis"?n.analysis:n.chat;if(r){let s=i.providers.find(a=>a.id===r);if(s)return s}return this.getDefaultProvider()}getDefaultProvider(){let{settings:t}=this.plugin;return t.defaultProviderId&&t.providers.find(i=>i.id===t.defaultProviderId)||null}};function ja(e){return e==="person"?"person":e==="object"?"object":e==="theme"?"theme":e==="project"||e==="thing"?"object":e==="idea"||e==="knowledge"?"theme":"object"}function Ha(e){return{person:"Person/",object:"Object/",theme:"Theme/"}[e]||""}var Ua=Ee;
