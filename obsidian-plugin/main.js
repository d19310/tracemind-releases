...
(${t.slice(0,150)})`;return`\u8FDE\u63A5\u5931\u8D25: ${t.slice(0,200)}`}function $t(e,t,i){let n=e.providers.map(r=>r.id===t?{...r,...i,id:t}:r);return{...e,providers:n}}function jt(e,t){let i=e.providers.filter(s=>s.id!==t),n=e.defaultProviderId;n===t&&(n=i[0]?.id||"");let r={...e.agentProviderMapping};return r.analysis===t&&(r.analysis=""),r.chat===t&&(r.chat=""),{...e,providers:i,defaultProviderId:n,agentProviderMapping:r}}V();var Ie=class extends x.PluginSettingTab{plugin;constructor(t,i){super(t,i),this.plugin=i}display(){let{containerEl:t}=this;t.empty(),t.createEl("h2",{text:"TraceMind \u8BBE\u7F6E"}),t.createEl("h3",{text:"AI Provider"});let i="",n="",r="",s="",a=!1,o="",l="openai";new x.Setting(t).setName("Provider \u7C7B\u578B").setDesc("\u9009\u62E9 API \u683C\u5F0F").addDropdown(p=>{p.addOption("openai","OpenAI-compatible").addOption("anthropic","Anthropic").addOption("ollama","Ollama").addOption("custom","Custom").setValue("openai").onChange(h=>{l=h})}),new x.Setting(t).setName("\u540D\u79F0").setDesc("Provider \u663E\u793A\u540D\u79F0").addText(p=>{p.setPlaceholder("My GPT-4").onChange(h=>{i=h})}),new x.Setting(t).setName("\u6A21\u578B").setDesc("\u6A21\u578B\u540D\u79F0\uFF0C\u5982 gpt-4\u3001qwen-plus").addText(p=>{p.setPlaceholder("gpt-4").onChange(h=>{n=h})}),new x.Setting(t).setName("Base URL").setDesc("OpenAI \u517C\u5BB9 API \u5730\u5740").addText(p=>{p.setPlaceholder("https://api.openai.com/v1").onChange(h=>{r=h})}),new x.Setting(t).setName("API Key").setDesc("API \u5BC6\u94A5").addText(p=>{p.setPlaceholder("").onChange(h=>{s=h}),p.inputEl.type="password"}),new x.Setting(t).setName("\u601D\u8003\u6A21\u5F0F").setDesc("\u5F00\u542F\u540E\u4F1A\u6309\u5F53\u524D Provider \u7C7B\u578B\u9644\u52A0\u601D\u8003/\u63A8\u7406\u53C2\u6570\uFF1B\u4EC5\u90E8\u5206\u6A21\u578B\u652F\u6301").addToggle(p=>{p.setValue(a).onChange(h=>{a=h})}),new x.Setting(t).setName("Reasoning Effort").setDesc("\u90E8\u5206\u6A21\u578B\u652F\u6301 high \u6216 max").addDropdown(p=>{p.addOption("","\u9ED8\u8BA4").addOption("high","high").addOption("max","max").setValue(o).onChange(h=>{o=h})}),new x.Setting(t).addButton(p=>{p.setButtonText("\u6DFB\u52A0 Provider"),p.setCta(),p.onClick(async()=>{if(!i||!n||!r){new x.Notice("\u8BF7\u586B\u5199\u540D\u79F0\u3001\u6A21\u578B\u548C Base URL");return}let h=`provider-${Date.now()}`;this.plugin.settings.providers.push({id:h,name:i,providerType:l,model:n,baseUrl:r,apiKey:s,enableThinking:a,reasoningEffort:o}),await this.plugin.saveSettings(),this.display(),new x.Notice("Provider \u5DF2\u6DFB\u52A0")})});for(let p=0;p<this.plugin.settings.providers.length;p++){let h=this.plugin.settings.providers[p],g=this.plugin.settings.defaultProviderId===h.id;this.renderProviderRow(t,h,g)}this.plugin.settings.providers.length===0&&t.createEl("p",{text:"\u6682\u65E0 Provider\uFF0C\u8BF7\u6DFB\u52A0\u4E00\u4E2A",cls:"lifewiki-no-providers"}),t.createEl("h3",{text:"Agent \u914D\u7F6E"});let c=this.plugin.settings.agentProviderMapping,u={};for(let p of this.plugin.settings.providers)u[p.id]=p.name;new x.Setting(t).setName("AI \u5206\u6790").setDesc("\u65E5\u8BB0\u5206\u6790\u4F7F\u7528\u7684 AI Provider").addDropdown(p=>{p.addOption("","\u4F7F\u7528\u9ED8\u8BA4 Provider");for(let[h,g]of Object.entries(u))p.addOption(h,g);p.setValue(c.analysis).onChange(async h=>{this.plugin.settings.agentProviderMapping.analysis=h,await this.plugin.saveSettings()})}),new x.Setting(t).setName("AI \u804A\u5929").setDesc("\u804A\u5929\u4F7F\u7528\u7684 AI Provider").addDropdown(p=>{p.addOption("","\u4F7F\u7528\u9ED8\u8BA4 Provider");for(let[h,g]of Object.entries(u))p.addOption(h,g);p.setValue(c.chat).onChange(async h=>{this.plugin.settings.agentProviderMapping.chat=h,await this.plugin.saveSettings()})}),t.createEl("h3",{text:"\u672C\u5730 Agent"}),t.createEl("p",{text:"\u542F\u7528\u540E\uFF0C\u5728\u804A\u5929\u6A21\u5F0F\u7684\u8F93\u5165\u6846\u5DE6\u4FA7\u53EF\u9009\u62E9\u672C\u5730\u5B89\u88C5\u7684 AI agent CLI\uFF08Claude Code\u3001Hermes \u7B49\uFF09\u3002",cls:"setting-item-description"});let d=t.createEl("div",{cls:"tracemind-agent-status"});new x.Setting(t).setName("\u542F\u7528\u672C\u5730 Agent").setDesc("\u5F00\u542F\u540E\u7CFB\u7EDF\u5C06\u68C0\u6D4B\u672C\u673A\u5B89\u88C5\u7684 agent CLI\uFF0C\u5E76\u5728\u804A\u5929\u8F93\u5165\u6846\u5DE6\u4FA7\u63D0\u4F9B\u9009\u62E9\u5668").addToggle(p=>{p.setValue(this.plugin.settings.localAgentEnabled).onChange(async h=>{this.plugin.settings.localAgentEnabled=h,await this.plugin.saveSettings(),h?this.detectAndShowAgents(d):d.empty()})}),this.plugin.settings.localAgentEnabled&&this.detectAndShowAgents(d);let f=document.createElement("style");f.textContent=`
		...
		`,t.appendChild(f)}editingProviderId=null;editDraft=null;renderProviderRow(t,i,n){let r=this.editingProviderId===i.id,s=r?this.editDraft:i,a=new x.Setting(t).setName(`${s.name}${n?" (\u9ED8\u8BA4)":""}`).setDesc(`[${s.providerType||"openai"}] ${s.baseUrl} / ${s.model}${s.enableThinking?" / thinking:on":""}${s.reasoningEffort?` / reasoning:${s.reasoningEffort}`:""}`);if(a.addToggle(o=>{o.setTooltip("\u8BBE\u4E3A\u9ED8\u8BA4").setValue(n).onChange(async l=>{l&&(this.plugin.settings.defaultProviderId=i.id),await this.plugin.saveSettings(),this.display()})}),r){new x.Setting(t).setName("\u540D\u79F0").addText(l=>l.setValue(s.name).onChange(c=>{this.editDraft.name=c})),new x.Setting(t).setName("Provider \u7C7B\u578B").addDropdown(l=>{l.addOption("openai","OpenAI-compatible").addOption("anthropic","Anthropic").addOption("ollama","Ollama").addOption("custom","Custom").setValue(s.providerType).onChange(c=>{this.editDraft.providerType=c})}),new x.Setting(t).setName("\u6A21\u578B").addText(l=>l.setValue(s.model).onChange(c=>{this.editDraft.model=c})),new x.Setting(t).setName("Base URL").addText(l=>l.setValue(s.baseUrl).onChange(c=>{this.editDraft.baseUrl=c})),new x.Setting(t).setName("API Key").addText(l=>{l.setValue(s.apiKey).onChange(c=>{this.editDraft.apiKey=c}),l.inputEl.type="password"}),new x.Setting(t).setName("\u601D\u8003\u6A21\u5F0F").addToggle(l=>l.setValue(s.enableThinking??!1).onChange(c=>{this.editDraft.enableThinking=c})),new x.Setting(t).setName("Reasoning Effort").addDropdown(l=>{l.addOption("","\u9ED8\u8BA4").addOption("high","high").addOption("max","max").setValue(s.reasoningEffort||"").onChange(c=>{this.editDraft.reasoningEffort=c})});let o=new x.Setting(t);o.addButton(l=>{l.setButtonText("\u4FDD\u5B58").setCta().onClick(async()=>{let c=this.editDraft;if(!c.name.trim()||!c.model.trim()||!c.baseUrl.trim()){new x.Notice("\u540D\u79F0\u3001\u6A21\u578B\u548C Base URL \u4E0D\u80FD\u4E3A\u7A7A");return}this.plugin.settings=$t(this.plugin.settings,i.id,c),await this.plugin.saveSettings(),this.editingProviderId=null,this.editDraft=null,this.display(),new x.Notice("Provider \u5DF2\u66F4\u65B0")})}),o.addButton(l=>{l.setButtonText("\u53D6\u6D88").onClick(()=>{this.editingProviderId=null,this.editDraft=null,this.display()})})}else a.addButton(o=>{o.setButtonText("\u7F16\u8F91").onClick(()=>{this.editingProviderId=i.id,this.editDraft={...i},this.display()})}),a.addButton(o=>{o.setButtonText("\u6D4B\u8BD5").onClick(async()=>{new x.Notice("\u6B63\u5728\u6D4B\u8BD5...");try{let l=await Te([{role:"user",content:"\u4F60\u597D"}],{provider:i.providerType||"openai",apiKey:i.apiKey,model:i.model,baseUrl:i.baseUrl,enableThinking:i.enableThinking,reasoningEffort:i.reasoningEffort});new x.Notice("\u8FDE\u63A5\u6210\u529F: "+l.content.substring(0,50))}catch(l){new x.Notice(Nt(l))}})}),a.addButton(o=>{o.setButtonText("\u5220\u9664").onClick(async()=>{this.plugin.settings=jt(this.plugin.settings,i.id),await this.plugin.saveSettings(),this.display()})})}async detectAndShowAgents(t){t.empty();let{resolveExecutable:i}=await Promise.resolve().then(()=>(de(),Je)),n=[{key:"claude-code",name:"Claude Code",binary:"claude"},{key:"hermes",name:"Hermes",binary:"hermes"}];for(let r of n){let s=t.createEl("div",{cls:"tracemind-agent-row"}),o=!!await i(r.binary);s.createEl("span",{cls:`tracemind-agent-dot ${o?"available":"unavailable"}`}).setText(o?"\u{1F7E2}":"\u{1F534}"),s.createEl("span",{text:`${r.name} ${o?"\u2014 \u5DF2\u68C0\u6D4B\u5230":"\u2014 \u672A\u68C0\u6D4B\u5230\uFF0C\u8BF7\u786E\u8BA4\u5DF2\u5B89\u88C5"}`,cls:"tracemind-agent-label"})}}};var Vt={providers:[],defaultProviderId:"",agentProviderMapping:{analysis:"",chat:""},localAgentEnabled:!1};var E=require("obsidian");var Xe=require("obsidian"),er=".lifewiki/templates";async function tr(e,t){let i=`templates/${t}`,n=e.getAbstractFileByPath(i);if(n instanceof Xe.TFile)return await e.read(n);let r=`${er}/${t}`;return n=e.getAbstractFileByPath(r),n instanceof Xe.TFile?await e.read(n):null}function pe(e,t){return t.split(".").reduce((i,n)=>i?.[n],e)}function ir(e,t){let i=e,n=/\{\{#if\s+([^}]+)\}\}([\s\S]*?)\{\{\/if\}\}/g;i=i.replace(n,(s,a,o)=>{if(!pe(t,a.trim())){let u=o.split(/\{\{else\}\}/);return u.length>1?u[1].trim():""}return o.split(/\{\{else\}\}/)[0].trim()});let r=/\{\{#each\s+([^}]+)\}\}([\s\S]*?)\{\{\/each\}\}/g;return i=i.replace(r,(s,a,o)=>{let l=pe(t,a.trim());return!Array.isArray(l)||l.length===0?"":l.map(c=>{let u=o;return u=u.replace(/\{\{this\.([^}]+)\}\}/g,(d,f)=>pe(c,f.trim())??""),u=u.replace(/\{\{([^#/][^}]*?)\}\}/g,(d,f)=>{let p=f.trim();return p==="this"?String(c):pe(c,p)??""}),(typeof c=="string"||typeof c=="number")&&(u=u.replace(/\{\{this\}\}/g,String(c))),u}).join("")}),i}function nr(e,t){let i=e,n=/\{\{([^#/][^}]*?)\}\}/g;return i=i.replace(n,(r,s)=>{let a=s.trim(),o=pe(t,a);return o==null?"":typeof o=="object"?JSON.stringify(o):String(o)}),i}async function Ht(e,t,i){let n=await tr(e,t);n===null&&(console.warn(`[TemplateLoader] Template not found: ${t}, falling back to default`),n=rr(t,i));let r=ir(n,i);return r=nr(r,i),r}function rr(e,t){switch(e.replace("-template.md","")){case"journal":return`# ${t.date||"Untitled"}
...
`;default:return"{{content}}"}}var O="tracemind-block-editor",te="Daily",Ut="\u8BB0\u5F55\uFF0C\u662FAI\u65F6\u4EE3\u7684\u4EBA\u751F\u590D\u5229\u3002";function Ze(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,e=>{let t=Math.random()*16|0;return(e==="x"?t:t&3|8).toString(16)})}function et(e){let t=0;for(let n=0;n<e.length;n++){let r=e.charCodeAt(n);t=(t<<5)-t+r,t=t&t}let i=Math.abs(t).toString(16).padStart(8,"0");return`${i.substring(0,8)}-${i.substring(0,4)}-4${i.substring(0,3)}-${i.substring(0,4)}-${i.substring(0,12)}`}function Fe(e){let t=Array.isArray(e)?e.join(" "):e||"";return Array.from(new Set(t.split(/[\s,，#]+/).map(i=>i.trim()).filter(Boolean))).slice(0,6)}function tt(e){return Fe(e).join(" ")||"\u5F85\u5206\u6790"}function Me(e){return Fe(e).map(t=>`#${t}`).join(" ")||"#\u5F85\u5206\u6790"}var Be=class extends E.ItemView{plugin;blocks=[];selectedBlockId=null;currentDate;inputValue="";isLoading=!1;contentContainer=null;childInputEl=null;selectedBlockContent=null;inputAreaEl=null;inputTextarea=null;inputHintEl=null;inputAppendFooterEl=null;appendModeActionsEl=null;appendSubmitBtn=null;isAppendMode=!1;appendModeBlockId=null;isEditMode=!1;editModeBlockId=null;flowLineEl=null;constructor(t,i){super(t),this.plugin=i,this.currentDate=this.formatDate(new Date)}getBlockById(t){return this.blocks.find(i=>i.id===t)}focusBlockById(t){if(this.blocks.find(n=>n.id===t))return this.selectedBlockId=t,this.isAppendMode=!1,this.appendModeBlockId=null,this.isEditMode=!1,this.editModeBlockId=null,this.renderBlocks(),this.scrollBlockIntoView(t),!0;for(let n of this.blocks)if(n.children.find(s=>s.id===t))return this.selectedBlockId=t,this.isAppendMode=!1,this.appendModeBlockId=null,this.isEditMode=!1,this.editModeBlockId=null,this.renderBlocks(),this.scrollBlockIntoView(t,!0),!0;return!1}startAppendForBlock(t,i){let n=t;if(!this.blocks.find(s=>s.id===t)){let s=this.blocks.find(a=>a.children.some(o=>o.id===t));if(!s)return!1;n=s.id}return this.selectBlock(n),this.scrollBlockIntoView(n),i&&this.inputTextarea&&(this.inputTextarea.placeholder=i,this.inputHintEl&&(this.inputHintEl.textContent=i,this.inputHintEl.removeAttribute("style")),setTimeout(()=>this.inputTextarea?.focus(),0)),!0}getViewType(){return O}getDisplayText(){return"TraceMind \u8FF9\u5FC6"}getIcon(){return"brain"}async setCurrentDate(t){this.currentDate=this.formatDate(t),await this.renderView()}async renderView(){let t=this.containerEl;t.empty();let i=t.createEl("div",{cls:"lifewiki-diary-container",attr:{style:"display: flex; flex-direction: column; height: 100%;"}});this.addStyles();let n=i.createEl("div",{cls:"lifewiki-diary-header"}),r=n.createEl("h1",{cls:"lifewiki-diary-date"});r.createEl("span",{text:"\u{1F4C5}",cls:"lifewiki-diary-date-icon"}),r.createEl("span",{text:this.currentDate});let s=await this.loadSlogan();n.createEl("span",{text:s,cls:"lifewiki-diary-tagline"}),i.createEl("h2",{text:"Flow of Today\uFF1A",cls:"lifewiki-diary-section-title"}),this.contentContainer=i.createEl("div",{cls:"lifewiki-diary-content",attr:{style:"flex: 1; overflow-y: auto;"}}),await this.loadBlocks(),this.createInputArea(i),this.contentContainer?.addEventListener("click",a=>{let o=a.target,l=o.closest(".lifewiki-block.editing, .lifewiki-block-group.editing, .lifewiki-block-child.editing"),c=o.closest(".lifewiki-block, .lifewiki-block-group, .lifewiki-block-child"),u=o.closest(".lifewiki-input-area");this.isEditMode&&!l&&this.exitEditMode(),this.isAppendMode&&!c&&!u&&this.cancelAppendMode(),!this.isAppendMode&&!this.isEditMode&&!c&&(this.selectedBlockId=null,this.plugin.getAIAnalysisView()?.clearConversation())})}async onOpen(){await this.renderView()}addStyles(){let t=document.createElement("style");t.textContent=`
		...
		`,this.containerEl.appendChild(t)}createInputArea(t){this.inputAreaEl=t.createEl("div",{cls:"lifewiki-input-area"});let i=this.inputAreaEl.createEl("div",{cls:"lifewiki-input-inner"});this.inputTextarea=i.createEl("textarea",{cls:"lifewiki-input-box",attr:{placeholder:"\u8BB0\u5F55\u4ECA\u5929\u7684\u751F\u6D3B..."}});let n=i.createEl("div",{cls:"lifewiki-input-bottom"});this.inputHintEl=n.createEl("span",{cls:"lifewiki-input-hint",text:"Enter \u53D1\u9001"}),this.appendModeActionsEl=n.createEl("div",{cls:"lifewiki-append-mode-actions"}),this.appendSubmitBtn=this.appendModeActionsEl.createEl("button",{cls:"lifewiki-append-submit-btn",text:"\u5C06\u5728 HH:mm \u8FD9\u6761\u65E5\u8BB0\u4E0B\u8FFD\u52A0"}),this.appendSubmitBtn.addEventListener("click",()=>{this.submitAppend()}),this.appendModeActionsEl.createEl("button",{cls:"lifewiki-append-cancel-btn",text:"\xD7"}).addEventListener("click",()=>{this.cancelAppendMode()});let s=n.createEl("button",{cls:"lifewiki-diary-send-btn",attr:{type:"button",title:"\u53D1\u9001\u65E5\u8BB0"}});(0,E.setIcon)(s,"arrow-up"),s.addEventListener("click",a=>{a.preventDefault(),a.stopPropagation(),this.isAppendMode?this.submitAppend():this.inputTextarea&&this.submitBlock(this.inputTextarea)}),this.inputTextarea.addEventListener("focus",()=>{this.plugin.getAIAnalysisView()?.setMode("analysis"),this.isAppendMode||this.scrollToLastBlock()}),this.inputTextarea.addEventListener("input",()=>{if(!this.inputTextarea)return;this.inputValue=this.inputTextarea.value;let a=this.inputTextarea.value.length;this.inputHintEl.textContent=`${a}/250 \xB7 Enter \u53D1\u9001`}),this.inputTextarea.addEventListener("keydown",a=>{a.key==="Enter"&&(this.isAppendMode?a.shiftKey||(a.preventDefault(),this.submitAppend()):a.shiftKey||(a.preventDefault(),this.submitBlock(this.inputTextarea)))}),this.textarea=this.inputTextarea}async loadBlocks(){let t=`Daily/${this.currentDate}.md`,i=this.app.vault.getAbstractFileByPath(t);if((!i||!(i instanceof E.TFile))&&(i=this.app.vault.getAbstractFileByPath(`${this.currentDate}.md`)),(!i||!(i instanceof E.TFile))&&(i=this.app.vault.getAbstractFileByPath(`${te}/${this.currentDate}.md`)),!i||!(i instanceof E.TFile)){this.renderEmptyState();return}let n=await this.app.vault.read(i);this.parseBlocksFromContent(n),this.renderBlocks()}async loadSlogan(){let t=`Daily/${this.currentDate}.md`,i=this.app.vault.getAbstractFileByPath(t);if((!i||!(i instanceof E.TFile))&&(i=this.app.vault.getAbstractFileByPath(`${this.currentDate}.md`)),(!i||!(i instanceof E.TFile))&&(i=this.app.vault.getAbstractFileByPath(`${te}/${this.currentDate}.md`)),!i||!(i instanceof E.TFile))return Ut;let r=(await this.app.vault.read(i)).match(/>\s*\[!NOTE\]\s*(.+)/);return r&&r[1]?r[1].trim():Ut}renderEmptyState(){this.contentContainer&&(this.contentContainer.empty(),this.contentContainer.createEl("div",{cls:"lifewiki-empty-state",text:`\u4ECA\u5929\u7684\u65E5\u8BB0\u8FD8\u6CA1\u6709\u5F00\u59CB\u3002
...
\u4F1A\u8BDD\u8BB0\u5F55\u5C06\u88AB\u6C38\u4E45\u5220\u9664\u3002`)}confirm(s)&&await this.deleteBlock(t,i,n,r)}async deleteBlock(t,i,n,r){try{if(n&&i?await this.deleteChildBlockFromFile(t,i):await this.deleteParentBlockFromFile(t,r),r){let a=this.plugin.getSessionManager(),o=i||t;await a.clearSession(o)}await this.loadBlocks(),this.renderBlocks(),this.selectedBlockId=null,this.selectedBlockContent=null;let s=this.plugin.getAIAnalysisView();s&&s.setActiveBlock(null,null)}catch(s){console.error("[LifeWiki] Error deleting block:",s),alert("\u5220\u9664\u5931\u8D25: "+(s instanceof Error?s.message:"\u672A\u77E5\u9519\u8BEF"))}}async deleteChildBlockFromFile(t,i){let n=`Daily/${this.currentDate}.md`,r=this.app.vault.getAbstractFileByPath(n);if((!r||!(r instanceof E.TFile))&&(r=this.app.vault.getAbstractFileByPath(`${this.currentDate}.md`)),(!r||!(r instanceof E.TFile))&&(r=this.app.vault.getAbstractFileByPath(`${te}/${this.currentDate}.md`)),!(r instanceof E.TFile))return;let a=(await this.app.vault.read(r)).split(`
`),o=new RegExp(`^- \\d{2}:\\d{2}\\s.+<!-- ${t} -->`),l=a.filter(u=>!u.match(o));await this.app.vault.modify(r,l.join(`
`));let c=this.blocks.find(u=>u.id===i);c&&(c.children=c.children.filter(u=>u.id!==t))}async deleteParentBlockFromFile(t,i){let n=`Daily/${this.currentDate}.md`,r=this.app.vault.getAbstractFileByPath(n);if((!r||!(r instanceof E.TFile))&&(r=this.app.vault.getAbstractFileByPath(`${this.currentDate}.md`)),(!r||!(r instanceof E.TFile))&&(r=this.app.vault.getAbstractFileByPath(`${te}/${this.currentDate}.md`)),!(r instanceof E.TFile))return;let a=(await this.app.vault.read(r)).split(`
...
`))}async submitBlock(t){let i=t.value.trim();if(!i||this.isLoading)return;this.isLoading=!0;let n=new Date,r=`${n.getHours().toString().padStart(2,"0")}:${n.getMinutes().toString().padStart(2,"0")}`,s={id:Ze(),timestamp:r,source:"TraceMind",category:"\u5F85\u5206\u6790",content:i,children:[],parentId:null};this.blocks.push(s),t.value="",this.inputValue="",this.renderBlocks(),await this.appendBlockToFile(s),await this.startAIAnalysis(s),this.isLoading=!1}async appendBlockToFile(t){let i=`Daily/${this.currentDate}.md`,n=this.app.vault.getAbstractFileByPath(i);if(n instanceof E.TFile||this.app.vault.getAbstractFileByPath("Daily")instanceof E.TFolder||await this.app.vault.createFolder("Daily"),(!n||!(n instanceof E.TFile))&&(n=this.app.vault.getAbstractFileByPath(`${this.currentDate}.md`)),!(n instanceof E.TFile)){let o=await Ht(this.app.vault,"journal-template.md",{date:this.currentDate})+`
...
\u53EA\u8FD4\u56DE\u5408\u6CD5 JSON\u3002`;try{let a=await n.chat([{role:"user",content:s}],"analysis"),o=this.extractJSON(a.content);return JSON.parse(o)}catch{return{}}}async parseClarificationResponse(t,i){let n=this.plugin.getAIProvider(),r=this.plugin.getUserProfileContext(),s=i.subtype?he(i.type,i.subtype)||i.subtype:"",a=s?`${i.type} / ${i.subtype}\uFF08${s}\uFF09`:i.type,o=["\u7528\u6237\u56DE\u7B54\u4E86\u5173\u4E8E\u300C"+i.name+"\u300D\uFF08\u7C7B\u578B\uFF1A"+a+"\uFF09\u7684\u6F84\u6E05\u95EE\u9898\u3002"];r&&(o.push(""),o.push(r),o.push(""),o.push("\u6839\u636E\u4E0A\u8FF0\u7528\u6237\u6863\u6848\uFF0C\u8BF7\u505A\u5408\u7406\u63A8\u65AD\u3002\u4F8B\u5982\uFF1A\u7528\u6237\u56DE\u7B54\u201C\u662F\u540C\u4E8B\u201D\uFF0C\u5219\u516C\u53F8\u5E94\u4E0E\u7528\u6237\u6863\u6848\u4E2D\u7684\u516C\u53F8\u76F8\u540C\u3002\u7528\u6237\u56DE\u7B54\u201C\u662F\u670B\u53CB\u201D\uFF0C\u5219\u5173\u7CFB\u4E3A friend\u3002")),o.push(""),o.push("\u7528\u6237\u56DE\u7B54\uFF1A"+t);let l=o.concat(["\u8BF7\u4ECE\u7528\u6237\u56DE\u7B54\u4E2D\u63D0\u53D6\u5173\u952E\u5C5E\u6027\u4FE1\u606F\u3002","","\u5F53\u524D\u5B9E\u4F53\u7C7B\u578B\u662F "+a+"\uFF0C\u53EF\u7528\u7684\u5C5E\u6027\u540D\u4E3A\uFF1A",Jt(i.type,i.subtype),"","=== \u91CD\u8981\uFF1Aattributes \u5FC5\u987B\u662F\u5E73\u94FA\u7684 key-value\uFF0C\u4E0D\u8981\u5D4C\u5957===",'\u9519\u8BEF\u793A\u4F8B\uFF1A{ "person": { "company": "xxx" } }','\u6B63\u786E\u793A\u4F8B\uFF1A{ "company": "xxx", "role": "xxx" }',"","\u8FD4\u56DE\u4E00\u4E2A JSON \u5BF9\u8C61\uFF0C\u4F8B\u5982\u7528\u6237\u8BF4\u201C\u5F20\u4E09\u662F\u5B57\u8282\u8DF3\u52A8\u7684\u4EA7\u54C1\u7ECF\u7406\uFF0C\u662F\u6211\u540C\u4E8B\uFF0C\u53EB\u4ED6\u4E09\u54E5\u201D\uFF0C\u5219\u8FD4\u56DE\uFF1A","{",'  "acknowledgment": "\u660E\u767D\u4E86\uFF0C\u5F20\u4E09\u5728\u5B57\u8282\u8DF3\u52A8\u505A\u4EA7\u54C1\u7ECF\u7406\uFF0C\u662F\u4F60\u540C\u4E8B\u3002",','  "attributes": { "company": "\u5B57\u8282\u8DF3\u52A8", "role": "\u4EA7\u54C1\u7ECF\u7406", "relationship_to_user": "\u540C\u4E8B", "aliases": "\u4E09\u54E5" }',"}","","\u53EA\u8FD4\u56DE\u5408\u6CD5 JSON\uFF0C\u4E0D\u8981 markdown\u3002"]).join(`
...
`,document.head.appendChild(t)}};async function ie(e,t){if(!e.vault.getAbstractFileByPath(t))try{await e.vault.createFolder(t)}catch(n){if(!n.message?.includes("already exists"))throw n}}async function W(e,t){let i=t.split("/");if(i.length<2)return;let n=i.slice(0,-1),r="";for(let s of n)r=r?`${r}/${s}`:s,await ie(e,r)}function Si(e){return typeof e>"u"||e===null}function Cr(e){return typeof e=="object"&&e!==null}function Ar(e){return Array.isArray(e)?e:Si(e)?[]:[e]}function Tr(e,t){var i,n,r,s;if(t)for(s=Object.keys(t),i=0,n=s.length;i<n;i+=1)r=s[i],e[r]=t[r];return e}function Sr(e,t){var i="",n;for(n=0;n<t;n+=1)i+=e;return i}function Ir(e){return e===0&&Number.NEGATIVE_INFINITY===1/e}var Mr=Si,Fr=Cr,Br=Ar,Pr=Sr,Dr=Ir,Lr=Tr,k={isNothing:Mr,isObject:Fr,toArray:Br,repeat:Pr,isNegativeZero:Dr,extend:Lr};function Ii(e,t){var i="",n=e.reason||"(unknown reason)";return e.mark?(e.mark.name&&(i+='in "'+e.mark.name+'" '),i+="("+(e.mark.line+1)+":"+(e.mark.column+1)+")",!t&&e.mark.snippet&&(i+=`

`+e.mark.snippet),n+" "+i):n}function be(e,t){Error.call(this),this.name="YAMLException",this.reason=e,this.mark=t,this.message=Ii(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}be.prototype=Object.create(Error.prototype);be.prototype.constructor=be;be.prototype.toString=function(t){return this.name+": "+Ii(this,t)};var S=be;function st(e,t,i,n,r){var s="",a="",o=Math.floor(r/2)-1;return n-t>o&&(s=" ... ",t=n-o+s.length),i-n>o&&(a=" ...",i=n+o-a.length),{str:s+e.slice(t,i).replace(/\t/g,"\u2192")+a,pos:n-t+s.length}}function ot(e,t){return k.repeat(" ",t-e.length)+e}function _r(e,t){if(t=Object.create(t||null),!e.buffer)return null;t.maxLength||(t.maxLength=79),typeof t.indent!="number"&&(t.indent=1),typeof t.linesBefore!="number"&&(t.linesBefore=3),typeof t.linesAfter!="number"&&(t.linesAfter=2);for(var i=/\r?\n|\r|\0/g,n=[0],r=[],s,a=-1;s=i.exec(e.buffer);)r.push(s.index),n.push(s.index+s[0].length),e.position<=s.index&&a<0&&(a=n.length-2);a<0&&(a=n.length-1);var o="",l,c,u=Math.min(e.line+t.linesAfter,r.length).toString().length,d=t.maxLength-(t.indent+u+3);for(l=1;l<=t.linesBefore&&!(a-l<0);l++)c=st(e.buffer,n[a-l],r[a-l],e.position-(n[a]-n[a-l]),d),o=k.repeat(" ",t.indent)+ot((e.line-l+1).toString(),u)+" | "+c.str+`
`+o;for(c=st(e.buffer,n[a],r[a],e.position,d),o+=k.repeat(" ",t.indent)+ot((e.line+1).toString(),u)+" | "+c.str+`
`,o+=k.repeat("-",t.indent+u+3+c.pos)+`^
`,l=1;l<=t.linesAfter&&!(a+l>=r.length);l++)c=st(e.buffer,n[a+l],r[a+l],e.position-(n[a]-n[a+l]),d),o+=k.repeat(" ",t.indent)+ot((e.line+l+1).toString(),u)+" | "+c.str+`
`;return o.replace(/\n$/,"")}var Rr=_r,Or=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],Nr=["scalar","sequence","mapping"];function $r(e){var t={};return e!==null&&Object.keys(e).forEach(function(i){e[i].forEach(function(n){t[String(n)]=i})}),t}function jr(e,t){if(t=t||{},Object.keys(t).forEach(function(i){if(Or.indexOf(i)===-1)throw new S('Unknown option "'+i+'" is met in definition of "'+e+'" YAML type.')}),this.options=t,this.tag=e,this.kind=t.kind||null,this.resolve=t.resolve||function(){return!0},this.construct=t.construct||function(i){return i},this.instanceOf=t.instanceOf||null,this.predicate=t.predicate||null,this.represent=t.represent||null,this.representName=t.representName||null,this.defaultStyle=t.defaultStyle||null,this.multi=t.multi||!1,this.styleAliases=$r(t.styleAliases||null),Nr.indexOf(this.kind)===-1)throw new S('Unknown kind "'+this.kind+'" is specified for "'+e+'" YAML type.')}var C=jr;function pi(e,t){var i=[];return e[t].forEach(function(n){var r=i.length;i.forEach(function(s,a){s.tag===n.tag&&s.kind===n.kind&&s.multi===n.multi&&(r=a)}),i[r]=n}),i}function Vr(){var e={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},t,i;function n(r){r.multi?(e.multi[r.kind].push(r),e.multi.fallback.push(r)):e[r.kind][r.tag]=e.fallback[r.tag]=r}for(t=0,i=arguments.length;t<i;t+=1)arguments[t].forEach(n);return e}function ct(e){return this.extend(e)}ct.prototype.extend=function(t){var i=[],n=[];if(t instanceof C)n.push(t);else if(Array.isArray(t))n=n.concat(t);else if(t&&(Array.isArray(t.implicit)||Array.isArray(t.explicit)))t.implicit&&(i=i.concat(t.implicit)),t.explicit&&(n=n.concat(t.explicit));else throw new S("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");i.forEach(function(s){if(!(s instanceof C))throw new S("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(s.loadKind&&s.loadKind!=="scalar")throw new S("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(s.multi)throw new S("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),n.forEach(function(s){if(!(s instanceof C))throw new S("Specified list of YAML types (or a single Type object) contains a non-Type object.")});var r=Object.create(ct.prototype);return r.implicit=(this.implicit||[]).concat(i),r.explicit=(this.explicit||[]).concat(n),r.compiledImplicit=pi(r,"implicit"),r.compiledExplicit=pi(r,"explicit"),r.compiledTypeMap=Vr(r.compiledImplicit,r.compiledExplicit),r};var Mi=ct,Fi=new C("tag:yaml.org,2002:str",{kind:"scalar",construct:function(e){return e!==null?e:""}}),Bi=new C("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(e){return e!==null?e:[]}}),Pi=new C("tag:yaml.org,2002:map",{kind:"mapping",construct:function(e){return e!==null?e:{}}}),Di=new Mi({explicit:[Fi,Bi,Pi]});function Hr(e){if(e===null)return!0;var t=e.length;return t===1&&e==="~"||t===4&&(e==="null"||e==="Null"||e==="NULL")}function Ur(){return null}function zr(e){return e===null}var Li=new C("tag:yaml.org,2002:null",{kind:"scalar",resolve:Hr,construct:Ur,predicate:zr,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"});function Yr(e){if(e===null)return!1;var t=e.length;return t===4&&(e==="true"||e==="True"||e==="TRUE")||t===5&&(e==="false"||e==="False"||e==="FALSE")}function Kr(e){return e==="true"||e==="True"||e==="TRUE"}function Wr(e){return Object.prototype.toString.call(e)==="[object Boolean]"}var _i=new C("tag:yaml.org,2002:bool",{kind:"scalar",resolve:Yr,construct:Kr,predicate:Wr,represent:{lowercase:function(e){return e?"true":"false"},uppercase:function(e){return e?"TRUE":"FALSE"},camelcase:function(e){return e?"True":"False"}},defaultStyle:"lowercase"});function Gr(e){return 48<=e&&e<=57||65<=e&&e<=70||97<=e&&e<=102}function qr(e){return 48<=e&&e<=55}function Qr(e){return 48<=e&&e<=57}function Jr(e){if(e===null)return!1;var t=e.length,i=0,n=!1,r;if(!t)return!1;if(r=e[i],(r==="-"||r==="+")&&(r=e[++i]),r==="0"){if(i+1===t)return!0;if(r=e[++i],r==="b"){for(i++;i<t;i++)if(r=e[i],r!=="_"){if(r!=="0"&&r!=="1")return!1;n=!0}return n&&r!=="_"}if(r==="x"){for(i++;i<t;i++)if(r=e[i],r!=="_"){if(!Gr(e.charCodeAt(i)))return!1;n=!0}return n&&r!=="_"}if(r==="o"){for(i++;i<t;i++)if(r=e[i],r!=="_"){if(!qr(e.charCodeAt(i)))return!1;n=!0}return n&&r!=="_"}}if(r==="_")return!1;for(;i<t;i++)if(r=e[i],r!=="_"){if(!Qr(e.charCodeAt(i)))return!1;n=!0}return!(!n||r==="_")}function Xr(e){var t=e,i=1,n;if(t.indexOf("_")!==-1&&(t=t.replace(/_/g,"")),n=t[0],(n==="-"||n==="+")&&(n==="-"&&(i=-1),t=t.slice(1),n=t[0]),t==="0")return 0;if(n==="0"){if(t[1]==="b")return i*parseInt(t.slice(2),2);if(t[1]==="x")return i*parseInt(t.slice(2),16);if(t[1]==="o")return i*parseInt(t.slice(2),8)}return i*parseInt(t,10)}function Zr(e){return Object.prototype.toString.call(e)==="[object Number]"&&e%1===0&&!k.isNegativeZero(e)}var Ri=new C("tag:yaml.org,2002:int",{kind:"scalar",resolve:Jr,construct:Xr,predicate:Zr,represent:{binary:function(e){return e>=0?"0b"+e.toString(2):"-0b"+e.toString(2).slice(1)},octal:function(e){return e>=0?"0o"+e.toString(8):"-0o"+e.toString(8).slice(1)},decimal:function(e){return e.toString(10)},hexadecimal:function(e){return e>=0?"0x"+e.toString(16).toUpperCase():"-0x"+e.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),ea=new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function ta(e){return!(e===null||!ea.test(e)||e[e.length-1]==="_")}function ia(e){var t,i;return t=e.replace(/_/g,"").toLowerCase(),i=t[0]==="-"?-1:1,"+-".indexOf(t[0])>=0&&(t=t.slice(1)),t===".inf"?i===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:t===".nan"?NaN:i*parseFloat(t,10)}var na=/^[-+]?[0-9]+e/;function ra(e,t){var i;if(isNaN(e))switch(t){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===e)switch(t){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===e)switch(t){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(k.isNegativeZero(e))return"-0.0";return i=e.toString(10),na.test(i)?i.replace("e",".e"):i}function aa(e){return Object.prototype.toString.call(e)==="[object Number]"&&(e%1!==0||k.isNegativeZero(e))}var Oi=new C("tag:yaml.org,2002:float",{kind:"scalar",resolve:ta,construct:ia,predicate:aa,represent:ra,defaultStyle:"lowercase"}),Ni=Di.extend({implicit:[Li,_i,Ri,Oi]}),$i=Ni,ji=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),Vi=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function sa(e){return e===null?!1:ji.exec(e)!==null||Vi.exec(e)!==null}function oa(e){var t,i,n,r,s,a,o,l=0,c=null,u,d,f;if(t=ji.exec(e),t===null&&(t=Vi.exec(e)),t===null)throw new Error("Date resolve error");if(i=+t[1],n=+t[2]-1,r=+t[3],!t[4])return new Date(Date.UTC(i,n,r));if(s=+t[4],a=+t[5],o=+t[6],t[7]){for(l=t[7].slice(0,3);l.length<3;)l+="0";l=+l}return t[9]&&(u=+t[10],d=+(t[11]||0),c=(u*60+d)*6e4,t[9]==="-"&&(c=-c)),f=new Date(Date.UTC(i,n,r,s,a,o,l)),c&&f.setTime(f.getTime()-c),f}function la(e){return e.toISOString()}var Hi=new C("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:sa,construct:oa,instanceOf:Date,represent:la});function ca(e){return e==="<<"||e===null}var Ui=new C("tag:yaml.org,2002:merge",{kind:"scalar",resolve:ca}),ht=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function ua(e){if(e===null)return!1;var t,i,n=0,r=e.length,s=ht;for(i=0;i<r;i++)if(t=s.indexOf(e.charAt(i)),!(t>64)){if(t<0)return!1;n+=6}return n%8===0}function da(e){var t,i,n=e.replace(/[\r\n=]/g,""),r=n.length,s=ht,a=0,o=[];for(t=0;t<r;t++)t%4===0&&t&&(o.push(a>>16&255),o.push(a>>8&255),o.push(a&255)),a=a<<6|s.indexOf(n.charAt(t));return i=r%4*6,i===0?(o.push(a>>16&255),o.push(a>>8&255),o.push(a&255)):i===18?(o.push(a>>10&255),o.push(a>>2&255)):i===12&&o.push(a>>4&255),new Uint8Array(o)}function pa(e){var t="",i=0,n,r,s=e.length,a=ht;for(n=0;n<s;n++)n%3===0&&n&&(t+=a[i>>18&63],t+=a[i>>12&63],t+=a[i>>6&63],t+=a[i&63]),i=(i<<8)+e[n];return r=s%3,r===0?(t+=a[i>>18&63],t+=a[i>>12&63],t+=a[i>>6&63],t+=a[i&63]):r===2?(t+=a[i>>10&63],t+=a[i>>4&63],t+=a[i<<2&63],t+=a[64]):r===1&&(t+=a[i>>2&63],t+=a[i<<4&63],t+=a[64],t+=a[64]),t}function fa(e){return Object.prototype.toString.call(e)==="[object Uint8Array]"}var zi=new C("tag:yaml.org,2002:binary",{kind:"scalar",resolve:ua,construct:da,predicate:fa,represent:pa}),ha=Object.prototype.hasOwnProperty,ga=Object.prototype.toString;function ya(e){if(e===null)return!0;var t=[],i,n,r,s,a,o=e;for(i=0,n=o.length;i<n;i+=1){if(r=o[i],a=!1,ga.call(r)!=="[object Object]")return!1;for(s in r)if(ha.call(r,s))if(!a)a=!0;else return!1;if(!a)return!1;if(t.indexOf(s)===-1)t.push(s);else return!1}return!0}function ma(e){return e!==null?e:[]}var Yi=new C("tag:yaml.org,2002:omap",{kind:"sequence",resolve:ya,construct:ma}),ba=Object.prototype.toString;function xa(e){if(e===null)return!0;var t,i,n,r,s,a=e;for(s=new Array(a.length),t=0,i=a.length;t<i;t+=1){if(n=a[t],ba.call(n)!=="[object Object]"||(r=Object.keys(n),r.length!==1))return!1;s[t]=[r[0],n[r[0]]]}return!0}function va(e){if(e===null)return[];var t,i,n,r,s,a=e;for(s=new Array(a.length),t=0,i=a.length;t<i;t+=1)n=a[t],r=Object.keys(n),s[t]=[r[0],n[r[0]]];return s}var Ki=new C("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:xa,construct:va}),Ea=Object.prototype.hasOwnProperty;function wa(e){if(e===null)return!0;var t,i=e;for(t in i)if(Ea.call(i,t)&&i[t]!==null)return!1;return!0}function ka(e){return e!==null?e:{}}var Wi=new C("tag:yaml.org,2002:set",{kind:"mapping",resolve:wa,construct:ka}),gt=$i.extend({implicit:[Hi,Ui],explicit:[zi,Yi,Ki,Wi]}),U=Object.prototype.hasOwnProperty,Oe=1,Gi=2,qi=3,Ne=4,lt=1,Ca=2,fi=3,Aa=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Ta=/[\x85\u2028\u2029]/,Sa=/[,\[\]\{\}]/,Qi=/^(?:!|!!|![a-z\-]+!)$/i,Ji=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function hi(e){return Object.prototype.toString.call(e)}function _(e){return e===10||e===13}function q(e){return e===9||e===32}function I(e){return e===9||e===32||e===10||e===13}function re(e){return e===44||e===91||e===93||e===123||e===125}function Ia(e){var t;return 48<=e&&e<=57?e-48:(t=e|32,97<=t&&t<=102?t-97+10:-1)}function Ma(e){return e===120?2:e===117?4:e===85?8:0}function Fa(e){return 48<=e&&e<=57?e-48:-1}function gi(e){return e===48?"\0":e===97?"\x07":e===98?"\b":e===116||e===9?"	":e===110?`
`:e===118?"\v":e===102?"\f":e===114?"\r":e===101?"\x1B":e===32?" ":e===34?'"':e===47?"/":e===92?"\\":e===78?"\x85":e===95?"\xA0":e===76?"\u2028":e===80?"\u2029":""}function Ba(e){return e<=65535?String.fromCharCode(e):String.fromCharCode((e-65536>>10)+55296,(e-65536&1023)+56320)}function Xi(e,t,i){t==="__proto__"?Object.defineProperty(e,t,{configurable:!0,enumerable:!0,writable:!0,value:i}):e[t]=i}var Zi=new Array(256),en=new Array(256);for(G=0;G<256;G++)Zi[G]=gi(G)?1:0,en[G]=gi(G);var G;function Pa(e,t){this.input=e,this.filename=t.filename||null,this.schema=t.schema||gt,this.onWarning=t.onWarning||null,this.legacy=t.legacy||!1,this.json=t.json||!1,this.listener=t.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=e.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function tn(e,t){var i={name:e.filename,buffer:e.input.slice(0,-1),position:e.position,line:e.line,column:e.position-e.lineStart};return i.snippet=Rr(i),new S(t,i)}function m(e,t){throw tn(e,t)}function $e(e,t){e.onWarning&&e.onWarning.call(null,tn(e,t))}var yi={YAML:function(t,i,n){var r,s,a;t.version!==null&&m(t,"duplication of %YAML directive"),n.length!==1&&m(t,"YAML directive accepts exactly one argument"),r=/^([0-9]+)\.([0-9]+)$/.exec(n[0]),r===null&&m(t,"ill-formed argument of the YAML directive"),s=parseInt(r[1],10),a=parseInt(r[2],10),s!==1&&m(t,"unacceptable YAML version of the document"),t.version=n[0],t.checkLineBreaks=a<2,a!==1&&a!==2&&$e(t,"unsupported YAML version of the document")},TAG:function(t,i,n){var r,s;n.length!==2&&m(t,"TAG directive accepts exactly two arguments"),r=n[0],s=n[1],Qi.test(r)||m(t,"ill-formed tag handle (first argument) of the TAG directive"),U.call(t.tagMap,r)&&m(t,'there is a previously declared suffix for "'+r+'" tag handle'),Ji.test(s)||m(t,"ill-formed tag prefix (second argument) of the TAG directive");try{s=decodeURIComponent(s)}catch{m(t,"tag prefix is malformed: "+s)}t.tagMap[r]=s}};function H(e,t,i,n){var r,s,a,o;if(t<i){if(o=e.input.slice(t,i),n)for(r=0,s=o.length;r<s;r+=1)a=o.charCodeAt(r),a===9||32<=a&&a<=1114111||m(e,"expected valid JSON character");else Aa.test(o)&&m(e,"the stream contains non-printable characters");e.result+=o}}function mi(e,t,i,n){var r,s,a,o;for(k.isObject(i)||m(e,"cannot merge mappings; the provided source object is unacceptable"),r=Object.keys(i),a=0,o=r.length;a<o;a+=1)s=r[a],U.call(t,s)||(Xi(t,s,i[s]),n[s]=!0)}function ae(e,t,i,n,r,s,a,o,l){var c,u;if(Array.isArray(r))for(r=Array.prototype.slice.call(r),c=0,u=r.length;c<u;c+=1)Array.isArray(r[c])&&m(e,"nested arrays are not supported inside keys"),typeof r=="object"&&hi(r[c])==="[object Object]"&&(r[c]="[object Object]");if(typeof r=="object"&&hi(r)==="[object Object]"&&(r="[object Object]"),r=String(r),t===null&&(t={}),n==="tag:yaml.org,2002:merge")if(Array.isArray(s))for(c=0,u=s.length;c<u;c+=1)mi(e,t,s[c],i);else mi(e,t,s,i);else!e.json&&!U.call(i,r)&&U.call(t,r)&&(e.line=a||e.line,e.lineStart=o||e.lineStart,e.position=l||e.position,m(e,"duplicated mapping key")),Xi(t,r,s),delete i[r];return t}function yt(e){var t;t=e.input.charCodeAt(e.position),t===10?e.position++:t===13?(e.position++,e.input.charCodeAt(e.position)===10&&e.position++):m(e,"a line break is expected"),e.line+=1,e.lineStart=e.position,e.firstTabInLine=-1}function w(e,t,i){for(var n=0,r=e.input.charCodeAt(e.position);r!==0;){for(;q(r);)r===9&&e.firstTabInLine===-1&&(e.firstTabInLine=e.position),r=e.input.charCodeAt(++e.position);if(t&&r===35)do r=e.input.charCodeAt(++e.position);while(r!==10&&r!==13&&r!==0);if(_(r))for(yt(e),r=e.input.charCodeAt(e.position),n++,e.lineIndent=0;r===32;)e.lineIndent++,r=e.input.charCodeAt(++e.position);else break}return i!==-1&&n!==0&&e.lineIndent<i&&$e(e,"deficient indentation"),n}function He(e){var t=e.position,i;return i=e.input.charCodeAt(t),!!((i===45||i===46)&&i===e.input.charCodeAt(t+1)&&i===e.input.charCodeAt(t+2)&&(t+=3,i=e.input.charCodeAt(t),i===0||I(i)))}function mt(e,t){t===1?e.result+=" ":t>1&&(e.result+=k.repeat(`
`,t-1))}function Da(e,t,i){var n,r,s,a,o,l,c,u,d=e.kind,f=e.result,p;if(p=e.input.charCodeAt(e.position),I(p)||re(p)||p===35||p===38||p===42||p===33||p===124||p===62||p===39||p===34||p===37||p===64||p===96||(p===63||p===45)&&(r=e.input.charCodeAt(e.position+1),I(r)||i&&re(r)))return!1;for(e.kind="scalar",e.result="",s=a=e.position,o=!1;p!==0;){if(p===58){if(r=e.input.charCodeAt(e.position+1),I(r)||i&&re(r))break}else if(p===35){if(n=e.input.charCodeAt(e.position-1),I(n))break}else{if(e.position===e.lineStart&&He(e)||i&&re(p))break;if(_(p))if(l=e.line,c=e.lineStart,u=e.lineIndent,w(e,!1,-1),e.lineIndent>=t){o=!0,p=e.input.charCodeAt(e.position);continue}else{e.position=a,e.line=l,e.lineStart=c,e.lineIndent=u;break}}o&&(H(e,s,a,!1),mt(e,e.line-l),s=a=e.position,o=!1),q(p)||(a=e.position+1),p=e.input.charCodeAt(++e.position)}return H(e,s,a,!1),e.result?!0:(e.kind=d,e.result=f,!1)}function La(e,t){var i,n,r;if(i=e.input.charCodeAt(e.position),i!==39)return!1;for(e.kind="scalar",e.result="",e.position++,n=r=e.position;(i=e.input.charCodeAt(e.position))!==0;)if(i===39)if(H(e,n,e.position,!0),i=e.input.charCodeAt(++e.position),i===39)n=e.position,e.position++,r=e.position;else return!0;else _(i)?(H(e,n,r,!0),mt(e,w(e,!1,t)),n=r=e.position):e.position===e.lineStart&&He(e)?m(e,"unexpected end of the document within a single quoted scalar"):(e.position++,r=e.position);m(e,"unexpected end of the stream within a single quoted scalar")}function _a(e,t){var i,n,r,s,a,o;if(o=e.input.charCodeAt(e.position),o!==34)return!1;for(e.kind="scalar",e.result="",e.position++,i=n=e.position;(o=e.input.charCodeAt(e.position))!==0;){if(o===34)return H(e,i,e.position,!0),e.position++,!0;if(o===92){if(H(e,i,e.position,!0),o=e.input.charCodeAt(++e.position),_(o))w(e,!1,t);else if(o<256&&Zi[o])e.result+=en[o],e.position++;else if((a=Ma(o))>0){for(r=a,s=0;r>0;r--)o=e.input.charCodeAt(++e.position),(a=Ia(o))>=0?s=(s<<4)+a:m(e,"expected hexadecimal character");e.result+=Ba(s),e.position++}else m(e,"unknown escape sequence");i=n=e.position}else _(o)?(H(e,i,n,!0),mt(e,w(e,!1,t)),i=n=e.position):e.position===e.lineStart&&He(e)?m(e,"unexpected end of the document within a double quoted scalar"):(e.position++,n=e.position)}m(e,"unexpected end of the stream within a double quoted scalar")}function Ra(e,t){var i=!0,n,r,s,a=e.tag,o,l=e.anchor,c,u,d,f,p,h=Object.create(null),g,y,v,b;if(b=e.input.charCodeAt(e.position),b===91)u=93,p=!1,o=[];else if(b===123)u=125,p=!0,o={};else return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=o),b=e.input.charCodeAt(++e.position);b!==0;){if(w(e,!0,t),b=e.input.charCodeAt(e.position),b===u)return e.position++,e.tag=a,e.anchor=l,e.kind=p?"mapping":"sequence",e.result=o,!0;i?b===44&&m(e,"expected the node content, but found ','"):m(e,"missed comma between flow collection entries"),y=g=v=null,d=f=!1,b===63&&(c=e.input.charCodeAt(e.position+1),I(c)&&(d=f=!0,e.position++,w(e,!0,t))),n=e.line,r=e.lineStart,s=e.position,se(e,t,Oe,!1,!0),y=e.tag,g=e.result,w(e,!0,t),b=e.input.charCodeAt(e.position),(f||e.line===n)&&b===58&&(d=!0,b=e.input.charCodeAt(++e.position),w(e,!0,t),se(e,t,Oe,!1,!0),v=e.result),p?ae(e,o,h,y,g,v,n,r,s):d?o.push(ae(e,null,h,y,g,v,n,r,s)):o.push(g),w(e,!0,t),b=e.input.charCodeAt(e.position),b===44?(i=!0,b=e.input.charCodeAt(++e.position)):i=!1}m(e,"unexpected end of the stream within a flow collection")}function Oa(e,t){var i,n,r=lt,s=!1,a=!1,o=t,l=0,c=!1,u,d;if(d=e.input.charCodeAt(e.position),d===124)n=!1;else if(d===62)n=!0;else return!1;for(e.kind="scalar",e.result="";d!==0;)if(d=e.input.charCodeAt(++e.position),d===43||d===45)lt===r?r=d===43?fi:Ca:m(e,"repeat of a chomping mode identifier");else if((u=Fa(d))>=0)u===0?m(e,"bad explicit indentation width of a block scalar; it cannot be less than one"):a?m(e,"repeat of an indentation width identifier"):(o=t+u-1,a=!0);else break;if(q(d)){do d=e.input.charCodeAt(++e.position);while(q(d));if(d===35)do d=e.input.charCodeAt(++e.position);while(!_(d)&&d!==0)}for(;d!==0;){for(yt(e),e.lineIndent=0,d=e.input.charCodeAt(e.position);(!a||e.lineIndent<o)&&d===32;)e.lineIndent++,d=e.input.charCodeAt(++e.position);if(!a&&e.lineIndent>o&&(o=e.lineIndent),_(d)){l++;continue}if(e.lineIndent<o){r===fi?e.result+=k.repeat(`
`,s?1+l:l):r===lt&&s&&(e.result+=`
`);break}for(n?q(d)?(c=!0,e.result+=k.repeat(`
`,s?1+l:l)):c?(c=!1,e.result+=k.repeat(`
`,l+1)):l===0?s&&(e.result+=" "):e.result+=k.repeat(`
`,l):e.result+=k.repeat(`
`,s?1+l:l),s=!0,a=!0,l=0,i=e.position;!_(d)&&d!==0;)d=e.input.charCodeAt(++e.position);H(e,i,e.position,!1)}return!0}function bi(e,t){var i,n=e.tag,r=e.anchor,s=[],a,o=!1,l;if(e.firstTabInLine!==-1)return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=s),l=e.input.charCodeAt(e.position);l!==0&&(e.firstTabInLine!==-1&&(e.position=e.firstTabInLine,m(e,"tab characters must not be used in indentation")),!(l!==45||(a=e.input.charCodeAt(e.position+1),!I(a))));){if(o=!0,e.position++,w(e,!0,-1)&&e.lineIndent<=t){s.push(null),l=e.input.charCodeAt(e.position);continue}if(i=e.line,se(e,t,qi,!1,!0),s.push(e.result),w(e,!0,-1),l=e.input.charCodeAt(e.position),(e.line===i||e.lineIndent>t)&&l!==0)m(e,"bad indentation of a sequence entry");else if(e.lineIndent<t)break}return o?(e.tag=n,e.anchor=r,e.kind="sequence",e.result=s,!0):!1}function Na(e,t,i){var n,r,s,a,o,l,c=e.tag,u=e.anchor,d={},f=Object.create(null),p=null,h=null,g=null,y=!1,v=!1,b;if(e.firstTabInLine!==-1)return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=d),b=e.input.charCodeAt(e.position);b!==0;){if(!y&&e.firstTabInLine!==-1&&(e.position=e.firstTabInLine,m(e,"tab characters must not be used in indentation")),n=e.input.charCodeAt(e.position+1),s=e.line,(b===63||b===58)&&I(n))b===63?(y&&(ae(e,d,f,p,h,null,a,o,l),p=h=g=null),v=!0,y=!0,r=!0):y?(y=!1,r=!0):m(e,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),e.position+=1,b=n;else{if(a=e.line,o=e.lineStart,l=e.position,!se(e,i,Gi,!1,!0))break;if(e.line===s){for(b=e.input.charCodeAt(e.position);q(b);)b=e.input.charCodeAt(++e.position);if(b===58)b=e.input.charCodeAt(++e.position),I(b)||m(e,"a whitespace character is expected after the key-value separator within a block mapping"),y&&(ae(e,d,f,p,h,null,a,o,l),p=h=g=null),v=!0,y=!1,r=!1,p=e.tag,h=e.result;else if(v)m(e,"can not read an implicit mapping pair; a colon is missed");else return e.tag=c,e.anchor=u,!0}else if(v)m(e,"can not read a block mapping entry; a multiline key may not be an implicit key");else return e.tag=c,e.anchor=u,!0}if((e.line===s||e.lineIndent>t)&&(y&&(a=e.line,o=e.lineStart,l=e.position),se(e,t,Ne,!0,r)&&(y?h=e.result:g=e.result),y||(ae(e,d,f,p,h,g,a,o,l),p=h=g=null),w(e,!0,-1),b=e.input.charCodeAt(e.position)),(e.line===s||e.lineIndent>t)&&b!==0)m(e,"bad indentation of a mapping entry");else if(e.lineIndent<t)break}return y&&ae(e,d,f,p,h,null,a,o,l),v&&(e.tag=c,e.anchor=u,e.kind="mapping",e.result=d),v}function $a(e){var t,i=!1,n=!1,r,s,a;if(a=e.input.charCodeAt(e.position),a!==33)return!1;if(e.tag!==null&&m(e,"duplication of a tag property"),a=e.input.charCodeAt(++e.position),a===60?(i=!0,a=e.input.charCodeAt(++e.position)):a===33?(n=!0,r="!!",a=e.input.charCodeAt(++e.position)):r="!",t=e.position,i){do a=e.input.charCodeAt(++e.position);while(a!==0&&a!==62);e.position<e.length?(s=e.input.slice(t,e.position),a=e.input.charCodeAt(++e.position)):m(e,"unexpected end of the stream within a verbatim tag")}else{for(;a!==0&&!I(a);)a===33&&(n?m(e,"tag suffix cannot contain exclamation marks"):(r=e.input.slice(t-1,e.position+1),Qi.test(r)||m(e,"named tag handle cannot contain such characters"),n=!0,t=e.position+1)),a=e.input.charCodeAt(++e.position);s=e.input.slice(t,e.position),Sa.test(s)&&m(e,"tag suffix cannot contain flow indicator characters")}s&&!Ji.test(s)&&m(e,"tag name cannot contain such characters: "+s);try{s=decodeURIComponent(s)}catch{m(e,"tag name is malformed: "+s)}return i?e.tag=s:U.call(e.tagMap,r)?e.tag=e.tagMap[r]+s:r==="!"?e.tag="!"+s:r==="!!"?e.tag="tag:yaml.org,2002:"+s:m(e,'undeclared tag handle "'+r+'"'),!0}function ja(e){var t,i;if(i=e.input.charCodeAt(e.position),i!==38)return!1;for(e.anchor!==null&&m(e,"duplication of an anchor property"),i=e.input.charCodeAt(++e.position),t=e.position;i!==0&&!I(i)&&!re(i);)i=e.input.charCodeAt(++e.position);return e.position===t&&m(e,"name of an anchor node must contain at least one character"),e.anchor=e.input.slice(t,e.position),!0}function Va(e){var t,i,n;if(n=e.input.charCodeAt(e.position),n!==42)return!1;for(n=e.input.charCodeAt(++e.position),t=e.position;n!==0&&!I(n)&&!re(n);)n=e.input.charCodeAt(++e.position);return e.position===t&&m(e,"name of an alias node must contain at least one character"),i=e.input.slice(t,e.position),U.call(e.anchorMap,i)||m(e,'unidentified alias "'+i+'"'),e.result=e.anchorMap[i],w(e,!0,-1),!0}function se(e,t,i,n,r){var s,a,o,l=1,c=!1,u=!1,d,f,p,h,g,y;if(e.listener!==null&&e.listener("open",e),e.tag=null,e.anchor=null,e.kind=null,e.result=null,s=a=o=Ne===i||qi===i,n&&w(e,!0,-1)&&(c=!0,e.lineIndent>t?l=1:e.lineIndent===t?l=0:e.lineIndent<t&&(l=-1)),l===1)for(;$a(e)||ja(e);)w(e,!0,-1)?(c=!0,o=s,e.lineIndent>t?l=1:e.lineIndent===t?l=0:e.lineIndent<t&&(l=-1)):o=!1;if(o&&(o=c||r),(l===1||Ne===i)&&(Oe===i||Gi===i?g=t:g=t+1,y=e.position-e.lineStart,l===1?o&&(bi(e,y)||Na(e,y,g))||Ra(e,g)?u=!0:(a&&Oa(e,g)||La(e,g)||_a(e,g)?u=!0:Va(e)?(u=!0,(e.tag!==null||e.anchor!==null)&&m(e,"alias node should not have any properties")):Da(e,g,Oe===i)&&(u=!0,e.tag===null&&(e.tag="?")),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):l===0&&(u=o&&bi(e,y))),e.tag===null)e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);else if(e.tag==="?"){for(e.result!==null&&e.kind!=="scalar"&&m(e,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+e.kind+'"'),d=0,f=e.implicitTypes.length;d<f;d+=1)if(h=e.implicitTypes[d],h.resolve(e.result)){e.result=h.construct(e.result),e.tag=h.tag,e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);break}}else if(e.tag!=="!"){if(U.call(e.typeMap[e.kind||"fallback"],e.tag))h=e.typeMap[e.kind||"fallback"][e.tag];else for(h=null,p=e.typeMap.multi[e.kind||"fallback"],d=0,f=p.length;d<f;d+=1)if(e.tag.slice(0,p[d].tag.length)===p[d].tag){h=p[d];break}h||m(e,"unknown tag !<"+e.tag+">"),e.result!==null&&h.kind!==e.kind&&m(e,"unacceptable node kind for !<"+e.tag+'> tag; it should be "'+h.kind+'", not "'+e.kind+'"'),h.resolve(e.result,e.tag)?(e.result=h.construct(e.result,e.tag),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):m(e,"cannot resolve a node with !<"+e.tag+"> explicit tag")}return e.listener!==null&&e.listener("close",e),e.tag!==null||e.anchor!==null||u}function Ha(e){var t=e.position,i,n,r,s=!1,a;for(e.version=null,e.checkLineBreaks=e.legacy,e.tagMap=Object.create(null),e.anchorMap=Object.create(null);(a=e.input.charCodeAt(e.position))!==0&&(w(e,!0,-1),a=e.input.charCodeAt(e.position),!(e.lineIndent>0||a!==37));){for(s=!0,a=e.input.charCodeAt(++e.position),i=e.position;a!==0&&!I(a);)a=e.input.charCodeAt(++e.position);for(n=e.input.slice(i,e.position),r=[],n.length<1&&m(e,"directive name must not be less than one character in length");a!==0;){for(;q(a);)a=e.input.charCodeAt(++e.position);if(a===35){do a=e.input.charCodeAt(++e.position);while(a!==0&&!_(a));break}if(_(a))break;for(i=e.position;a!==0&&!I(a);)a=e.input.charCodeAt(++e.position);r.push(e.input.slice(i,e.position))}a!==0&&yt(e),U.call(yi,n)?yi[n](e,n,r):$e(e,'unknown document directive "'+n+'"')}if(w(e,!0,-1),e.lineIndent===0&&e.input.charCodeAt(e.position)===45&&e.input.charCodeAt(e.position+1)===45&&e.input.charCodeAt(e.position+2)===45?(e.position+=3,w(e,!0,-1)):s&&m(e,"directives end mark is expected"),se(e,e.lineIndent-1,Ne,!1,!0),w(e,!0,-1),e.checkLineBreaks&&Ta.test(e.input.slice(t,e.position))&&$e(e,"non-ASCII line breaks are interpreted as content"),e.documents.push(e.result),e.position===e.lineStart&&He(e)){e.input.charCodeAt(e.position)===46&&(e.position+=3,w(e,!0,-1));return}if(e.position<e.length-1)m(e,"end of the stream or a document separator is expected");else return}function nn(e,t){e=String(e),t=t||{},e.length!==0&&(e.charCodeAt(e.length-1)!==10&&e.charCodeAt(e.length-1)!==13&&(e+=`
`),e.charCodeAt(0)===65279&&(e=e.slice(1)));var i=new Pa(e,t),n=e.indexOf("\0");for(n!==-1&&(i.position=n,m(i,"null byte is not allowed in input")),i.input+="\0";i.input.charCodeAt(i.position)===32;)i.lineIndent+=1,i.position+=1;for(;i.position<i.length-1;)Ha(i);return i.documents}function Ua(e,t,i){t!==null&&typeof t=="object"&&typeof i>"u"&&(i=t,t=null);var n=nn(e,i);if(typeof t!="function")return n;for(var r=0,s=n.length;r<s;r+=1)t(n[r])}function za(e,t){var i=nn(e,t);if(i.length!==0){if(i.length===1)return i[0];throw new S("expected a single document in the stream, but found more")}}var Ya=Ua,Ka=za,rn={loadAll:Ya,load:Ka},an=Object.prototype.toString,sn=Object.prototype.hasOwnProperty,bt=65279,Wa=9,xe=10,Ga=13,qa=32,Qa=33,Ja=34,ut=35,Xa=37,Za=38,es=39,ts=42,on=44,is=45,je=58,ns=61,rs=62,as=63,ss=64,ln=91,cn=93,os=96,un=123,ls=124,dn=125,A={};A[0]="\\0";A[7]="\\a";A[8]="\\b";A[9]="\\t";A[10]="\\n";A[11]="\\v";A[12]="\\f";A[13]="\\r";A[27]="\\e";A[34]='\\"';A[92]="\\\\";A[133]="\\N";A[160]="\\_";A[8232]="\\L";A[8233]="\\P";var cs=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],us=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function ds(e,t){var i,n,r,s,a,o,l;if(t===null)return{};for(i={},n=Object.keys(t),r=0,s=n.length;r<s;r+=1)a=n[r],o=String(t[a]),a.slice(0,2)==="!!"&&(a="tag:yaml.org,2002:"+a.slice(2)),l=e.compiledTypeMap.fallback[a],l&&sn.call(l.styleAliases,o)&&(o=l.styleAliases[o]),i[a]=o;return i}function ps(e){var t,i,n;if(t=e.toString(16).toUpperCase(),e<=255)i="x",n=2;else if(e<=65535)i="u",n=4;else if(e<=4294967295)i="U",n=8;else throw new S("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+i+k.repeat("0",n-t.length)+t}var fs=1,ve=2;function hs(e){this.schema=e.schema||gt,this.indent=Math.max(1,e.indent||2),this.noArrayIndent=e.noArrayIndent||!1,this.skipInvalid=e.skipInvalid||!1,this.flowLevel=k.isNothing(e.flowLevel)?-1:e.flowLevel,this.styleMap=ds(this.schema,e.styles||null),this.sortKeys=e.sortKeys||!1,this.lineWidth=e.lineWidth||80,this.noRefs=e.noRefs||!1,this.noCompatMode=e.noCompatMode||!1,this.condenseFlow=e.condenseFlow||!1,this.quotingType=e.quotingType==='"'?ve:fs,this.forceQuotes=e.forceQuotes||!1,this.replacer=typeof e.replacer=="function"?e.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function xi(e,t){for(var i=k.repeat(" ",t),n=0,r=-1,s="",a,o=e.length;n<o;)r=e.indexOf(`
`,n),r===-1?(a=e.slice(n),n=o):(a=e.slice(n,r+1),n=r+1),a.length&&a!==`
`&&(s+=i),s+=a;return s}function dt(e,t){return`
`+k.repeat(" ",e.indent*t)}function gs(e,t){var i,n,r;for(i=0,n=e.implicitTypes.length;i<n;i+=1)if(r=e.implicitTypes[i],r.resolve(t))return!0;return!1}function Ve(e){return e===qa||e===Wa}function Ee(e){return 32<=e&&e<=126||161<=e&&e<=55295&&e!==8232&&e!==8233||57344<=e&&e<=65533&&e!==bt||65536<=e&&e<=1114111}function vi(e){return Ee(e)&&e!==bt&&e!==Ga&&e!==xe}function Ei(e,t,i){var n=vi(e),r=n&&!Ve(e);return(i?n:n&&e!==on&&e!==ln&&e!==cn&&e!==un&&e!==dn)&&e!==ut&&!(t===je&&!r)||vi(t)&&!Ve(t)&&e===ut||t===je&&r}function ys(e){return Ee(e)&&e!==bt&&!Ve(e)&&e!==is&&e!==as&&e!==je&&e!==on&&e!==ln&&e!==cn&&e!==un&&e!==dn&&e!==ut&&e!==Za&&e!==ts&&e!==Qa&&e!==ls&&e!==ns&&e!==rs&&e!==es&&e!==Ja&&e!==Xa&&e!==ss&&e!==os}function ms(e){return!Ve(e)&&e!==je}function me(e,t){var i=e.charCodeAt(t),n;return i>=55296&&i<=56319&&t+1<e.length&&(n=e.charCodeAt(t+1),n>=56320&&n<=57343)?(i-55296)*1024+n-56320+65536:i}function pn(e){var t=/^\n* /;return t.test(e)}var fn=1,pt=2,hn=3,gn=4,ne=5;function bs(e,t,i,n,r,s,a,o){var l,c=0,u=null,d=!1,f=!1,p=n!==-1,h=-1,g=ys(me(e,0))&&ms(me(e,e.length-1));if(t||a)for(l=0;l<e.length;c>=65536?l+=2:l++){if(c=me(e,l),!Ee(c))return ne;g=g&&Ei(c,u,o),u=c}else{for(l=0;l<e.length;c>=65536?l+=2:l++){if(c=me(e,l),c===xe)d=!0,p&&(f=f||l-h-1>n&&e[h+1]!==" ",h=l);else if(!Ee(c))return ne;g=g&&Ei(c,u,o),u=c}f=f||p&&l-h-1>n&&e[h+1]!==" "}return!d&&!f?g&&!a&&!r(e)?fn:s===ve?ne:pt:i>9&&pn(e)?ne:a?s===ve?ne:pt:f?gn:hn}function xs(e,t,i,n,r){e.dump=(function(){if(t.length===0)return e.quotingType===ve?'""':"''";if(!e.noCompatMode&&(cs.indexOf(t)!==-1||us.test(t)))return e.quotingType===ve?'"'+t+'"':"'"+t+"'";var s=e.indent*Math.max(1,i),a=e.lineWidth===-1?-1:Math.max(Math.min(e.lineWidth,40),e.lineWidth-s),o=n||e.flowLevel>-1&&i>=e.flowLevel;function l(c){return gs(e,c)}switch(bs(t,o,e.indent,a,l,e.quotingType,e.forceQuotes&&!n,r)){case fn:return t;case pt:return"'"+t.replace(/'/g,"''")+"'";case hn:return"|"+wi(t,e.indent)+ki(xi(t,s));case gn:return">"+wi(t,e.indent)+ki(xi(vs(t,a),s));case ne:return'"'+Es(t)+'"';default:throw new S("impossible error: invalid scalar style")}})()}function wi(e,t){var i=pn(e)?String(t):"",n=e[e.length-1]===`
`,r=n&&(e[e.length-2]===`
`||e===`
`),s=r?"+":n?"":"-";return i+s+`
`}function ki(e){return e[e.length-1]===`
`?e.slice(0,-1):e}function vs(e,t){for(var i=/(\n+)([^\n]*)/g,n=(function(){var c=e.indexOf(`
`);return c=c!==-1?c:e.length,i.lastIndex=c,Ci(e.slice(0,c),t)})(),r=e[0]===`
`||e[0]===" ",s,a;a=i.exec(e);){var o=a[1],l=a[2];s=l[0]===" ",n+=o+(!r&&!s&&l!==""?`
`:"")+Ci(l,t),r=s}return n}function Ci(e,t){if(e===""||e[0]===" ")return e;for(var i=/ [^ ]/g,n,r=0,s,a=0,o=0,l="";n=i.exec(e);)o=n.index,o-r>t&&(s=a>r?a:o,l+=`
`+e.slice(r,s),r=s+1),a=o;return l+=`
`,e.length-r>t&&a>r?l+=e.slice(r,a)+`
`+e.slice(a+1):l+=e.slice(r),l.slice(1)}function Es(e){for(var t="",i=0,n,r=0;r<e.length;i>=65536?r+=2:r++)i=me(e,r),n=A[i],!n&&Ee(i)?(t+=e[r],i>=65536&&(t+=e[r+1])):t+=n||ps(i);return t}function ws(e,t,i){var n="",r=e.tag,s,a,o;for(s=0,a=i.length;s<a;s+=1)o=i[s],e.replacer&&(o=e.replacer.call(i,String(s),o)),(j(e,t,o,!1,!1)||typeof o>"u"&&j(e,t,null,!1,!1))&&(n!==""&&(n+=","+(e.condenseFlow?"":" ")),n+=e.dump);e.tag=r,e.dump="["+n+"]"}function Ai(e,t,i,n){var r="",s=e.tag,a,o,l;for(a=0,o=i.length;a<o;a+=1)l=i[a],e.replacer&&(l=e.replacer.call(i,String(a),l)),(j(e,t+1,l,!0,!0,!1,!0)||typeof l>"u"&&j(e,t+1,null,!0,!0,!1,!0))&&((!n||r!=="")&&(r+=dt(e,t)),e.dump&&xe===e.dump.charCodeAt(0)?r+="-":r+="- ",r+=e.dump);e.tag=s,e.dump=r||"[]"}function ks(e,t,i){var n="",r=e.tag,s=Object.keys(i),a,o,l,c,u;for(a=0,o=s.length;a<o;a+=1)u="",n!==""&&(u+=", "),e.condenseFlow&&(u+='"'),l=s[a],c=i[l],e.replacer&&(c=e.replacer.call(i,l,c)),j(e,t,l,!1,!1)&&(e.dump.length>1024&&(u+="? "),u+=e.dump+(e.condenseFlow?'"':"")+":"+(e.condenseFlow?"":" "),j(e,t,c,!1,!1)&&(u+=e.dump,n+=u));e.tag=r,e.dump="{"+n+"}"}function Cs(e,t,i,n){var r="",s=e.tag,a=Object.keys(i),o,l,c,u,d,f;if(e.sortKeys===!0)a.sort();else if(typeof e.sortKeys=="function")a.sort(e.sortKeys);else if(e.sortKeys)throw new S("sortKeys must be a boolean or a function");for(o=0,l=a.length;o<l;o+=1)f="",(!n||r!=="")&&(f+=dt(e,t)),c=a[o],u=i[c],e.replacer&&(u=e.replacer.call(i,c,u)),j(e,t+1,c,!0,!0,!0)&&(d=e.tag!==null&&e.tag!=="?"||e.dump&&e.dump.length>1024,d&&(e.dump&&xe===e.dump.charCodeAt(0)?f+="?":f+="? "),f+=e.dump,d&&(f+=dt(e,t)),j(e,t+1,u,!0,d)&&(e.dump&&xe===e.dump.charCodeAt(0)?f+=":":f+=": ",f+=e.dump,r+=f));e.tag=s,e.dump=r||"{}"}function Ti(e,t,i){var n,r,s,a,o,l;for(r=i?e.explicitTypes:e.implicitTypes,s=0,a=r.length;s<a;s+=1)if(o=r[s],(o.instanceOf||o.predicate)&&(!o.instanceOf||typeof t=="object"&&t instanceof o.instanceOf)&&(!o.predicate||o.predicate(t))){if(i?o.multi&&o.representName?e.tag=o.representName(t):e.tag=o.tag:e.tag="?",o.represent){if(l=e.styleMap[o.tag]||o.defaultStyle,an.call(o.represent)==="[object Function]")n=o.represent(t,l);else if(sn.call(o.represent,l))n=o.represent[l](t,l);else throw new S("!<"+o.tag+'> tag resolver accepts not "'+l+'" style');e.dump=n}return!0}return!1}function j(e,t,i,n,r,s,a){e.tag=null,e.dump=i,Ti(e,i,!1)||Ti(e,i,!0);var o=an.call(e.dump),l=n,c;n&&(n=e.flowLevel<0||e.flowLevel>t);var u=o==="[object Object]"||o==="[object Array]",d,f;if(u&&(d=e.duplicates.indexOf(i),f=d!==-1),(e.tag!==null&&e.tag!=="?"||f||e.indent!==2&&t>0)&&(r=!1),f&&e.usedDuplicates[d])e.dump="*ref_"+d;else{if(u&&f&&!e.usedDuplicates[d]&&(e.usedDuplicates[d]=!0),o==="[object Object]")n&&Object.keys(e.dump).length!==0?(Cs(e,t,e.dump,r),f&&(e.dump="&ref_"+d+e.dump)):(ks(e,t,e.dump),f&&(e.dump="&ref_"+d+" "+e.dump));else if(o==="[object Array]")n&&e.dump.length!==0?(e.noArrayIndent&&!a&&t>0?Ai(e,t-1,e.dump,r):Ai(e,t,e.dump,r),f&&(e.dump="&ref_"+d+e.dump)):(ws(e,t,e.dump),f&&(e.dump="&ref_"+d+" "+e.dump));else if(o==="[object String]")e.tag!=="?"&&xs(e,e.dump,t,s,l);else{if(o==="[object Undefined]")return!1;if(e.skipInvalid)return!1;throw new S("unacceptable kind of an object to dump "+o)}e.tag!==null&&e.tag!=="?"&&(c=encodeURI(e.tag[0]==="!"?e.tag.slice(1):e.tag).replace(/!/g,"%21"),e.tag[0]==="!"?c="!"+c:c.slice(0,18)==="tag:yaml.org,2002:"?c="!!"+c.slice(18):c="!<"+c+">",e.dump=c+" "+e.dump)}return!0}function As(e,t){var i=[],n=[],r,s;for(ft(e,i,n),r=0,s=n.length;r<s;r+=1)t.duplicates.push(i[n[r]]);t.usedDuplicates=new Array(s)}function ft(e,t,i){var n,r,s;if(e!==null&&typeof e=="object")if(r=t.indexOf(e),r!==-1)i.indexOf(r)===-1&&i.push(r);else if(t.push(e),Array.isArray(e))for(r=0,s=e.length;r<s;r+=1)ft(e[r],t,i);else for(n=Object.keys(e),r=0,s=n.length;r<s;r+=1)ft(e[n[r]],t,i)}function Ts(e,t){t=t||{};var i=new hs(t);i.noRefs||As(e,i);var n=e;return i.replacer&&(n=i.replacer.call({"":n},"",n)),j(i,0,n,!0,!0)?i.dump+`
`:""}var Ss=Ts,Is={dump:Ss};function xt(e,t){return function(){throw new Error("Function yaml."+e+" is removed in js-yaml 4. Use yaml."+t+" instead, which is now safe by default.")}}var Ms=C,Fs=Mi,Bs=Di,Ps=Ni,Ds=$i,Ls=gt,_s=rn.load,Rs=rn.loadAll,Os=Is.dump,Ns=S,$s={binary:zi,float:Oi,map:Pi,null:Li,pairs:Ki,set:Wi,timestamp:Hi,bool:_i,int:Ri,merge:Ui,omap:Yi,seq:Bi,str:Fi},js=xt("safeLoad","load"),Vs=xt("safeLoadAll","loadAll"),Hs=xt("safeDump","dump"),Q={Type:Ms,Schema:Fs,FAILSAFE_SCHEMA:Bs,JSON_SCHEMA:Ps,CORE_SCHEMA:Ds,DEFAULT_SCHEMA:Ls,load:_s,loadAll:Rs,dump:Os,YAMLException:Ns,types:$s,safeLoad:js,safeLoadAll:Vs,safeDump:Hs};function we(e){let t=0;for(let i=0;i<e.length;i++){let n=e.charCodeAt(i);t=(t<<5)-t+n,t=t&t}return Math.abs(t).toString(16).padStart(8,"0").slice(0,8)}var vt={P0:1.5,P1:1,P2:.5};function Et(e,t){let i=typeof t.subtype=="string"?t.subtype:void 0,n=$(e,i,t),r=N(e,i),s=r.p0.length===0||r.p0.every(l=>M(n,l)),a=r.p1.some(l=>M(n,l)),o=r.p2.some(l=>M(n,l));return s&&a&&o?"L3":s&&a?"L2":s?"L1":"L0"}function yn(e,t,i,n=1){let r=typeof t.subtype=="string"?t.subtype:void 0,s=$(e,r,t),a=N(e,r);if(![...a.p0,...a.p1,...a.p2].some(c=>M(s,c)))return 0;let l=0;if(a.p0.length>0){let c=a.p0.filter(u=>M(s,u)).length;l+=c/a.p0.length*vt.P0}if(a.p1.length>0){let c=a.p1.filter(u=>M(s,u)).length;l+=c/a.p1.length*vt.P1}if(a.p2.length>0){let c=a.p2.filter(u=>M(s,u)).length;l+=c/a.p2.length*vt.P2}return l*n*(1+Math.log1p(i))}var wt={create(e){let t=new Date().toISOString();return{id:we(e.name),userId:e.userId||"",cardType:e.cardType,name:e.name,aliases:e.aliases||[],attributes:e.attributes||{},relatedPeople:[],relatedObjects:[],relatedThemes:[],evidenceEntryIds:[],confidence:.5,maturity:Et(e.cardType,e.attributes||{}),status:"needs_confirmation",lifecycle:"candidate",importance:0,createdAt:t,lastUpdated:t}}};var Us=Q.dump,zs=Q.load,Ue="---";function J(e){let t={id:e.id,name:e.name,type:e.cardType,maturity:e.maturity,confidence:e.confidence,status:e.status,aliases:e.aliases,createdAt:e.createdAt,lastUpdated:e.lastUpdated};for(let[a,o]of Object.entries(e.attributes))o!=null&&(t[a]=o);let i=[`# ${e.name}`,""],n=qs(e);n.length>0&&(i.push("## \u57FA\u672C\u4FE1\u606F"),i.push(...n),i.push(""));let r=e.attributes.interactions||[];if(r.length>0){i.push("## \u4E92\u52A8\u8BB0\u5F55");for(let a of r.slice(-5)){let o=a.timestamp?new Date(a.timestamp).toISOString().split("T")[0]:"";i.push("- "+o+" "+a.content)}i.push("")}else e.attributes.interactions;let s=Us(t).trim();return`${Ue}
${s}
${Ue}

${i.join(`
`)}`}var Ys=new Set(["L0","L1","L2","L3"]);function Ks(e){return typeof e=="string"&&Ys.has(e)}function oe(e){let i=Ws(e).frontmatter,n=i.type,r=Array.isArray(i.aliases)?i.aliases:[],s=new Set(["needs_confirmation","observing","active","archived"]),a=new Set(["id","name","type","maturity","confidence","aliases","createdAt","lastUpdated","lifecycle","importance","userId","relatedPeople","relatedObjects","relatedThemes","evidenceEntryIds"]),o=i.status,l=o!=null&&s.has(o),c={};for(let[f,p]of Object.entries(i))p!=null&&(a.has(f)||f==="status"&&l||(c[f]=p));let u=typeof c.subtype=="string"?c.subtype:void 0;Pe(n,u,i,c);let d=$(n,u,c);return{id:i.id||we(i.name),userId:"",cardType:n,name:i.name,aliases:r,attributes:d,relatedPeople:[],relatedObjects:[],relatedThemes:[],evidenceEntryIds:[],confidence:typeof i.confidence=="number"?i.confidence:.5,maturity:Ks(i.maturity)?i.maturity:"L0",status:l?o:"needs_confirmation",lifecycle:"candidate",importance:0,createdAt:i.createdAt||new Date().toISOString(),lastUpdated:i.lastUpdated||new Date().toISOString()}}function Ws(e){let t=e.trim();if(!t.startsWith(Ue))return{frontmatter:{},body:t};let i=t.indexOf(Ue,3);if(i===-1)return{frontmatter:{},body:t};let n=t.slice(3,i).trim(),r=t.slice(i+3).trim();return{frontmatter:zs(n)||{},body:r}}function Gs(e,t){let i=new Map,n=L(e);for(let r of n.commonAttributes)i.set(r.key,r.label);if(t&&n.subtypes?.[t])for(let r of n.subtypes[t].attributes)i.has(r.key)||i.set(r.key,r.label);return i}function mn(e,t){if(e[t.key]!=null&&e[t.key]!=="")return e[t.key];if(t.aliases){for(let i of t.aliases)if(e[i]!=null&&e[i]!=="")return e[i]}}function kt(e){if(Array.isArray(e))return e.map(String).join(", ");if(typeof e=="object"&&e!==null)try{return JSON.stringify(e)}catch{return""}return String(e)}function qs(e){let t=[],i=e.attributes,n=typeof i.subtype=="string"?i.subtype:void 0,r=N(e.cardType,n),s=Gs(e.cardType,n),a=L(e.cardType),o=new Map;for(let d of a.commonAttributes)o.set(d.key,d);if(n&&a.subtypes?.[n])for(let d of a.subtypes[n].attributes)o.has(d.key)||o.set(d.key,d);if((e.cardType==="object"||e.cardType==="theme")&&i.subtype){let d=he(e.cardType,i.subtype)||i.subtype;t.push("- \u7C7B\u578B\uFF1A"+d)}let l=new Set(["subtype"]),c=[...r.p0,...r.p1];for(let d of c){if(l.has(d))continue;let f=o.get(d);if(!f)continue;let p=mn(i,f);if(p!==void 0){let h=s.get(d)||d;t.push(`- ${h}\uFF1A${kt(p)}`),l.add(d)}}for(let d of r.p2){if(l.has(d))continue;let f=o.get(d);if(!f)continue;let p=mn(i,f);if(p!==void 0){let h=s.get(d)||d;t.push(`- ${h}\uFF1A${kt(p)}`),l.add(d)}}let u=new Set(o.keys());for(let d of o.values())if(d.aliases)for(let f of d.aliases)u.add(f);for(let[d,f]of Object.entries(i))l.has(d)||u.has(d)||d==="interactions"||d==="relatedEntities"||f!=null&&f!==""&&(t.push(`- ${d}\uFF1A${kt(f)}`),l.add(d));return t}function Qs(e){switch(e){case"person":return"Person/";case"object":return"Object/";case"theme":return"Theme/";default:return""}}function Js(e){return e.replace(/[\\/<>:"|?*]/g,"_").trim()}function bn(e,t){return`${Qs(t)}${Js(e)||"unnamed"}.md`}function xn(e){let t=Xs(e.type);return{path:bn(e.title,t),cardType:t,sanitizedName:e.title}}function Xs(e){return e==="person"?"person":e==="object"?"object":e==="theme"?"theme":e==="project"||e==="thing"?"object":e==="idea"||e==="knowledge"?"theme":"object"}var X={name:"",occupation:"",company:"",city:"",skills:[],roles:[],relationships:[],goals:[],focusAreas:[],lastUpdated:new Date().toISOString().split("T")[0]};function vn(e){let t={...X},i=e.match(/^---\n([\s\S]*?)\n---/);if(i)try{let n=Q.load(i[1]);n&&(typeof n.name=="string"&&(t.name=n.name),typeof n.occupation=="string"&&(t.occupation=n.occupation),typeof n.company=="string"&&(t.company=n.company),typeof n.city=="string"&&(t.city=n.city),Array.isArray(n.skills)&&(t.skills=n.skills.map(String)),Array.isArray(n.roles)&&(t.roles=n.roles.map(String)),Array.isArray(n.relationships)&&(t.relationships=n.relationships.map(String)),Array.isArray(n.goals)&&(t.goals=n.goals.map(String)),Array.isArray(n.focusAreas)&&(t.focusAreas=n.focusAreas.map(String)))}catch{}return!t.name&&!t.company?Zs(e):t}function Zs(e){let t={...X},i=e.split(`
`),n="";for(let r of i){let s=r.trim();if(s.startsWith("## ")){n=s.slice(3);continue}if(n==="\u57FA\u672C\u4FE1\u606F"&&s.startsWith("- ")){let a=s.slice(2),[o,...l]=a.split("\uFF1A"),c=l.join("\uFF1A");o==="\u59D3\u540D"&&(t.name=c),(o==="\u804C\u4E1A"||o==="\u804C\u4F4D")&&(t.occupation=c),(o==="\u516C\u53F8/\u7EC4\u7EC7"||o==="\u516C\u53F8")&&(t.company=c),o==="\u57CE\u5E02"&&(t.city=c)}if(s.startsWith("- ")&&!s.includes("\uFF1A")){let a=s.slice(2);if(a==="_\u6682\u65E0_")continue;n==="\u6280\u80FD\u4E0E\u4E13\u4E1A"&&t.skills.push(a),n==="\u89D2\u8272\u4E0E\u5173\u7CFB"&&t.roles.push(a),n==="\u76EE\u6807\u4E0E\u8BA1\u5212"&&t.goals.push(a),n==="\u5173\u6CE8\u9886\u57DF"&&t.focusAreas.push(a)}if(s.startsWith("- \u5173\u7CFB\uFF1A")&&n==="\u89D2\u8272\u4E0E\u5173\u7CFB"){let a=s.slice(5);a!=="_\u6682\u65E0_"&&t.relationships.push(a)}}return t}var eo="TraceMind/PROFILE.md";async function En(e){let t=e.vault.getFileByPath(eo);if(!t)return{...X};try{let i=await e.vault.read(t);return vn(i)}catch{return{...X}}}V();function to(e,t){let i=`\u4F60\u662F\u4E00\u4E2A\u7CBE\u51C6\u7684\u5B9E\u4F53\u63D0\u53D6\u548C\u65E5\u8BB0\u5206\u7C7B\u4E13\u5BB6\u3002\u8BF7\u5BF9\u4EE5\u4E0B\u65E5\u8BB0\u6587\u672C\u8FDB\u884C\u5206\u6790\u3002
...
${Qt()}`;if(t){let n=t.includes("\u5DF2\u77E5\u5B9E\u4F53");i+=`
...
\u65E5\u8BB0\u6587\u672C\uFF1A
${e}`,i}function io(e){let t=["person","object","theme"];try{let i=e.trim(),n=i.indexOf('{"entities"');if(n>=0){let l=0,c=n;for(let u=n;u<i.length;u++)if(i[u]==="{")l++;else if(i[u]==="}"&&(l--,l===0)){c=u+1;break}i=i.slice(n,c),console.log('[TraceMind] parseLLM: extracted JSON via {"entities"} pattern:',i.substring(0,200))}else{let l=i.lastIndexOf(">");if(l>=0&&l>i.length*.3){let u=i.slice(l+1).trim();u.startsWith("{")&&(i=u)}console.log("[TraceMind] parseLLM: after tag removal (first 200):",i.substring(0,200));let c=i.match(/```(?:json)?\s*\n?([\s\S]*?)```/);if(c&&(i=c[1].trim()),!i.startsWith("{")){let u=i.indexOf("{"),d=i.lastIndexOf("}");u!==-1&&d!==-1&&(i=i.slice(u,d+1))}console.log("[TraceMind] parseLLM: final JSON (first 200):",i.substring(0,200))}let r=JSON.parse(i);if(console.log("[TraceMind] parseLLM: parsed JSON:",JSON.stringify(r).substring(0,200)),!r.entities||!Array.isArray(r.entities))return{entities:[]};let s=["\u5DE5\u4F5C","\u751F\u6D3B","\u5B66\u4E60","\u8FD0\u52A8","\u5176\u4ED6"],a=typeof r.domain=="string"&&s.includes(r.domain)?r.domain:void 0,o=[];for(let l of r.entities)!l.name||typeof l.name!="string"||l.name.trim()===""||t.includes(l.type)&&o.push({name:l.name.trim(),type:l.type,subtype:l.subtype,confidence:typeof l.confidence=="number"?l.confidence:.5});return{domain:a,entities:o}}catch{return{entities:[]}}}async function wn(e,t){let i=t.provider||"openai",n={provider:i,apiKey:t.apiKey,model:t.model,baseUrl:t.baseUrl,enableThinking:t.enableThinking,reasoningEffort:t.reasoningEffort},r=Y(n);if(!r.valid)throw new Error(r.error);console.log("[TraceMind] LLM extract called, provider:",i,"baseUrl:",t.baseUrl,"model:",t.model);let s=to(e,t.profileContext);console.log("[TraceMind] LLM prompt:",s.substring(0,200));let a=ue(n,[{role:"user",content:s}]);console.log("[TraceMind] LLM URL:",a.url);let o=await fetch(a.url,{method:a.method||"POST",headers:a.headers,body:a.body});if(console.log("[TraceMind] LLM response status:",o.status),!o.ok)throw await ce(o);let l=await o.json(),c=Se(i,l);console.log("[TraceMind] LLM raw response:",c.content);let u=io(c.content);return console.log("[TraceMind] LLM parsed: domain=",u.domain,"entities=",u.entities.length,u.entities),u}V();var no={L0:30,L1:20,L2:10,L3:10},ro={P0:10,P1:5,P2:2};function ao(e){let t=no[e.maturityLevel]??10;return e.attributePriority&&(t+=ro[e.attributePriority]??2),e.type==="new_entity"&&(t+=10),t}function Ct(e,t,i,n){let r=[],s=typeof i.subtype=="string"?i.subtype:void 0,a=$(e,s,i),o=N(e,s);for(let l of o.p0)M(a,l)||r.push({type:"missing_attribute",entityName:"",entityType:e,maturityLevel:t,attributePriority:"P0",missingAttribute:l,score:0,description:`Missing P0 attribute: ${l}`});for(let l of o.p1)M(a,l)||r.push({type:"missing_attribute",entityName:"",entityType:e,maturityLevel:t,attributePriority:"P1",missingAttribute:l,score:0,description:`Missing P1 attribute: ${l}`});for(let l of o.p2)M(a,l)||r.push({type:"missing_attribute",entityName:"",entityType:e,maturityLevel:t,attributePriority:"P2",missingAttribute:l,score:0,description:`Missing P2 attribute: ${l}`});t!=="L0"&&n.length===0&&r.push({type:"missing_relation",entityName:"",entityType:e,maturityLevel:t,attributePriority:"P1",score:0,description:"No relations established"});for(let l of r)l.score=ao(l);return r.sort((l,c)=>c.score-l.score)}function so(e){let t={children:new Map,fail:null,output:[]};for(let n of e){let r=t;for(let s of n.text){let a=r.children.get(s);a||(a={children:new Map,fail:null,output:[]},r.children.set(s,a)),r=a}r.output.push({entityName:n.entityName,entityId:n.entityId,matchType:n.matchType,patternLen:n.text.length})}let i=[];for(let n of t.children.values())n.fail=t,i.push(n);for(;i.length>0;){let n=i.shift();for(let[r,s]of n.children){i.push(s);let a=n.fail;for(;a!==null&&!a.children.has(r);)a=a.fail;s.fail=a&&a.children.get(r)||t,s.fail&&s.output.push(...s.fail.output)}}return t}function oo(e,t){let i=[],n=new Set,r=e;for(let s=0;s<t.length;s++){let a=t[s];for(;r!==e&&!r.children.has(a);)r=r.fail;let o=r.children.get(a);o?r=o:r=e;for(let l of r.output){let c=l.entityId+":"+l.matchType;n.has(c)||(n.add(c),i.push({matchedText:t.slice(s-l.patternLen+1,s+1),entityName:l.entityName,entityId:l.entityId,matchType:l.matchType,position:s-l.patternLen+1}))}}return i}function kn(e,t){if(t.length===0)return[];let i=[];for(let r of t){r.name.length>=2&&i.push({text:r.name,entityName:r.name,entityId:r.id,matchType:"exact"});for(let s of r.aliases||[])s.length>=2&&i.push({text:s,entityName:r.name,entityId:r.id,matchType:"alias"});if(r.name.length>=2){let s=r.name.slice(0,Math.min(3,r.name.length));i.filter(o=>o.entityId===r.id&&o.text===s).length===0&&s.length>=2&&i.push({text:s,entityName:r.name,entityId:r.id,matchType:"prefix"})}}i.sort((r,s)=>s.text.length-r.text.length);let n=so(i);return oo(n,e)}var lo=5,Cn={company:"\u8FD9\u4E2A**\u516C\u53F8/\u7EC4\u7EC7**\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u4E1A\u52A1\u9886\u57DF\u3001\u5408\u4F5C\u5173\u7CFB\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002",project:"\u8FD9\u4E2A**\u9879\u76EE**\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5F53\u524D\u72B6\u6001\u3001\u65F6\u95F4\u8282\u70B9\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002",task:"\u8FD9\u4E2A**\u4EFB\u52A1**\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5F53\u524D\u72B6\u6001\u3001\u65F6\u95F4\u8282\u70B9\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002",product:"\u8FD9\u4E2A**\u4EA7\u54C1**\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5F53\u524D\u72B6\u6001\u3001\u5173\u952E\u7279\u6027\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002",technology:"\u8FD9\u4E2A**\u6280\u672F**\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5F53\u524D\u72B6\u6001\u3001\u4E3B\u8981\u7528\u9014\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002",document:"\u8FD9\u4E2A**\u6587\u6863**\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5F53\u524D\u72B6\u6001\u3001\u4E3B\u8981\u7528\u9014\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002",location:"\u8FD9\u4E2A**\u5730\u70B9**\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5728\u54EA\u91CC\u3001\u6709\u4EC0\u4E48\u7279\u522B\u4E4B\u5904\u7B49\u3002"},An={friction:"\u8FD9\u4E2A**\u6469\u64E6**\u80FD\u804A\u804A\u5417\uFF1F\u6BD4\u5982\u662F\u4EC0\u4E48\u5BFC\u81F4\u7684\u3001\u6301\u7EED\u591A\u4E45\u4E86\u3001\u5F71\u54CD\u6709\u591A\u5927\uFF1F",goal:"\u8FD9\u4E2A**\u76EE\u6807**\u80FD\u804A\u804A\u5417\uFF1F\u6BD4\u5982\u76EE\u524D\u8FDB\u5C55\u3001\u4E0B\u4E00\u6B65\u8BA1\u5212\u3001\u6709\u4EC0\u4E48\u963B\u7887\uFF1F",judgment:"\u8FD9\u4E2A**\u5224\u65AD**\u80FD\u804A\u804A\u5417\uFF1F\u6BD4\u5982\u57FA\u4E8E\u4EC0\u4E48\u5F62\u6210\u7684\u3001\u6709\u591A\u5927\u628A\u63E1\uFF1F",idea:"\u8FD9\u4E2A**\u60F3\u6CD5**\u80FD\u804A\u804A\u5417\uFF1F\u6BD4\u5982\u600E\u4E48\u4EA7\u751F\u7684\u3001\u6709\u6CA1\u6709\u66F4\u5177\u4F53\u7684\u601D\u8003\uFF1F"};function Tn(e,t){return e.type==="new_entity"?e.entityType==="object"&&t&&Cn[t]?`${e.entityName} ${Cn[t]}`:e.entityType==="object"?`${e.entityName} \u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5F53\u524D\u72B6\u6001\u3001\u65F6\u95F4\u8282\u70B9\u3001\u76F8\u5173\u80CC\u666F\u7B49\u3002`:e.entityType==="theme"&&t&&An[t]?`${e.entityName} ${An[t]}`:e.entityType==="theme"?`${e.entityName} \u80FD\u804A\u804A\u5417\uFF1F\u6BD4\u5982\u8FD9\u4E2A\u60C5\u51B5\u5F71\u54CD\u6709\u591A\u5927\u3001\u6301\u7EED\u591A\u4E45\u4E86\uFF1F`:e.entityType==="person"?`${e.entityName} \u662F\u8C01\uFF1F\u80FD\u4ECB\u7ECD\u4E00\u4E0B\u5417\uFF1F\u6BD4\u5982\u5728\u54EA\u5BB6\u516C\u53F8\u3001\u4EC0\u4E48\u804C\u4F4D\u3001\u548C\u4F60\u7684\u5173\u7CFB\u7B49\u3002`:`${e.entityName} \u662F\u4EC0\u4E48\uFF1F`:e.type==="missing_attribute"&&e.missingAttribute?{company:e.entityName+" \u5728\u54EA\u4E2A\u516C\u53F8\u6216\u7EC4\u7EC7\u5DE5\u4F5C\uFF1F",role:e.entityName+" \u7684\u804C\u4F4D\u6216\u89D2\u8272\u662F\u4EC0\u4E48\uFF1F",relationship_to_user:"\u4F60\u548C "+e.entityName+" \u662F\u4EC0\u4E48\u5173\u7CFB\uFF1F",responsibility:e.entityName+" \u8D1F\u8D23\u4EC0\u4E48\u5DE5\u4F5C\uFF1F",workingStyle:e.entityName+" \u7684\u534F\u4F5C\u98CE\u683C\u662F\u600E\u6837\u7684\uFF1F",subtype:e.entityName+" \u662F\u4EC0\u4E48\u7C7B\u578B\uFF1F\u6BD4\u5982\u9879\u76EE\u3001\u4EFB\u52A1\u3001\u4EA7\u54C1\u7B49\uFF1F",stage:e.entityName+" \u5F53\u524D\u5904\u4E8E\u4EC0\u4E48\u9636\u6BB5\uFF1F",owner:e.entityName+" \u7684\u8D1F\u8D23\u4EBA\u662F\u8C01\uFF1F",taskStatus:e.entityName+" \u5F53\u524D\u7684\u72B6\u6001\u662F\u4EC0\u4E48\uFF1F",nextAction:e.entityName+" \u7684\u4E0B\u4E00\u6B65\u884C\u52A8\u662F\u4EC0\u4E48\uFF1F",dueDate:e.entityName+" \u6709\u622A\u6B62\u65E5\u671F\u5417\uFF1F",assignee:e.entityName+" \u7531\u8C01\u8D1F\u8D23\uFF1F",parentProject:e.entityName+" \u5C5E\u4E8E\u54EA\u4E2A\u9879\u76EE\uFF1F",useCase:e.entityName+" \u7684\u4E3B\u8981\u7528\u9014\u662F\u4EC0\u4E48\uFF1F",adoptionStatus:e.entityName+" \u5F53\u524D\u91C7\u7528\u72B6\u6001\u5982\u4F55\uFF1F",description:"\u5173\u4E8E "+e.entityName+" \u6709\u4EC0\u4E48\u8865\u5145\u4FE1\u606F\uFF1F",trigger:e.entityName+" \u7684\u89E6\u53D1\u6761\u4EF6\u662F\u4EC0\u4E48\uFF1F",impact:e.entityName+" \u6709\u4EC0\u4E48\u5F71\u54CD\uFF1F",frequency:e.entityName+" \u51FA\u73B0\u7684\u9891\u7387\u5982\u4F55\uFF1F",possibleCause:e.entityName+" \u53EF\u80FD\u7684\u539F\u56E0\u662F\u4EC0\u4E48\uFF1F",claim:e.entityName+" \u7684\u5177\u4F53\u4E3B\u5F20\u662F\u4EC0\u4E48\uFF1F",judgmentConfidence:"\u4F60\u5BF9 "+e.entityName+" \u7684\u786E\u4FE1\u5EA6\u5982\u4F55\uFF1F",evidence:e.entityName+" \u6709\u4EC0\u4E48\u8BC1\u636E\u652F\u6301\uFF1F",counterEvidence:e.entityName+" \u6709\u53CD\u9762\u7684\u8BC1\u636E\u5417\uFF1F",desiredOutcome:e.entityName+" \u671F\u671B\u7684\u7ED3\u679C\u662F\u4EC0\u4E48\uFF1F",currentState:e.entityName+" \u5F53\u524D\u8FDB\u5C55\u5982\u4F55\uFF1F",coreIdea:e.entityName+" \u7684\u6838\u5FC3\u60F3\u6CD5\u662F\u4EC0\u4E48\uFF1F"}[e.missingAttribute]||`\u5173\u4E8E ${e.entityName} \u7684 ${e.missingAttribute} \u4FE1\u606F\u662F\u4EC0\u4E48\uFF1F`:e.type==="missing_relation"?`${e.entityName} \u548C\u4EC0\u4E48\u5176\u4ED6\u5B9E\u4F53\u6709\u5173\u8054\uFF1F`:e.type==="recurring_pattern"?`${e.entityName} \u5DF2\u7ECF\u591A\u6B21\u51FA\u73B0\uFF0C\u5B83\u4EE3\u8868\u4EC0\u4E48\uFF1F`:`\u8BF7\u63D0\u4F9B\u66F4\u591A\u5173\u4E8E ${e.entityName} \u7684\u4FE1\u606F\u3002`}function co(e,t){for(let[i,n]of t)if(n.name===e.name)return{cardId:i,maturity:n.maturity};return null}var ke=class{static analyzeBlock(t,i){return console.warn("[TraceMind] analyzeBlock (sync) is deprecated, use analyzeBlockAsync for LLM extraction"),{entities:[],newEntities:[],existingEntities:[],hasClarifications:!1,gapCount:0}}static async analyzeBlockAsync(t,i,n,r){let s=r&&r.length>0?kn(t,r):[],a=new Set(s.map(g=>g.entityId)),o=r&&r.length>0?r.filter(g=>{if(a.has(g.id))return!0;for(let y=0;y<=g.name.length-2;y++)if(t.includes(g.name.slice(y,y+2)))return!0;for(let y of g.aliases||[])for(let v=0;v<=y.length-2;v++)if(t.includes(y.slice(v,v+2)))return!0;return!1}).slice(0,10):[],l=o.length>0?o.map(g=>{let y=g.aliases&&g.aliases.length>0?"\uFF08\u522B\u540D\uFF1A"+g.aliases.join("\u3001")+"\uFF09":"";return g.name+y+" ["+g.cardType+"]"}).join("\u3001"):"";console.log("[TraceMind] AC scan found",s.length,"matches,",o.length,"candidates for LLM:",l);let c=[],u;if(n&&Y({provider:n.provider||"openai",apiKey:n.apiKey,model:n.model,baseUrl:n.baseUrl}).valid){console.log("[TraceMind] LLM config:",{baseUrl:n.baseUrl,model:n.model,hasApiKey:!!n.apiKey});try{let g={...n,profileContext:n.profileContext?n.profileContext+(l?`

\u5DF2\u77E5\u5B9E\u4F53\uFF08\u5DF2\u5EFA\u6863\uFF0C\u4E0D\u8981\u91CD\u590D\u63D0\u53D6\uFF0C\u6CE8\u610F\u76F8\u4F3C\u540D\u79F0\uFF09\uFF1A`+l:""):l?`

\u5DF2\u77E5\u5B9E\u4F53\uFF08\u5DF2\u5EFA\u6863\uFF0C\u4E0D\u8981\u91CD\u590D\u63D0\u53D6\uFF0C\u6CE8\u610F\u76F8\u4F3C\u540D\u79F0\uFF09\uFF1A`+l:""},y=await wn(t,g);console.log("[TraceMind] LLM extracted:",y.entities.length,y.entities,"domain:",y.domain),c=y.entities.map(v=>({...v})),u=y.domain}catch(g){console.warn("[TraceMind] LLM extraction failed:",g.message)}}else console.log("[TraceMind] No LLM config provided, skipping extraction");let f=new Set(c.map(g=>g.name)),p=new Set;for(let g of s)if(!p.has(g.entityName)&&(p.add(g.entityName),!f.has(g.entityName))){let y=r?.find(v=>v.name===g.entityName);y&&c.push({name:g.entityName,type:y.cardType,confidence:.9})}let h=uo(c,i);return h.domainCategory=u,h}static summarizeResult(t){if(t.entities.length===0)return"\u672A\u68C0\u6D4B\u5230\u9700\u8981\u5173\u6CE8\u7684\u5B9E\u4F53\u3002";let i=[];if(t.newEntities.length>0){let n=t.newEntities.map(r=>r.name).join("\u3001");i.push(`\u53D1\u73B0 ${t.newEntities.length} \u4E2A\u65B0\u5B9E\u4F53\uFF1A${n}`)}if(t.existingEntities.length>0){let n=t.existingEntities.map(r=>r.name).join("\u3001");i.push(`\u63D0\u53CA ${t.existingEntities.length} \u4E2A\u5DF2\u6709\u5B9E\u4F53\uFF1A${n}`)}return t.hasClarifications&&i.push("\u9700\u8981\u8FDB\u4E00\u6B65\u6F84\u6E05\u4FE1\u606F\u3002"),i.join(`
`)}};function uo(e,t){let i=[];for(let a of e){let o=co(a,t),l=a.subtype?{subtype:a.subtype}:{},c=o?.maturity??Et(a.type,l),u=yn(a.type,l,0),d=[];if(o){let h=Ct(a.type,c,l,[]);d.push(...h)}else{d.push({type:"new_entity",entityName:a.name,entityType:a.type,maturityLevel:"L0",attributePriority:"P0",score:40,description:`New entity: ${a.name}`});let h=Ct(a.type,"L0",l,[]);d.push(...h)}let f=d.slice(0,2).map(h=>Tn(h,a.subtype)),p={...a,isNew:!o,existingCardId:o?.cardId,maturity:c,priorityScore:u,clarificationQuestions:f,knowledgeGaps:d};i.push(p)}i.sort((a,o)=>a.isNew!==o.isNew?a.isNew?-1:1:o.priorityScore-a.priorityScore);let n=i.slice(0,lo),r=n.flatMap(a=>a.knowledgeGaps??[]),s=r.sort((a,o)=>o.score-a.score)[0];return{entities:n,newEntities:n.filter(a=>a.isNew),existingEntities:n.filter(a=>!a.isNew),hasClarifications:n.some(a=>a.isNew),gapCount:r.length,firstQuestion:s?Tn(s):void 0}}var po=Q.load,fo=new Set(["L0","L1","L2","L3"]),At=new Set(["id","name","type","subtype","maturity","confidence","aliases","createdAt","lastUpdated","lifecycle","importance","userId","relatedPeople","relatedObjects","relatedThemes","evidenceEntryIds","interactions","filePath","relationCount","summary"]);function z(e,t){let i=ho(e),n=i?.name;n||(n=t.split("/").pop()?.replace(".md","")||"");let r=i?.type||"person",s=i?.maturity,a=s&&fo.has(s)?s:"L0",o=typeof i?.confidence=="number"?i.confidence:.5,l=Array.isArray(i?.aliases)?i.aliases:[],c=i?.summary,u=i?.subtype,d={};if(i)for(let[g,y]of Object.entries(i))!At.has(g)&&y!=null&&(d[g]=y);Pe(r,u,i||{},d);let f=$(r,u,d),p=c||f.summary||d.context||void 0,h={};for(let[g,y]of Object.entries(f))!At.has(g)&&y!=null&&(h[g]=y);for(let[g,y]of Object.entries(d))!At.has(g)&&y!=null&&(!(g in f)||f[g]==null)&&(h[g]=y);return{id:i?.id||we(n),name:n,cardType:r,type:go(r),subtype:u,summary:p,maturity:a,confidence:o,filePath:t,aliases:l,relationCount:0,lastUpdated:i?.lastUpdated||new Date().toISOString(),metadata:Object.keys(h).length>0?h:void 0}}function Sn(e){let t=[];for(let i of e)if(i.content.trim())try{let n=z(i.content,i.path);t.push(n)}catch{}return{entries:t,lastRebuild:new Date().toISOString()}}function ho(e){let t=e.trim();if(!t.startsWith("---"))return null;let i=t.indexOf("---",3);if(i===-1)return null;let n=t.slice(3,i).trim();return po(n)||null}function go(e){switch(e){case"person":return"person";case"object":return"thing";case"theme":return"idea";default:return"thing"}}function In(e,t){let i=t.toLowerCase();return e.entries.filter(n=>n.name.toLowerCase().includes(i)||n.aliases.some(r=>r.toLowerCase().includes(i)))}function Z(e,t){let i=e.entries.findIndex(r=>r.id===t.id),n=[...e.entries];return i>=0?n[i]=t:n.push(t),{entries:n,lastRebuild:e.lastRebuild}}function Mn(e){return JSON.stringify(e,null,2)}function Fn(e){let t=JSON.parse(e);return{entries:t.entries||[],lastRebuild:t.lastRebuild||new Date().toISOString()}}var ze="TraceMind/index/entity-index.json";async function Bn(e,t){await W(e,ze);let i=Mn(t),n=e.vault.getFileByPath(ze);n?await e.vault.modify(n,i):await e.vault.create(ze,i)}async function Pn(e){let t=e.vault.getFileByPath(ze);if(!t)return null;try{return Fn(await e.vault.read(t))}catch{return null}}function Dn(e){let t=JSON.parse(e);return{blockId:t.blockId,content:t.content,messages:t.messages||[],analysisResult:t.analysisResult,createdAt:t.createdAt,updatedAt:t.updatedAt,currentPhase:t.currentPhase||"analysis"}}var yo="TraceMind/sessions";function Tt(e){return`${yo}/${e}.json`}function Ln(e){return Dn(e)}var P=require("obsidian");var ee=["Daily","Person","Object","Theme","TraceMind","TraceMind/sessions","TraceMind/index","TraceMind/insights"],T="TraceMind/PROFILE.md";function _n(e){let t=[];for(let i of ee)e.exists(i)||t.push(`\u76EE\u5F55: ${i}`);return e.exists(T)||t.push(`\u6863\u6848: ${T}`),t}function St(e){let t=[];for(let n of ee){let r=e.getType(n);r===null?t.push({type:"missing_dir",path:n,expected:"folder",actual:"unknown",label:`\u76EE\u5F55\u7F3A\u5931: ${n}`,repairable:!0}):r!=="folder"&&t.push({type:"wrong_type",path:n,expected:"folder",actual:r,label:`\u8DEF\u5F84\u7C7B\u578B\u9519\u8BEF: ${n}\uFF08\u5E94\u4E3A\u76EE\u5F55\uFF0C\u5B9E\u9645\u4E3A${r==="file"?"\u6587\u4EF6":"\u672A\u77E5"}\uFF09`,repairable:!1})}let i=e.getType(T);return i===null?t.push({type:"missing_file",path:T,expected:"file",actual:"unknown",label:`\u6863\u6848\u7F3A\u5931: ${T}`,repairable:!0}):i!=="file"&&t.push({type:"wrong_type",path:T,expected:"file",actual:i,label:`\u8DEF\u5F84\u7C7B\u578B\u9519\u8BEF: ${T}\uFF08\u5E94\u4E3A\u6587\u4EF6\uFF0C\u5B9E\u9645\u4E3A${i==="folder"?"\u76EE\u5F55":"\u672A\u77E5"}\uFF09`,repairable:!1}),t}async function It(e){try{return await e.stat(T)===null}catch{return!0}}function Rn(e,t){new Mt(e,t).open()}var mo=`---
name: ""
occupation: ""
company: ""
city: ""
...
`).trim(),tags:l,blockId:vo(),children:u})}}else n++}return t}var Eo=ee,Ke=class extends R.Plugin{settings;userProfile={...X};analysisService=ke;entityIndex={entries:[],lastRebuild:""};entityManager;sessionManager;aiProvider;aiAnalysisView;blockEditorView;calendarView;async onload(){console.log("TraceMind: loading...");try{await this.loadSettings(),this.userProfile=await En(this.app),Gt(),this.entityManager=new Pt(this.app,this),this.sessionManager=new Dt(this.app),this.aiProvider=new Lt(this),await this.sessionManager.initialize(),this.registerView(O,t=>(this.blockEditorView=new Be(t,this),this.blockEditorView)),this.registerView(ge,t=>(this.aiAnalysisView=new Le(t,this),this.aiAnalysisView)),this.registerView(ye,t=>(this.calendarView=new Re(t,this),this.calendarView.setOnDateClick(i=>this.navigateToDate(i)),this.calendarView)),this.addSettingTab(new Ie(this.app,this)),this.addRibbonIcon("brain","\u6253\u5F00 TraceMind",()=>{this.openTracemindView()}),this.addRibbonIcon("calendar","\u6253\u5F00\u65E5\u5386",()=>{this.openCalendarView()}),this.addCommand({id:"open-tracemind",name:"\u6253\u5F00 TraceMind \u89C6\u56FE",callback:()=>this.openTracemindView()}),this.addCommand({id:"open-calendar",name:"\u6253\u5F00\u65E5\u5386",callback:()=>this.openCalendarView()}),this.addCommand({id:"analyze-block",name:"\u5206\u6790\u5F53\u524D\u65E5\u8BB0\u5757",callback:()=>this.analyzeCurrentBlock()}),this.addCommand({id:"rebuild-index",name:"\u91CD\u5EFA\u5B9E\u4F53\u7D22\u5F15",callback:()=>this.rebuildEntityIndexCommand()}),this.registerEvent(this.app.workspace.on("editor-change",()=>{this.onEditorChange()})),console.log("TraceMind: loaded successfully"),await It(this.app.vault.adapter)?Rn(this.app,async()=>{await this.ensureVaultStructure(),await this.rebuildEntityIndex()}):await this.checkVaultStructureThenContinue()}catch(t){console.error("TraceMind: Failed to load",t),new R.Notice("TraceMind \u52A0\u8F7D\u5931\u8D25: "+t.message)}}onunload(){console.log("TraceMind: unloading...")}async loadSettings(){let t=await this.loadData();this.settings={...Vt,...t};for(let i of this.settings.providers)i.providerType||(i.baseUrl?.includes("anthropic.com")?i.providerType="anthropic":i.baseUrl?.includes("localhost:11434")||i.baseUrl?.includes("127.0.0.1:11434")?i.providerType="ollama":i.providerType="openai")}async saveSettings(){await this.saveData(this.settings)}async ensureVaultStructure(){for(let t of Eo)await ie(this.app,t);console.log("TraceMind: vault structure ensured")}autoAnalysisTimer=null;onEditorChange(){this.autoAnalysisTimer&&clearTimeout(this.autoAnalysisTimer),this.autoAnalysisTimer=setTimeout(()=>{this.autoAnalysisTimer=null},2e3)}async rebuildEntityIndexCommand(){await this.rebuildEntityIndex(),new R.Notice(`\u5B9E\u4F53\u7D22\u5F15\u5DF2\u91CD\u5EFA: ${this.entityIndex.entries.length} \u4E2A\u5B9E\u4F53`)}async initializeEntityIndex(){let t=await Pn(this.app);if(t&&t.entries.length>0){this.entityIndex=t,console.log(`TraceMind: loaded entity index with ${t.entries.length} entries from file`);return}await this.rebuildEntityIndex({persist:!0})}async rebuildEntityIndex(t={persist:!0}){let i=["Person","Object","Theme"],n=[];for(let r of i)try{let s=await this.app.vault.adapter.list(r+"/");for(let a of s.files)if(a.endsWith(".md")){let o=await this.app.vault.adapter.read(a);n.push({path:a,content:o})}}catch{}this.entityIndex=Sn(n),console.log(`TraceMind: entity index rebuilt with ${this.entityIndex.entries.length} entries`),t.persist&&await this.persistEntityIndex()}async checkVaultStructureThenContinue(){let t=St({getType:i=>{let n=this.app.vault.getAbstractFileByPath(i);return n?n.children!==void 0?"folder":"file":null}});if(t.length===0){await this.initializeEntityIndex();return}return new Promise(i=>{On(this.app,t,async()=>{for(let n of t)n.repairable&&(n.type==="missing_dir"?await ie(this.app,n.path):n.type==="missing_file"&&n.path===T&&(this.app.vault.getAbstractFileByPath(T)||await this.app.vault.create(T,`---
name: ""
occupation: ""
company: ""
city: ""
...
## \u5173\u6CE8\u9886\u57DF
- _\u6682\u65E0_
`)));return St({getType:n=>{let r=this.app.vault.getAbstractFileByPath(n);return r?r.children!==void 0?"folder":"file":null}})},()=>{i()},async()=>{await this.initializeEntityIndex(),i()})})}async persistEntityIndex(){try{await Bn(this.app,this.entityIndex)}catch(t){console.error("TraceMind: failed to persist entity index",t),new R.Notice("\u5B9E\u4F53\u7D22\u5F15\u4FDD\u5B58\u5931\u8D25: "+t.message)}}async navigateToDate(t){this.app.workspace.getLeavesOfType(O).length===0&&await this.openTracemindView();let n=this.app.workspace.getLeavesOfType(O);for(let r of n){let s=r.view;typeof s.setCurrentDate=="function"&&await s.setCurrentDate(t)}}async openCalendarView(){let{workspace:t}=this.app,i=t.getLeavesOfType(ye);if(i.length>0)t.revealLeaf(i[0]);else{let n=t.getRightLeaf(!1);n&&(await n.setViewState({type:ye,active:!0}),t.revealLeaf(n))}}async openTracemindView(){let{workspace:t}=this.app,i=t.getLeavesOfType(O);if(i.length>0)t.revealLeaf(i[0]);else{let r=t.getLeaf(!1);r&&(await r.setViewState({type:O,active:!0}),t.revealLeaf(r))}if(t.getLeavesOfType(ge).length===0){let r=t.getRightLeaf(!1);r&&(await r.setViewState({type:ge,active:!0}),t.revealLeaf(r))}}async openBlockEditor(){return this.openTracemindView()}async analyzeCurrentBlock(){let t=this.app.workspace.getActiveFile();if(!t){new R.Notice("\u8BF7\u5148\u6253\u5F00\u4E00\u4E2A\u65E5\u8BB0\u6587\u4EF6");return}let i=await this.app.vault.read(t),n=t.basename;console.log("[TraceMind] analyzeCurrentBlock file:",t.path,"content length:",i.length),console.log("[TraceMind] analyzeCurrentBlock content preview:",i.substring(0,300));try{let r=await this.aiProvider.analyzeBlock(i,n);new R.Notice(`\u5206\u6790\u5B8C\u6210: \u68C0\u6D4B\u5230 ${r.entities.length} \u4E2A\u5B9E\u4F53`),console.log("[TraceMind] analyzeCurrentBlock: tmResult:",r),this.updateAIAnalysis(r)}catch(r){new R.Notice("\u5206\u6790\u5931\u8D25: "+r.message),console.error("TraceMind: analysis error",r)}}getAIAnalysisView(){return this.aiAnalysisView}getBlockEditorView(){return this.blockEditorView}getCalendarView(){return this.calendarView}getEntityManager(){return this.entityManager}getSessionManager(){return this.sessionManager}getAIProvider(){return this.aiProvider}getUserProfile(){return this.userProfile}getUserProfileContext(){let t=this.userProfile,i=[];return t.name&&i.push("\u59D3\u540D\uFF1A"+t.name),t.occupation&&i.push("\u804C\u4E1A\uFF1A"+t.occupation),t.company&&i.push("\u516C\u53F8/\u7EC4\u7EC7\uFF1A"+t.company),t.city&&i.push("\u57CE\u5E02\uFF1A"+t.city),t.skills.length>0&&i.push("\u6280\u80FD\uFF1A"+t.skills.join("\u3001")),t.relationships.length>0&&i.push("\u5173\u7CFB\uFF1A"+t.relationships.join("\u3001")),t.goals.length>0&&i.push("\u76EE\u6807\uFF1A"+t.goals.join("\u3001")),t.focusAreas.length>0&&i.push("\u5173\u6CE8\u9886\u57DF\uFF1A"+t.focusAreas.join("\u3001")),i.length===0?"":`\u7528\u6237\u6863\u6848\uFF1A
`+i.map(function(n){return"- "+n}).join(`
`)}buildAnalysisResult(t,i,n){return Hn(t,i,n)}updateAIAnalysis(t){this.aiAnalysisView&&this.aiAnalysisView.updateAnalysis(t)}getBlockEditorDate(){if(this.blockEditorView&&this.blockEditorView.currentDate){let t=this.blockEditorView.currentDate;if(t instanceof Date&&!isNaN(t.getTime())){let i=t.getFullYear(),n=String(t.getMonth()+1).padStart(2,"0"),r=String(t.getDate()).padStart(2,"0");return`${i}-${n}-${r}`}if(typeof t=="string"&&t.match(/^\d{4}-\d{2}-\d{2}$/))return t}return null}async getCachedInsight(t){try{let i=Ye(t),n=this.app.vault.getFileByPath(i);if(!n)return null;let r=await this.app.vault.read(n);return Nn(r)}catch{return null}}async readDailyDiary(t){try{let i=`Daily/${t}.md`,n=this.app.vault.getFileByPath(i);if(!n){let r=this.app.vault.getFileByPath(`${t}.md`);return r?await this.app.vault.read(r):null}return await this.app.vault.read(n)}catch{return null}}async readYesterdayDiary(t){let i=new Date(t);for(let n=1;n<=7;n++){let r=new Date(i);r.setDate(r.getDate()-n);let s=r.getFullYear(),a=String(r.getMonth()+1).padStart(2,"0"),o=String(r.getDate()).padStart(2,"0"),l=`${s}-${a}-${o}`,c=await this.readDailyDiary(l);if(c)return c}return""}async hasMinimumBlocks(t){let i=await this.readDailyDiary(t);return i?Bt(i).length>=5:!1}async generateDailyInsight(t,i){let n=await this.readDailyDiary(t);if(!n)throw new Error("\u627E\u4E0D\u5230\u4ECA\u5929\u7684\u65E5\u8BB0\u6587\u4EF6");let r=await this.readYesterdayDiary(t),s=this.getUserProfileContext(),a=Zt(this.entityIndex.entries),o=Xt({todayBlocks:n,yesterdayBlocks:r,profileContext:s,entityIndexSummary:a}),l=this.getAIProvider().getProviderForContext("analysis");if(!l)throw new Error("\u8BF7\u5148\u5728\u8BBE\u7F6E\u4E2D\u914D\u7F6E AI Provider");let c={provider:l.providerType||"openai",apiKey:l.apiKey,model:l.model,baseUrl:l.baseUrl,enableThinking:l.enableThinking,reasoningEffort:l.reasoningEffort},u="",d=null;if(await qe(o,c,{onDelta:g=>{u+=g,i.onDelta(g)},onDone:g=>{},onError:g=>{d=g,i.onError(g)}}),d)throw d;if(!u)throw new Error("LLM \u8FD4\u56DE\u4E86\u7A7A\u5185\u5BB9");let f=await De(n,r),p=Bt(n),h={date:t,content:u,contentHash:f,generatedAt:new Date().toISOString(),blockCount:p.length};return await jn(this.app,h),i.onDone(u),h}};function Hn(e,t,i,n){let r=[],s=[],a=[],o={people:r,objects:s,dimensions:a},l={person:"people",object:"objects",theme:"dimensions"},c=[];for(let u of e){let d=l[u.type],f=i.indexOf(u.name),p=u.name;if(f>=0){let h=Math.max(0,f-20),g=Math.min(i.length,f+u.name.length+30),y=i.slice(h,g);h>0&&(y="..."+y),g<i.length&&(y+="..."),p=y}o[d].push({type:u.type,name:u.name,confidence:u.confidence??.5,context:p,isArchived:!!u.existingCardId,newEntity:u.isNew,maturity:u.maturity,priorityScore:u.priorityScore,clarificationQuestions:u.clarificationQuestions}),u.isNew&&c.push(u.name)}return{blockId:t,timestamp:new Date().toISOString(),category:c.length>0?"\u5F85\u786E\u8BA4":n||"\u5DE5\u4F5C",areas:n?[n]:[],entities:{people:r,objects:s,dimensions:a},needsConfirmation:c,aiResponse:wo(e)}}function wo(e){let t=[];for(let i of e)i.clarificationQuestions.length>0&&t.push(`\u5173\u4E8E ${i.name}\uFF1A${i.clarificationQuestions[0]}`);return t.length===0?`\u68C0\u6D4B\u5230\u4EE5\u4E0B\u5B9E\u4F53\uFF1A${e.map(n=>n.name).join("\u3001")}\u3002`:t.join(`
`)}var Pt=class{constructor(t,i){this.app=t;this.plugin=i}app;plugin;findEntity(t){let i=In(this.plugin.entityIndex,t);return i.find(r=>r.name.toLowerCase()===t.toLowerCase())||i[0]||null}getEntity(t){return this.plugin.entityIndex.entries.find(i=>i.id===t)||null}async createEntity(t){let i=ko(t.type),n=t.aliases||[],r=wt.create({name:t.title,cardType:i,attributes:t.metadata||{},aliases:n});t.interactions&&Array.isArray(t.interactions)&&(r.attributes.interactions=t.interactions);let{path:s}=xn({title:t.title,type:t.type});await W(this.app,s);let a=this.app.vault.getFileByPath(s);if(a){let c=await this.app.vault.read(a),u=z(c,s);return this.plugin.entityIndex=Z(this.plugin.entityIndex,u),await this.plugin.persistEntityIndex(),{...t,id:u.id}}let o=J(r);await this.app.vault.create(s,o);let l=z(o,s);return this.plugin.entityIndex=Z(this.plugin.entityIndex,l),await this.plugin.persistEntityIndex(),{...t,id:l.id}}async updateEntity(t,i){let n=this.getEntity(t);if(!n)return;let r=this.app.vault.getFileByPath(n.filePath);if(!r)return;let s=await this.app.vault.read(r),a=oe(s);for(let[c,u]of Object.entries(i))c==="lastUpdated"?a.lastUpdated=u:c==="interactions"?a.attributes.interactions=u:c==="aliases"&&Array.isArray(u)?a.aliases=u:a.attributes[c]=u;a.lastUpdated=i.lastUpdated||new Date().toISOString();let o=J(a);await this.app.vault.modify(r,o);let l=z(o,n.filePath);this.plugin.entityIndex=Z(this.plugin.entityIndex,l),await this.plugin.persistEntityIndex()}wikifyContent(t){let i=t;i=i.replace(/\[\[(Person|Object|Theme)\/(?:\[\[(?:Person|Object|Theme)\/[^\]]+\]\])\|([^\]]+)\]\]/g,"[[$1/$2|$2]]");let r=[...this.plugin.entityIndex.entries].sort((a,o)=>o.name.length-a.name.length),s=[];for(let a of r){let o=a.cardType==="person"?"Person":a.cardType==="object"?"Object":"Theme";a.name.length>=2&&s.push({term:a.name,name:a.name,folder:o});for(let l of a.aliases||[])l.length>=2&&s.push({term:l,name:a.name,folder:o})}s.sort((a,o)=>o.term.length-a.term.length);for(let a of s){let o=a.term.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");if(!new RegExp("(?<!\\[\\[)"+o+"(?!\\]\\|)").test(i))continue;let l="[["+a.folder+"/"+a.name+"|"+a.term+"]]",c=new RegExp("(?<!\\[\\[)"+o+"(?!\\]\\|)","g");i=i.replace(c,l)}return i}async refreshWikilinks(t){let i=this.getEntity(t);if(!i)return;let n=this.app.vault.getFileByPath(i.filePath);if(!n)return;let r=await this.app.vault.read(n),s=oe(r),a=s.attributes.interactions||[],o=!1;for(let l of a)if(l.content&&typeof l.content=="string"){let c=this.wikifyContent(l.content);c!==l.content&&(l.content=c,o=!0)}if(o){s.attributes.interactions=a;let l=J(s);await this.app.vault.modify(n,l);let c=z(l,i.filePath);this.plugin.entityIndex=Z(this.plugin.entityIndex,c),await this.plugin.persistEntityIndex()}}async addInteraction(t,i){let n=this.getEntity(t);if(!n)return;let r=this.app.vault.getFileByPath(n.filePath);if(!r)return;let s=await this.app.vault.read(r),a=oe(s),o=a.attributes.interactions||[];o.push(i),a.attributes.interactions=o,a.lastUpdated=new Date().toISOString();let l=J(a);await this.app.vault.modify(r,l);let c=z(l,n.filePath);this.plugin.entityIndex=Z(this.plugin.entityIndex,c),await this.plugin.persistEntityIndex()}async linkRelatedEntities(t){if(!(t.length<2)){for(let i of t){let n=this.findEntity(i.name);if(!n)continue;let r=this.app.vault.getFileByPath(n.filePath);if(!r)continue;let s=await this.app.vault.read(r),a=oe(s);for(let c of t)c.name!==i.name&&(c.type==="person"?a.relatedPeople.includes(c.name)||a.relatedPeople.push(c.name):c.type==="object"?a.relatedObjects.includes(c.name)||a.relatedObjects.push(c.name):c.type==="theme"&&(a.relatedThemes.includes(c.name)||a.relatedThemes.push(c.name)));let o=J(a);await this.app.vault.modify(r,o);let l=z(o,n.filePath);this.plugin.entityIndex=Z(this.plugin.entityIndex,l)}await this.plugin.persistEntityIndex()}}async enrichEntity(t,i){return i}buildEntityIndex(){let t=new Map;for(let i of this.plugin.entityIndex.entries)t.set(i.id,new Set([i.name,...i.aliases]));return t}},Dt=class{constructor(t){this.app=t}app;cache=new Map;chatSession={blockId:"chat:global",messages:[],createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};async initialize(){try{let t=await this.app.vault.adapter.list("TraceMind/sessions/");for(let i of t.files)if(i.endsWith(".json")){let n=await this.app.vault.adapter.read(i),r=Ln(n);this.cache.set(r.blockId,this.toViewSession(r))}}catch{}}getSession(t,i){return this.cache.get(t)||null}getOrCreateSession(t,i){let n=this.cache.get(t);if(n)return n;let r={blockId:t,content:"",messages:[],analysisResult:null,reviewCards:{},createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),currentPhase:"detection"};return this.cache.set(t,r),r}setContent(t,i,n){let r=this.getOrCreateSession(t,n);r.content=i,r.updatedAt=new Date().toISOString(),this.writeSession(t,r)}setSession(t,i,n){let r=this.getOrCreateSession(t,n),s={...r,...i,blockId:t,updatedAt:new Date().toISOString(),analysisResult:i.analysisResult??r.analysisResult};return this.cache.set(t,s),this.writeSession(t,s),s}setAnalysisResult(t,i,n){let r=this.getOrCreateSession(t,n);r.analysisResult=i,r.updatedAt=new Date().toISOString(),r.currentPhase="complete",this.cache.set(t,r),this.writeSession(t,r)}addMessage(t,i,n){let r=this.getOrCreateSession(t,n);r.messages.push(i),r.updatedAt=new Date().toISOString(),this.cache.set(t,r),this.writeSession(t,r)}addChatMessage(t){this.chatSession.messages.push(t),this.chatSession.updatedAt=new Date().toISOString()}getChatSession(){return this.chatSession}clearChatSession(){this.chatSession={blockId:"chat:global",messages:[],createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()}}async clearSession(t){this.cache.delete(t);try{let i=this.app.vault.getFileByPath(Tt(t));i&&await this.app.vault.delete(i)}catch{}}updateReviewCard(t,i,n,r){let s=this.getOrCreateSession(t,r);s.reviewCards||(s.reviewCards={}),s.reviewCards[i]={status:n.status||"pending",supplement:n.supplement,updatedAt:new Date().toISOString()},s.updatedAt=new Date().toISOString(),this.cache.set(t,s),this.writeSession(t,s)}writeSession(t,i){try{let n=Tt(t),r={blockId:i.blockId,content:i.content,messages:i.messages,createdAt:i.createdAt,updatedAt:i.updatedAt,currentPhase:i.currentPhase};i.analysisResult&&(r.analysisResult=i.analysisResult);let s=JSON.stringify(r,null,2),a=this.app.vault.getFileByPath(n);a?this.app.vault.modify(a,s):this.app.vault.create(n,s)}catch(n){console.error("TraceMind: failed to write session",n)}}toViewSession(t){return{blockId:t.blockId,content:t.content,messages:t.messages,analysisResult:t.analysisResult??null,reviewCards:t.reviewCards??{},createdAt:t.createdAt,updatedAt:t.updatedAt,currentPhase:t.currentPhase||"detection"}}},Lt=class{constructor(t){this.plugin=t}plugin;isReady(){let{settings:t}=this.plugin;if(!t.defaultProviderId)return!1;let i=t.providers.find(n=>n.id===t.defaultProviderId);return!!i&&!!i.apiKey&&!!i.baseUrl}async chat(t,i){let n=this.getProviderForContext(i??"chat");if(!n)throw new Error("No AI provider configured");let{chat:r}=await Promise.resolve().then(()=>(V(),Qe));return{content:(await r(t.map(a=>({role:a.role,content:a.content})),{provider:n.providerType||"openai",apiKey:n.apiKey,model:n.model,baseUrl:n.baseUrl,enableThinking:n.enableThinking,reasoningEffort:n.reasoningEffort})).content,usage:{promptTokens:0,completionTokens:0,totalTokens:0}}}async streamChat(t,i,n){let r=this.getProviderForContext(n??"chat");if(!r){i.onError(new Error("No AI provider configured"));return}let{streamChat:s}=await Promise.resolve().then(()=>(V(),Qe));await s(t.map(a=>({role:a.role,content:a.content})),{provider:r.providerType||"openai",apiKey:r.apiKey,model:r.model,baseUrl:r.baseUrl,enableThinking:r.enableThinking,reasoningEffort:r.reasoningEffort},i)}async analyzeBlock(t,i=""){let n=new Map;for(let l of this.plugin.entityIndex.entries)n.set(l.id,{name:l.name,cardType:l.type,maturity:l.maturity||"L0"});console.log("[TraceMind] analyzeBlock: loaded",n.size,"existing cards from index");let r=this.getProviderForContext("analysis");if(!r)return console.warn("[TraceMind] analyzeBlock: no AI provider configured, cannot extract entities"),new R.Notice("\u8BF7\u5148\u5728\u8BBE\u7F6E\u4E2D\u914D\u7F6E AI Provider"),{entities:[],newEntities:[],existingEntities:[],hasClarifications:!1,gapCount:0};console.log("[TraceMind] analyzeBlock: using LLM extraction, provider:",r.name);let s=this.plugin.getUserProfileContext(),a=await ke.analyzeBlockAsync(t,n,{apiKey:r.apiKey||"",model:r.model||"gpt-4",baseUrl:r.baseUrl||"",provider:r.providerType,enableThinking:r.enableThinking,reasoningEffort:r.reasoningEffort,profileContext:s||void 0},this.plugin.entityIndex.entries);console.log("[TraceMind] analyzeBlock result entities:",a.entities.length,a);let o=Hn(a.entities,i,t,a.domainCategory);return{...o,analysisResult:o}}getProviderForContext(t){let{settings:i}=this.plugin,n=i.agentProviderMapping,r=t==="analysis"?n.analysis:n.chat;if(r){let s=i.providers.find(a=>a.id===r);if(s)return s}return this.getDefaultProvider()}getDefaultProvider(){let{settings:t}=this.plugin;return t.defaultProviderId&&t.providers.find(i=>i.id===t.defaultProviderId)||null}};function ko(e){return e==="person"?"person":e==="object"?"object":e==="theme"?"theme":e==="project"||e==="thing"?"object":e==="idea"||e==="knowledge"?"theme":"object"}var Co=Ke;0&&(module.exports={TraceMindPlugin});
